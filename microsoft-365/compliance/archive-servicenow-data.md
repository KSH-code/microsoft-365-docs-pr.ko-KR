...
- ServiceNow 응용 프로그램을 만들어 ServiceNow 계정에서 데이터를 페치합니다. 응용 프로그램을 만드는 단계별 지침은 [Merge1 Third-Party Connectors 사용자 가이드를 참조하십시오.](https://docs.ms.merge1.globanetportal.com/Merge1%20Third-Party%20Connectors%20ServiceNow%20User%20Guide%20.pdf)
