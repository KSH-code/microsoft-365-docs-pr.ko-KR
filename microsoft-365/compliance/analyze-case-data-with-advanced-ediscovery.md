...
**Prepare** \> 고급 eDiscovery의 **분석** 프로세스 준비 과정에서는 포함 된 파일에 다음 기능을 적용 합니다. 
...
## <a name="additional-resources-for-advanced-ediscovery-classic-analysis"></a>고급 eDiscovery (클래식) 분석용 추가 리소스
