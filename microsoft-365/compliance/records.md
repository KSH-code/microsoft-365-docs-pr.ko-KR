...
:::image type="content" source="media/recordversioning7.png" alt-text="레코드로 태그가 지정된 문서에 대한 세부 정보 창":::
...
:::image type="content" source="media/recordversioning8.png" alt-text="레코드로 태그가 지정된 문서의 레코드 상태 속성":::
...
:::image type="content" source="media/recordversioning9.png" alt-text="레코드 문서가 잠금 해제됨을 표시하는 레코드 상태":::
...
:::image type="content" source="media/recordversioning10.png" alt-text="자료 보존 라이브러리에 표시된 레코드":::
...
:::image type="content" source="media/recordversioning11.png" alt-text="자료 보존 라이브러리":::

<br/><br/>

:::image type="content" source="media/recordversioning12.png" alt-text="자료 보존 라이브러리의 레코드 폴더":::
...
:::image type="content" source="media/recordversioning13.png" alt-text="기록 버전 관리 이벤트에 대한 감사 로그 검색":::
