...
5. **지능형** 검색 페이지에서 참가자 위험 정책에 대 한 [변칙 및 공격적인 언어](insider-risk-management-policies.md#intelligent-detections) 검색을 구성 합니다.
...
9. **모니터링 창 선택** 페이지에는 **참가자 위험 설정** > **정책** 기간 페이지의 정책에 대 한 [모니터링 창 조건이](insider-risk-management-policies.md#policy-timeframes) 표시 됩니다. *Departing employee data 절도* policy template을 선택한 경우에는 MICROSOFT 365 HR 커넥터에서 종료 날짜 이후의 작업을 검색 하기 위해 *작업 후 종료 확인* 확인란을 선택할 수 있습니다.
