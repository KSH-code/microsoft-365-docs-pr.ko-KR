...
1. Microsoft 365 [](https://compliance.microsoft.com)센터에서 내부자 위험 관리로 이동한 후  페이지의 오른쪽 위 모서리에서 내부자 위험 설정을 선택합니다. 
