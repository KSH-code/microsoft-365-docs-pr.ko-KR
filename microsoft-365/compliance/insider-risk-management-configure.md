...
이 정책은 중요 한 정보에 대 한 높은 심각도 DLP 경고에 대 한 참가자 위험 관리 지표를 제공 하는 데 도움이 되며, 조직의 전체 위험 관리 범위를 구성 하는 데 있어 중요 한 요소입니다. 참가자 위험 관리 및 DLP 정책 통합 및 계획 고려 사항에 대 한 자세한 내용은 [참가자 위험 관리 정책을](insider-risk-management-policies.md#data-leaks)참조 하세요.
