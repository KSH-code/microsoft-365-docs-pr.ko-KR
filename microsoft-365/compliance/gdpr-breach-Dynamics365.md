...
선언된 CRSPI에 대한 알림 프로세스는 빠르게 이동하는 보안 위험을 고려하면서 최대한 신속하게 발생됩니다. 일반적으로 인시던트 조사가 진행되는 동안에 알림 작성 프로세스가 수행됩니다. 고객 알림은 다음 상황을 *제외하고* 위반을 선언한 시점으로부터 즉시 전달됩니다.
