...
고급 eDiscovery를 사용 하 여 데이터를 분석 하려면 &amp; Microsoft 365 보안 &amp; 준수 센터의 **콘텐츠 검색** 페이지에 나열 된 365 콘텐츠 검색의 결과와 보안 &amp; 및 준수 센터의 **ediscovery** 페이지에 나열 된 ediscovery 사례와 연결 된 검색을 사용할 수 있습니다. 
...
> [!NOTE]
> Office 365 외부에 데이터가 있고이를 Office 365로 가져와서 고급 eDiscovery에서이를 준비 하 고 분석할 수 있도록 하려면 office 365에서 [PST 파일을 365 office로 가져오기 개요](https://support.office.com/article/ba688e0a-0fcb-4bd7-8e57-2b669564ea84) 및 [타사 데이터 보관](https://go.microsoft.com/fwlink/p/?linkid=716918)을 참조 하세요. 
