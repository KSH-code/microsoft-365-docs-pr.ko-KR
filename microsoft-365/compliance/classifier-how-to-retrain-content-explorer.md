...
8. 피드백 **보내기를** 선택하면 평가, 분류 및 기타 학습 가능한 분류자 제안이 `match` `not a match` 있습니다. 분류자에 30개 피드백 인스턴스를 제공하면 자동으로 재조정됩니다. 재조정은 1시간에서 4시간까지 걸릴 수 있습니다. 분류자에는 하루 두 번만 재조정할 수 있습니다.
...
11. 재 교육이 완료되면 분류기를 선택해 재조정 개요를 열 수 있습니다.
