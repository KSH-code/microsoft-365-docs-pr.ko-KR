...
4. 커넥터를 식별하는 고유한 이름을 입력하고 다음을 **선택합니다.**
...
저장 & 완료를 선택하면 Microsoft  365 준수 센터의 커넥터 마법사에 있는 사용자 매핑 페이지가 표시됩니다.
...
3. 원본이 **있는 커넥터** 상태  아래에서 다운로드 로그 링크를 선택하여 커넥터의 상태 로그를 열거나 저장합니다. 이 로그에는 Microsoft 클라우드로 가져온 데이터가 포함되어 있습니다.
