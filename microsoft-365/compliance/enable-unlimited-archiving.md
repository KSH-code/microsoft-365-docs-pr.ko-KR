...
값은 자동 확장 보관이 비활성 사서함에 대해 사용하도록 설정되어 있는  `True` 것입니다. 값은 자동 확장 보관이 사용되지 않는 `False` 경우를 나타냅니다.
...
- 자동 확장 보관을 켜면 보관을 해제할 수 있습니다. 또한 관리자는 자동 확장 보관에 대한 저장소 할당량도 조정할 수 없습니다.

- 자동 확장 보관은 Exchange 하이브리드 배포의 클라우드 기반 보관 사서함에 대해 지원됩니다. 그러나 클라우드 기반 보관 사서함에 대해 자동 확장 보관을 사용하도록 설정한 후 사서함을 다시 보관하는 오프보드를 On-premises Exchange 조직에 오프보드할 수 없습니다. 자동 확장 보관은 모든 버전의 사서함에 대해 지원되지 Exchange Server.
