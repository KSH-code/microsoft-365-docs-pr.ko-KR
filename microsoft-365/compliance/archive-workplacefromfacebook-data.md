...
3. Microsoft 365 규정 준수 센터에서 만든 Facebook 커넥터에서 Workplace를 매일 Veritas Merge1에 연결하고 Workplace 항목을 Microsoft 클라우드의 안전한 Azure Storage 위치로 전송합니다.
...
Facebook 커넥터에서 Workplace를 만든 후 규정 준수 센터에서 커넥터 상태를 Microsoft 365 있습니다.
