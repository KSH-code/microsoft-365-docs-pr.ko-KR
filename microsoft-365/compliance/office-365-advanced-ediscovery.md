...
> [!IMPORTANT]
> **고급 eDiscovery (클래식)는 2020 년 12 월 31 일에 영구적으로 폐기 됩니다.**<br/>
> 최신 버전의 Advanced eDiscovery에 계속 투자 하면 고급 eDiscovery (클래식)에서 사례 및 사례 데이터를 영구적으로 회수 하 고 제거 하는 것을 알리는 것입니다.
> *고급 ediscovery v 1.0*이 라고도 하는 클래식 (advanced ediscovery)을 계속 사용 하 고 있는 경우에는 가능한 한 빨리 고급 ediscovery [v 2.0](overview-ediscovery-20.md) ( *Microsoft 365의 고급 ediscovery 솔루션*이 라고도 함)을 사용 하세요.  모든 사례 및 사례 데이터를 제거 하는 방법에 대 한 준비에서는 [사례에서 데이터를 내보내서](https://docs.microsoft.com/microsoft-365/compliance/export-results-in-advanced-ediscovery?view=o365-worldwide)사례 데이터를 보관할 수 있습니다.
> Advanced eDiscovery v 2.0에는 Advanced eDiscovery v 1.0에 있는 유사한 기능이 포함 되어 있지만 custodian 관리, 통신 관리 및 검토 집합과 같은 다양 한 새로운 기능도 제공 됩니다. 고급 eDiscovery v 1.0의 이전 retirment 단계에 대 한 자세한 내용은 [레거시 ediscovery 도구의 만료](legacy-ediscovery-retirement.md#advanced-ediscovery-v10)를 참조 하세요.
