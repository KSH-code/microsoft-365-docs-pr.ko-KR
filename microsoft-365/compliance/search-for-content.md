...
- 바이러스, 위험한 첨부 파일 또는 피싱 메시지를 [검색 하 고 삭제 하는 메시지 등의 전자 메일 메시지](search-for-and-delete-messages-in-your-organization.md)
...
- 대/소문자에 대응 하는 항목이 해당 폴더에 있는 것으로 확신 하는 경우 [특정 사서함 및 사이트 폴더](use-content-search-for-targeted-collections.md) (a * 대상 모음 이라고 함) 검색
