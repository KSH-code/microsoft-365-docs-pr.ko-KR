---
title: 모바일 Windows 10 도구를 Windows 11 장치 온보드 및 장치 관리
f1.keywords: NOCSH
ms.author: chrfox
author: chrfox
manager: laurawi
...
ms.locfileid: "60950860"
---
# <a name="onboard-windows-10-and-windows-11-devices-using-mobile-device-management-tools"></a>모바일 Windows 10 도구를 Windows 11 장치 온보드 및 장치 관리
...
MDM(모바일 장치 관리) 솔루션을 사용하여 장치를 구성할 수 있습니다. Microsoft 365 보호는 장치 관리 정책을 만들 수 있는 OMA-URIs MDM을 지원합니다.
...
- [그룹 정책을 Windows 10 장치 온보드](device-onboarding-gp.md)
- [Windows 10 사용하여 장치 온보드 Microsoft Endpoint Configuration Manager](device-onboarding-sccm.md)
- [로컬 스크립트를 사용하여 Windows 10 장치 온보딩](device-onboarding-script.md)
