...
규정 준수 관리자는 이제 GA(규정 준수 센터) 내에서 종합적인 준수 관리 솔루션으로 Microsoft 365 [있습니다.](microsoft-365-compliance-center.md) 이 릴리스를 통해 준수 관리자는 Microsoft Service Trust Portal에서 이전 위치의 전환을 완료합니다. 준수 관리자는 미국 정부 Community(GCC) 보통, GCC 및 DoD(국방부) 고객에게도 제공됩니다.
...
[Microsoft 준수 관리자는](https://compliance.microsoft.com/compliancemanager) 보다 [간편하고 편리한](microsoft-365-compliance-center.md) Microsoft 365 규정 준수 요구 사항을 관리하는 데 도움이 되는 Microsoft 365 규정 준수 센터의 기능입니다. 규정 준수 관리자는 데이터 보호 위험 인벤토리를 수집하는 것부터 제어 구현의 복잡도 관리, 규정 및 인증을 최신으로 유지, 감사자에 보고하는 것까지 규정 준수 여정 전체를 도울 수 있습니다.
...
평가는 특정 규정, 표준 또는 정책의 컨트롤 그룹화입니다. 평가 내에서 조치를 완료하면 표준, 규정 또는 법률의 요구 사항을 충족하는 데 도움이됩니다. 예를 들어, 그 안의 모든 작업을 완료하면 ISO 27001 요구 사항에 Microsoft 365 설정이 도움이 된다고 평가할 수 있습니다.
...
데이터 개인 정보 보호 규정을 준수하는 데 도움을 주기 위해 규정 준수 관리자를 사용하는 등 모든 사용자에 대해 기능을 계획하고 구현하기 위한 종단 Microsoft 365 안내하는 워크플로를 설계했습니다. 자세한 내용은 [Microsoft 365를 사용하여 데이터 개인 정보 보호 규정을 위한 정보 보호를 구현합니다](../solutions/information-protection-deploy.md)(aka.ms/m365dataprivacy)를 참조하세요. 