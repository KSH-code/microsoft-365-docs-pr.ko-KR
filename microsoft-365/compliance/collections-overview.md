---
title: Advanced eDiscovery의 컬렉션 개요
f1.keywords:
- NOCSH
ms.author: markjjo
author: markjjo
...
- MOE150
- MET150
description: Advanced eDiscovery의 컬렉션을 사용하여 사례 또는 조사와 관련이 있는 콘텐츠를 검색하고 수집합니다.
...
---
# <a name="learn-about-collections-in-advanced-ediscovery"></a>Advanced eDiscovery의 컬렉션에 대한 자세한 정보

> [!NOTE]
> 이 문서에서 설명하는 Advanced eDiscovery에서 새 컬렉션 환경을 출시할 것입니다. 이 롤아웃은 모든 조직에서 사용할 수 있도록 하기까지 몇 주가 소요됩니다. 조직에서 새 컬렉션 환경을 사용할 수 없는 경우에도 [Advanced eDiscovery](create-search-to-collect-data.md)검색 도구를 사용하여 사례 콘텐츠를 수집할 수 있습니다.
...
Advanced eDiscovery의 컬렉션이 릴리스되고 나면 Microsoft 365  규정 준수 센터의 Advanced eDiscovery 사례에서 검색 탭의 이름도 컬렉션으로 업데이트되었습니다.  컬렉션의 범위와 크기를 정의하는 단계는 검색과 동일한 프로세스에 따라 위치 및 조건을 정의합니다. 초안으로 저장 및 미리 보기 예상 결과 보기를 사용하면 전체 검색 및 컬렉션을 검토 집합에 커밋하기 전에 대상 컬렉션 범위를 빠르게 유효성 검사할 수 있습니다. 이렇게 하면 검색 및 수집 프로세스 중에 콘텐츠를 최소화하기 위해 작업을 관리하고 대상이 지정되는 작업을 다시 시작할 수 있습니다.

## <a name="collections-workflow"></a>컬렉션 워크플로

Advanced eDiscovery의 컬렉션 사용을 시작하기 위해 프로세스의 각 단계에 대한 기본 워크플로 및 설명은 다음과 있습니다.

![Advanced eDiscovery의 컬렉션 워크플로](../media/CollectionsWorkflow.png)
