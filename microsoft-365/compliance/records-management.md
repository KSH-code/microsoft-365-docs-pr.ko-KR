...
- **콘텐츠를 레코드로 레이블** 최종 사용자가 적용하는 [레코드 레이블](records.md)을 게시하거나 특정한 중요 정보, 키워드 또는 콘텐츠 유형을 포함하는 항목에 레코드 레이블을 [자동으로 적용](labels.md#applying-a-retention-label-automatically-based-on-conditions)합니다.
