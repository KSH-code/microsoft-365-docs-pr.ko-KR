...
- **콘텐츠를 레코드로 레이블** 콘텐츠를 [레코드](records.md)로 선언하여 최종 사용자가 적용하거나 중요한 정보, 키워드 또는 콘텐츠 유형을 식별하여 [자동으로 적용](labels.md#applying-a-retention-label-automatically-based-on-conditions)할 수 있는 보존 레이블을 작성하고 게시합니다.
