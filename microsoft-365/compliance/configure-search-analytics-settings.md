...
- 임계값: 두 문서의 유사성 수준이 임계값을 초과 하면 동일한 중복 집합에 저장 됩니다.
...
- 동적으로 최대 테마 수 조정: 경우에 따라 원하는 수의 테마를 만들 수 있는 문서가 충분 하지 않을 수 있습니다. 이 설정을 사용 하도록 설정 하는 경우 원하는 최대 테마 수를 강제 실행 하는 것이 아니라 시스템에서 최대 테마 수를 동적으로 조정 합니다.
