...
## <a name="overview-of-dlp-for-microsoft-teams"></a>데이터용 DLP 개요 Microsoft Teams
...
## <a name="add-microsoft-teams-as-a-location-to-existing-dlp-policies"></a>기존 Microsoft Teams DLP 정책에 위치로 추가
...
## <a name="define-a-new-dlp-policy-for-microsoft-teams"></a>사용자에 대한 새 DLP 정책을 Microsoft Teams
