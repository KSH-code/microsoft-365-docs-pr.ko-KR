...
description: Microsoft 365의 내부자 위험 관리 사용자 대시보드에 대해 자세히 알아보시다
...
- **위험 수준:** 사용자의 현재 계산된 위험 수준입니다. 이 점수는 24시간마다 계산하며 사용자와 연결된 모든 활성 경고의 경고 위험 점수를 사용 합니다. 트리거 표시기만 있는 사용자의 경우 위험 수준은 0입니다.
...
- **사용자 프로필** 탭
    - **이름 및 제목:** Azure Active Directory의 사용자 이름 및 위치 제목입니다. 내부자 위험 관리에 대한 전역 비어 있는 경우 이러한 사용자 필드는 비어 있거나 비어 있습니다.
...
내부자 위험 관리 사용자를 위해 Power Automate 흐름을 실행, 관리 또는 만들 수 있습니다.
