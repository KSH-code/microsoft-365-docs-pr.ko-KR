...
|:-----------------------------|:----------------|:--------------|
| 신규| **악성 URL이 포함된 전자 메일 메시지가 전달 후 제거됨**   | 0179B3F7-3FDA-40C3-8F24-278563978DBB |
| 신규| **악성 파일이 포함된 전자 메일 메시지가 전달 후 제거됨**  | 8E6BA277-EF39-404E-AAF1-294F6D9A2B88 |
| 신규| **캠페인의 전자 메일 메시지가 전달되었다가 나중에 제거됨** | ef850570-5624-42b2-ff0a-08d8d899d578 |
| 신규|**악성 전자 메일이 전송되었다가 나중에 제거됨**                | a1f563cc-fb1f-466b-1fb5-08d8d71a3050 |
...
| e **Discovery 시작 또는 내보내기**| 6FDC5710-3998-47F0-AFBB-57CEFD7378AE | 보통| 정보 |
|||||
...
| **캠페인의 전자 메일 메시지가 전달되었다가 나중에 제거됨**(신규) | 경고는 2021년 5월 14일부터 트리거됩니다.|
| **악성 전자 메일이 전송되었다가 나중에 제거됨**(신규) | 경고는 2021년 5월 14일부터 트리거됩니다.|
| **피싱 URL이 포함된 전자 메일 메시지가 전달 후 제거됨**(기존. 제거 예정)| 경고 정책은 2021년 5월 14일에 제거될 예정입니다. [이러한 변경 사항에 대해 대비하는 데 필요한 작업](#what-you-need-to-do-to-prepare-for-these-changes) 섹션을 참조하세요.|
| **맬웨어가 포함된 전자 메일 메시지가 전달 후 제거됨**(기존. 제거 예정) | 경고 정책은 2021년 5월 14일에 제거될 예정입니다. [이러한 변경 사항에 대해 대비하는 데 필요한 작업](#what-you-need-to-do-to-prepare-for-these-changes) 섹션을 참조하세요. |
|||
...
새 경고가 울리기 시작하고 위에 나열된 날짜에 조직의 AIR 조사가 트리거됩니다. 제거할 두 가지 경고를 운영하는 보안 조직에 미치는 영향을 줄이기 위해 기존 경고 정책에 의해 트리거된 경고 *및* 2021년 4월 5일부터 2021년 5월 14일 사이에 새 경고 정책에 의해 트리거된 경고가 표시됩니다. 이는 보안 팀이 필요한 변경 사항을 처리할 수 있는 시간을 제공하기 위한 것입니다. 이 짧은 기간 동안 경고 볼륨이 증가한 보안 팀을 지원하기 위해 기존 경고와 새 경고가 모두 동일한 AIR 조사와 연관되고 동일한 인시던트로 연관됩니다. 보다 구체적으로, 여기에는 알림, AIR 조사 및 인시던트에 대한 다음과 같은 동작이 포함됩니다.
...
조직에서 이러한 경고를 활용하는 방법에 따라 준비해야 할 작업이 결정됩니다. 경고를 작동하여 API, 경고 전자 메일 알림을 통해 사용하거나 Office 365 보안 및 준수 센터(`https://protection.office.com/viewalerts`) 또는 Microsoft 보안 센터(`https://security.microsoft.com/viewalerts`)에서 경고를 사용하고 있는 경우 워크플로를 수정해야 합니다.
...
- 아무것도 하지 마세요. 당사는 2021년 5월 14일에 기존 경고 정책을 비활성화할 예정입니다.

**이러한 경고를 작동한 경우:**

- 2021년 5월 14일에 기존 경고 정책이 제거될 것으로 예상하고 워크플로의 일부로 새 경고를 사용하기 시작하세요. 티켓팅 시스템에 사용자 지정 로직, 경고 전자 메일 알림을 받는 보안 편지함 또는 경고 이름 또는 경고 정책 ID(CorrelationId)에 따라 달라지는 SIEM 솔루션이 있는 경우 변경 사항을 수용하도록 논리를 수정해야 합니다.
...
- 수정한 후에는 기존 경고 정책을 실행 중지하여 조직의 경고 볼륨을 줄일 수 있습니다.
  ...
  또는 이러한 경고 정책을 2021년 5월 14일에 삭제하기 전까지 활성화 상태로 둘 수 있습니다.
