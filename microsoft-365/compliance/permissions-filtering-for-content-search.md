...
또한 검색 권한 필터링을 사용 하 여 사서함, SharePoint 사이트, OneDrive 계정 등의 사용자 콘텐츠 위치를 제어 하는 Office 365 조직 내에서 *준수 경계*라고 하는 논리적 경계를 만들 수 있습니다. 특정 eDiscovery 관리자가 검색할 수 있습니다. 자세한 내용은 [Office 365에서 eDiscovery 조사에 대 한 준수 경계 설정을](tagging-and-assessment-in-advanced-ediscovery.md)참조 하세요.
...
- 준수 보안 필터 cmdlet을 실행 하려면 보안 & 준수 센터에서 조직 관리 역할 그룹의 구성원 이어야 합니다. 자세한 내용은 [Security & 준수 센터의 사용 권한을](/security/office-365-security/protect-against-threats.md)참조 하세요.
