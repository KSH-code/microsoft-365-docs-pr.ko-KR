...
|Inclusive_type  <br/> |메일  <br/> |0-포함 하지 않음, 1-포괄, 2 포함 마이너스, 3 포함 복사본 값에 따라 파일이 포함 되는지 여부를 나타냅니다.  <br/> |예  <br/> |예  <br/> |
...
|Email_participant_domains  <br/> |메일  <br/> |누락 된 링크를 포함 하 여 전자 메일 스레드에 있는 모든 참가자의 도메인입니다.  <br/> |예  <br/> |예  <br/> |
|Email_sender  <br/> |메일  <br/> |전자 메일 보낸 사람 이름 및/또는 주소입니다.  <br/> |예  <br/> |예  <br/> |
|Email_sender_domain  <br/> |메일  <br/> |전자 메일 보낸 사람의 도메인  <br/> |예  <br/> |예  <br/> |
|Email_to  <br/> |메일  <br/> |전자 메일의 받는 사람입니다.  <br/> |예  <br/> |예  <br/> |
|Email_cc  <br/> |메일  <br/> |전자 메일의 참조 받는 사람입니다.  <br/> |예  <br/> |예  <br/> |
...
|Email_has_attachment  <br/> |메일  <br/> |전자 메일에 첨부 파일이 하나 이상 있는지를 나타냅니다.  <br/> |아니요  <br/> |예  <br/> |
|Email_importance  <br/> |메일  <br/> |전자 메일 중요도 속성  <br/> |아니요  <br/> |예  <br/> |
|Email_level  <br/> |메일  <br/> |전자 메일 스레드 내에서 전자 메일의 수준을 나타냅니다. 첨부 파일의 경우 첨부 된 전자 메일의 값입니다.  <br/> |아니요  <br/> |예  <br/> |
|Email_recipients  <br/> |메일  <br/> |전자 메일 받는 사람 이름, 참조 및 숨은 참조  <br/> |아니요  <br/> |예  <br/> |
|Email_security  <br/> |메일  <br/> |전자 메일 보안 속성  <br/> |아니요  <br/> |예  <br/> |
|Email_sensitivity  <br/> |메일  <br/> |전자 메일 민감도 속성  <br/> |아니요  <br/> |예  <br/> |
...
|Parent_node  <br/> |메일  <br/> |전자 메일 스레드의 노드를 누락 된 링크가 아닌 가장 가까운 상위 노드에 연결 합니다.  <br/> |아니요  <br/> |예  <br/> |
|Set_order_inclusives_first  <br/> |메일  <br/> |전자 메일 및 첨부 파일: 카운터가 시간순으로 정렬 됩니다 (먼저 Inclusives). 문서: 먼저 피벗 및 유사성 점수에 따라 정렬 합니다.  <br/> |아니요  <br/> |예  <br/> |
