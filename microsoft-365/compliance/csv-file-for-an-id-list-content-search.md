...
1. 보안 & 준수 센터에서 새 또는 안내가 제공 되는 콘텐츠 검색을 만들고 실행 합니다.

2. 콘텐츠 검색 결과를 내보내거나 콘텐츠 검색 보고서를 내보냅니다. 자세한 내용은 다음을 참조하세요.
...
3. 전체 **문서 ID** 열을 마우스 오른쪽 단추로 클릭 하 고 **셀 서식을**선택 합니다.

4. **범주** 상자에서 **숫자**를 클릭 합니다.

5. 소수 자릿수를 **0**으로 변경 하 고 **확인** 을 클릭 하 여 변경 내용을 저장 합니다. 문서 ID 열의 값이 번호로 변경 됩니다.
