...
ms.locfileid: "60010084"
---
# <a name="information-barriers-in-microsoft-365"></a>Microsoft 365의 정보 장벽

Microsoft 365를 사용하면 그룹과 조직 전체에서 통신 및 공동 작업을 할 수 있으며, 필요한 경우 특정 사용자 그룹 간 통신 및 공동 작업을 제한하는 방법을 지원할 수 있습니다. 여기에는 조직에서 이해 상충이 발생하지 않도록 두 그룹 간의 통신 및 공동 작업을 제한하려는 상황이나 시나리오가 포함됩니다. 여기에는 내부 정보를 보호하기 위해 조직 내부의 특정 사용자 간의 통신 및 공동 작업을 제한해야 하는 상황도 포함됩니다.
...
1. Microsoft 365의 [정보 장벽에](information-barriers.md) 대한 자세한 정보
2. 선행 [구성 및 사용 권한 구성](information-barriers-policies.md#step-1-make-sure-prerequisites-are-met)
3. 조직에서 [사용자 세그먼트화](information-barriers-policies.md#step-2-segment-users-in-your-organization)
4. 정보 장벽 [정책 만들기 및 구성](information-barriers-policies.md#step-3-define-information-barrier-policies)
5. 정보 [장벽 정책 적용](information-barriers-policies.md#step-4-apply-information-barrier-policies)
