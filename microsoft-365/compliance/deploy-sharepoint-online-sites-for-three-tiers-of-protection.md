...
디자인 프로세스에 대한 자세한 내용은 [격리된 SharePoint Online 팀 사이트 디자인](/security/office-365-security/design-an-isolated-sharepoint-online-team-site.md)을 참조하세요.
...
자세한 단계는 [격리된 SharePoint Online 팀 사이트 배포](/security/office-365-security/design-an-isolated-sharepoint-online-team-site.md)의 **1단계**를 참조하세요.
...
1. IT 관리자 또는 사이트에 대한 액세스 요청에 응답하고 처리할 책임이 있는 다른 사용자(belindan@contoso.com - UPN의 한 가지 예)의 UPN(사용자 계정 이름)을 결정합니다. 
...
자세한 단계는 [격리된 SharePoint Online 팀 사이트 배포](/security/office-365-security/design-an-isolated-sharepoint-online-team-site.md)를 참조하세요.
