...
Microsoft 365 준수 센터의 Veritas 커넥터를 사용하여 확대/축소 모임에서 조직 내 사용자 사서함으로 데이터를 Microsoft 365 수 있습니다. Veritas는 [](https://globanet.com/zoom/) 타사 데이터 원본에서 항목을 캡처하고 해당 항목을 정기적으로 가져오도록 구성된 확대/축소 모임 커넥터를 Microsoft 365. 커넥터는 채팅, 녹음된 파일 및 메타데이터를 포함하여 모임의 콘텐츠를 확대/축소 모임 계정에서 전자 메일 메시지 형식으로 변환한 다음 모임의 사용자 사서함으로 Microsoft 365.
...
3. Microsoft 365 준수 센터에서 만든 확대/축소 모임 커넥터는 매일 Veritas Merge1에 연결하고 모임 메시지를 Microsoft 클라우드의 안전한 Azure Storage 위치로 전송합니다.
...
확대/축소 모임 커넥터를 만든 후 준수 센터에서 커넥터 상태를 Microsoft 365 있습니다.
