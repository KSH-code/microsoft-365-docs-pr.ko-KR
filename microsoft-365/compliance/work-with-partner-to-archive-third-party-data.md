...
1. 사용자 계정을 만들고 계획 Exchange Online 라이선스를 할당합니다. 에 [사용자 추가를 Microsoft 365.](../admin/add-users/add-users.md) 계획 2 라이선스는 사서함을 소송 자료 보관에 두거나 무제한 저장소 할당량인 보관 사서함을 사용하도록 설정하는 데 필요합니다.
