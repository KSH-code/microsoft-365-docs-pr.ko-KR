...
ms.locfileid: "34431709"
---
# <a name="gdpr"></a>GDPR

이 라이브러리는 GDPR(일반 데이터 보호 규정)에 대한 기술 지침을 제공합니다.

- [정보 보호](gdpr-information-protection.md)
- [데이터 주체 요청](gdpr-data-subject-requests.md)
- [위반 알림](gdpr-breach-notification.md)

Microsoft가 GDPR을 지원하는 방법에 대한 자세한 내용은 보안 센터의 [GDPR 개요](https://www.microsoft.com/en-us/trustcenter/privacy/gdpr/gdpr-overview)를 참조하세요.
