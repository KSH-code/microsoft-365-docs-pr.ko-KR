...
-   **저장소 계정.** Azure Storage(Blob)의 위치를 선택합니다. 자세한 내용은 [Microsoft Azure Storage 소개 - Blob 저장소](https://docs.microsoft.com/azure/storage/common/storage-introduction#blob-storage) 문서를 참조하세요.
