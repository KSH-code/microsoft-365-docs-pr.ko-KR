...
|위치|위치|위치|문서가 원본으로 사용된 위치의 유형을 나타내는 문자열입니다.<br /><br />**가져온 데이터** - 비영구 Office 365 데이터<br />**Teams** - Microsoft Teams<br />**Exchange** - Exchange 사서함<br />**SharePoint** - SharePoint 사이트<br />**OneDrive** - OneDrive 계정|
