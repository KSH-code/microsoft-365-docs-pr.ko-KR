...
다음 개요에서는 커넥터를 사용하여 피벗 데이터를 커넥터에 보관하는 Microsoft 365.

![피벗 데이터에 대한 보관 워크플로입니다.](../media/PivotConnectorWorkflow.png)
...
1. 피벗 사용자를 사용자 Microsoft 365 **매핑 페이지에서** 자동 사용자 매핑을 사용하도록 설정합니다. 피벗 항목에는 조직의 사용자에 대한 전자 메일 주소가 포함된 *Email이라는* 속성이 포함됩니다. 커넥터가 이 주소를 Microsoft 365 사용자 사서함으로 항목을 가져올 수 있습니다.
