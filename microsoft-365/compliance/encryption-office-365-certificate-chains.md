...
| **핀(SHA-256)** | H0IkzshPyZztiB/2/P0+IfjFGcVHqmpd094kcwLOUNE= |
...
| **제목** | CN=D-TRUST Root Class 3 CA 2 2009<br>O=D-Trust GmbH<br>C=DE |
| --- | --- |
| **일련 번호** | 09:83:F3 |
| **공개 키 길이** | RSA 2048비트(e 65537) |
| **서명 알고리즘** | sha256RSA |
...
| **핀(SHA-256)** | 7KDxgUAs56hlKzG00DbfJH46MLf0GlDZHsT5CwBrQ6E= |
...
| **제목** | CN=D-TRUST Root Class 3 CA 2 EV 2009<br>O=D-Trust GmbH<br>C=DE |
| --- | --- |
| **일련 번호** | 09:83:F4 |
| **공개 키 길이** | RSA 2048비트(e 65537) |
| **서명 알고리즘** | sha256RSA |
...
| **핀(SHA-256)** | K87oWBWM9UZfyddvDfoxL+8lpNyoUB2ptGtn0fv6G2Q= |
...
| **제목** | CN=VeriSign Class 3 Public Primary Certification Authority - G5<br>OU= &quot; (c) 2006 VeriSign, Inc. - 권한이 부여된 사용 전용&quot;<br>OU=VeriSign Trust Network<br>O= &quot; VeriSign, Inc.&quot;<br>C=US |
| --- | --- |
...
| **핀(SHA-256)** | JbQbUG5JMJUoI6brnx0x3vZF6jilxsapbXGVfjhN8Fg= |
...
| --- | --- |
| **발급자** | CN=CNNIC ROOT <br>O=CNNIC <br>C=CN |
| **일련 번호** | 49:33:00:7C |
| **공개 키 길이** | RSA 2048비트(e 65537) |
| **서명 알고리즘** | sha256RSA |
...
| **핀(SHA-256)** | dKZRcLDh7hBNZTmTIHOGJ6C2Om/ITjUCPkOnLTnrZXk= |
...
| --- | --- |
| **발급자** | CN=D-TRUST Root Class 3 CA 2 2009<br>O=D-Trust GmbH<br>C=DE |
| **주체 대체 이름** | RFC822 Name=info@d-trust.net<br>URL=http://www.d-trust.net |
| **일련 번호** | 09:90:63 |
| **공개 키 길이** | RSA 2048비트(e 65537) |
| **서명 알고리즘** | sha256RSA |
...
| **핀(SHA-256)** | 9w0QP9HzLXkfs+4zENaUFq2XKcQON1oyksoJ+Gg2AZE= |
| **CRL URL** | ldap://directory.d-trust.net/CN=D-TRUST%20Root%20Class%203%20CA%202%202009,O=D-Trust%20GmbH,C=DE?certificaterevocationlist<br>http://www.d-trust.net/crl/d-trust\_root\_class\_3\_ca\_2\_2009.crl |
...
| **제목** | CN=D-TRUST SSL Class 3 CA 1 EV 2009<br>O=D-Trust GmbH<br>C=DE |
| --- | --- |
| **발급자** | CN=D-TRUST Root Class 3 CA 2 EV 2009<br>O=D-Trust GmbH<br>C=DE |
| **주체 대체 이름** | RFC822 Name=info@d-trust.net<br>URL=http://www.d-trust.net |
| **일련 번호** | 09:90:64 |
| **공개 키 길이** | RSA 2048비트(e 65537) |
| **서명 알고리즘** | sha256RSA |
...
| **공개 키 길이** | RSA 2048 비트 |
| **서명 알고리즘** | sha256RSA |
| **이전이 아닌 유효성** | 2020년 9월 24일 목요일 오후 5:00 |
| **다음 기간까지의 유효 기간** | 2030년 9월 24일 화요일 오후 4:59 |
...
| **제목** | CN=DigiCert SHA2 High Assurance Server CA<br>OU=www.digicert.com<br>O=DigiCert Inc<br>C=US |
| --- | --- |
| **발급자** | CN=DigiCert High Assurance EV Root CA<br>OU=www.digicert.com<br>O=DigiCert Inc<br>C=US |
...
| **핀(SHA-256)** | k2v657xBsOVe1PQRwOsHsw3bsGT2VzIqz5K+59sNQws= |
| **CRL URL** | http://crl4.digicert.com/DigiCertHighAssuranceEVRootCA.crl |
| **OCSP URL** | http://ocsp.digicert.com |
...
| **핀(SHA-256)** | LvRiGEjRqfzurezaWuj8Wie2gyHMrW5Q06LspMnox7A= |
...
| **핀(SHA-256)** | 86fLIetopQLDNxFZ0uMI66Xpl1pFgLlHn9v6kT0i4I= |
...
| **핀(SHA-256)** | IQBnBEiFuhj+8x6X8XLgh01V9Ic5/V3IRQLNFFc7v4= |
...
### <a name="lets-encrypt-authority-x3"></a>**기관 X3 암호화**

| **제목** | CN=Let's Encrypt Authority X3<br>O=암호화<br>C=US |
| --- | --- |
| **발급자** | CN=DST Root CA X3<br>O=Digital Signature Trust Co. |
...
| **핀(SHA-256)** | YLh1dUR9y6Kja30RrAn7JKnbQG/uEtLMkBgFF2Fuihg= |
...
### <a name="microsoft-azure-tls-issuing-ca-02"></a>**Microsoft Azure TLS 발행 CA 02**
...
### <a name="microsoft-azure-tls-issuing-ca-05"></a>**Microsoft Azure TLS 발행 CA 05**
...
| **제목** | CN=Symantec Class 3 EV SSL CA - G3<br>OU=Symantec Trust Network<br>O=Symantec Corporation<br>C=US |
| --- | --- |
| **발급자** | CN=VeriSign Class 3 Public Primary Certification Authority - G5<br>OU= &quot; (c) 2006 VeriSign, Inc. - 권한이 부여된 사용 전용&quot;<br>OU=VeriSign Trust Network<br>O= &quot; VeriSign, Inc.&quot;<br>C=US |
...
| **핀(SHA-256)** | gMxWOrX4PMQesK9qFNbYBxjBfjUvlkn/vN1n+L9lE5E= |
...
| **핀(SHA-256)** | 9n0izTnSRF+W4W4JTq51avSXkWhQB8duS2bxVLfzXsY= |
| **CRL URL** | http://s1.symcb.com/pca3-g5.crl |
| **OCSP URL** | http://s2.symcb.com |
...
| **핀(SHA-256)** | /36ymPAVaJl3QDyB1lUkVf9GqJNug0R8JJPDN6348p8= |
...
다음 목록에는 위에 포함되지 않은 레거시 인증서가 포함되어 있으며 시간이 지날 때 위의 목록과 병합됩니다.
