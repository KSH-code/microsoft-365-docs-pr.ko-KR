...
상업용 Microsoft 365 사용자, Outlook.com 사용자 및 다른 전자 메일 공급자 (예: Gmail 및 Yahoo)의 기타 사용자를 포함 하 여 GCC를 제외한 모든 받는 사람은 래퍼 메일을 받습니다. 이 래퍼 메일은 받는 사람이 메시지를 읽고 회신할 수 있는 OME 포털에 받는 사람을 리디렉션합니다.
