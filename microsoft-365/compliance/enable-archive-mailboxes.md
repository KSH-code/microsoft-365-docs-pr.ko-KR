...
Microsoft 365 규정 준수 센터의 **보관함** 페이지에서 사용자의 보관 사서함을 비활성화할 수도 있습니다. 보관 사서함을 비활성화 한 후 다시 연결할 수 있습니다이 사용자의 기본 사서함을 해제 후 30 일 이내. 이 경우 보관 사서함의 원래 내용은 복원 됩니다. 30 일이 지나면 원래 보관 사서함의 내용을 영구적으로 삭제 하 고 복구할 수 없습니다. 따라서 아카이브 해제 한 후 30 일 이상 다시 설정, 보관 사서함이 새로 만들어집니다.
