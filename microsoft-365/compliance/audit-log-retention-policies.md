...
1. [https://compliance.microsoft.com](https://compliance.microsoft.com)으로 이동하여 보안 및 규정 준수 센터의 권한 페이지에서 조직 구성 역할이 할당된 사용자 계정으로 로그인합니다.
...
## <a name="manage-audit-log-retention-policies"></a>감사 로그 보존 정책 관리
...
정책을 삭제하려면 **삭제** ![삭제 아이콘](../media/92a9f8e0-d469-48da-addb-69365e7ffb6f.jpg) 아이콘을 클릭한 후에 정책의 삭제를 확인합니다. 정책이 대시보드에서 제거되지만 조직에서 정책이 제거되는 데 최대 30분이 걸릴 수 있습니다.
