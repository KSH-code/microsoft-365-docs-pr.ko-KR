...
조직에서 제어하는 중요한 항목을 식별하고 분류하는 것은 정보 보호 분야의 [첫 번째 단계입니다.](protect-information.md)  Microsoft 365는 항목을 분류할 수 있도록 세 가지 방법으로 항목을 식별합니다.
...
- 패턴: 패턴은 중요한 정보 유형이 검색하는 것을 정의합니다. 다음 구성 요소로 구성됩니다.
    - 기본 요소 - 중요한 정보 유형이 찾는 기본 요소입니다. 체크 um  유효성 검사, 키워드 목록, 키워드 사전 또는 함수를 포함하거나 포함하지 않은 정규식일 수 **있습니다.**
...
중요한 정보 유형 엔터티  정의에서 신뢰 수준은 기본 요소 외에 검색되는 받던 증거의 정도를 반영합니다. 항목에 더 많은 지원 증거가 포함되어 있는 경우 일치하는 항목에 찾고 있는 중요한 정보가 포함되어 있다는 신뢰도가 높아지기만 합니다. 예를 들어 신뢰 수준이 높은 일치는 기본 요소의 근접성에서 더 많은 지원 증거를 포함하고 신뢰 수준이 낮은 일치는 근접한 증거를 거의 또는 거의 포함하지 않습니다. 
...
- **높은 신뢰도**: 값 85, 일치하는 항목은 오타가 가장 적지만 거짓 부정은 가장 적습니다.  

높은 신뢰도 패턴은 낮은 수(5~10)와 높은 수를 사용하는 낮은 신뢰도 패턴(20 이상)을 사용해야 합니다.
...
> [!NOTE]
> 향상된 신뢰 수준은 Microsoft 365 서비스에 대한 데이터 손실 방지, Microsoft 365 서비스용 Microsoft Information Protection, 통신 준수, 정보 거버넌스 및 레코드 관리 내에서 즉시 사용할 수 있습니다.
