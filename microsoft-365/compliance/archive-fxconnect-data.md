...
다음 개요에서는 커넥터를 사용하여 FX 서버의 FX 커넥트 보관하는 Microsoft 365.

![FX 데이터 보관 워크플로를 커넥트.](../media/FXConnectConnectorWorkflow.png)

1. 조직은 FX 서버와 함께 커넥트 FX 서버 커넥트 구성합니다.
...
2. **FX** 커넥트 설명 페이지에서 커넥터 **추가를 클릭합니다.**
...
## <a name="step-2-configure-the-fx-connect-connector-on-the-veritas-merge1-site"></a>2단계: Veritas Merge1 사이트에서 FX 커넥트 커넥터 구성
...
2. 커넥터 **탭을** 클릭한 다음 **FX** 커넥트 선택하여 플라이아웃 페이지를 표시합니다. 이 페이지에는 커넥터에 대한 속성과 정보가 포함되어 있습니다.
