...
---
# <a name="set-up-a-connector-to-archive-fx-connect-data-preview"></a>FX Connect 데이터를 보관 하는 연결선 설정 (미리 보기)
...
- FX Connect 커넥터에 대 한 사용 조건과 조건을 수락 하 여 Globanet Merge1 계정을 만듭니다. 이 작업을 수행 하려면 [Globanet 고객 지원](https://globanet.com/contact-us)에 문의 하세요. 1 단계에서 커넥터를 만들 때이 계정에 로그인 해야 합니다.
