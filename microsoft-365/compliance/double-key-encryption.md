...
2. 이중 키 암호화를 사용하여 레이블을 만들 수 있습니다. 보안 및 준수 센터에서 Microsoft 365 보호로 이동하고 이중 [키 암호화를](https://compliance.microsoft.com) 사용하여 새 레이블을 만들 수 있습니다. 민감도 레이블을 사용하여 암호화를 적용하여 콘텐츠에 대한 [액세스 제한을 참조하세요.](./encryption-sensitivity-labels.md)
...
1. 시작 Windows 시작 메뉴에서 OpenSSL 명령 프롬프트를 실행합니다.
...
규정 Microsoft 365 센터에서 새 민감도 레이블을 만들고 다른 경우처럼 암호화를 적용합니다. 이중 **키 암호화 사용을 선택하고** 키의 끝점 URL을 입력합니다.

예:

> [!div class="mx-imgBorder"]
> ![보안 및 준수 센터에서 이중 Microsoft 365 사용을 선택합니다.](../media/dke-use-dke.png)
