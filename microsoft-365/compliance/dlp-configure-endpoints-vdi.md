...
5. 패키지 **다운로드를** 클릭하고 파일 .zip 저장합니다.

6. .zip 파일에서 추출한 DeviceCompliancePackage 폴더의 파일을 경로의 `golden/master` 이미지로 `C:\WINDOWS\System32\GroupPolicy\Machine\Scripts\Startup` 복사합니다. 
...
9. 로컬 그룹 정책 편집기 창을 열고 컴퓨터 **구성** Windows 설정  >    >    >  **시작으로 이동합니다.**
...
5. 솔루션을 테스트합니다.
   ...
   1. **각 디바이스에 대한** 단일 항목: 각 디바이스에서 하나의 항목만 Microsoft Defender 보안 센터.<br>
