...
Microsoft 365 준수 센터에서 **통신 준수** 를 메뉴 옵션으로 사용할 수 있도록 하려면 관리 검토 관리자 역할이 할당 되어야 합니다. 정책이 일치 하는 메시지를 조사 하 고 수정 하려면 **사례 관리** 및 역할 **검토** 를 할당 받아야 합니다.
  
이렇게 하려면 자신을 관리 검토 역할 그룹의 구성원으로 추가 하거나 새 역할 그룹을 만들 수 있습니다.
  
### <a name="add-required-roles-to-the-supervisory-reviewer-role-group"></a>관리 Reviewer 역할 그룹에 필요한 역할 추가
...
3. **관리 검토** 역할 그룹을 선택 하 고 세부 정보 페이지의 **할당 된 역할** 섹션에서 **편집** 을 클릭 합니다.

4. **편집**을 선택 하 고 **추가**를 선택 합니다. **사례 관리** 및 **검토**에 대 한 확인란을 선택 하 고 **추가**를 선택 합니다.

5. **완료**를 선택한 다음 **저장**을 선택 합니다.

6. **구성원** 섹션에서 **편집** 을 선택 하 여 조직에 대 한 통신 준수를 관리 하려는 사용자를 추가 합니다.

7. **편집**을 선택 하 고 **추가**를 선택 합니다. 정책과 일치 하는 메시지를 관리 하려는 모든 사용자 및 그룹의 확인란을 선택한 다음 **추가**를 선택 합니다.

8. **완료**를 선택한 다음 **저장**을 선택 합니다.

9. **닫기를** 선택 하 여 역할 그룹 세부 정보 페이지를 종료 합니다.
