...
다음 단계에서는 Windows PowerShell을 보안 & 준수 센터 및 Exchange Online 조직 둘 다에 연결 합니다. 3 단계에서 실행 하는 스크립트에는 보안 & 준수 센터의 콘텐츠 검색 cmdlet과 Exchange Online의 원본 위치 eDiscovery cmdlet에 대 한 액세스 권한이 필요 하기 때문에이 작업이 필요 합니다.
