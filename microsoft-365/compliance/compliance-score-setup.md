...
---
# <a name="microsoft-compliance-score-setup-preview"></a>Microsoft 준수 점수 설정 (미리 보기)
...
대시보드 보기를 필터링 하 여 특정 규정과 표준, 솔루션, 작업 유형, 그룹 또는 데이터 보호 범주와 관련 된 항목만 볼 수 있습니다. 이 방식으로 보기를 필터링 하면 대시보드의 점수가 필터링 되며, 필터 조건을 기준으로 하 여 총 가능한 점수를 얻은 점의 수를 보여 줍니다.
...
실시간으로 점수가 조정 되며, 필터 조건에 해당 하는 향상 작업, 솔루션 및 점수 분류 정보만 표시 됩니다. 규정 준수 점수를 로그 아웃 하는 경우 필터링 된 보기는 다시 로그인 할 때 유지 됩니다.
