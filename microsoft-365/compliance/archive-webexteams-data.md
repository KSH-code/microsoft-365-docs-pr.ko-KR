...
Microsoft 365 준수 센터의 Veritas 커넥터를 사용하여 Webex 2013에서 Teams 조직의 사용자 사서함으로 데이터를 Microsoft 365 보관합니다. Veritas는 [Webex](https://globanet.com/webex-teams/) Teams 통신 항목을 캡처하고 가져오도록 구성된 Webex Teams 커넥터를 Microsoft 365. 커넥터는 조직의 Webex Teams 계정에서 1:1 채팅, 그룹 대화, 채널 대화 및 첨부 파일과 같은 Webex Teams 콘텐츠를 전자 메일 메시지 형식으로 변환한 다음 해당 항목을 조직의 사용자 사서함으로 Microsoft 365.
...
3. Microsoft 365 준수 센터에서 만든 Webex Teams 커넥터는 매일 Veritas Merge1에 연결하고 Webex Teams 항목을 Microsoft 클라우드의 보안 Azure Storage 위치로 전송합니다.
...
Webex 커넥터를 만든 Teams 준수 센터에서 커넥터 상태를 Microsoft 365 있습니다.
