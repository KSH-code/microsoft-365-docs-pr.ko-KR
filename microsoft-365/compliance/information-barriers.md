...
정보 장벽 정책이 적용된 경우 다른 특정 사용자와 파일을 통신하거나 공유하면 안되는 사용자는 해당 사용자를 찾고, 선택하거나, 채팅하거나, 전화를 걸 수 없습니다. 정보 장벽을 통해 무단 통신 및 공동 작업을 방지하기 위한 검사가 진행됩니다. 
...
정보 장벽이 있는 사용자 경험에 대한 자세한 내용은 [SharePoint Online의](https://docs.microsoft.com/sharepoint/information-barriers) 정보 장벽을 참조하세요.
