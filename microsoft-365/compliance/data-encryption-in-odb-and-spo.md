...
BitLocker는 서비스 전반에서 비즈니스용 OneDrive 및 SharePoint Online에 배포되고 있습니다. 파일 단위 암호화는 비즈니스용 OneDrive 및 Office 365의 SharePoint Online에서 다중 테 넌 트 기술을 기반으로 구축 되는 새로운 전용 환경인 경우에도 발생 합니다.
