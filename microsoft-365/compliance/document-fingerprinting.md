...
> [!IMPORTANT]
> 현재 DLP는 Exchange Online에서만 검색 방법으로 문서 지문을 사용할 수 있습니다.
...
현재 보안 및 준수 센터에서 PowerShell을 사용하여 문서 지문을 만들 &amp; 수 있습니다. 연결하기 위해 보안 및 [준수 & PowerShell에 연결을 참조합니다.](/powershell/exchange/connect-to-scc-powershell)
...
다음 예와 같이 Exchange Online의 메일 흐름 규칙에서 데이터 분류 규칙 패키지를 사용할 수도 있습니다. 이 명령을 실행하려면 먼저 [Exchange Online PowerShell에 연결해야 합니다.](/powershell/exchange/connect-to-exchange-online-powershell) 또한 규칙 패키지가 보안 및 준수 센터에서 Exchange 관리 센터로 동기화하는 데 &amp; 시간이 소요됩니다.
