...
2. **[Azure & Dynamics 365](gdpr-breach-azure-dynamics.md)**  
    ...
    - *위반 감지* : Microsoft 및 고객 모두에게 보안 의무가 있으므로 Azure 서비스는 공유 책임 모델을 사용하여 보안 및 운영 책임을 정의합니다. Microsoft는 고객의 책임 영역 내에서 보안 인시던트를 모니터링하거나 대응하지 않습니다. 적절한 서비스 계약을 바탕으로 고객 인시던트 대응 시 Azure [고객 지원](https://azure.microsoft.com/support/options/)과의 협업이 수반될 수 있습니다. Microsoft Azure는 고객이 보안 인시던트 대응을 개발 및 관리하기 위해 활용할 수 있는 다양한 서비스(예: [Azure Defender](https://azure.microsoft.com/services/security-center/))도 제공합니다.
