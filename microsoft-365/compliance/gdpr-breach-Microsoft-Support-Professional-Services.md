...
선언이 진행되려면 Microsoft 데이터 보호 인시던트 대응 팀에서 위에 정의된 데이터 보호 인시던트가 발생했다는 사실을 확인해야 합니다. 선언은 데이터 보호 인스턴트가 발생했음을 확인하기 위한 모든 관련 정보를 사용할 수 있게 되면 바로 진행됩니다.
