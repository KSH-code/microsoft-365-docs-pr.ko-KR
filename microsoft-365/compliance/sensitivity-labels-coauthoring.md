...
> 
> 조직 내에 이전 위치에 레이블 지정 메타데이터를 읽거나 쓰는 앱, 서비스, 스크립트 또는 도구가 있다면, 이 설정을 사용하지 마세요.
...
- 테넌트의 모든 앱, 서비스 및 운영 도구는 새 [레이블 지정 메타데이터](#metadata-changes-for-sensitivity-labels)를 지원해야 합니다.
    
    - **엔터프라이즈용 Microsoft 365 앱**
        - Windows: [현재 채널(미리 보기)](https://office.com/insider), 최소 빌드 16.0.13801.20182 사용 또는 [베타 채널](https://office.com/insider) 최소 빌드 16.0.13819.20006 사용
        - macOS: [베타 채널](https://office.com/insider), 최소 빌드 16.47.218.0 사용
        - iOS: 아직 지원되지 않음
        - Android: 아직 지원되지 않음
...
- [민감도 레이블을 조건으로 하는 DLP 정책](dlp-sensitivity-label-as-condition.md)을 사용할 때는 암호화되지 않은 전자 메일 첨부 파일을 지원하지 않습니다.
