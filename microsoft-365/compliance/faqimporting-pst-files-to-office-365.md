...
Microsoft 데이터 센터에 하드 드라이브가 도착하면 PST 파일을 해당 조직의 Microsoft Azure 저장소 영역에 업로드하는 데 영업일 기준으로 7~10일 정도 소요됩니다. PST 파일이 **ingestiondata**라는 Azure blob 컨테이너에 업로드 됩니다. 
