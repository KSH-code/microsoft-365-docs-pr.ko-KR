...
description: Microsoft 365 규정 준수 센터에서 커넥터를 설정하고 사용하여 WeChat 데이터를 Microsoft 365.
ms.openlocfilehash: 3ee858cd09c1b6c7bd29dc5e2162753df9f5544a
ms.sourcegitcommit: 3e971b31435d17ceeaa9871c01e88e25ead560fb
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 06/09/2021
ms.locfileid: "52861635"
---
# <a name="set-up-a-connector-to-archive-wechat-data-preview"></a>WeChat 데이터를 보관할 커넥터 설정(미리 보기)

Microsoft 365 준수 센터의 TeleMessage 커넥터를 사용하여 WeChat 및 WeCom 통화, 채팅, 첨부 파일, 파일 및 회수된 메시지를 가져오고 보관합니다. 커넥터를 설정하고 구성한 후 조직의 TeleMessage 계정에 연결하고 TeleMessage WeChat Archiver를 사용하여 직원의 모바일 통신을 조직의 사서함으로 Microsoft 365.
...
3. Microsoft 365 준수 센터에서 만드는 WeChat Archiver 커넥터는 매일 TeleMessage 사이트에 연결하고 이전 24시간 동안의 전자 메일 메시지를 Microsoft 클라우드의 보안 Azure Storage 영역으로 전송합니다.
...
이 섹션의 단계에 따라 준수 센터에서 WeChat Archiver 커넥터를 Microsoft 365 합니다. 커넥터는 사용자가 제공한 정보를 사용하여 TeleMessage 사이트에 연결하고 WeChat 통신 데이터를 사용자의 해당 사용자 사서함으로 Microsoft 365.
