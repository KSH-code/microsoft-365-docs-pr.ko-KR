...
description: 관리자는 TeleMessage 커넥터를 설정하여 O2 모바일 네트워크에서 SMS 및 MMS 데이터를 가져오고 보관할 수 Microsoft 365. 이를 통해 타사 데이터 원본의 데이터를 보관할 수 Microsoft 365 보존, 콘텐츠 검색 및 보존 정책과 같은 규정 준수 기능을 사용하여 조직의 타사 데이터를 관리할 수 있습니다.
ms.openlocfilehash: 01e47cbd3cafe049bd444a50f1ed39c2b79701a1
ms.sourcegitcommit: c2d752718aedf958db6b403cc12b972ed1215c00
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 08/26/2021
ms.locfileid: "58571474"
---
# <a name="set-up-a-connector-to-archive-o2-network-data"></a>O2 네트워크 데이터를 보관할 커넥터 설정

서버의 TeleMessage 커넥터를 Microsoft 365 규정 준수 센터 O2 모바일 네트워크에서 SMS(Short Messaging Service) 메시지 및 음성 통화를 가져오고 보관할 수 있습니다. 커넥터를 설정하고 구성한 후 이 커넥터는 매일 조직의 O2 네트워크에 연결하고 SMS 및 음성 통화를 조직의 사서함으로 Microsoft 365.

SMS 메시지 및 음성 통화가 사용자 사서함에 저장되고 나면 소송 보존, Microsoft 365 검색 및 보존 정책과 같은 Microsoft 365 준수 기능을 O2 네트워크 데이터에 적용할 수 있습니다. 예를 들어 콘텐츠 검색을 사용하여 O2 네트워크 SMS 메시지 및 음성 통화를 검색하거나 O2 네트워크 데이터가 포함된 사서함을 보안 센터의 경우 Advanced eDiscovery 있습니다. O2 네트워크 커넥터를 사용하여 조직에서 데이터를 가져오고 보관할 Microsoft 365 정부 및 규제 정책을 준수하는 데 도움이 될 수 있습니다.
...
3. Microsoft 365 규정 준수 센터 만드는 O2 네트워크 커넥터는 매일 TeleMessage 사이트에 연결하고 지난 24시간 동안의 SMS 메시지 및 음성 통화를 Microsoft 클라우드의 안전한 Azure Storage 위치로 전송합니다. 또한 커넥터는 SMS 메시지의 내용과 음성 통화를 전자 메일 메시지 형식으로 변환합니다.
...
이전 섹션에 설명된 선행 작업을 완료한 후 O2 네트워크 커넥터를 구성할 수 Microsoft 365 규정 준수 센터. 커넥터는 사용자가 제공한 정보를 사용하여 TeleMessage 사이트에 연결하고 SMS 메시지 및 음성 통화를 서버의 해당 사용자 사서함 상자로 Microsoft 365.
