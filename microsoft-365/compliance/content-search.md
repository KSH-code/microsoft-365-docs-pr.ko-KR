...
ms.locfileid: "60175374"
---
# <a name="create-a-content-search"></a>콘텐츠 검색 만들기

Microsoft 365 규정 준수 센터의 콘텐츠 검색 eDiscovery 도구를 사용하여 조직에서 전자 메일, 문서, 인스턴트 메시징 대화와 같은 콘텐츠를 검색할 수 있습니다. 다음 Microsoft 365 데이터 원본에서 콘텐츠를 검색하려면 이 도구를 사용하세요.
