...
내부자 위험 관리 경고 정보는 보안 정보 및 이벤트 관리(SIEM) 서비스로 내보낼 Office 365 관리 작업 API Office 365 [있습니다.](/office/office-365-management-api/office-365-management-activity-api-schema#security-and-compliance-alerts-schema) Office 365 활동 API를 사용하여 조직에서 내부자 위험 정보를 관리하거나 집계하는 데 사용할 수 있는 다른 응용 프로그램으로 경고 정보를 내보낼 수 있습니다. 알림 정보는 관리 활동 API를 통해 60분마다 내보내고 Office 365 수 있습니다.
