...
---
# <a name="get-started-with-content-explorer"></a>Get started with content explorer
...
> 
### <a name="required-permissions-to-access-items-in-content-explorer"></a>Required permissions to access items in content explorer
...
## <a name="content-explorer"></a>Content explorer
...
### <a name="sensitive-information-types"></a>Sensitive information types
...
### <a name="sensitivity-labels"></a>Sensitivity labels
...
### <a name="retention-labels"></a>Retention labels
...
### <a name="how-to-use-content-explorer"></a>How to use content explorer
...
> [!NOTE]
> **OneDrive** We have listened to your valuable feedback on OneDrive integration during our preview program. Based on that feedback, the OneDrive functionality will remain in preview till all fixes are in place. 테넌트에 따라 일부 고객의 경우 OneDrive를 위치로 인식하지 못할 수 있습니다. We appreciate your continued support on this.
