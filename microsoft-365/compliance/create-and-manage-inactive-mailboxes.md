...
- 삭제 된 Exchange Online 사서함과 연결 된 라이선스는 해당 사용자 계정을 삭제 한 후에 사용할 수 있습니다. 그런 다음 [해당 라이선스를 다른 사용자에 게 할당할](https://support.office.com/article/997596b5-4173-4627-b915-36abac6786dc)수 있습니다. 
...
사서함이 보류 되거나 보존 정책이 적용 된 후 다음 단계는 사서함을 삭제 하는 것입니다. 사서함을 삭제 하는 가장 좋은 방법은 Microsoft 365 관리 센터에서 해당 사용자 계정을 삭제 하는 것입니다. 사용자 계정을 삭제 하는 방법에 대 한 자세한 내용은 [조직에서 사용자 삭제](https://support.office.com/article/d5155593-3bac-4d8d-9d8b-f4513a81479e)를 참조 하십시오.
