...
사용자가 특정 문서를 보았는지 또는 사서함에서 항목을 제거했는지 확인해야 하나요? 이 경우 Microsoft 365 규정 준수 센터를 사용하여 통합 감사 로그를 검색하고 조직의 사용자 및 관리자 활동을 볼 수 있습니다. 통합 감사 로그를 사용해야 하는 이유는 무엇일까요? Microsoft 365에서 다음과 같은 유형의 [사용자 및 관리자](#audited-activities) 활동을 검색할 수 있기 때문입니다.
...
- 먼저 관리자(또는 또 다른 관리자)가 감사 로깅을 켜야 감사 로그를 검색할 수 있습니다. 감사 로깅을 켜려면 보안 및 준수 센터의 **감사 로그 시작** 페이지에서 **감사** 를 클릭합니다. (링크가 표시되지 않는 경우, 조직에서 감사를 이미 사용하는 중입니다. 감사 로깅을 켜면 감사 로그를 준비 중이며 준비가 아료된 후 두 시간 내에 검색을 실행할 수 있다는 메시지가 표시됩니다. 이 작업은 한 번만 수행하면 됩니다. 자세한 내용은 [감사 로그 검색 켜기 또는 끄기](turn-audit-log-search-on-or-off.md)를 참조하세요.
...
- 감사 로그를 검색하려면 Exchange Online에서 보기 전용 감사 로그 또는 감사 로그 역할을 할당받아야 합니다. 기본적으로 이러한 역할은 Exchange 관리 센터의 **사용 권한** 페이지에 있는 컴플라이언스 관리 및 조직 관리 역할 그룹에 할당됩니다. Office 365 및 Microsoft 365의 전역 관리자는 Exchange Online의 조직 관리 역할 그룹의 구성원으로 자동 추가됩니다. 사용자에게 최소 수준의 권한으로 감사 로그를 검색할 수 있는 기능을 부여하려면 Exchange Online에서 사용자 지정 역할 그룹을 생성하고 보기 전용 감사 로그 또는 감사 로그 역할을 추가한 다음 사용자를 새 역할 그룹의 구성원으로 추가할 수 있습니다. 자세한 내용은 [Exchange Online에서 역할 그룹 관리](https://go.microsoft.com/fwlink/p/?LinkID=730688)를 참조하세요.
  ...
  > [!IMPORTANT]
  > 사용자에게 보안 및 준수 센터의 **권한** 페이지에서 보기 전용 감사 로그 또는 감사 로그 역할을 할당하면 사용자는 감사 로그를 검색할 수 없습니다. Exchange Online에서 권한을 할당해야 합니다. 감사 로그를 검색하는 데 사용되는 기본 cmdlet이 Exchange Online cmdlet이기 때문입니다.

- 사용자나 관리자가 감사 대상 활동을 수행하면 감사 기록이 조직의 감사 로그에 생성 및 저장됩니다. 감사 기록이 보존되는(감사 로그에서 검색 가능한) 시간은 Office 365 또는 Microsoft 365 Enterprise 구독, 그리고 특히 특정 사용자에게 할당된 라이선스 유형에 따라 다릅니다.

  - Office 365 E5 또는 Microsoft 365 E5 라이선스가 할당된 사용자(또는 Microsoft 365 E5 컴플라이언스 또는 Microsoft 365 E5 eDiscovery 및 감사 추가 기능 라이선스가 있는 사용자)의 경우 Azure Active Directory, Exchange 및 SharePoint 작업에 대한 감사 기록은 기본적으로 1년 동안 유지됩니다. 또한 조직은 감사 로그 보존 정책을 작성하여 다른 서비스의 활동에 대한 감사 기록을 최대 1년 동안 유지할 수 있습니다. 자세한 내용은 [감사 로그 보존 정책 관리](audit-log-retention-policies.md)를 참조하세요.

    > [!NOTE]
    > 조직이 감사 기록의 1년 보존을 위해 개인 미리보기 프로그램에 참여한 경우 일반 가용성 롤아웃 날짜 이전에 생성 된 감사 기록의 보존 기간은 재설정되지 않습니다.

  - 기타(E5가 아닌 경우) Office 365 또는 Microsoft 365 라이선스가 할당된 사용자의 경우 감사 기록은 90일 동안 유지됩니다. 통합 감사 기록을 지원하는 Office 365 및 Microsoft 365 구독 목록은 [보안 및 준수 센터 서비스 설명](https://docs.microsoft.com/office365/servicedescriptions/office-365-platform-service-description/office-365-securitycompliance-center)을 참조하세요.

    > [!NOTE]
    > 기본적으로 사서함 감사가 설정되어 있더라도 일부 사용자에 대한 사서함 감사 이벤트는 보안 및 준수 센터의 감사 로그 검색에서 발견되지 않거나 Office 365 관리 작업 API를 통해 찾지 못할 수 있습니다. 자세한 내용은 [사서함 감사 로깅에 관한 자세한 정보](enable-mailbox-auditing.md#more-information)를 참조하세요.
...
- 이전에 설명한 것처럼, 감사 로그를 검색하는 데 사용되는 기본 cmdlet은 **Search-UnifiedAuditLog** 인 Exchange Online cmdlet입니다. 즉 보안 및 준수 센터의 **감사 로그 검색** 페이지를 사용하는 대신 이 cmdlet을 사용하여 감사 로그를 검색할 수 있습니다. Exchange Online 조직에 연결된 원격 PowerShell에서 이 cmdlet을 실행해야 합니다. 자세한 내용은 [Search-UnifiedAuditLog](https://go.microsoft.com/fwlink/p/?linkid=834776)를 참조하세요.
  ...
  **Search-UnifiedAuditLog** cmdlet에서 반환되는 검색 결과를 CSV 파일로 내보내는 방법에 대한 자세한 내용은 [감사 로그 기록 내보내기, 구성 및 보기](export-view-audit-log-records.md#tips-for-exporting-and-viewing-the-audit-log)의 "감사 로그 내보내기 및 보기 팁" 섹션을 참조하세요.

- 감사 로그에서 프로그래밍 방식으로 데이터를 다운로드하려면 PowerShell 스크립트를 사용하는 대신 Office 365 관리 작업 API를 사용하는 것이 좋습니다. Office 365 관리 작업 API는 조직의 작업, 보안 및 규정 준수 모니터링 솔루션을 개발하는 데 사용할 수 있는 REST 웹 서비스입니다. 자세한 내용은 [Office 365 Management Activity API reference](https://docs.microsoft.com/office/office-365-management-api/office-365-management-activity-api-reference)(Office 365 관리 작업 API 참조)를 참조하세요.

- 감사 기록 검색 결과에 해당 감사 로그 기록이 반환되려면 이벤트 발생 시점으로부터 30분에서 24시간 정도 걸릴 수 있습니다. 다음 표에는 Office 365의 여러 서비스가 표시되는 데 걸리는 시간이 나와 있습니다.
...
- Azure AD(Azure Active Directory)는 Office 365의 디렉터리 서비스입니다. 통합 감사 로그에는 Microsoft 365 관리 센터 또는 Azure 관리 포털에서 수행되는 사용자, 그룹, 응용 프로그램, 도메인 및 디렉터리 활동이 포함됩니다. Azure AD 이벤트의 전체 목록은 [Azure Active Directory 감사 보고서 이벤트](https://go.microsoft.com/fwlink/p/?LinkID=616549)를 참조하세요.

- Power BI에 대한 감사 로깅은 기본적으로 사용할 수 없습니다. 감사 로그에서 Power BI 활동을 검색하려면 Power BI 관리자 포털에서 감사를 사용으로 설정해야 합니다. 지침에 대한 내용은 [Power BI 관리자 포털](https://docs.microsoft.com/power-bi/service-admin-portal#audit-logs)을 참조하세요.

## <a name="search-the-audit-log"></a>감사 로그 검색

> [!NOTE]
> 2020년 10월 22일부터 2020년 11월 6일까지 감사 로그 검색 도구에서 Azure AD 활동을 사용할 수 없는 문제가 있었습니다. 이러한 활동에는 Azure AD 사용자 관리 활동, 그룹 관리 활동, 응용프로그램 관리 활동, 역할 관리 활동 및 디렉터리 관리 활동이 포함됩니다. 이 기간 동안 누락된 이벤트는 앞으로 며칠 동안 사용할 수 있으며, 늦어도 2020년 11월 20일까지는 완료될 것으로 예상됩니다. 일부 경우에는 고객이 2020년 10월 26일부터 2020년 11월 05일 사이에 생성된 이벤트에 대한 중복 이벤트 데이터를 찾을 수 있습니다.
...
1. [https://protection.office.com](https://protection.office.com)으로 이동합니다.
    ...
    > [!TIP]
    > 비공개 브라우징 세션(일반 세션이 아님)을 사용하여 보안 및 준수 센터에 액세스하면 현재 로그온한 자격 증명이 사용되지 않으므로 비공개 브라우징 세션을 사용하세요. Internet Explorer 또는 Microsoft Edge에서 InPrivate 브라우징 세션을 열려면 Ctrl+Shift+P를 누르면 됩니다. Google Chrome에서 비공개 브라우징 세션(시크릿 모드 창이라고 함)을 열려면 Ctrl+Shift+N을 누릅니다.
...
4. 다음과 같은 검색 조건을 구성합니다. 
   ...
   1. **파일 또는 폴더**: 파일이나 폴더 이름의 일부 또는 전체를 입력하여 지정한 키워드를 포함하는 파일이나 폴더와 관련된 활동을 검색합니다. 파일 또는 폴더의 URL을 지정할 수도 있습니다. URL을 사용할 경우 전체 URL 경로를 입력하고, 또는 URL의 일부만 입력하는 경우 특수 문자나 공백을 포함하지 마세요.
...
5. **검색** 을 클릭하여 검색 조건을 사용한 검색을 실행합니다. 
   ...
   검색 결과가 로드되고, 잠시 후에 **결과** 에 표시됩니다. 검색이 완료되면 찾은 결과 수가 표시됩니다. **결과** 창에는 150개 이벤트 단위로 최대 5,000개의 이벤트가 표시됩니다. 검색 조건을 충족하는 이벤트가 5,000개를 초과하는 경우 최신 5,000개의 이벤트가 표시됩니다.
...
- Exchange 관리자 감사 로그의 이벤트를 표시하려면 **활동** 목록에서 **모든 활동에 대한 결과 표시** 를 선택해야 합니다. 이 감사 로그의 이벤트는 결과의 **활동** 열에 cmdlet 이름(예: **Set-Mailbox**)을 표시합니다. 자세한 내용을 보려면 이 항목에서 **감사되는 활동** 탭을 클릭한 다음 **Exchange 관리자 활동** 을 클릭합니다.
...
- 5,000개의 결과가 발견되면 검색 조건을 충족한 이벤트가 5,000개 이상 있다고 가정할 수 있습니다. 검색 조건을 구체화한 다음 검색을 다시 실행하여 더 적은 결과를 반환하거나, **결과 내보내기** \> **모든 결과 다운로드** 를 선택하여 모든 검색 결과를 내보낼 수 있습니다.
...
- **IP 주소**: 활동을 기록할 때 사용된 디바이스의 IP 주소입니다. IP 주소는 IPv4 또는 IPv6 주소 형식으로 표시됩니다.

   > [!NOTE]
  > 일부 서비스의 경우 이 필드에 표시되는 값은 사용자를 대신하여 서비스를 호출하는 신뢰할 수 있는 응용프로그램(예: 웹 앱의 Office)의 IP 주소일 수 있으며 활동을 수행한 사용자가 사용하는 디바이스의 IP 주소가 아닐 수 있습니다. 또한 Azure Active Directory 관련 이벤트에 대한 관리 작업(또는 시스템 계정에서 수행하는 작업)의 경우 IP 주소가 기록되지 않고 이 필드에 표시된 값은 `null`입니다.
...
- **세부 정보**: 활동에 대한 정보입니다. 마찬가지로, 일부 활동에는 값이 없습니다.
...
검색 결과 목록에서 이벤트 기록을 클릭하여 이벤트에 대한 세부 정보를 볼 수 있습니다. 이벤트 기록의 자세한 속성이 포함된 **세부 정보** 페이지가 표시됩니다. 표시되는 속성은 이벤트가 발생한 서비스에 따라 다릅니다. 이러한 세부 정보를 표시하려면 **추가 정보** 를 클릭합니다. 지침은 [Office 365 감사 로그의 자세한 속성](detailed-properties-in-the-office-365-audit-log.md)을 참조하세요.
...
감사 로그 검색 결과를 로컬 컴퓨터의 CSV(쉼표로 구분된 값) 파일로 내보낼 수 있습니다. Microsoft Excel에서 이 파일을 열고 검색, 정렬, 필터링, 단일 열(다중 속성 포함)을 여러 개의 열로 분할 등의 기능을 사용할 수 있습니다.
...
- 모든 검색 결과를 다운로드하는 경우 CSV 파일에는 각 이벤트에 대한 추가 정보가 포함된 **AuditData** 라는 열이 포함됩니다. 이 열의 데이터는 감사 로그 기록의 여러 속성을 포함하는 JSON 개체로 구성됩니다. JSON 개체의 각 *property:value* 쌍은 쉼표로 구분됩니다. Excel의 Power Query Editor에서 JSON 변환 도구를 사용하여 **AuditData** 열을 여러 열로 분할하여 JSON 개체의 각 속성에 고유한 열이 있도록 할 수 있습니다. 이렇게 하면 이러한 속성 중 하나 이상을 정렬하고 필터링할 수 있습니다. 전원 쿼리 편집기를 사용하여 JSON 개체를 변환하는 단계별 지침은 [감사 로그 기록 내보내기, 구성 및 보기](export-view-audit-log-records.md)를 참조하세요.
...
이 섹션의 표에서는 Office 365에서 감사되는 활동에 대해 설명합니다. 보안 및 컴플라이언스 센터에서 감사 로그를 검색하여 이러한 이벤트를 검색할 수 있습니다.

이 표에는 관련 활동 또는 특정 서비스의 활동이 그룹화되어 표시됩니다. 표에는 **활동** 드롭다운 목록에 표시되는 이름과 검색 결과를 내보낼 때 CSV 파일 및 감사 기록의 자세한 정보에 표시되는 해당 작업의 이름이 포함됩니다. 자세한 정보에 대한 설명은 [감사 로그의 자세한 속성](detailed-properties-in-the-office-365-audit-log.md)을 참조하세요.
...
|(없음)|FileAccessedExtended|"액세스한 파일"(FileAccessed) 활동과 관련이 있습니다. FileAccessedExtended 이벤트는 동일한 사용자가 장시간(최대 3시간) 지속적으로 파일에 액세스할 때 기록됩니다. <br/><br/> FileAccessedExtened 이벤트 로깅의 목적은 파일에 지속적으로 액세스할 때 기록되는 FileAccessed 이벤트의 수를 줄이는 것입니다. 이렇게 하면 기본적으로 무엇이 동일한 사용자 활동인지에 대한 여러 FileAccessed 기록의 노이즈를 줄일 수 있으며 초기( 및 중요한) FileAccessed 이벤트에 집중할 수 있습니다.|
|파일의 보존 레이블 변경|ComplianceSettingChanged|보존 레이블이 문서에 적용되거나 문서에서 제거되었습니다. 이 이벤트는 보존 레이블이 수동으로 또는 메시지에 자동으로 적용될 때 트리거됩니다.|
|기록 상태를 잠김으로 변경함|LockRecord|문서를 기록으로 분류하는 보존 레이블의 기록 상태가 잠겼습니다. 이것은 문서를 수정하거나 삭제할 수 없음을 의미합니다. 사이트에 대해 적어도 기여자 권한이 할당된 사용자만 문서의 기록 상태를 변경할 수 있습니다.|
|기록 상태를 잠김 해제로 변경함|UnlockRecord|문서를 기록으로 분류하는 보존 레이블의 기록 상태가 잠금 해제되었습니다. 이것은 문서를 수정하거나 삭제할 수 있음을 의미합니다. 사이트에 대해 적어도 기여자 권한이 할당된 사용자만 문서의 기록 상태를 변경할 수 있습니다.|
...
|(없음)|FileModifiedExtended|"수정된 파일"(FileModified) 활동과 관련이 있습니다. FileModifiedExtended 이벤트는 동일한 사용자가 장시간(최대 3시간) 지속적으로 파일에 수정할 때 기록됩니다. <br/><br/> FileModifiedExtended 이벤트 로깅의 목적은 파일에 지속적으로 수정할 때 기록되는 FileModified 이벤트의 수를 줄이는 것입니다. 이렇게 하면 기본적으로 무엇이 동일한 사용자 활동인지에 대한 여러 FileModified 기록의 노이즈를 줄일 수 있으며 초기( 및 중요한) FileModified 이벤트에 집중할 수 있습니다.|
|파일 이동됨|FileMoved|사용자가 사이트의 현재 위치에서 새 위치로 문서를 이동합니다.|
|(없음)|FilePreviewed|사용자는 SharePoint 또는 비즈니스용 OneDrive 사이트에서 파일을 미리 봅니다. 이러한 이벤트는 일반적으로 이미지 갤러리 보기와 같이 단일 활동을 기반으로 대량으로 발생합니다.|
|수행한 검색 쿼리|SearchQueryPerformed|사용자 또는 시스템 계정은 SharePoint 또는 비즈니스용 OneDrive에서 검색을 수행합니다. 서비스 계정에서 검색 쿼리를 수행하는 몇 가지 일반적인 시나리오에는 사이트 및 OneDrive 계정에 eDiscovery 보존 및 보존 정책을 적용하는 것과 보존 혹은 민감도 레이블이 사이트 콘텐츠에 자동으로 적용되는 경우가 포함됩니다.|
...
|(없음)|PageViewedExtended|"페이지 표시"(PageViewed) 활동과 관련이 있습니다. PageViewedExtended 이벤트는 동일한 사용자가 장시간(최대 3시간) 지속적으로 웹 페이지를 확인할 때 기록됩니다. <br/><br/> PageViewedExtended 이벤트 로깅의 목적은 페이지에 지속적으로 볼 때 기록되는 PageViewed 이벤트의 수를 줄이는 것입니다. 이렇게 하면 기본적으로 무엇이 동일한 사용자 활동인지에 대한 여러 PageViewed 기록의 노이즈를 줄일 수 있으며 초기( 및 중요한) PageViewed 이벤트에 집중할 수 있습니다.|
|클라이언트가 신호를 보낸 보기|ClientViewSignaled|사용자의 클라이언트(예: 웹 사이트 또는 모바일 앱)가 표시된 페이지를 사용자가 봤다는 신호를 보냈습니다. 이 활동은 종종 페이지의 PagePrefetched 이벤트 다음에 기록됩니다.<br/><br/>**주의**: ClientViewSignaled 이벤트는 서버가 아닌 클라이언트가 신호를 보내므로 서버에서 이벤트를 기록하지 않아 감사 로그에 표시되지 않을 수 있습니다. 또한 감사 기록에 있는 정보를 신뢰할 수 없을 수도 있습니다. 그러나 신호를 만드는 데 사용되는 토큰에 의해 사용자의 ID가 확인되기 때문에 해당 감사 기록에 나열된 사용자의 ID는 정확합니다. |
|(없음)|PagePrefetched|사용자의 클라이언트(예: 웹 사이트 또는 모바일 앱)는 사용자가 탐색할 경우 성능 향상을 돕기 위해 지정된 페이지를 요청했습니다. 이 이벤트는 페이지 내용이 사용자의 클라이언트에 제공되었음을 나타내기 위해 기록됩니다. 이 이벤트는 사용자가 페이지로 이동했음을 나타내는 명확한 표시가 아닙니다. <br/><br/> 페이지 내용이 클라이언트에 의해 렌더링되면(사용자의 요청에 따라) ClientViewSignaled 이벤트가 생성되어야 합니다. 일부 사전 추출은 클라이언트에서 지원하지 않으므로 일부 사전 추출된 작업이 PageViewed 이벤트로 기록될 수 있습니다.|
||||
...
**비사용자의 활동이 "OneDriveMpc-Transform_Thumbnail"과 같은 사용자 에이전트를 포함하는 FilePreviewed 감사 기록을 트리거할 수 있나요?**

비사용자 작업이 이와 같은 이벤트를 생성하는 시나리오는 알지 못합니다. 사용자 프로필 카드를 여는 것과 같은 사용자 작업이(웹용 Outlook의 메시지에서 해당 이름 또는 전자 메일 주소를 클릭하여) 유사한 이벤트를 생성합니다.

**OneDriveMpc-Transform_Thumbnail에 대한 통화는 항상 사용자가 의도적으로 트리거하나요?**

아니요. 그러나 브라우저 프리 페치의 결과로 유사한 이벤트가 기록될 수 있습니다.

**Microsoft에서 등록한 IP 주소에서 오는 FilePreviewed 이벤트가 표시되는 경우, 사용자의 디바이스 화면에 미리 보기가 표시되었다는 것을 의미 하나요?**

아니요. 브라우저 프리 페치의 결과로서 이벤트가 기록되었을 수 있습니다.

**문서를 미리 보는 사용자가 FileAccessed 이벤트를 생성하는 경우의 시나리오가 있나요?**

FilePreviewed 및 FileAccessed 이벤트는 모두 사용자의 호출로 인해 파일이 읽히거나 파일의 축소판 그림 렌더링 읽기가 발생했음을 나타냅니다. 이러한 이벤트는 미리 보기와 액세스 의도에 맞게 조정되지만, 이벤트 구별은 사용자의 의도를 보장하지는 않습니다.

#### <a name="the-appsharepoint-user-in-audit-records"></a>감사 기록의 app\@sharepoint 사용자입니다.

일부 파일 작업(및 기타 SharePoint 관련 작업)에 대한 감사 기록에서 작업을 수행한 사용자(사용자 및 사용자 ID 필드에 식별됨)가 app@sharepoint인 것을 알 수 있습니다. 활동을 수행한 "사용자"가 응용 프로그램임을 나타냅니다. 이 경우 응용 프로그램은 SharePoint에서 사용자, 관리자 또는 서비스를 대신하여 조직 차원의 작업(예: SharePoint 사이트 또는 OneDrive 계정 검색)을 수행할 수 있는 권한을 부여받았습니다. 응용 프로그램에 대한 사용 권한을 부여하는 이 프로세스를 *SharePoint 앱 전용* 액세스라고 합니다. 이는 작업을 수행하기 위해 SharePoint에 제공된 인증이 사용자 대신 응용 프로그램에서 수행되었음을 나타냅니다. 이것이 특정 감사 기록에서 app@sharepoint 사용자가 식별되는 이유입니다. 자세한 내용은 [SharePoint 앱 전용을 사용하여 액세스 권한 부여](https://docs.microsoft.com/sharepoint/dev/solution-guidance/security-apponly-azureacs)를 참조하세요.

예를 들어 app@sharepoint는 종종 "수행된 검색 쿼리" 및 "액세스된 파일" 이벤트의 사용자로 식별됩니다. 이는 조직에서 SharePoint 앱 전용 액세스 권한을 가진 응용 프로그램이 사이트 및 OneDrive 계정에 보존 정책을 적용할 때 검색 쿼리를 수행하고 파일에 액세스하기 때문입니다.

다음은 app@sharepoint를 감사 기록에서 활동을 수행한 사용자로 식별할 수 있는 몇 가지 다른 시나리오입니다.

- Microsoft 365 그룹입니다. 사용자 또는 관리자가 새 그룹을 만들 때 사이트 모음 만들기, 목록 업데이트 및 SharePoint 그룹에 구성원 추가에 대한 감사 기록이 생성됩니다. 이러한 작업은 그룹을 만든 사용자를 대신하여 응용 프로그램이 수행됩니다.
...
이러한 시나리오와 다른 시나리오에서는 지정된 사용자로 app@sharepoint를 사용하는 여러 감사 기록이 짧은 시간 내에, 종종 서로 몇 초 내에 생성되었음을 알 수 있습니다. 이는 또한 동일한 사용자 시작 작업에 의해 트리거된 것일 수도 있음을 나타냅니다. 또한 감사 기록의 ApplicationDisplayName 및 EventData 필드는 이벤트를 트리거한 시나리오 또는 응용 프로그램을 식별하는 데 도움이 될 수 있습니다.

### <a name="folder-activities"></a>폴더 활동

다음 표에서는 SharePoint Online 및 비즈니스용 OneDrive의 폴더 작업에 대해 설명합니다. 앞에서 설명한 대로 일부 SharePoint 활동에 대한 감사 기록은 app@sharepoint 사용자가 작업을 시작한 사용자 또는 관리자를 대신하여 작업을 수행했음을 나타냅니다. 앞에서 설명한 대로 일부 SharePoint 활동에 대한 감사 기록은 app@sharepoint 사용자가 작업을 시작한 사용자 또는 관리자를 대신하여 작업을 수행했음을 나타냅니다. 자세한 내용은 [감사 기록에 있는 app\@sharepoint 사용자](#the-appsharepoint-user-in-audit-records)를 참조하세요.
...
다음 표에서는 사용자가 SharePoint Online의 목록 및 목록 항목과 상호 작용하는 시간과 관련된 활동을 설명합니다. 앞에서 설명한 대로 일부 SharePoint 활동에 대한 감사 기록은 app@sharepoint 사용자가 작업을 시작한 사용자 또는 관리자를 대신하여 작업을 수행했음을 나타냅니다. 자세한 내용은 [감사 기록에 있는 app\@sharepoint 사용자](#the-appsharepoint-user-in-audit-records)를 참조하세요.
...
|목록 콘텐츠 유형이 만들어짐|ListContentTypeCreated|사용자가 목록 내용 유형을 만들었습니다. 목록 컨텐츠 유형은 하나 이상의 SharePoint 목록에 연결된 컨텐츠 유형입니다.|
|목록 항목이 만들어짐|ListItemCreated|사용자가 기존 SharePoint 목록에서 항목을 만들었습니다.|
|사이트 열 만들기|SiteColumnCreated|사용자가 SharePoint 사이트 열을 만들었습니다. 사이트 열은 목록에 첨부되지 않은 열입니다. 사이트 열은 또한 지정된 웹의 모든 목록에서 사용할 수 있는 메타데이터 구조입니다.|
|사이트 콘텐츠 유형이 만들어짐|사이트 ContentType이 만들어짐|사용자가 사이트 내용 유형을 만들었습니다. 사이트 내용 유형은 상위 사이트에 연결된 내용 유형입니다.|
...
|회사에서 공유할 수 있는 링크 생성됨 |CompanyLinkCreated|사용자가 리소스에 대한 회사 차원의 링크를 만들었습니다. 회사 차원의 링크는 조직의 구성원만 사용할 수 있습니다. 게스트는 사용할 수 없습니다.|
...
|공유 파일, 폴더 또는 사이트|SharingSet|사용자(구성원 또는 게스트)는 SharePoint 또는 비즈니스용 OneDrive의 파일, 폴더 또는 사이트를 조직의 디렉터리에 있는 사용자와 공유했습니다. 이 작업에 대한 **세부 정보** 열의 값은 리소스가 공유된 사용자의 이름과 이 사용자가 구성원인지 게스트인지 여부를 식별합니다.<br/><br/> 이 활동에는 대체로 사용자에게 리소스에 대한 액세스 권한이 어떻게 부여되었는지를 설명(예: 리소스에 대한 액세스 권한이 있는 그룹에 사용자 추가)하는 두 번째 이벤트가 수반됩니다.|
...
다음 표에는 SharePoint에서 사용 권한을 할당하고 그룹을 사용하여 사이트에 대한 액세스 권한을 부여하거나 취소하는 것과 관련된 이벤트가 나열되어 있습니다. 앞에서 설명한 대로 일부 SharePoint 활동에 대한 감사 기록은 app@sharepoint 사용자가 작업을 시작한 사용자 또는 관리자를 대신하여 작업을 수행했음을 나타냅니다. 자세한 내용은 [감사 기록에 있는 app\@sharepoint 사용자](#the-appsharepoint-user-in-audit-records)를 참조하세요.

|이름|작업|설명|
|:-----|:-----|:-----|
|사이트 모음 관리자 추가됨|SiteCollectionAdminAdded|사이트 모음 관리자 또는 소유자는 사용자를 사이트의 사이트 모음 관리자로 추가합니다. 사이트 모음 관리자는 사이트 모음 및 모든 하위 사이트에 대한 전체 제어 권한을 가집니다. 이 활동은 관리자가 직접 사용자의 OneDrive 계정에 대한 액세스 권한을 부여한 경우에도 기록됩니다(SharePoint 관리 센터에서 사용자 프로필을 편집하거나 [Microsoft 365 관리 센터를 사용하여](https://docs.microsoft.com/office365/admin/add-users/get-access-to-and-back-up-a-former-user-s-data)).|
...
|사이트 사용 권한 수정됨|SitePermissionsModified|사이트 관리자 또는 소유자(또는 시스템 계정)가 사이트에 대한 그룹에 할당된 사용 권한 수준을 변경합니다. 그룹에서 모든 사용 권한이 제거된 경우에도 이 활동이 기록됩니다. <br/><br/> **주의**: 이 작업은 SharePoint Online에서 더 이상 사용되지 않습니다. 관련 이벤트를 찾으려면 **사이트 모음 관리자 추가됨**, **SharePoint 그룹에 사용자 또는 그룹을 추가함**, **사용자가 그룹을 만들 수 있도록 허용됨**, **그룹 생성됨**, **그룹 삭제됨** 같은 기타 권한 관련 활동을 검색할 수 있습니다.|
|사이트 모음에서 사용 권한 수준 제거됨|PermissionLevelRemoved|사이트 모음에서 사용 권한 수준이 제거되었습니다.|
|사이트 모음 관리자 제거됨|SiteCollectionAdminRemoved|사이트 모음 관리자 또는 소유자는 사이트의 사이트 모음 관리자로 사용자를 제거합니다. 이 활동은 관리자가 SharePoint 관리 센터에서 사용자 프로필을 편집하여 사용자의 OneDrive 계정에 대한 사이트 수집 관리자 목록에서 자신을 제거하는 경우에도 기록됩니다. 감사 로그 검색 결과에서 이 활동을 반환하려면 모든 활동을 검색해야 합니다.|
...
다음 표에는 SharePoint Online의 사이트 관리 작업에서 발생하는 이벤트가 나열되어 있습니다. 앞에서 설명한 대로 일부 SharePoint 활동에 대한 감사 기록은 app@sharepoint 사용자가 작업을 시작한 사용자 또는 관리자를 대신하여 작업을 수행했음을 나타냅니다. 앞에서 설명한 대로 일부 SharePoint 활동에 대한 감사 기록은 app@sharepoint 사용자가 작업을 시작한 사용자 또는 관리자를 대신하여 작업을 수행했음을 나타냅니다. 자세한 내용은 [감사 기록에 있는 app\@sharepoint 사용자](#the-appsharepoint-user-in-audit-records)를 참조하세요.
...
|사이트 지리적 이동 취소됨|SiteGeoMoveCancelled|SharePoint 또는 전역 관리자가 SharePoint 또는 OneDrive 사이트 지리적 이동을 취소했습니다. Multi-Geo 기능을 통해 조직은 지역이라고 불리는 여러 Microsoft 데이터 센터 지역을 포괄할 수 있습니다. 자세한 내용은 [OneDrive 및 SharePoint Online에서 Multi-Geo 기능](https://go.microsoft.com/fwlink/?linkid=860840)을 참조하세요.|
|공유 정책 변경됨|SharingPolicyChanged|SharePoint 또는 전역 관리자가 Microsoft 365 관리 포털, SharePoint 관리 포털 또는 SharePoint Online 관리 셸을 사용하여 SharePoint 공유 정책을 변경했습니다. 조직의 공유 정책 설정에 대한 변경 내용이 모두 기록됩니다. 변경된 정책은 이벤트 기록의 자세한 속성의 **ModifiedProperties** 필드에서 식별됩니다.|
|디바이스 액세스 정책 변경됨|DeviceAccessPolicyChanged|SharePoint 또는 전역 관리자가 조직의 관리되지 않는 디바이스 정책을 변경했습니다. 이 정책은 조직에 가입되지 않은 디바이스에서의 SharePoint, OneDrive 및 Microsoft 365에 대한 액세스를 제어합니다. 이 정책을 구성하려면 Enterprise Mobility + Security 구독이 필요합니다. 자세한 내용은 [관리되지 않는 디바이스에서의 액세스 제어](https://docs.microsoft.com/sharepoint/control-access-from-unmanaged-devices)를 참조하세요.|
...
|사이트 지리적 이동 완료됨|SiteGeoMoveCompleted|조직에서 전역 관리자가 예약한 사이트 지역 이동이 성공적으로 완료되었습니다. 멀티 지오(Multi-Geo) 기능을 통해 조직은 지오(geos)라고 불리는 여러 마이크로소프트 데이터 센터 지역을 포괄할 수 있습니다. 자세한 정보는 [Office 365의 OneDrive 및 SharePoint Online에서 Multi-Geo 기능](https://go.microsoft.com/fwlink/?linkid=860840)을 참조하시기 바랍니다.|
...
|분리된 허브 사이트 삭제됨|HubSiteOrphanHubDeleted|SharePoint 또는 전역 관리자가 연결된 사이트가 없는 허브 사이트인 분리된 허브 사이트를 삭제합니다. 원래 허브 사이트가 삭제되어 연결이 끊긴 허브가 원인일 수 있습니다.|
...
|허브 사이트 등록됨|HubSiteRegistered|SharePoint 또는 전역 관리자가 허브 사이트를 생성합니다. 그 결과 사이트가 허브 사이트로 등록되었습니다.|
...
|예약된 사이트 지리적 이동|SiteGeoMoveScheduled|SharePoint 또는 전역 관리자가 SharePoint 또는 OneDrive 사이트 지리적 이동을 예약했습니다. Multi-Geo 기능을 통해 조직은 지역이라고 불리는 여러 Microsoft 데이터 센터 지역을 포괄할 수 있습니다. 자세한 내용은 [Office 365의 OneDrive 및 SharePoint Online에서 Multi-Geo 기능](https://go.microsoft.com/fwlink/?linkid=860840)을 참조하세요.|
...
|허브 사이트 등록이 취소됨|HubSiteUnregistered|SharePoint 또는 전역 관리자는 사이트를 허브 사이트로 등록 취소합니다. 허브 사이트가 등록되지 않은 경우 더 이상 허브 사이트로 작동하지 않습니다.|
||||

### <a name="exchange-mailbox-activities"></a>Exchange 사서함 활동

다음 표에는 사서함 감사 기록으로 기록될 수 있는 활동이 나와 있습니다. 사서함 소유자, 위임된 사용자 또는 관리자가 수행하는 사서함 활동은 최대 90일 동안 감사 로그에 자동으로 기록됩니다. 관리자는 조직의 모든 사용자에 대해 사서함 감사 기록을 해제할 수 있습니다. 이 경우 사용자에 대한 사서함 작업이 기록되지 않습니다. 자세한 내용은 [사서함 감사 관리](enable-mailbox-auditing.md)를 참조하세요.
...
|이름|작업|설명|
|:-----|:-----|:-----|
|액세스한 사서함 항목|MailItemsAccessed|메시지가 사서함에서 읽히거나 액세스되었습니다. 이 활동에 대한 감사 기록은 두 가지 방법 중 하나로 트리거됩니다. 즉, 메일 클라이언트(예: Outlook)가 메시지에 대한 바인딩 작업을 수행할 때 또는 메일 프로토콜(예: Exchange ActiveSync 또는 IMAP)이 메일 폴더의 항목을 동기화할 때 발생합니다. 이 활동은 Office 365 또는 Microsoft 365 E5 라이센스를 가진 사용자에게만 기록됩니다. 이 활동에 대한 감사 기록을 분석하는 것은 손상된 전자 메일 계정을 조사할 때 유용합니다. 자세한 내용은 [고급 감사](advanced-audit.md#access-to-crucial-events-for-investigations)의 "조사용으로 중요한 이벤트에 액세스" 섹션을 참조하세요. |
...
|일정 폴더에 대한 대리인 액세스 권한이 있는 사용자 추가 또는 제거 됨|UpdateCalendarDelegation|사용자가 다른 사용자의 사서함 일정에 대리인으로 추가 또는 제거되었습니다. 일정 위임은 동일한 조직의 다른 사용자에게 사서함 소유자의 일정을 관리할 수 있는 권한을 부여합니다.|
|폴더에 사용 권한 추가됨|AddFolderPermissions|폴더 권한이 추가되었습니다. 폴더 권한은 사서함의 폴더와 해당 폴더에 있는 메시지에 액세스할 수 있는 조직의 사용자를 제어합니다.|
|메시지가 다른 폴더에 복사됨|복사|메시지가 다른 폴더에 복사되었습니다.|
|생성된 사서함 항목|만들기|사서함의 일정, 연락처, 메모 또는 작업 폴더에 항목이 생성되었습니다. 예를 들어 새 모임 요청이 생성되었습니다. 메시지 작성, 보내기 또는 받기는 감사되지 않습니다. 사서함 폴더 만들기도 감사되지 않습니다.|
|Outlook 웹앱에서 새 편지함 규칙 만들어짐|New-InboxRule|사서함에 액세스할 수 있는 사서함 소유자 또는 다른 사용자가 Outlook 웹앱에서 받은 편지함 규칙을 만들었습니다.|
|지운 편지함 폴더에서 메시지 삭제됨|SoftDelete|지운 편지함 폴더에서 메시지가 삭제 또는 영구적으로 삭제되었습니다. 이러한 항목은 복구 가능한 항목 폴더로 이동됩니다. 사용자가 메시지를 선택하고 **Shift+Delete** 를 누르는 경우에도 복구 가능한 항목 폴더로 이동됩니다.|
|메시지가 기록으로 지정됨|ApplyRecordLabel|메시지가 기록으로 분류되었습니다. 이는 콘텐츠를 기록으로 분류하는 보존 레이블이 수동으로 또는 메시지에 자동으로 적용되는 경우 발생합니다.|
...
|폴더에서 사용 권한이 제거됨|RemoveFolderPermissions|폴더 권한이 제거되었습니다. 폴더 권한은 사서함의 폴더와 해당 폴더에 있는 메시지에 액세스할 수 있는 조직의 사용자를 제어합니다.|
|보낸 메시지|보내기|메시지를 보내거나 회신하거나 전달했습니다. 이 활동은 Office 365 또는 Microsoft 365 E5 라이선스를 가진 사용자에게만 기록됩니다. 자세한 내용은 [고급 감사](advanced-audit.md#access-to-crucial-events-for-investigations)의 "조사용으로 중요한 이벤트에 액세스" 섹션을 참조하세요.|
...
|사용자 암호 변경됨|사용자 암호 변경|사용자가 암호를 변경합니다. 사용자가 암호를 재설정할 수 있도록 하려면 조직에서 (모든 사용자 또는 선택한 사용자에 대해) 셀프 서비스 암호 재설정을 활성화해야 합니다. 또한 Azure Active Directory에서 셀프 서비스 암호 재설정 작업을 추적할 수 있습니다. 자세한 내용은 [Azure AD 암호 관리 옵션 보고](https://docs.microsoft.com/azure/active-directory/authentication/howto-sspr-reporting)를 참조하세요.
...
|사용자 업데이트됨|사용자 업데이트|관리자가 사용자 계정의 속성을 하나 이상 변경합니다. 업데이트할 수 있는 사용자 속성 목록은 [Azure Active Directory 감사 보고서 이벤트](https://go.microsoft.com/fwlink/p/?LinkID=616549)에서 "사용자 속성 업데이트" 섹션을 참조하세요.|
||||

### <a name="azure-ad-group-administration-activities"></a>Azure AD 그룹 관리 활동

다음 표에서는 관리자 또는 사용자가 Microsoft 365 그룹을 만들거나 변경할 때 또는 관리자가 Microsoft 365 관리자 센터 또는 Azure 관리 포털을 사용하여 보안 그룹을 만들 때 기록되는 그룹 관리 활동을 보여줍니다. Office 365의 그룹에 대한 자세한 내용은 [Microsoft 365 관리 센터에서 그룹 보기, 만들기, 삭제](https://docs.microsoft.com/microsoft-365/admin/create-groups/create-groups)를 참조하세요.

|이름|작업|설명|
|:-----|:-----|:-----|
|그룹 추가됨|그룹 추가|그룹이 생성되었습니다.|
|그룹에 구성원 추가됨|그룹에 구성원 추가|그룹에 구성원이 추가되었습니다.|
|그룹 삭제됨|그룹 삭제|그룹이 삭제되었습니다.|
|그룹에서 구성원 제거됨|그룹에서 구성원 제거|그룹에서 구성원이 제거되었습니다.|
|그룹 업데이트됨|그룹 업데이트|그룹의 속성이 변경되었습니다.|
||||
...
|이름|작업|설명|
|:-----|:-----|:-----|
|위임 항목 추가됨|위임 항목 추가|Azure AD에서 인증 권한이 생성/응용 프로그램에 부여되었습니다.|
|서비스 사용자 추가됨|서비스 사용자 추가|응용 프로그램이 Azure AD에 등록되었습니다. 응용 프로그램은 디렉터리에서 서비스 사용자로 표시됩니다.|
|서비스 사용자에 자격 증명 추가됨 |서비스 사용자 자격 증명 추가|Azure AD의 서비스 사용자에 자격 증명이 추가되었습니다. 서비스 사용자는 디렉터리의 응용 프로그램을 나타냅니다.|
|위임 항목 제거됨|위임 항목 제거|Azure AD의 응용 프로그램에서 인증 권한이 제거되었습니다.|
|디렉터리에서 서비스 사용자 제거됨|서비스 사용자 제거|응용 프로그램이 Azure AD에서 삭제/등록 취소되었습니다. 응용 프로그램은 디렉터리에서 서비스 사용자로 표시됩니다.|
|서비스 사용자에서 자격 증명 제거됨 |서비스 사용자 자격 증명 제거|Azure AD의 서비스 사용자에서 자격 증명이 제거되었습니다. 서비스 사용자는 디렉터리의 응용 프로그램을 나타냅니다.|
|위임 항목 설정|위임 항목 설정|Azure AD의 응용 프로그램에 대해 인증 권한을 업데이트했습니다.|
||||
...
|회사 정보 설정|회사 정보 설정|조직에 대한 회사 차원 정보를 업데이트했습니다. 여기에는 Microsoft 365에서 보내는 구독 관련 전자 메일의 전자 메일 주소와 Microsoft 365 서비스에 대한 기술 알림이 포함됩니다.|
...
보안 및 준수 센터에서 또는 해당 PowerShell cmdlet을 실행하여 수행한 콘텐츠 검색 및 eDiscovery 관련 활동은 감사 로그에 기록됩니다. 여기에는 다음 활동이 포함됩니다.
...
> [!NOTE]
> **활동** 드롭다운 목록의 **eDiscovery 활동** 및 **Advanced eDiscovery 활동** 아래에 나열된 활동에서 발생한 이벤트가 검색 결과에 표시될 때까지 최대 30분이 걸립니다. 반대로, eDiscovery cmdlet 활동의 해당 이벤트가 검색 결과에 나타날 때까지는 최대 24시 간이 걸립니다.

### <a name="advanced-ediscovery-activities"></a>고급 eDiscovery 활동

Advanced eDiscovery에서 감사 로그에서 작업을 검색할 수도 있습니다. 이 활동에 대한 설명은 [감사 로그에서 eDiscovery 활동 검색](search-for-ediscovery-activities-in-the-audit-log.md#advanced-ediscovery-activities)에서 “고급 eDiscovery 활동” 섹션을 참조하세요.

### <a name="power-bi-activities"></a>Power BI 활동

Power BI에서 감사 로그 활동을 검색할 수 있습니다. Power BI 활동에 대한 자세한 내용은 [조직 내에서 감사 사용](https://docs.microsoft.com/power-bi/service-admin-auditing#activities-audited-by-power-bi)의 "Power BI가 감사한 활동" 섹션을 참조하세요.

Power BI에 대한 감사 로깅은 기본적으로 사용할 수 없습니다. 감사 로그에서 Power BI 활동을 검색하려면 Power BI 관리자 포털에서 감사를 사용으로 설정해야 합니다. 지침에 대한 내용은 [Power BI 관리자 포털](https://docs.microsoft.com/power-bi/service-admin-portal#audit-logs)을 참조하세요.

### <a name="microsoft-workplace-analytics-activities"></a>Microsoft Workplace Analytics 활동

Workplace Analytics는 조직 전체에서 그룹이 공동으로 작업하는 방법에 대한 인사이트를 제공합니다. 다음 표에는 Workplace Analytics에서 관리자 역할 또는 분석가 역할이 할당된 사용자가 수행한 활동이 나와 있습니다. 분석가 역할이 할당된 사용자는 모든 서비스 기능에 완전히 액세스할 수 있으며 제품을 사용하여 분석을 수행합니다. 관리자 역할이 할당된 사용자는 개인 정보 설정 및 시스템 기본값을 구성할 수 있으며 Workplace Analytics에서 조직 데이터를 준비, 업로드 및 확인할 수 있습니다. 자세한 내용은 [Workplace Analytics](https://docs.microsoft.com/workplace-analytics/index-orig)를 참조하세요.
...
감사 로그에서 Microsoft Teams의 사용자 및 관리자 활동을 검색할 수 있습니다. Teams는 Office 365의 채팅 중심 업무 공간입니다. 팀의 대화, 회의, 파일 및 메모를 한 곳에 모읍니다. 감사 대상 Teams 활동에 대한 설명은 [Microsoft Teams에서 이벤트 감사 로그 검색](https://docs.microsoft.com/microsoftteams/audit-log-events#teams-activities)을 참조하세요.

### <a name="microsoft-teams-healthcare-activities"></a>Microsoft Teams 보건 활동

조직에서 Microsoft Teams에서 [환자 응용 프로그램](https://docs.microsoft.com/MicrosoftTeams/expand-teams-across-your-org/healthcare/patients-app-overview)을 사용하는 경우 감사 로그에서 환자 앱 사용과 관련된 작업을 검색할 수 있습니다. 사용자 환경이 환자 앱을 지원하도록 구성된 경우 **활동** 선택 목록에서 이러한 활동에 대한 추가 활동 그룹을 사용할 수 있습니다.
...
조직에서 Microsoft Teams에서 Shifts 응용 프로그램을 사용하는 경우 감사 로그에서 Shifts 앱 사용과 관련된 작업을 검색할 수 있습니다. 사용자 환경이 Shifts 앱을 지원하도록 구성된 경우 **활동** 선택 목록에서 이러한 활동에 대한 추가 활동 그룹을 사용할 수 있습니다.
...
다음 표에서는 Yammer에서 감사 로그에 기록되는 사용자 및 관리자 활동을 보여줍니다. 감사 로그에서 Yammer 관련 활동을 반환하려면 **활동** 목록에서 **모든 활동에 대한 결과 표시** 를 선택해야 합니다. 날짜 범위 상자와 **사용자** 목록을 사용하여 결과를 좁힙니다.
...
감사 로그에서 Power Automation(이전의 Microsoft Flow)에서 작업을 검색할 수 있습니다. 이러한 활동에는 흐름 작성, 편집 및 삭제, 흐름 권한 변경 등이 포함됩니다. Power Automation 활동에 대한 감사 정보는 현재 [보안 및 준수 센터에서 제공되는 Microsoft Flow 감사 이벤트 블로그](https://flow.microsoft.com/blog/security-and-compliance-center)를 참조하세요.

### <a name="microsoft-power-apps-activities"></a>Microsoft Power Apps 활동

감사 로그에서 Power Apps에서 앱 관련 활동을 검색할 수 있습니다. 이러한 활동에는 앱 만들기, 시작 및 게시 등이 포함됩니다. 앱에 권한을 할당하는 것도 감사 대상입니다. 모든 Power Apps 활동에 대한 설명은 [에 대한 활동 기록](https://docs.microsoft.com/power-platform/admin/logging-powerapps#what-events-are-audited)을 참조하세요.

### <a name="microsoft-stream-activities"></a>Microsoft Stream 활동

감사 로그에서 Microsoft Stream의 작업을 검색할 수 있습니다. 이러한 활동에는 사용자가 수행하는 비디오 활동, 그룹 채널 활동 및 사용자 관리, 조직 설정 관리, 보고서 내보내기 등의 관리자 활동이 포함됩니다. 이러한 활동에 대한 설명은 [의 감사 로그](https://docs.microsoft.com/stream/audit-logs#actions-logged-in-stream)에서 "로그인된 Stream" 섹션을 참조하세요.

### <a name="content-explorer-activities"></a>콘텐츠 탐색기 활동

다음 표에는 감사 로그에 기록된 콘텐츠 탐색기의 활동이 나열되어 있습니다. 콘텐츠 탐색기는 Microsoft 365 규정 준수 센터의 데이터 분류 도구에서 액세스합니다. 자세한 내용은 [데이터 분류 콘텐츠 탐색기](data-classification-content-explorer.md) 사용을 참조하세요.
...
다음 표에는 감사 로그에서 검색할 수 있는 격리 활동이 나열되어 있습니다. 격리에 대한 자세한 내용은 [Office 365에서 전자 메일 메시지 격리](../security/office-365-security/quarantine-email-messages.md)를 참조하세요.
...
다음 표에는 감사 로그에 로그인한 Microsoft Forms의 사용자 및 관리자 작업이 나열되어 있습니다. Microsoft Forms는 분석을 위한 데이터를 수집하는 데 사용되는 양식/퀴즈/조사 도구입니다. 

아래의 설명에서 언급된 것과 같이, 일부 작업은 추가 활동 매개 변수를 포함합니다.

> [!NOTE]
> Forms 활동이 공동 작성자 또는 익명 응답자에 의해 수행되는 경우, Forms 활동은 약간 다르게 기록됩니다. 자세한 내용은 [공동 작업자와 익명 응답자가 수행한 Forms 활동](#forms-activities-performed-by-coauthors-and-anonymous-responders) 섹션을 참조하세요.

|이름|작업|설명|
|:-----|:-----|:-----|
|메모가 작성됨|CreateComment|양식 소유자가 퀴즈에 메모 또는 점수를 추가합니다.|
|양식이 만들어짐|CreateForm|양식 소유자가 새 양식을 만듭니다.|
|양식이 편집됨|EditForm|양식 소유자는 질문 작성, 삭제 또는 편집과 같은 양식을 편집합니다. *EditOperation:string* 속성은 편집 작업 이름을 나타냅니다. 가능한 작업은 다음과 같습니다.<br/>- CreateQuestion<br/>- CreateQuestionChoice <br/>- DeleteQuestion <br/>- DeleteQuestionChoice <br/>- DeleteFormImage <br/>- DeleteQuestionImage <br/>- UpdateQuestion <br/>- UpdateQuestionChoice <br/>- UploadFormImage/Bing/Onedrive <br/>- UploadQuestionImage <br/>- ChangeTheme <br><br>FormImage에는 사용자가 이미지를 업로드할 수 있는 양식 내의 모든 위치(예: 쿼리나 배경 테마)가 포함됩니다.|
|양식 이동됨|MoveForm|양식 소유자가 양식을 이동합니다. <br><br>속성 DestinationUserId:string은 양식을 이동한 사용자의 사용자 ID를 나타냅니다. NewFormId:string 속성은 새로 복사한 양식의 새 ID입니다.|
...
|공유 양식 복사가 허용됨|AllowShareFormForCopy|양식 소유자는 다른 사용자와 양식을 공유하기 위해 서식 파일 링크를 작성합니다. 이 이벤트는 양식 소유자가 서식 파일 URL을 생성하기 위해 클릭할 때 기록됩니다.|
|공유 양식 복사가 허용되지 않음|DisallowShareFormForCopy|양식 소유자 서식 파일 링크를 삭제합니다.|
|양식 공동 작성이 추가됨|AddFormCoauthor|사용자는 공동 작업 링크를 사용하여 응답에 대한 설계/보기를 도와줍니다. 이 이벤트는 사용자가 공동 작업 URL을 사용할 때 기록됩니다(공동 작업 URL이 처음 생성될 때는 기록되지 않음).|
|양식 공동 작성이 제거됨|RemoveFormCoauthor|양식 소유자가 공동 작업 링크를 삭제합니다.|
|응답 페이지를 확인함|ViewRuntimeForm|사용자가 보기에 대한 응답 페이지를 열었습니다. 이 이벤트는 사용자가 응답을 제출하는지 여부에 관계없이 기록됩니다.|
|응답이 만들어짐|CreateResponse|새 응답을 받는 것과 유사합니다. 사용자가 양식에 대한 응답을 제출했습니다. <br><br>속성 ResponseId: 문자열 및 속성 ResponderId: 문자열은 어떤 결과를 보고 있는지 나타냅니다. <br><br>익명의 응답자의 경우 ResponderId 속성은 null입니다.|
...
|양식 피싱 상태가 업데이트됨|UpdatePhishingStatus|이 이벤트는 최종 보안 상태가 변경되었는지에 관계없이 내부 보안 상태에 대한 세부 값이 변경될 때마다 기록됩니다(예: 이제 양식이 닫힘 또는 열림). 즉, 최종 보안 상태 변경 없이 중복 이벤트가 나타날 수 있습니다. 이 이벤트의 가능한 상태 값은 다음과 같습니다.<br/>- 다운시킴 <br/>- 관리자가 다운시킴 <br/>- 관리자가 차단 해제함 <br/>- 자동 차단됨 <br/>- 자동 차단 해제됨 <br/>- 보고된 고객 <br/>- 보고된 고객 초기화|
|사용자 피싱 상태 업데이트됨|UpdateUserPhishingStatus|이 이벤트는 사용자 보안 상태 값이 변경될 때마다 기록됩니다. 사용자가 Microsoft Online 안전 팀에 의해 제거된 피싱 양식을 생성할 때 감사 기록의 사용자 상태 값은 **피셔로 확인** 됩니다. 관리자가 사용자의 차단을 해제하면 사용자 상태 값이 **일반 사용자로 재설정** 으로 설정됩니다.|
...
양식은 양식을 설계할 때와 반응을 분석할 때 공동 작업을 지원합니다. 양식 공동 작업자를 *공동 작성자* 라고 합니다. 공동 작성자는 양식 소유자가 양식 삭제 또는 이동을 제외한 모든 작업을 수행할 수 있습니다. 또한 양식을 사용하여 익명으로 응답할 수 있는 양식을 만들 수 있습니다. 즉, 양식에 응답하기 위해 응답자가 조직에 서명할 필요가 없습니다.

다음 표에서는 공동 작성자와 익명 응답자가 수행한 활동에 대한 감사 기록의 감사 활동과 정보를 설명합니다.
...
| 보존 정책에서 설정을 삭제했습니다.| RemoveRetentionComplianceRule<br/>| 관리자가 보존 정책의 구성 설정을 삭제했습니다. 이 활동은 관리자가 보존 정책을 삭제하거나 [Remove-RetentionComplianceRule](https://docs.microsoft.com/powershell/module/exchange/Remove-RetentionComplianceRule) cmdlet을 실행할 때 기록될 가능성이 높습니다.|
...
| 보존 정책에 대한 설정 업데이트 | SetRetentionComplianceRule | 관리자가 기존 보존 정책에 대한 보존 설정을 변경했습니다. 보존 설정에는 항목이 보존되는 기간과 보존 기간이 만료될 때 발생하는 작업(예: 항목 삭제, 항목 보존, 보존 및 삭제)이 포함됩니다. 이 활동은 또한 [Set-RetentionComplianceRule](https://docs.microsoft.com/powershell/module/exchange/set-retentioncompliancerule) cmdlet을 실행하는 것과도 같습니다. |
...
Exchange 관리자 감사 기록(Office 365에서 기본적으로 사용 가능)은 관리자(또는 관리 권한이 할당된 사용자)가 Exchange 온라인 조직을 변경할 때 감사 로그에 이벤트를 기록합니다. Exchange 관리 센터를 사용하거나 Exchange Online PowerShell에서 cmdlet을 실행하여 변경한 내용은 Exchange 관리 감사 로그에 기록됩니다. **Get-**, **Search-** 또는 **Test-** 동사로 시작하는 cmdlet이 감사 로그에 기록되지 않습니다. Exchange의 관리 감사 로깅에 대한 자세한 내용은 [관리자 감사 로깅](https://go.microsoft.com/fwlink/p/?LinkID=619225)을 참조하세요.

> [!IMPORTANT]
> Exchange 관리자 감사 로그 또는 감사 로그에 기록되지 않은 일부 Exchange 온라인 cmdlet입니다. 이러한 cmdlet의 대부분은 Exchange 온라인 서비스 유지 보수와 관련이 있으며 Microsoft 데이터 센터 직원 또는 서비스 계정에 의해 실행됩니다. 이러한 cmdlet은 많은 "잡음" 감사 이벤트를 발생시키기 때문에 기록되지 않습니다. 감사 대상이 아닌 Exchange Online cmdlet이 있는 경우 [보안 및 규정 준수 User Voice 포럼](https://office365.uservoice.com/forums/289138-office-365-security-compliance)에 제안을 제출하고 감사용으로 사용하도록 설정되도록 요청하시기 바랍니다. 또한 DCR(설계 변경 요청)을 Microsoft 지원부에 제출할 수도 있습니다.
...
- 실행된 cmdlet, 사용된 매개 변수 및 매개 변수 값, 영향을 받은 개체에 대한 정보를 가져오려면 **모든 결과 다운로드** 옵션을 선택하여 검색 결과를 내보낼 수 있습니다. 자세한 내용은 [감사 로그 기록 내보내기, 구성 및 보기](export-view-audit-log-records.md)를 참조하세요.
...
- Exchange 관리 센터를 사용하거나 Exchange Online PowerShell에서 **Search-AdminAuditLog** 를 실행하여 Exchange 관리 감사 로그의 이벤트를 볼 수도 있습니다. 이렇게 하면 Exchange Online 관리자가 수행한 작업을 구체적으로 검색할 수 있습니다. 자세한 내용은

  - [관리자 감사 로그 보기](https://technet.microsoft.com/library/dn342832%28v=exchg.150%29.aspx)를 참조하세요.
...
Exchange Online, SharePoint Online, 비즈니스용 OneDrive, Azure Active Directory, Microsoft Teams, Dynamics 365, Office 365용 Defender 및 Power BI와 같이 가장 많이 사용되는 서비스가 감사됩니다. 감사 대상서비스 목록은 [이 문서의 시작](search-the-audit-log-in-security-and-compliance.md)을 참조하세요.

**Office 365의 감사 서비스에서 어떤 활동을 감사하나요?**

감사되는 활동의 목록과 설명을 보려면 이 문서의 [감사되는 활동](#audited-activities) 섹션을 참조하세요.

**이벤트가 발생한 후 감사 기록을 사용하는 데 시간이 얼마나 걸리나요?**

대부분의 감사 데이터는 30분 이내에 사용할 수 있지만 해당 감사 로그 항목이 검색 결과에 표시되는 데 이벤트가 발생한 후 최대 24시간이 걸릴 수 있습니다. 다른 서비스의 이벤트를 사용할 수 있는 데 걸리는 시간을 보여주는 이 문서의 [감사 로그 검색 요구 사항](#requirements-to-search-the-audit-log) 섹션의 표를 참조하세요.

**감사 기록은 얼마나 오래 보존되나요?**

앞에서 설명한 것처럼 Office 365 E5 또는 Microsoft E5 라이선스가 할당된 사용자(또는 Microsoft 365 E5 추가 기능 라이선스가 있는 사용자)가 수행한 활동에 대한 감사 기록은 1년 동안 보존됩니다. 통합 감사 기록을 지원하는 기타 모든 구독의 경우 감사 기록은 90일 동안 유지됩니다.

**프로그래밍 방식으로 감사 데이터에 액세스할 수 있나요?**

예. Office 365 관리 작업 API를 사용하여 감사 로그를 프로그래밍 방식으로 가져옵니다. 시작하려면 [Office 365 관리 작업 API를 사용하여 시작](https://docs.microsoft.com/office/office-365-management-api/get-started-with-office-365-management-apis)을 참조하세요.
...
**감사 서비스에서 기록 중복 제거를 지원하나요?**

아니요. 감사 서비스 파이프라인은 거의 실시간이므로 중복 제거를 지원할 수 없습니다.

**여러 지역에 걸쳐 데이터 흐름을 감사하나요?**

아니요. 현재 북미, 유럽, 중동, 아프리카 및 아시아 태평양 지역에 감사 파이프라인을 배치하고 있습니다. 그러나 로드 밸런싱을 위해 실시간 사이트 문제에서만 데이터를 이러한 영역으로 이동할 수 있습니다. 이러한 작업을 수행하면 전송 중인 데이터가 암호화됩니다.

**감사 데이터는 암호화되어 있나요?**

감사 데이터는 통합 감사 파이프라인이 배포된 동일한 영역의 Exchange 편지함(정지된 데이터)에 저장됩니다. 사용되지 않는 사서함 데이터는 Exchange에서 암호화되지 않습니다. 그러나 Microsoft 데이터 센터의 Exchange 서버는 BitLocker를 통해 암호화되므로 서비스 수준 암호화는 모든 편지함 데이터를 암호화합니다. 자세한 내용은 [비즈니스용 Skype Office 365 암호화, 비즈니스용 OneDrive SharePoint Online 및 Exchange Online](office-365-encryption-for-skype-onedrive-sharepoint-and-exchange.md)을 참조하세요.
