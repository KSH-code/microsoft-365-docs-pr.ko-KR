...
앱 거버넌스를 시작하기 전에 [Microsoft 365 관리 센터 구독](https://www.microsoft.com/microsoft-365/compare-all-microsoft-365-plans) 및 추가 기능을 확인해야 합니다. 앱 거버넌스에 액세스하고 사용하려면 조직에 다음 구독 또는 추가 기능 중 하나가 있어야 합니다.
