...
---
# <a name="set-up-a-connector-to-archive-webpage-data-preview"></a>웹 페이지 데이터를 보관 하는 커넥터 설정 (미리 보기)
...
2. **커넥터** 탭을 클릭 한 다음 **웹 페이지 캡처** 커넥터를 선택 하 여 커넥터에 대 한 속성 및 정보가 포함 된 플라이 아웃 페이지를 표시 합니다.
