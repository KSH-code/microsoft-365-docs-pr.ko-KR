...
>
> 릴리스 공지 사항을 읽으려면 [Microsoft 레코드 관리 다단계 처리 발표](https://techcommunity.microsoft.com/t5/security-compliance-and-identity/announcing-multi-stage-disposition-in-microsoft-records/ba-p/2361849)에 대한 블로그 게시물을 참조하세요.
