...
서식 있는 형식:
- 0, 1, 2, 3, 6, 7 또는 8로 시작 하는 네 자리 숫자
- 하이픈
- 4자리 숫자
- 하이픈
- 숫자
...
- 또는 Keyword_passport Keyword_australia_passport_number 키워드가 발견됩니다.
...
- 성별에 해당하는 1자리 숫자(1900년 이전의 시민 또는 시민권이 2배인 시민의 경우 1-남성, 2-여성, 기타 숫자도 가능) 
- 생년월일(YYMMDD)에 해당하는 6자리 숫자
- 일련 번호에 해당하는 3자리 숫자
- 검사 숫자 1개
