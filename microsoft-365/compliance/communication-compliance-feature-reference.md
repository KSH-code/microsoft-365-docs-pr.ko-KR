...
통신 규정 준수 사용을 시작하기 전에 검토된 통신이 필요한 사용자 결정해야 합니다. 정책에서 사용자 전자 메일 주소는 감독할 개인 또는 사용자 그룹을 식별합니다. 이러한 그룹의 몇 가지 예로는 Microsoft 365 그룹, Exchange 기반 메일 그룹, Yammer 커뮤니티 및 Microsoft Teams 채널이 있습니다. 특정 제외 그룹 또는 그룹 목록을 사용하여 검사에서 특정 사용자 또는 그룹을 제외할 수도 있습니다.
...
- **Microsoft Teams:** 공개 및 개인 Microsoft Teams 채널에서 채팅 커뮤니케이션과 개별 채팅을 검색할 수 있습니다. 사용자가 Microsoft Teams 적용 범위를 선택한 통신 준수 정책에 할당되면 사용자에 대한 채팅 커뮤니케이션이 사용자가 구성원인 모든 Microsoft Teams에서 자동으로 모니터링됩니다. Microsoft Teams 범위는 미리 정의된 정책 템플릿에 대해 자동으로 포함되며 사용자 지정 정책 템플릿에서 기본적으로 선택됩니다. 커뮤니케이션 준수 정책 조건과 일치하는 Teams 채팅을 처리하는 데 최대 48시간이 걸릴 수 있습니다. 다음 그룹 관리 구성을 사용하여 Teams의 개별 사용자 채팅 및 채널 통신을 감독합니다.
    ...
    - **Teams 채널 커뮤니케이션의 경우:** 특정 사용자가 포함된 모든 Microsoft Teams 채널 또는 Microsoft 365 그룹을 커뮤니케이션 규정 준수 정책에 할당합니다. 다른 Microsoft Teams 채널 또는 Microsoft 365 그룹에 동일한 사용자를 추가하는 경우 이러한 새 채널 및 그룹을 통신 준수 정책에 추가해야 합니다.
...
Office 365에서 감독 정책을 사용하고 Microsoft 365에서 커뮤니케이션 규정 준수 정책으로 전환할 계획인 조직은 다음 중요한 지점을 이해해야 합니다.
