...
통신 준수 기능을 관리 하기 위한 권한을 구성 하는 데 사용 되는 역할에는 다섯 가지가 있습니다. Microsoft 365 준수 센터에서 **통신 준수** 를 메뉴 옵션으로 사용할 수 있도록 하려면 *통신 준수 관리자* 역할을 할당 받아야 합니다.
...
통신 준수 역할 그룹을 구성할 때 다음 역할 옵션 중에서 선택 합니다.
...
- **Racy 이미지**: sexually suggestive 인 이미지를 검색 하지만 성인으로 간주 되는 이미지 보다 덜 명시적 콘텐츠를 포함 합니다.
