...
7. **취소** 를 클릭 하 여 마법사를 닫습니다. 
    ...
    4 단계에서 가져오기 작업을 만들 때 Security & 준수 센터의 **가져오기** 페이지로 다시 돌아옵니다. 
