...
|[사용자가 권한을 할당하도록 허용](encryption-sensitivity-labels.md#let-users-assign-permissions)                     | 미리 보기: [Office 참가자](https://office.com/insider)            | 미리 보기: [Office 참가자](https://office.com/insider)        | 검토 중   | 검토 중         | 검토 중                                                        |
