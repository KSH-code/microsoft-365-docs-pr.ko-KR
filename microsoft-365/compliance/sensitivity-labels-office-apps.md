...
|[레이블 분석을 사용 하 여 레이블 사용을 확인](label-analytics.md) 하 고 관리자를 위해 데이터 보내기                      | 검토 중            | 검토 중        | 검토 중   | 검토 중         | 예로 <sup>\*</sup>                                                        |
...
<sup>\*</sup> 현재는 우편물 레이블을 제거 하거나 분류 수준을 낮추기 위해 맞춤 텍스트를 포함 하지 않습니다.
...
|[레이블 분석을 사용 하 여 레이블 사용을 확인](label-analytics.md) 하 고 관리자를 위해 데이터 보내기                      | 검토 중                       | 검토 중                    | 검토 중           | 검토 중               | 예               |
|[사용자가 전자 메일 및 문서에 레이블을 적용 해야 합니다.](sensitivity-labels.md#what-label-policies-can-do)   | 검토 중                       | 검토 중                    | 검토 중           | 검토 중               | 검토 중               |
...
의미 있는 보고를 사용 하 여 보다 일관성 있는 레이블 환경을 제공 하려면 문서 보호에 레이블을 적용 하는 데 사용할 수 있는 적절 한 레이블과 지침을 제시 합니다. 예를 들면 다음과 같습니다.
...
또한 외부 사용자는 Windows에서 Microsoft 365 앱 ([이전 Office 365 앱](https://docs.microsoft.com/deployoffice/name-change))을 사용 하는 경우 암호화 된 문서에 대해 microsoft 계정을 사용할 수 있으며, macos (버전 16.42 +), Android (버전 16.0.13029 +) 및 iOS (버전 2.42 +)에서 새롭게 지원 됩니다. 예를 들어, 사용자는 암호화 된 문서를 함께 공유 하 고, 암호화 설정은 Gmail 전자 메일 주소를 지정 합니다. 이 사용자는 Gmail 전자 메일 주소를 사용 하는 자신의 Microsoft 계정을 만들 수 있습니다. 그런 다음이 계정으로 로그인 한 후 해당 사용자에 대해 지정 된 사용 제한에 따라 문서를 열고 편집할 수 있습니다. 이 시나리오의 연습 예제를 보려면 보호 된 [문서 열기 및 편집](https://docs.microsoft.com/azure/information-protection/secure-collaboration-documents#opening-and-editing-the-protected-document)을 참조 하십시오.
