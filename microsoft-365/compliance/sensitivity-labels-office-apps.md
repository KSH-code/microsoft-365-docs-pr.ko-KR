...
- 조직의 사용자가 민감도 레이블을 사용 하기 시작 하는 데 도움이 되는 추가 리소스입니다.
...
## <a name="when-office-365-applies-content-marking-and-encryption-to-content"></a>Office 365에서 콘텐츠 표시 및 콘텐츠에 대 한 암호화를 적용 하는 경우
