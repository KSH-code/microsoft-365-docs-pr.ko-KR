...
- Office 365 그룹(그룹의 사서함, 사이트 및 문서의 콘텐츠에 적용됩니다. Planner, Yammer, CRM Microsoft Teams, PowerBI, Stream, Exchange 및 SharePoint 팀 사이트의 콘텐츠에 대한 지원은 곧 제공될 예정입니다.)
...
이전에 Office 365에서 콘텐츠를 보존하거나 삭제하는 데 사용된 다른 여러 기능이 있습니다. 이러한 기능은 아래에 나열되어 있습니다. 이러한 기능은 보존 정책 및 레이블과 함께 계속해서 작동합니다. 그러나 앞으로 데이터 거버넌스의 경우 이러한 기능 대신 보존 정책이나 레이블을 사용하는 것이 좋습니다. Office 365 전반에서 콘텐츠를 보존하고 삭제까지 할 수 있는 기능은 보존 정책이 유일합니다.
...
이전에 데이터 거버넌스 용도로 이와 같은 eDiscovery 보류를 사용한 적이 있는 경우, 앞으로는 사전 규정 준수를 위해 보존 정책을 사용해야 합니다. 보류는 eDiscovery용으로만 사용해야 합니다.
