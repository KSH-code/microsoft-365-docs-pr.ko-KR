...
ms.locfileid: "39625339"
---
# <a name="compliance-offering-financial-supervisory-authority-fsa-denmark"></a>규정 준수 제안: 덴마크 금융감독청(FSA)

## <a name="about-the-fsa"></a>FSA 정보

산업부, 사업부 및 재무부 산하의 [금융감독청](https://aka.ms/FinServ-Guide-Denmark)([Finanstilsynet](https://www.finanstilsynet.dk/))은 덴마크 정부의 금융 규제 기관입니다. 이 기관의 주요 역할은 덴마크 재무 기관을 위한 규정 지침을 준비하고 규정 준수를 모니터링할 뿐만 아니라 지역적, 국제적 당국 및 규제 기관과 협업하는 것입니다.
...
비즈니스 기능을 클라우드로 이동할 때 덴마크의 금융 기관에서 알아야 하는 몇 가지 지침이 있습니다. 일반적으로 금융 조직이 아웃소싱한 기능을 모니터링하고 감사할 수 있게 지원하는 금융 기관 및 서비스 제공업체 모두에 대한 계약상 요구 사항을 규정합니다. 여기에는 다음이 포함됩니다.

산업부, 사업부 및 재무부에서 발행한 지침:

- 재무 기관에 대한 덴마크 법률([덴마크어](https://www.retsinformation.dk/Forms/R0710.aspx?id=193767))
- 주요 활동 영역의 아웃소싱에 대한 집행 명령 1304([덴마크어](https://www.retsinformation.dk/Forms/R0710.aspx?id=134352) 및 [영어](https://www.dfsa.dk/?la=en)) 및 함께 제공되는 지침(덴마크어)
- FSA에서 발행한 IT 아웃소싱의 일부로 클라우드 서비스를 사용하는 데에 대한 지침([덴마크어](https://www.finanstilsynet.dk/?id=131889))
...
- [준수 점검 목록: 덴마크](https://www.retsinformation.dk/Forms/R0710.aspx): 금융 기관은 Microsoft 비즈니스 클라우드 서비스의 위험 평가를 시행하는데 도움을 받을 수 있습니다. 
- [위험 평가 & 준수 가이드](https://docs.microsoft.com/azure/industry/financial/): Microsoft 클라우드 서비스의 위험 평가 및 규제 기관의 알림에 대한 거버넌스 모델을 만들 수 있습니다.
- [금융 유스케이스](https://www.finanstilsynet.dk/~/media/Lovgivning/Oversat-lovgivning/Executive-orders/1304_251110-pdf.pdf): 금융 서비스용 Azure 솔루션을 구축하기 위한 유스케이스 개요, 자습서 및 기타 리소스..
...
예. 주요 활동 영역의 아웃소싱에 대한 집행 명령(및 함께 제공되는 지침)은 금융 기관이 클라우드 서비스 계약에 포함해야 하는 몇 가지 특정 조건을 규정합니다. Microsoft [점검 목록](https://azure.microsoft.com/resources/videos/azurecon-2015-financial-services-compliance-in-azure/)의 2부(48페이지)는 이 사항들을 Microsoft 계약 문서에서 그들이 언급되는 섹션에 매핑을 합니다.
...
- [Azure에서의 금융 서비스 규정 준수](https://aka.ms/AzureCompliance)
...
이 제공 사항에 대한 배경 설명 문서가 필요한가요? [PDF](https://download.microsoft.com/download/E/9/7/E9793230-8137-4297-BC5E-A43F8732CCCD/FSA-Compliance.pdf)를 다운로드합니다.
