...
민감도 레이블을 만들거나 편집하기 위해 **암호화** 페이지에서 **암호화 설정 구성** 을 선택하는 경우, 다음 옵션 중 하나를 선택할 수 있습니다.
...
아래에 나오는 각 예제에 대해 **암호화 설정 구성** 을 선택하는 경우, **암호화** 페이지에서 구성을 수행합니다.
...
9. **암호화** 페이지에서 **다음** 을 선택하고 구성을 완료합니다.
...
- 여러 사용자가 동시에 암호화된 파일을 편집하려면 모두 웹용 Office를 사용해야 합니다.  또는 Windows 및 Mac의 경우 [민감도 레이블로 암호화된 파일에 대해 공동 작성을 사용하도록 설정](sensitivity-labels-coauthoring.md)했고 사용자에게 [필요한 최소 버전](sensitivity-labels-office-apps.md#sensitivity-label-capabilities-in-word-excel-and-powerpoint)의 Word, Excel 및 PowerPoint가 있습니다. 그와 같은 상황이 아니고 파일이 이미 열려있는 경우:
...
- iOS 및 Android용 Office 앱의 [자동 저장](https://support.office.com/article/what-is-autosave-6d6bd723-ebfd-4e40-b5f6-ae6e8088f7a5) 기능은 암호화된 파일에 대해 비활성화됩니다. [민감도 레이블로 암호화된 파일에 대해 공동 작성을 사용하도록 설정](sensitivity-labels-coauthoring.md)하지 않은 경우 Windows 및 Mac에서 암호화된 파일에 대해서도 이 기능이 비활성화됩니다. 사용자에게는 자동 저장을 설정하기 전에 사용 권한의 제한을 해제해야 한다는 메시지가 표시됩니다.
