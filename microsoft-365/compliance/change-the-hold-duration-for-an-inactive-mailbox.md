...
- PowerShell을 사용하여 Exchange Online 사서함에 대한 소송 보류 기간을 변경해야 합니다. EAC(Exchange 관리 센터)는 사용할 수 없습니다. 그러나 PowerShell 또는 EAC를 사용하여 Exchange Online 보류 기간을 변경할 In-Place 있습니다. 보안 및 규정 준수 센터 또는 보안 및 준수 센터 powerShell을 & 보존 정책의 보존 기간을 Microsoft 365 수 있습니다.
