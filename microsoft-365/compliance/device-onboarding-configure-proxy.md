---
title: Information Protection의 장치 프록시 및 인터넷 연결 설정 구성
f1.keywords:
- CSH
ms.author: chrfox
author: chrfox
...
search.appverid:
- MET150
description: Information Protection의 장치 프록시 및 인터넷 연결 설정 구성
ms.openlocfilehash: 645bb3eca60e37db817f810992fd5022399e1249
ms.sourcegitcommit: 8eca41cd21280ffcb1f50cafce7a934e5544f302
ms.translationtype: HT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/12/2021
ms.locfileid: "60950861"
---
# <a name="configure-device-proxy-and-internet-connection-settings-for-information-protection"></a>Information Protection의 장치 프록시 및 인터넷 연결 설정 구성

Microsoft 엔드포인트 기술은 WinHTTP(Microsoft Windows HTTP)를 사용하여 데이터를 보고하고 Microsoft 엔드포인트 클라우드 서비스와 통신합니다. 포함된 서비스는 LocalSystem 계정을 사용하여 시스템 컨텍스트에서 실행됩니다.
