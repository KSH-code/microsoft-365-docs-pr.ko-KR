...
description: 준수 센터의 콘텐츠 검색에서 Microsoft 365 컴퓨터로 내보낼 수 있습니다. 전자 메일 결과는 PST 파일로 내보낼 수 있습니다. 사이트 SharePoint 비즈니스용 OneDrive 콘텐츠는 기본 Office 내보낼 수 있습니다.
...
- 검색 결과를 로컬 컴퓨터에 다운로드하는 것이 좋습니다. 그러나 검색 결과를 다운로드할 때 회사의 방화벽 또는 프록시 인프라에서 문제를 발생시켰을 수 있도록 네트워크 외부의 가상 데스크톱에 검색 결과를 다운로드하는 것이 좋습니다. 이렇게하면 많은 수의 파일을 내보낼 때 Azure 데이터 연결에서 발생하는 시간 제한이 줄어들 수 있습니다. 가상 데스크톱에 대한 자세한 내용은 가상 [데스크톱 Windows 참조하세요.](https://azure.microsoft.com/services/virtual-desktop) 
...
7. 콘텐츠 **Exchange 내보내기에서** 다음 옵션 중 하나를 선택합니다.
...
8. 중복 **제거 사용 확인란을** 클릭하여 중복 메시지를 제외합니다. 이 옵션은 검색의 콘텐츠 원본에 사서함 또는 공용 폴더가 포함된 Exchange 표시됩니다. 
...
9. 문서에 **대한 버전 SharePoint** 확인란을 클릭하여 모든 버전의 SharePoint 내보낼 수 있습니다. 이 옵션은 검색의 콘텐츠 원본에 사이트 또는 사이트가 포함된 SharePoint 비즈니스용 OneDrive 표시됩니다. 
  
10. **압축된(압축된)** 폴더에서 파일 내보내기 확인란을 클릭하여 검색 결과를 압축된 폴더로 내보낼 수 있습니다. 이 옵션은 개별 메시지로 Exchange 내보낼 때 그리고 검색 결과에 문서 또는 문서의 SharePoint OneDrive 사용할 수 있습니다. 이 옵션은 주로 항목을 내보낼 때 파일 경로 Windows 260자 제한을 사용하는 데 사용됩니다. 자세한 내용은 추가 정보 섹션에서 "내보낼 항목의 [파일 이름"을 참조하세요.](#more-information) 
