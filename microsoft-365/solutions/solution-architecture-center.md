...
이 솔루션 및 아키텍처 센터에서는 안전 하 고 준수 하는 최신 공동 작업을 위해 통합 Microsoft 365 솔루션을 이해 하 고 계획 하 고 구현 하는 데 필요한 기술 지침을 함께 제공 합니다. 이 센터에서는 다음을 확인할 수 있습니다.
...
- [Microsoft 365을 사용한 보안 공동 작업 설정](setup-secure-collaboration-with-teams.md)
- [Microsoft 365를 통한 위협 보호 배포](deploy-threat-protection.md)
