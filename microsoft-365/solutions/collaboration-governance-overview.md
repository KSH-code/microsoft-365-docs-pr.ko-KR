...
|[Project 및 로드맵](https://support.microsoft.com/project)|웹 기반 프로젝트 관리 도구|
...
다음 세 가지 주요 통신 방법이 Microsoft 365.
...
공동 작업 기능의 사용 방법을 결정할 때 Microsoft 365 이러한 통신 방법과 사용자가 서로 다른 시나리오에서 사용할 가능성이 높은 방법을 고려합니다.
...
- **조직 및** 다양한 유형의 콘텐츠 및 시나리오에 맞게 조정 - 그룹 또는 부서마다 요구 사항을 고려하고 인트라넷 콘텐츠와 사용자의 콘텐츠와 같은 다양한 형식의 콘텐츠를 OneDrive 고려합니다.

- **비즈니스 우선 순위에 맞추기** - 비즈니스 목표는 거버넌스에 투자해야 하는 시간 및 에너지의 정도를 정의하는 데 도움이 됩니다.

- **직접 만든** 솔루션에 거버넌스 결정이 직접 추가됩니다. 대부분의 거버넌스 결정은 관리 방법의 기능을 설정하거나 해제하여 구현할 수 Microsoft 365.


- **단계적 방법 사용** - 공동 작업 기능을 먼저 소수의 사용자 그룹에 롤아웃합니다. 더 큰 그룹으로 진행하기 전에 피드백을 얻거나 지원 센터 티켓을 감시하고 필요한 설정이나 프로세스를 업데이트합니다.

- **교육으로 강화** - microsoft에서 [](/office365/customlearning) 제공하는 교육을 통해 조직에 Microsoft 365 기대치가 강화되도록 학습 경로와 같은 솔루션을 조정합니다.

- **조직에서** 거버넌스 정책 및 지침을 전달하기 위한 전략이 있습니다. Microsoft 365 커뮤니케이션 사이트에 SharePoint 센터를 만들어 정책 및 절차를 전달합니다.
...
2. 서비스의 설정 이해 [-](groups-sharepoint-governance.md) 그룹 및 SharePoint 그룹 및 기타 서비스의 설정과 SharePoint [Teams](groups-sharepoint-teams-governance.md) 상호 [작용합니다.](groups-services-interactions.md) 거버넌스 전략을 계획할 때 이러한 상호 작용을 이해해야 합니다.
3. 사용자 액세스 관리 계획 - 그룹, 액세스 권한 및 그룹에서 사용자에게 부여할 액세스 SharePoint [계획할](groups-teams-access-governance.md)Teams.
4. 준수 설정 관리 계획 - Microsoft 365 그룹, Teams 및 SharePoint [옵션을 검토합니다.](groups-teams-compliance-governance.md)
...
Microsoft Learn의 이러한 교육 모듈은 Microsoft의 관리 기능을 학습하는 데 도움이 될 Microsoft 365.
...
- [사용자 Microsoft 365 수용](https://www.youtube.com/watch?v=dAamBF1gb7M)

**거버넌스**

그룹 만료 수명 주기, 이름 지정 정책, 분류 레이블, 외부 게스트와의 공동 작업 및 그룹 만들기 권한을 관리하는 방법을 알아보습니다.

- [그룹으로 공동 작업 변환 및 섀도 IT Office 365 격투](https://www.youtube.com/watch?v=Bhf_bKx3lAg)

**고객 예제**

전역 공동 작업 플랫폼을 제공하기 위해 Microsoft 365 그룹, SharePoint, Teams Yammer 함께 작업하는 방법에 대한 배경 예제를 참조합니다.

- [그룹, Office 365, SharePoint, Teams 및 사용자 Yammer](https://www.youtube.com/watch?v=Rx9eVwqXeQk)
