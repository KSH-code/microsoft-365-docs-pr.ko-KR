...
- <span data-ttu-id="7d073-113">지역 데이터 규정을 준수</span><span class="sxs-lookup"><span data-stu-id="7d073-113">Adherence to regional data regulations</span></span>

<span data-ttu-id="7d073-114">다음은 하이브리드 작업자에 대한 보안 및 규정 준수 서비스를 제공하는 Microsoft 365의 기능입니다.</span><span class="sxs-lookup"><span data-stu-id="7d073-114">Here are the features of Microsoft 365 that provide security and compliance services for hybrid workers.</span></span>
...
## <a name="security"></a><span data-ttu-id="7d073-116">보안</span><span class="sxs-lookup"><span data-stu-id="7d073-116">Security</span></span>

<span data-ttu-id="7d073-117">Microsoft 365의 이러한 보안 기능으로 애플리케이션과 데이터를 보호합니다.</span><span class="sxs-lookup"><span data-stu-id="7d073-117">Protect your applications and data with these security features of Microsoft 365.</span></span>

| <span data-ttu-id="7d073-118">기능 또는 특징</span><span class="sxs-lookup"><span data-stu-id="7d073-118">Capability or feature</span></span> | <span data-ttu-id="7d073-119">필요한 이유</span><span class="sxs-lookup"><span data-stu-id="7d073-119">Why I need it</span></span> | <span data-ttu-id="7d073-120">라이선싱</span><span class="sxs-lookup"><span data-stu-id="7d073-120">Licensing</span></span> |
|:-------|:-----|:-------|
| <span data-ttu-id="7d073-121">Office 365용 Microsoft Defender</span><span class="sxs-lookup"><span data-stu-id="7d073-121">Microsoft Defender for Office 365</span></span> | <span data-ttu-id="7d073-122">전자 메일 메시지, 사무실 문서 및 협업 도구와 같은 Microsoft 365 앱과 데이터를 공격으로부터 보호합니다.</span><span class="sxs-lookup"><span data-stu-id="7d073-122">Protect your Microsoft 365 apps and data—such as email messages, Office documents, and collaboration tools—from attack.</span></span> <br><br> <span data-ttu-id="7d073-p102">Office365용 Microsoft Defender는 보안 위험을 감지, 조사 및 조치하기 위해 앱에서 보내는 신호를 수집 및 분석하고 전자 메일 메시지, 링크(URL) 및 협업 도구로 인해 발생하는 악의적인 위협으로부터 조직을 보호합니다. 또한 표준적이고 엄격한 보안 자세를 위한 자동화된 테넌트 구성 평가 및 구성 도구 기능도 제공합니다.</span><span class="sxs-lookup"><span data-stu-id="7d073-p102">Microsoft Defender for Office 365 collects and analyzes signals from your apps for detection, investigation, and remediation of security risks and safeguards your organization against malicious threats posed by email messages, links (URLs), and collaboration tools. It also provides automated tenant configuration assessment and configuration tooling for standard and strict security postures.</span></span> | <span data-ttu-id="7d073-125">Microsoft 365 E3 혹은 E5</span><span class="sxs-lookup"><span data-stu-id="7d073-125">Microsoft 365 E3 or E5</span></span> | 
| <span data-ttu-id="7d073-126">악성 프로그램 차단</span><span class="sxs-lookup"><span data-stu-id="7d073-126">Malware protection</span></span> | <span data-ttu-id="7d073-127">Microsoft Defender Antivirus 및 Device Guard는 장치 기반 말웨어 방지 기능을 제공합니다.</span><span class="sxs-lookup"><span data-stu-id="7d073-127">‎Microsoft Defender Antivirus and Device Guard provides device-based malware protection.</span></span> <br><br> <span data-ttu-id="7d073-p103">쉐어포인트 온라인에서는 알려진 악성 프로그램이 있는지 파일 업로드를 자동으로 검색합니다. ‎</span><span class="sxs-lookup"><span data-stu-id="7d073-p103">SharePoint‎ Online automatically scans file uploads for known malware. ‎</span></span><br><br> <span data-ttu-id="7d073-130">EOP(Exchange Online Protection)는 클라우드 편지함을 보호합니다.</span><span class="sxs-lookup"><span data-stu-id="7d073-130">Exchange Online Protection‎ (‎EOP‎) secures cloud mailboxes.</span></span> | <span data-ttu-id="7d073-131">Microsoft 365 E3 혹은 E5</span><span class="sxs-lookup"><span data-stu-id="7d073-131">Microsoft 365 E3 or E5</span></span> |
| <span data-ttu-id="7d073-132">엔드포인트용 Microsoft Defender</span><span class="sxs-lookup"><span data-stu-id="7d073-132">Microsoft Defender for Endpoint</span></span> | <span data-ttu-id="7d073-133">사이버 위협 및 데이터 침해로부터 조직의 장치를 보호하고 고급 위협에 대해 감지, 조사 및 대응합니다.</span><span class="sxs-lookup"><span data-stu-id="7d073-133">Protect your organization’s devices from cyber threats and data breaches and detect, investigate, and respond to advanced threats.</span></span> | <span data-ttu-id="7d073-134">Microsoft 365 E5</span><span class="sxs-lookup"><span data-stu-id="7d073-134">Microsoft 365 E5</span></span> |
| <span data-ttu-id="7d073-135">클라우드 앱 보안</span><span class="sxs-lookup"><span data-stu-id="7d073-135">Cloud App Security</span></span> | <span data-ttu-id="7d073-136">Microsoft 365 및 기타 SaaS 앱 모두 클라우드 기반 서비스를 공격으로부터 보호합니다.</span><span class="sxs-lookup"><span data-stu-id="7d073-136">Protect your cloud-based services—both Microsoft 365 and other SaaS apps—from attack.</span></span> | <span data-ttu-id="7d073-137">Microsoft 365 E5 또는 개별 클라우드 앱 보안 라이선를 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="7d073-137">Microsoft 365 E5 or individual Cloud App Security licenses</span></span> |
| <span data-ttu-id="7d073-138">Azure AD ID 보호</span><span class="sxs-lookup"><span data-stu-id="7d073-138">Azure AD Identity Protection</span></span>  | <span data-ttu-id="7d073-139">ID 기반 리스크의 감지 및 해결 작업을 자동화합니다.</span><span class="sxs-lookup"><span data-stu-id="7d073-139">Automate detection and remediation of identity-based risks.</span></span> <br><br><span data-ttu-id="7d073-140">위험 기반 조건부 액세스 정책을 만들어 위험 로그인에 대한 MFA(다단계 인증)를 요구합니다.</span><span class="sxs-lookup"><span data-stu-id="7d073-140">Create risk-based Conditional Access policies to require multi-factor authentication (MFA) for risky sign-ins.</span></span> | <span data-ttu-id="7d073-141">Azure AD Premium P2 라이선스를 포함한 Microsoft 365 E5 또는 E3</span><span class="sxs-lookup"><span data-stu-id="7d073-141">Microsoft 365 E5 or E3 with Azure AD Premium P2 licenses</span></span> |
||||

<span data-ttu-id="7d073-142">첫 번째 단계는 [Microsoft Secure Score](/microsoft-365/security/defender/microsoft-secure-score)에 대해 알아보고 사용하는 것입니다.</span><span class="sxs-lookup"><span data-stu-id="7d073-142">You first step should be to learn about and use [Microsoft Secure Score ](/microsoft-365/security/defender/microsoft-secure-score).</span></span>
