...
| 기능 또는 특징 | 설명 | 라이선싱 |
|:-------|:-----|:-------|
| 규정 관리자 | 규정 준수 활동을 관리하고 현재 규정 준수 구성의 전체 점수를 얻은 다음 개선을 위한 권장 사항을 찾아야 합니다. 이 도구는 Microsoft 365 준수 센터의 워크플로 기반 위험 평가 도구입니다. | Microsoft 365 E3 및 E5 |
...
Microsoft 365 규정 준수 센터에서 제공되는 준수 관리자는 사용자에게 적용되는 여러 데이터 개인 정보 규정과 관련된 것뿐만 아니라 개선 작업을 전반적으로 추적하고 관리할 수 있는 기본 제공 기능을 제공합니다.
