...
![blocks Foundation 솔루션 이러한 솔루션은 특정 비즈니스 문제 또는 요구에 대한 완전한 ](https://docs.microsoft.com/office/media/icons/blocks-blue.png)  지침을 제공합니다. 개념과 기능을 안내하고 계획에서 구현에, 도입에까지 최종 결과로 이어지기 위한 선택을 하는 데 도움이 됩니다.
