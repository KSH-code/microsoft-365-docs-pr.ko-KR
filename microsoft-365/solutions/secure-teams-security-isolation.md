...
<a name="poster"></a>이 시나리오에 대 한 2페이지 요약을 보려면 [보안 격리 포스터를 사용한 Microsoft 팀](../downloads/team-security-isolation-poster.pdf)를 참조하세요.

[![보안 격리를 사용하여 Microsoft 팀 구성하기](../media/secure-teams-security-isolation/team-security-isolation-poster.png)](../downloads/team-security-isolation-poster.pdf)
...
3. **레이블 만들기**를 클릭합니다.
4. 팀 이름과 유사한 레이블 이름을 입력합니다. 예를 들어 **매우 중요 - 프로젝트 Saturn**이 있습니다.
5. 도구 설명을 추가한 다음 **다음**을 클릭합니다.
6. **암호화** 페이지의 **암호화** 드롭다운에서 **적용**을 선택합니다.
7. 팀 사용 권한을 추가하려면:<br>
  a. **사용 권한 할당**을 클릭합니다.<br>
  b. **사용자 또는 그룹 추가**를 클릭하고, 만든 팀을 선택한 다음, **추가**를 클릭합니다.<br>
  c. **사용 권한 선택**을 클릭합니다.<br>
  d. 드롭다운 목록에서 **공동 작성**을 선택한 다음 **저장**을 클릭합니다.<br>
8. 레이블이 있는 파일에 읽기 전용 권한이 있는 사용자 또는 그룹 포함하기:<br>
  a. **사용 권한 할당**을 클릭합니다.<br>
  b. **사용자 또는 그룹 추가**를 클릭하고, 추가하려는 사용자 또는 그룹을 선택한 다음, **추가**를 클릭합니다.<br>
  c. **사용 권한 선택**을 클릭합니다.<br>
  d. 드롭다운 목록에서 **뷰어**를 선택한 다음 **저장**을 클릭합니다.<br>
  e. **저장**을 클릭합니다.
9. **다음**을 클릭합니다.
10. 이 레이블로 분류된 파일에 머리글, 바닥글 또는 워터마크를 자동으로 추가하려는 경우 콘텐츠 표시 페이지에서 **콘텐츠 표시**를 설정합니다.
11. **사이트 및 그룹 설정** 페이지에서 **사이트 및 그룹 설정**을 **켜짐**으로 설정합니다.
12. **Office 365 그룹에 연결된 팀 사이트의 개인 정보 보호** 드롭다운에서 **비공개 - 구성원만 사이트에 액세스할 수 있음**을 선택합니다.
13. 게스트 액세스를 허용하려면 **Office 365 그룹 소유자가 조직 외부의 사용자를 그룹에 추가할 수 있도록 허용** 확인란을 선택합니다. 
14. **관리되지 않는 장치**에서 **액세스 차단**을 선택합니다.
15. **다음**을 클릭합니다.
16. **Office 앱에 대한 자동 레이블 지정** 페이지에서 **다음**을 클릭합니다.
17. **제출**을 클릭한 다음 **완료**를 클릭합니다.
