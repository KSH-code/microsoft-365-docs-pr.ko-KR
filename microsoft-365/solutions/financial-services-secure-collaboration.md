...
***Teams는 포괄적인 Microsoft 365 보안 및 규정 준수 제품군과 함께 금융 서비스 기관이 비즈니스를 효과적으로 수행하고 규정을 준수할 수 있도록 기업용 디지털 통신 채널을 제공합니다.*** 이 문서의 나머지 부분에서는 기록 관리, 정보 보호, 정보 장벽 및 감독 통제를 위한 Microsoft 365 내장 기능이 어떻게 팀에게 이러한 규제 의무를 충족시킬 수 있는 강력한 도구 세트를 제공하는지 설명합니다.
