...
1. **암호화** 페이지의 **암호화** 드롭다운에서 **적용** 을 선택합니다.
1. 팀 사용 권한을 추가하려면:<br>a. **사용 권한 할당** 을 클릭합니다.<br>NS. **사용자 또는 그룹 추가** 를 클릭하고 **회사 전략** 을 선택한 다음 **추가** 를 클릭합니다.<br> c. **사용 권한 선택** 을 클릭합니다.<br> d. 드롭다운 목록에서 **공동 작성** 을 선택한 다음 **저장** 을 클릭합니다.<br>
1. **다음** 을 클릭합니다.
1. **콘텐츠 표시** 페이지에서 **다음** 을 클릭합니다.
1. **사이트 및 그룹 설정** 페이지에서 **사이트 및 그룹 설정** 을 **켜짐** 으로 설정합니다.
1. **Office 365 그룹에 연결된 팀 사이트의 개인 정보 보호** 드롭다운에서 **비공개 - 구성원만 사이트에 액세스할 수 있음** 을 선택합니다.
1. **관리되지 않는 장치** 에서 **액세스 차단** 을 선택합니다.
1. **다음** 을 클릭합니다.
1. **Office 앱에 대한 자동 레이블 지정** 페이지에서 **다음** 을 클릭합니다.
1. **제출** 을 클릭한 다음 **완료** 를 클릭합니다.
...
1. **사이트** 에서 **활성 사이트** 를 클릭합니다.
1. **회사 전략** 사이트를 클릭합니다.
1. **정책** 탭의 **민감도** 에서 **편집** 을 클릭합니다.
1. **회사 전략** 레이블을 선택한 다음 **저장** 을 클릭합니다.
1. **정책** 탭의 **외부 공유** 에서 **편집** 을 클릭합니다.
1. **조직 내부 사용자만** 을 선택합니다.
1. **기본 공유** 링크 유형에서 **조직 수준 설정과 동일** 확인란을 선택 취소하고 **기존 액세스가 있는 사용자** 를 선택합니다.
1. **저장** 을 클릭합니다.
