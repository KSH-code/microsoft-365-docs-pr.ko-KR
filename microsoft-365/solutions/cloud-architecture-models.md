...
이러한 클라우드 아키텍처 포스터는 Microsoft 365, Azure AD(Azure Active Directory), Microsoft Intune, Microsoft Dynamics 365 및 하이브리드 On-premises 및 클라우드 솔루션을 비롯한 Microsoft 클라우드 서비스에 대한 정보를 제공합니다. 
