...
ms.locfileid: "50422762"
---
# <a name="employee-quick-setup"></a>직원 빠른 설정

비즈니스용 Microsoft 365를 새로 사용하나요? :::image type="icon" source="../media/video-call-icon.png" border="false":::[이 비디오를 시청하여](https://support.microsoft.com/office/d6466f0d-5d13-464a-adcb-00906ae87029) 자세한 정보를 봐야 합니다. 그런 후 다음 단계를 수행하세요.
...
## <a name="4-save-or-copy-files-to-onedrive"></a>4. 파일을 OneDrive에 저장 또는 복사

- Office 앱의 다른 저장  **메뉴에서 문서를 OneDrive에** 저장합니다.
...
- 또는 바탕 화면이나 문서의 파일을 **OneDrive** 에 복사합니다.
    ...
    > [!TIP]
    > Microsoft 365의 [](https://support.microsoft.com/office/d18d21a0-1f9f-4f6c-ac45-d52afa0a4a2e) 사이트에 파일을 저장할 수 있습니다.
...
- 앱 **스토어** 또는 Google Play 스토어에서 휴대폰에서 Outlook을 다운로드합니다. 열고 시작을 선택하고 **전자** 메일과 암호를 추가합니다.
- 그렇지 않으면 iOS 또는 Android 장치에서는 Outlook을 열고 **설정** 으로 이동합니다.

    **계정 추가** 를 선택한 다음 **전자 메일 계정 추가** 를 선택하고 전자 메일 및 암호를 입력합니다.
- Windows **Phone에서** **설정,** 전자 **메일 + 계정,** **계정 추가,** Exchange 를 **선택합니다.**