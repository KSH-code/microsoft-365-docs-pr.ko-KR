...
Microsoft 365를 통해 비즈니스를 클라우드로 전환하기로 결정한 것을 축하합니다. 비즈니스에 한 사람이든 20이든, 약간 계획을 세우면 Microsoft 365 Business Premium을 가장 잘 사용할 수 있습니다.
...
- PC 및 Mac에서 직접 실행하는 Word, Excel 및 Teams와 같은 기능이 풍부한 버전의 Office 앱을 사용하려는 경우 [Office 365 Business Premium을](https://products.office.com/en-us/business/office-365-business-premium) 선택하세요. 이는 온라인 앱에 추가됩니다.
...
- 도메인 이름은 조직에 전문적이며 기억하기 쉬운 온라인 _ID(예:_ rob@contoso.com. 이미 있는 경우 Microsoft 365 또는 Microsoft 365로 가져올 수 있습니다. 전환에&#39;도움이 될 것입니다.
- 도메인이&#39;없는지 여부 Microsoft&#39;Microsoft 365에 등록할 때 한 번만 다운로드할 수 있습니다.
...
- 비즈니스 소프트웨어 및 서비스를 사용해야 하는 회사의 모든 직원 또는 사용자를 Microsoft 365에서 사용자로 추가합니다. 할당한 라이선스와 동일한 라이선스를 할당하거나(예: Microsoft 365 Business Premium) 더 적거나 적은 기능을 사용하여 다른 요금제(예: Microsoft 365 Business Basic)를 할당할 수 있습니다.
...
- Microsoft 365 Business Premium을 사용하면 장치에 대한 보호, 온라인 위협으로부터 보호, 우발적인 데이터 손실 방지를 얻을 수 있습니다. Windows 10 Pro Windows Defender Office 앱에 대한 업데이트, BitLocker 및 자동 업데이트도 사용할 수 있습니다.
- MFA(Multi-Factor Authentication), 전자 메일 암호화, 맬웨어 보호 및 랜섬웨어 보호를 설정하여 장치 및 데이터에 대한 무단 액세스를 방지할 수 있습니다.
- PC, SharePoint 또는 비즈니스용 OneDrive 또는 모바일 장치에 로컬로 저장된 중요한 작업 데이터를 보호할 수 있습니다. Microsoft 365용 MDM(기본 제공 모바일 장치 관리)을 사용하면 iPhone, iPad, Androids 및 Windows 휴대폰과 같은&#39; 장치를 사용하여 사용자를 보호하고 관리할 수 있습니다. MDM을 사용하여 장치 보안 정책을 만들고 관리하고, 원격으로 장치를 초기화하고, 자세한 장치 보고서를 볼 수 있습니다.

## <a name="6-upgrade-your-pcs-to-windows-10-pro"></a>6. PC를 Windows 10 Pro로 업그레이드

- 고급 보안 및 장치 관리와 같은 모든 Microsoft 365 Business Premium 기능을 사용할 수 있도록 PC를 Windows 10 Professional로 업그레이드합니다(Windows 7 Pro&#39;Windows 8 Pro 또는 Windows 8.1 Pro를 실행하는 경우 Microsoft 365 Business Premium을 무료로 사용하세요.
...
- Microsoft 365를&#39;Windows 10 PC를 Microsoft 365 Business Premium 및 Azure Active Directory에 연결하고 싶을 것입니다. 이를 통해 Microsoft 365 Business Premium에서 PC를 관리하여 데이터 손실 및 기타 사이버 위협으로부터 소프트웨어 업데이트 및 보호를 받을 수 있습니다.
- PC를 연결할 때 Windows 10은 조직&#39;네트워크에 장치를 등록한 다음 조직에서 사용자 이름 및 암호를 사용하여 로그인하고 리소스에 액세스할&#39;수 있도록 디바이스를 네트워크에 연결합니다.
- 조직의 요구&#39;따라 2단계 인증, 암호화 및 Microsoft Intune과 같은 모바일 장치 관리를 설정해야 할 수 있습니다.

## <a name="8-set-up-and-use-office-apps"></a>8. Office 앱 설정 및 사용

- Word, Excel 및 PowerPoint와 같이 사용할 수 있는 모든 Office 앱을 사용하여 시작하세요. 아직&#39;않은 경우 웹 사이트 에서 Microsoft Office [수 있습니다.](https://www.office.com/)
- Outlook을 처음&#39;작업을 먼저 하는 것이 있습니다. You&#39;ll enter your Microsoft 365 email address and password and have immediate access to your email, calendar, and contacts.
...
- 비즈니스 문서 및 기타&#39;이전 전자 메일, 일정 및 연락처를 Microsoft 365 Business Premium으로 가져오는 것이 좋습니다.
...
- 비즈니스 문서의 경우 파일을 비즈니스용 OneDrive로 끌어서 놓고 일반 또는 공유 비즈니스 파일의 경우 SharePoint에 복사할 수 있습니다.

## <a name="10-set-up-your-phones"></a>10. 휴대폰 설정

- 휴대폰을 사용하여 이동 중 생산성을 유지하려는 경우 Outlook, Teams&#39;Excel과 같은 Office 앱을 Android 및 iOS와 같은 모바일 장치에 추가할 수 있습니다.
- Microsoft 365 Business Premium을 사용하면 각 장치에 보안이 적용되어 앱을 설치 및 열 때&#39;핀을 만들고, 두 번째 인증 형식을 만들며, 휴대폰에서 비즈니스 데이터를 보호하는 데 도움이 되는 기타 설정을 만들지 묻는 메시지가 표시됩니다.