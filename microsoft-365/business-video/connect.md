...
Microsoft 365 Business Premium(이전의 Microsoft 365 Business)를 설정한 후 사용자와 직원은 몇 가지 단계를 완료하여 보안 및 관리 기능을 활용해야 합니다. 여기서&#39;방법을 알 수 있습니다.
...
다음으로 다음을 위해 Microsoft 365 Business.
...
회사에서 설치한 방법에 따라 Microsoft 365 Business PC를 암호화하는 알림이 표시될 수 있습니다. PC를 암호화하는 방법:

1. 필요한  **암호화 메시지를**  선택합니다.
2. 다른 **&#39;** 소프트웨어가 설치되어 있지 않은 경우를 선택하고 모든 디스크를 암호화한 다음 예를 **선택합니다.** 진행률 표시줄이 **BitLocker** 시작 창이 표시됩니다.
...
이제 PC가 보호되고 관리되는 Microsoft 365 Business.