...
비즈니스용 Microsoft 365에서는 조직의 사용자와 파일을 쉽게 공유할 수 있지만 조직 외부의 사용자와 공유해야 하는 경우도 있습니다. 고객과 안전하게 파일을 공유하려면 보안 링크를 보낼 수 있습니다.

## <a name="try-it"></a>사용해 보세요!

1. SharePoint 사이트의 문서 라이브러리 맨 위에 있는 새로 고치기 를 클릭한 다음 폴더 를 **선택합니다.**
