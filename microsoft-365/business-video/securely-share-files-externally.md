...
## <a name="watch-securely-share-files-outside-your-organization"></a>감시: 조직 외부의 파일을 안전하게 공유

> [!VIDEO https://www.microsoft.com/videoplayer/embed/RE22Yf0?autoplay=false]

비즈니스 Microsoft 365 조직의 사용자와 파일을 쉽게 공유할 수 있지만 조직 외부의 사용자와 공유해야 하는 경우도 있습니다. 고객과 안전하게 파일을 공유하려면 보안 링크를 보낼 수 있습니다.
...
1. 업로드 라이브러리에 공유할 파일을 선택하거나 새로 만들기를  선택하면 라이브러리에 직접 새 문서를 만들 수 있습니다.
...
1. 링크 **보내기 창에서** 고객의 전자 메일 주소를 입력하고 메시지를 입력한 다음 보내기 를 **선택합니다.**
    ...
    고객이 폴더에 액세스하기 위해 본인에게 보내야 하는 확인 코드가 있는 전자 메일을 받게 됩니다. 전자 메일을 찾을 수 없는 경우 스팸 폴더를 확인해야 합니다.
