...
4. 미용실 또는 치과 연습과 같이 실행한 비즈니스의 이름과 유형을 제공하고 예약으로 **를 선택합니다.**

5. 이제 조직에 대해 Bookings를 설정할 준비가 완료되었습니다. [Microsoft Bookings 항목의](bookings-overview.md) 단계에 따라 Bookings 설정을 완료합니다. 모바일 장치로 돌아가서 모바일 앱에서 로그아웃합니다. 다시 로그인하여 새 예약 일정으로 이동하세요.
