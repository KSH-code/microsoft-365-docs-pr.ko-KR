...
Office 365 그룹에는 조직에 필요한 거 버 넌 스 기능을 구현 하기 위한 다양 한 도구가 포함 되어 있습니다. 이 문서에서는 IT 전문가를 대상으로 거 버 넌 스에 대 한 요구 사항을 확인 하 고 조직의 프로필을 기반으로이를 충족 하는 방법을 안내 합니다.

## <a name="why-office-365-groups"></a>Office 365 그룹의 이유
...
Office 365 그룹은 사용자에 게 도움을 주며, 공동 작업에 필요한 많은 도구를 한 단계로 제공 하 여 섀도 위험을 줄여줍니다. Office 365 그룹에서는 공동 작업을 수행 하려는 사용자 집합을 선택 하 고, 해당 사용자가 공유할 리소스 모음을 쉽게 설정할 수 있습니다. 리소스에 사용 권한을 수동으로 할당 하는 것은 그룹에 구성원을 추가 하는 것이 그룹에서 제공 하는 모든 자산에 필요한 사용 권한을 자동으로 부여 하는 것 보다 더 이상입니다.
...
- Microsoft 팀-Office 365의 채팅 기반 작업 영역
...
- Outlook 그룹: 최신 DL (전자 메일 기반 공동 작업)
  - 대상 정보 교환에 대 한 장소
  - Dl을 Office 365 그룹으로 업그레이드 [하 고 업그레이드 해야 하는 이유는 무엇 인가요?](https://support.office.com/article/why-you-should-upgrade-your-distribution-lists-to-groups-in-outlook-7fb3d880-593b-4909-aafa-950dd50ce188)

- SharePoint-모든 Office 365 그룹에 대 한 핵심 콘텐츠 공동 작업 환경
...
**이 섹션의 항목은**다음과 같습니다.
- [Office 365 그룹을 만들 수 있는 사용자 제어](https://docs.microsoft.com/office365/admin/create-groups/plan-for-groups-governance#control-who-can-create-office-365-groups)
...
| 의해     | 그룹 만들기는 특정 사용자, 팀 또는 서비스로 제한 됩니다. 자세한 내용은 [Office 365 그룹을 만들 수 있는 사용자 관리](https://support.office.com/article/manage-who-can-create-office-365-groups-4c46c8cb-17d0-44b5-9776-005fced8e618)를 참조하세요. |
...
> [!Important]
> 그룹 및 팀 만들기를 제한 하면 서비스 작동을 위해 그룹을 만들어야 하는 Office 365 서비스가 많기 때문에 생산성이 저하 될 수 있습니다. 자세한 내용은 [Office 365 그룹을 만드는 이유를 제어 하는 이유](https://docs.microsoft.com/office365/admin/create-groups/manage-creation-of-groups?view=o365-worldwide%23why-control-who-creates-office-365-groups) 를 참조 하세요.

#### <a name="resources"></a>*리소스*
- [Office 365 그룹을 만들 수 있는 사용자 관리](https://docs.microsoft.com/office365/admin/create-groups/manage-creation-of-groups?view=o365-worldwide)
...
#### <a name="resources"></a>*리소스*
- [삭제 된 Office 365 그룹 복원](https://support.office.com/article/Restore-a-deleted-Office-365-Group-b7c66b59-657a-4e1a-8aa0-8163b1f4eb54?ui=en-US&rs=en-001&ad=US)
...
#### <a name="resources"></a>*리소스*
- [Office 365 그룹 명명 정책](https://docs.microsoft.com/office365/admin/create-groups/groups-naming-policy)
...
#### <a name="resources"></a>*리소스*
- [Office 365 그룹에 연결 사용 지침](https://docs.microsoft.com/office365/enterprise/manage-office-365-groups-with-powershell#link-to-your-office-365-groups-usage-guidelines)
...
- [감사 로그 검색](https://docs.microsoft.com/office365/securitycompliance/search-the-audit-log-in-security-and-compliance)
- [원본 위치 유지 만들기 또는 제거](https://docs.microsoft.com/exchange/security-and-compliance/create-or-remove-in-place-holds)
- [보존 정책 만들기](https://docs.microsoft.com/office365/securitycompliance/retention-policies)
...
>- 기존 SharePoint 팀 사이트를 새 Office 365 그룹에 연결 합니다.
...
>-Office 365 groups 보고서는 지난 7 일, 30 일, 90 일 또는 180 일 동안의 추세에 대해 볼 수 있습니다.
...
|         |         |         |
|---------|---------|---------|
|![이미지 desc](../media/decision_point.png)|의사 결정 지점|<ul><li>조직에서 Office 365 그룹의 사용을 이해 하려면 일반 보고서가 필요 합니까?<li>조직에 외부 구성원이 있는 모든 그룹에 대 한 보고가 필요 합니까?</li></ul>|
|![이미지 desc](../media/next_steps.png)|다음 단계|<ul><li>정기적으로 그룹을 검토 하는 조직의 요구 사항 활동 보고서를 문서화 합니다.</li></ul>|


#### <a name="resources"></a>*리소스*
- [관리 센터의 Office 365 보고서](https://support.office.com/article/Office-365-Reports-in-the-admin-center-Office-365-groups-a27f1a99-3557-4f85-9560-a28e3d822a40)
...
- [Office 365 그룹 보고서 (통합 그룹)](https://gallery.technet.microsoft.com/office/Office-365-Groups-Report-7e3e161b)
...
비즈니스 Essentials 및 Business Premium 요금제를 포함 하는 최소 Exchange Online 및 SharePoint Online 라이선스 및 Enterprise E1, E3 및 E5 요금제가 Azure Active Directory Premium과 함께 Office 365을 배포한 조직을 고려 합니다. 사용권.
...
| 숨겨진 멤버 자격 | 그룹의 구성원이 아닌 사용자의 Office 365 그룹 구성원 숨기기 | 아니요                                    |   TBD        |
| 만료 정책 | 만료 정책을 설정 하 여 Office 365 그룹의 수명 주기를 관리 합니다. | P1                                    |  TBD        |
| 그룹 활동 보고서 | 조직의 Office 365 그룹 활동에 대 한 통찰력을 얻고 만들고 사용 중인 Office 365 그룹의 수를 확인 합니다. | 아니요                                    |    TBD       |
| 보존 정책 | 보안 & 준수 센터에서 Office 365 그룹에 대 한 보존 정책을 설정 하 여 특정 기간에 대 한 데이터를 보존 하거나 삭제 합니다. **참고:** 이 기능을 사용 하려면 Office 365 Enterprise e 3 이상에 대 한 라이선스가 필요 합니다. | 아니요                                    |    TBD       |
| 데이터 손실 방지 정책 | Office 365 그룹 연결 사이트에서 중요 한 정보를 식별 하 고 실수로 공유 되지 않도록 합니다. **참고:** 이 기능을 사용 하려면 Office 365 Enterprise e 3 이상에 대 한 라이선스가 필요 합니다. | 아니요                                    |     TBD      |
