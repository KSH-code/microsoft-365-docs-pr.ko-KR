...
> [!TIP]
> Office 365 연결 된 Yammer 그룹은 Yammer에서 만들어야 하지만, 다른 Office 365 그룹과 마찬가지로 Microsoft 365 관리 센터에서 관리할 수 있습니다. 자세한 내용은 [Yammer 및 Office 365 그룹](https://support.office.com/article/d8c239dc-a48b-47ab-b85e-6b4b8191a869.aspx)을 참조하세요. 
...
1. [관리 센터](https://go.microsoft.com/fwlink/p/?linkid=848041)에서 **그룹** > **그룹** 페이지로 이동 합니다. 

::: moniker-end

::: moniker range="o365-21vianet"

1. [관리 센터](https://go.microsoft.com/fwlink/p/?linkid=850627)에서 **그룹** > **그룹** 페이지로 이동 합니다. 
...
4. **기본** 페이지에서 그룹 이름 및 설명 (선택 사항)을 입력 합니다.  Select **Next**. 
    
5. **설정 편집** 페이지에서 그룹의 고유한 전자 메일 주소를 입력 하 고, 개인 정보 옵션을 선택한 후 Microsoft 팀을 추가할 것인지 여부를 선택 하 고**다음**을 클릭 합니다.
    
6. **소유자** 에서 그룹을 관리 하도록 지정할 사용자의 이름을 하나 이상 선택 합니다. 모든 그룹 소유자는 그룹 받은 편지함에서 전자 메일을 삭제할 수 있습니다. 다른 구성원은 그룹 받은 편지함에서 전자 메일을 삭제할 수 없습니다.  Select **Next**. 
...
1. 관리 센터에서 새 그룹이 표시 되도록 페이지를 새로 고치고 **그룹** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=2052855" target="_blank">그룹</a>을 선택한 다음 구성원을 추가 하려는 그룹의 이름을 선택 합니다.
...
## <a name="who-can-delete-email-from-the-group-inbox"></a>그룹 받은 편지함에서 전자 메일을 삭제할 수 있는 사람은?
...
새 그룹을 만들고 구성원을 추가한 후에는 그룹 이름 또는 설명 편집, 소유자 또는 구성원 변경, 외부 보낸 사람이 그룹에 전자 메일을 보낼 수 있는지 여부 지정, 그룹의 복사본을 보낼지 여부와 같은 그룹을 추가로 구성할 수 있습니다. 구성원에 대 한 대화입니다. [Office 365 그룹 관리를](manage-groups.md)참조 하세요.

## <a name="related-articles"></a>관련 문서

[Office 365 그룹 관리](manage-groups.md)
