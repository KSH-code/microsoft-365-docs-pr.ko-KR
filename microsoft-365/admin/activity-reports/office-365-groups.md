...
|8.  <br/> |범례에서 항목을 선택 하 여 차트에 표시 되는 계열을 필터링 할 수 있습니다. 예를 들어 **그룹** 차트에서 **전체** 또는 **활성** 합계를 선택 하 ![ 고 ](../../media/8eebd496-5955-4419-8d53-5f3ba1ad1c88.png) 각 그룹에 관련 된 정보만 표시 되도록 합니다. 이 선택 항목을 변경해도 눈금 표에 있는 정보가 변경되지는 않습니다.  <br/> |
...
|10  <br/> |**More Actions** ![ 열 머리글 옆에 있는 추가 작업 단추 모바일 OWA 추가 작업을 선택 하거나 탭 ](../../media/80044eef-2368-4c7e-8d31-7155b029e0cf.png) 하 여 보고서에서 열을 추가 하거나 제거 합니다.  <br/> ![그룹 보고서-열 선택](../../media/d7fb95d6-2a2e-4144-b80d-581223e48043.png)|
