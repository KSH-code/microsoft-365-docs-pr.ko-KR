---
title: Microsoft 365 관리 센터 보고서 - Microsoft Teams 활동 관리
ms.author: kwekua
author: kwekua
manager: scotv
audience: Admin
...
ms.locfileid: "52924270"
---
# <a name="microsoft-365-admin-center-reports---microsoft-teams-user-activity"></a>Microsoft 365 관리 센터 보고서 - Microsoft Teams 활동 관리
...
|7.  <br/> |범례에서 항목을 선택하여 차트에 있는 계열을 필터링할 수 있습니다. 예를 들어 활동  차트에서 채널 메시지, 채팅 **메시지,** 통화  또는 모임을 선택하여 각각에 관련된 정보만 볼 수 있습니다.   이 선택 항목을 변경해도 눈금 표에 있는 정보가 변경되지는 않습니다.  <br/> ![활동 Microsoft Teams 필터링](../../media/c819c4ea-6e9a-4411-a0dd-9f800d64ce38.png)|
