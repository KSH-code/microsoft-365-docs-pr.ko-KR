...
Office 정품 인증 보고서는 하나 이상의 장치에서 Office 구독을 정품 인증한 사용자의 보기를 제공합니다. 엔터프라이즈용 Microsoft 365 앱, Project 및 Visio Pro for Office 365 구독 정품 인증에 대한 분석과 데스크톱 및 디바이스의 정품 인증 분석 기능을 제공합니다. 이 보고서는 Office 구독 정품 인증에 대한 추가 도움말 및 지원이 필요할 수 있는 사용자를 식별하는 데 유용할 수 있습니다.
