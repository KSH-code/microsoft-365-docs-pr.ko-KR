...
|:-----|:-----|
|**메트릭**|**정의**|
|URL  <br/> |사용자의 OneDrive에 대한 웹 주소입니다. <br/> |
|삭제됨  <br/> |OneDrive의 지우기 상태입니다. 계정이 삭제됨으로 표시되려면 7일 이상이 소요됩니다.  <br/> |
|소유자  <br/> |OneDrive의 기본 관리자 사용자 이름입니다.   <br/> |
|소유자 사용자 이름  <br/> |OneDrive 소유자의 전자 메일 주소입니다. <br/> |
|마지막 활동 날짜(UTC)  <br/> | OneDrive에서 파일 활동을 수행한 가장 최근 날짜입니다. OneDrive에 파일 활동이 없으면, 값은 비어 있게 됩니다.  <br/> |
|파일  <br/> |OneDrive의 파일 수입니다. <br/>|
|활성 파일  <br/> | 기간 내의 활성 파일 수입니다.<br/> 참고: 보고서에 대해 지정된 기간 동안 파일이 제거된 경우 보고서에 표시된 활성 파일 수가 OneDrive의 현재 파일 수보다 클 수 있습니다. >  삭제된 사용자는 180일 동안 계속해서 보고서에 표시됩니다.  <br/> |
|사용된 저장소(MB)  <br/> |OneDrive에서 사용하는 저장소의 양(MB)입니다. |
|||