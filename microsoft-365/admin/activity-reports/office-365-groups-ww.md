...
2. 대시보드 홈 페이지에서 활성 사용자  - Microsoft 365 앱 또는 활성 사용자 - Microsoft 365 서비스 카드의 추가 정보 보기 단추를 클릭하여 Office 365 보고서 페이지로 이동합니다.
  
## <a name="interpret-the-groups-report"></a>그룹 보고서 해석

그룹 활동 탭을 선택하여 Office 365 보고서에서 정품 인증을 **볼 수** 있습니다.<br/>![Microsoft 365 보고서 - Microsoft Office 365 그룹 활동입니다.](../../media/ab90e30b-8938-4110-ab3d-ee472a4cfe21.png)
...
|타이핑  <br/> |그룹 유형입니다. 비공개 또는 공개 그룹일 수 있습니다.  <br/> |
...
|Yammer 메시지(게시)  <br/> |보고 기간 동안 Yammer 그룹에 게시된 메시지 수입니다.  <br/> |
|Yammer 메시지(읽기)  <br/> |보고 기간 동안 Yammer 그룹에서 읽은 대화 수입니다.  <br/> |
