...
그룹 활동 탭을 선택하여 Office 365 보고서에서 활성화를 볼 **수** 있습니다.<br/>![Microsoft 365 보고서 - Microsoft Office 365 활동입니다.](../../media/ab90e30b-8938-4110-ab3d-ee472a4cfe21.png)
...
|마지막 활동 날짜(UTC)  <br/> |그룹에서 메시지를 받은 최근 날짜입니다. 전자 메일 대화, Yammer 또는 사이트에서 활동이 발생한 최근 날짜입니다.  <br/> |
|유형  <br/> |그룹 유형입니다. 비공개 또는 공개 그룹일 수 있습니다.  <br/> |
|전자 메일로 Exchange  <br/> |그룹에서 받은 메시지 수입니다.|
|전자 메일(Exchange 전체)  <br/> |그룹 사서함의 총 항목 수입니다.  <br/> |
|MB(Exchange 사서함 저장소)  <br/> |그룹의 사서함에서 사용하는 저장소입니다. <br/>|
|SharePoint 파일(합계)  <br/> |그룹 사이트에 저장된 SharePoint 수입니다.  <br/> |
|SharePoint 파일(활성)  <br/> |보고 기간 동안 SharePoint(보거나 수정, 동기화, 내부 또는 외부적으로 공유)된 파일 수입니다.  <br/> |
|SharePoint 사용된 총 사이트 저장소(MB)  <br/> |보고 기간 동안 사용된 저장소의 양(MB)입니다.  <br/> |
|메시지의 Yammer(게시)  <br/> |보고 기간 동안 Yammer 그룹에 게시된 메시지 수입니다.  <br/> |
|메시지의 Yammer(읽기)  <br/> |보고 기간 동안 Yammer 그룹에서 읽은 대화 수입니다.  <br/> |
|Yammer 메시지(liked)  <br/> |보고 기간 동안 Yammer 그룹에서 좋아하는 메시지 수입니다.  <br/> |
