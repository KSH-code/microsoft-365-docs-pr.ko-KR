...
OneDrive 보고서에서 활동 탭을 선택하여 활동을 볼 **수** 있습니다.<br/>![Microsoft 365 보고서 - Microsoft OneDrive 활동 보고서.](../../media/c89df0b0-2611-4acf-9ef7-17cedf7977be.png)

열 **선택을 선택하여** 보고서에서 열을 추가하거나 제거합니다.  <br/> ![OneDrive 활동 보고서 - 열 선택](../../media/252f311f-ffde-4e5a-9158-2b822bf86964.png)
...
|마지막 활동 날짜(UTC)  <br/> |선택한 날짜 범위에 대한 OneDrive 계정에서 파일 활동을 수행한 가장 최신 날짜입니다. . 특정 날짜에 발생한 활동을 보려면 차트에서 직접 날짜를 선택합니다.  <br/> |
|보거나 편집한 파일  <br/> |사용자가 업로드, 다운로드, 수정 또는 본 파일 수입니다.   <br/> |
|동기화된 파일  <br/> |사용자의 로컬 장치에서 OneDrive 계정으로 동기화된 파일 수입니다. <br/> |
