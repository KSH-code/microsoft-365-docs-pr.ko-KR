...
**작업** 탭을 선택 하 여 OneDrive 보고서에서 활동을 볼 수 있습니다.<br/>![Microsoft 365 보고서-Microsoft OneDrive 활동 보고서](../../media/c89df0b0-2611-4acf-9ef7-17cedf7977be.png)

**열 선택을** 선택 하 여 보고서에서 열을 추가 하거나 제거 합니다.  <br/> ![OneDrive 활동 보고서-열 선택](../../media/252f311f-ffde-4e5a-9158-2b822bf86964.png)
...
|:-----|:-----|
|**메트릭**|**정의**|
|사용자 이름  <br/> |OneDrive 계정 소유자의 사용자 이름입니다.  <br/> |
|마지막 활동 날짜 (UTC)  <br/> |선택한 날짜 범위에 대해 OneDrive 계정에서 파일 활동이 수행 된 마지막 날짜입니다. . 특정 날짜에 발생한 활동을 보려면 차트에서 직접 날짜를 선택합니다.  <br/> |
|보거나 편집한 파일  <br/> |사용자가 업로드, 다운로드, 수정 또는 본 파일의 수입니다.   <br/> |
|동기화 된 파일  <br/> |사용자의 로컬 장치에서 OneDrive 계정으로 동기화 된 파일의 수입니다. <br/> |
|내부적으로 공유 되는 파일  <br/> | 조직 내의 사용자 또는 외부 사용자를 포함할 수 있는 그룹 내의 사용자와 공유한 파일의 수입니다.  <br/> |
|외부적으로 공유 되는 파일  <br/> |조직 외부의 사용자와 공유한 파일의 수입니다. <br/>|
|삭제됨  <br/> | 이는 사용자의 라이선스가 제거 되었음을 나타냅니다.  <br/> 참고: 삭제 된 사용자에 대 한 활동은 선택한 기간 동안 특정 시간에 라이선스가 부여 된 경우에만 보고서에 계속 표시 됩니다. **삭제된** 열을 통해 사용자가 더 이상 활성이 아니지만 보고서의 데이터에 기여함을 알 수 있습니다.  <br/> |
