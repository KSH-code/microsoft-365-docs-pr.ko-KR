...
3. 전자 메일 **활동 드롭다운** 목록에서 Exchange 사서함 사용  \> **을 선택합니다.**
...
|4.  <br/> |**저장소** 차트에는 조직에서 사용한 저장소 크기가 표시됩니다. 저장소 차트에는 보관 사서함이 없습니다. 자동 확장 보관에 대한 자세한 내용은 [Microsoft 365의](../../compliance/unlimited-archiving.md)무제한 보관 개요를 참조하세요.<br/> |
