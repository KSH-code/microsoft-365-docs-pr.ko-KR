...
|3.  <br/> |**Sites** 차트에는 사용자가 보고 기간 내에 파일을 보고, 수정 하 고, 업로드 하 고, 다운로드 하 고, 공유 하 고, 동기화 하거나 페이지를 본 사이트를 포함 하 여 전체 및 활성 사이트의 수가 표시 됩니다.  <br/> |
