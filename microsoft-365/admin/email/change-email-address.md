...
When you change your domain's email to come to Microsoft 365, by updating your domain's MX record during setup, ALL email sent to that domain will start coming to Microsoft 365. MX 레코드를 변경하기 전에 도메인에 전자 메일이 있는 모든 사용자에 대해 Microsoft 365에서 사용자를 추가하고 사서함을 만들었다고 합니다. 도메인의 모든 사용자에 대한 전자 메일을 Microsoft 365로 이동하고 싶지 않은가요? 대신 몇 가지 전자 메일 주소만 사용하여 [Microsoft 365를 시험해](https://docs.microsoft.com/microsoft-365/admin/misc/pilot-microsoft-365-from-my-custom-domain?view=o365-worldwide)볼 수 있습니다.
