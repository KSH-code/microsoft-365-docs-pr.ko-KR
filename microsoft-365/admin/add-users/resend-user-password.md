...
description: 암호를 다시 설정하고 새 Microsoft 365 사용자에게 전자 메일을 보내는 방법을 배워야 합니다.
ms.openlocfilehash: 2b2c8657a4bbd4745a3fee34fc259244b83640d3
ms.sourcegitcommit: 1244bbc4a3d150d37980cab153505ca462fa7ddc
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 03/26/2021
ms.locfileid: "51222102"
---
# <a name="resend-a-users-password---admin-help"></a>사용자 암호 다시 보내기 - 관리자 도움말

이 문서에서는 Office 365의 새 사용자에게 알림 전자 메일을 다시 전송하는 방법을 설명합니다. 이 경우 새 사용자를 만들 때 새 암호가 있는 전자 메일을 받을 수 없습니다. 이 작업을 위해 사용자의 암호를 다시 설정하면 됩니다.
