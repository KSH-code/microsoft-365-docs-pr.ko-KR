...
---
# <a name="reset-office-365-business-passwords"></a>Office 365 business 암호 재설정
...
## <a name="reset-an-office-365-business-password-for-someone-else"></a>다른 사용자의 Office 365 Business 암호 재설정

이러한 단계는 Office 365 Business 요금제를 사용하는 사람에게만 해당합니다. 이 작업을 수행 하려면 Microsoft 365 관리자 계정으로 로그인 해야 합니다. [관리자 계정 이란?](../admin-overview/admin-overview.md)
...
## <a name="reset-my-office-365-tenant-admin-password"></a>내 Office 365 테 넌 트 관리자 암호 다시 설정

암호를 잊어 잊고 사용자의 암호가 브라우저에 저장 되어 있기 때문에 다음과 같이 Office 365에 로그인 할 수 있는 경우 다음 단계를 사용 합니다. 
    
1. Office 365에서 **설정** \> **Office 365** \> **개인 정보**를 선택 합니다. 
...
## <a name="reset-all-office-365-business-passwords-for-everyone-in-your-organization-at-the-same-time"></a>조직에 속한 모든 사용자의 Office 365 Business 암호를 동시에 재설정
...
## <a name="reset-office-365-business-passwords-in-bulk"></a>Office 365 Business 암호를 대량으로 재설정
<a name="bkmk_forgot"> </a>
...
개요 정보는 [Office 365 관리자를 위한 PowerShell](https://support.office.com/article/40fdcbd4-c34f-42ab-8678-8b3751137ef1.aspx)을 참조하세요.
...
[사용자가 Office 365에서 암호를 직접 재설정할 수 있도록 허용](let-users-reset-passwords.md)
