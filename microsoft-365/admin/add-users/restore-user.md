...
이러한 단계를 수행하려면 Microsoft 365 전역 관리자 또는 사용자 관리 관리자 되어야 합니다. 
...
1. 관리 [센터로 이동한](https://go.microsoft.com/fwlink/p/?linkid=848041)다음 **사용자** \> **삭제된 사용자를 선택합니다.**

::: moniker-end

::: moniker range="o365-21vianet"

1. 관리 [센터로 이동한](https://go.microsoft.com/fwlink/p/?linkid=850627)다음 **사용자** \> **삭제된 사용자를 선택합니다.**
...
관리 [센터로 이동한](https://go.microsoft.com/fwlink/p/?linkid=848041)다음 **사용자** \> **삭제된 사용자를 선택합니다.**
