...
다음 단계에 따라 [Microsoft 365 Business Standard](https://go.microsoft.com/fwlink/p/?LinkId=627220), Microsoft 365 Business Basic, Microsoft 365 Apps for business, or Office 365 Education를 통해 비즈니스 혹은 [비영리 기관](https://go.microsoft.com/fwlink/p/?LinkId=627221)을 시작하고 운영할 수 있습니다.
  
비즈니스용이 아닌가요? [Microsoft 365 Family 또는 Microsoft 365 Personal 설정](https://support.office.com/article/65415a24-3cbf-4f30-901d-9bf9eba7fce2.aspx)을 참조하세요.
...
1. 비즈니스용 Microsoft 365 요금제에 등록하려면 [Office 제품 사이트](https://www.aka.ms/office365signup)로 이동하고 **지금 구입**을 선택합니다.

2. **Microsoft 365 Business Standard**와 같은 등록할 요금제를 선택합니다.

3. 다음 단계에 따라 비즈니스용 Microsoft 365 요금제에 등록하세요.
...
*다음 절차를 사용하여 **[Microsoft 365 Business Basic](https://go.microsoft.com/fwlink/p/?LinkId=627218)** 구독을 설치하세요. 이 요금제를 사용하면 온라인으로 Office 365에 연결할 수 있습니다. Office 앱을 설치할 필요가 없습니다.*

### <a name="1-create-microsoft-365-accounts-and-add-your-domain"></a>1. Microsoft 365 계정 만들기 및 도메인 추가

이 단계에서는 설치 마법사를 사용하여 사용자의 Microsoft 365 계정을 만들고 도메인을 추가합니다. 이 마법사를 사용하면 rob@contoso.com과 같이 모든 사용자의 사용자 ID와 전자 메일을 비즈니스에 맞게 개인 설정할 수 있습니다.
...
다른 전자 메일 시스템의 기존 전자 메일 및 연락처를 사서함으로 이동하여 모두 한 곳에서 볼 수 있습니다.
...
Outlook에서 Microsoft 전자 메일을 관리할 뿐만 아니라 Gmail 및 Yahoo 계정과 같은 다른 전자 메일 계정을 Outlook에 연결할 수도 있습니다. 이렇게 하면 모든 전자 메일을 한 곳에서 관리할 수 있습니다. 최대 5개의 전자 메일 계정을 Outlook에 연결할 수 있습니다.
  
::: moniker range="o365-worldwide"

[https://www.office.com/signin](https://www.office.com/signin)에서 회사 또는 학교 계정으로 Microsoft 365에 로그인합니다.
...
Microsoft를 사용하면 간편하게 온라인에 파일을 저장할 수 있습니다. 내 비즈니스에 꼭 맞는 저장소 위치를 확인하려면 [문서를 저장할 수 있는 위치](https://support.office.com/article/c7c20284-bc94-47f4-9728-d28e9daf0790.aspx)를 참조하세요.
  
관리자가 사용자의 Microsoft 계정을 만들면 해당 사용자에게 자동으로 **OneDrive** 클라우드 저장소 위치가 제공됩니다. OneDrive를 사용하면 컴퓨터, 휴대폰 및 태블릿에서 파일에 액세스할 수 있습니다.  
  
1. 컴퓨터에서 파일 탐색기를 사용하여 OneDrive를 엽니다. 또는 [Microsoft 365](https://www.office.com)를 통해 앱 시작 관리자에서 **OneDrive**를 엽니다.
...
***[Microsoft 365 앱의 Business 요금제](https://go.microsoft.com/fwlink/p/?LinkId=627219)** 에는 Microsoft 전자 메일 또는 비즈니스용 Skype가 포함되어 있지 않습니다. 다음 설치 절차에서는 기존 전자 메일 계정(예: Gmail)을 Outlook에 추가하는 방법을 보여줍니다.*
...
Microsoft를 사용하면 간편하게 온라인에 파일을 저장할 수 있습니다. 내 비즈니스에 꼭 맞는 저장소 위치를 확인하려면 [Office 365에서 문서를 저장할 수 있는 위치](https://support.office.com/article/c7c20284-bc94-47f4-9728-d28e9daf0790.aspx)를 참조하세요.
...
이 단계에서는 Microsoft 365 관리 센터에 로그인하고 학교 도메인을 구독에 추가합니다. 이렇게 하면 Education 구독 자격이 있는지 Microsoft에 확인하게 됩니다.
