...
각 개별 받는 사람의 이름을 입력 하지 않고 전자 메일을 사용자 그룹에 게 보낼 때 사용 됩니다 (메일 그룹)은 특정 토론 주체 (예: "Marketing") 나 자주 통신 하는 데 필요한 일반 작업을 공유 하는 사용자에 의해 구성 됩니다. 또한 전자 메일을 여러 전자 메일 주소로 자동 전달할 수 있는 방법을 제공 합니다.
...
2. **Groups** \> 왼쪽 탐색 창에서 그룹 **그룹** 을 선택한 다음 **그룹 추가** 를 선택 합니다. 
...
6. 메일 그룹에 사용자를 추가 하려면 그룹 [에 사용자 또는 연락처 추가](../email/add-user-or-contact-to-distribution-list.md)를 참조 하세요.
...
메일 [그룹](https://docs.microsoft.com/office365/troubleshoot/groups/distribution-list-issues) 문제에 대 한 도움을 받을 수 있습니다. 
