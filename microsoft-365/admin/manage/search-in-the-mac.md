...
검색 결과는 서로 다른 범주로 구성됩니다. 대부분의 범주는 관리 센터의 항목입니다. 예를 들어 사용자, 그룹, 공유 사서함 또는 도메인이 있습니다. 다른 범주에는 사용자가 탐색할 수 있는 위치, 수행할 수 있는 작업 또는 변경할 수 있는 앱 수준 설정이 표시됩니다. 또한 설명서와 관련된 범주도 있습니다.

다음 섹션에서는 관리 센터에서 검색 가능한 다양한 영역 및 범주에 대해 설명합니다.

## <a name="before-you-begin"></a>시작하기 전에

관리자는 관리 센터에서 검색해야 합니다. 검색 결과에는 로그인한 사용자가 가지는 관리자 권한으로 범위가 지정됩니다. 예를 들어 SharePoint 관리자가 관리 센터에 영역이나 범주를 볼 수 없는 경우 검색에 해당 영역이 표시되지 않습니다.
...
M365 관리 센터에서 작업 범주에 자주 사용되는 작업이 포함되어 있습니다. 시스템의 동사로 생각할 수 있습니다. 예를 들어 모든 페이지에서 "암호 다시 설정"을 검색한 다음 사용자에 대해 하나 이상의 암호를 다시 설정할 수도 있습니다. "사용자 삭제"를 검색하고 사용자 삭제 페이지에서 사용자를 삭제할 수 있습니다.
