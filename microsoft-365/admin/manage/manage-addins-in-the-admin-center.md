...
> [!NOTE]
> Office 스토어에 대 한 액세스를 차단 하면 [테스트용 Office 추가 기능에서 테스트를](https://docs.microsoft.com/office/dev/add-ins/testing/create-a-network-shared-folder-catalog-for-task-pane-and-content-add-ins)수행할 수 없습니다.
