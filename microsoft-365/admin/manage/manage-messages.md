...
메시지 센터 게시물은 새로운 기능과 변경된 기능에 대한 중요한 공지 사항입니다. 이 문서에서는 조직의 변경 관리에 도움이 되는 메시지를 사용하여 수행할 수 있는 작업에 대한 자세한 정보를 제공합니다.
  
## <a name="read-a-message"></a>메시지 읽기

메시지 센터로 이동하려면 [관리 센터](https://go.microsoft.com/fwlink/p/?linkid=2024339)로 이동하고 **상태** > **메시지 센터** 를 선택합니다.

메시지 제목을 선택하여 읽기 영역에서 엽니다. 모든 메시지에는 변경사항 요약, 변경사항이 사용자에게 미치는 영향에 대한 설명, 변경사항 준비 방법에 대한 정보 및 자세한 내용을 볼 수 있는 추가 정보 링크가 포함됩니다. 메시지가 만료된 후에도 추가 정보를 계속 사용할 수 있습니다.

## <a name="filter-and-sort"></a>필터링 및 정렬
...
2. 메시지를 선택하고 **복원** 을 선택하면 메시지가 받은 편지함으로 복원됩니다.
