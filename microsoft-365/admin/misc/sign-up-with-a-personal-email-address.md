...
---
# <a name="signing-up-for-office-365-with-a-personal-email-address"></a>개인 전자 메일 주소로 Office 365에 등록

## <a name="when-you-skip-adding-a-custom-domain"></a>사용자 지정 도메인 추가를 건너뛰는 경우

  
개인 전자 메일 주소로 Office 365에 등록하고 지금 사용자 지정 도메인 추가를 건너뛰면 특정 기능에 대한 액세스를 제한할 수 있습니다. [](../get-help-with-domains/what-is-a-domain.md) 
  
지금 사용자 지정 도메인을 추가하려면 아래 모든 프리미엄 기능에 액세스할 수 있습니다.
  
|**기능**|**개인 전자 메일이 있는 Office 365**|**사용자 지정 도메인이 있는 Office 365**|
|:-----|:-----|:-----|
