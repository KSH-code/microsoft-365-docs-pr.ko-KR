---
title: 전자 메일 및 데이터를 전자 메일로 Microsoft 365 Business Standard
f1.keywords:
- NOCSH
ms.author: pebaum
author: pebaum
...
ROBOTS: NOINDEX
description: 데이터를 새 비즈니스 ID로 이동하는 방법을 학습합니다.
ms.openlocfilehash: 69953736003fb6d19be37baafb0715bc1468843fd2ed81b94b593c6e56a68ae7
ms.sourcegitcommit: a1b66e1e80c25d14d67a9b46c79ec7245d88e045
ms.translationtype: MT
ms.contentlocale: ko-KR
ms.lasthandoff: 08/05/2021
ms.locfileid: "53823906"
---
# <a name="move-email-and-data-to-microsoft-365-business-standard"></a>전자 메일 및 데이터를 전자 메일로 Microsoft 365 Business Standard

새 비즈니스 id로 Microsoft 365 Business Standard 새 *비즈니스 ID를 제공하게 됩니다.* 새로운 전자 메일 계정과 비즈니스 데이터에 대한 별도의 OneDrive 계정을 얻습니다. 
 ...
 **OneDrive 데이터 복사**
1. 하드 드라이브에 임시 폴더를 만들어 비즈니스용 폴더로 마이그레이션하려는 파일을 Microsoft 365 저장합니다.
...
3. 비즈니스용 Microsoft 365 사용할 파일을 1단계에서 만든 로컬 폴더에 복사합니다.
    
 **비즈니스용 OneDrive 파일로 Microsoft 365 가져오기**
1. 이동하여 [admin.microsoft.com](https://go.microsoft.com/fwlink/?LinkId=816877) 사용자 이름과 암호를 사용하여 비즈니스용 Microsoft 365 앱 로그인합니다. 
    
2. 왼쪽 위에서 **앱 시작 관리자** 아이콘을 선택한 다음 **OneDrive** 를 선택합니다.
  
    > [!TIP]
    > 비즈니스용 OneDrive를 처음으로 열 때 OneDrive를 설정해야 합니다. 이 경우 시작 화면 비즈니스용 OneDrive 다음 **을** **선택합니다.** 설정 OneDrive 설정한 후 사용자 OneDrive **준비 를 선택합니다.** 
  
3. 빈 OneDrive 폴더로 이동합니다. 하위 폴더를 만들하려면 새 폴더 **를** \> **선택합니다.**

4. 하드 **업로드** 파일을 복사한 하드 드라이브에서 파일을 OneDrive 선택합니다. 
...
1. 각 사용자는 비즈니스용 구독과 함께 제공된 새 전자 메일 Microsoft 365 설정해야 합니다. 이렇게 하려면 새 전자 메일 계정의 주소가 필요합니다. 각 사용자의 전자 메일 계정은 비즈니스용 전자 메일 계정에 로그인하는 데 사용하는 사용자 Microsoft 365 동일합니다. 예를 들면 sue@contoso.onmicrosoft.com 또는 david@contoso.com과 비슷합니다.
...
1. 그러면 PST 파일에 저장된 전자 메일, 일정, 작업 및 연락처가 비즈니스용 Microsoft 365 계정으로 병합됩니다.
    
2. PST 파일에 저장된 정보를 비즈니스용 Microsoft 365 계정으로 가져오기 위해 각 사용자가 [.pst](https://support.microsoft.com/office/431a8e9a-f99f-4d5f-ae48-ded54b3440ac)파일 에서 전자 메일, 연락처 및 일정 가져오기의 단계를 Outlook 합니다.
