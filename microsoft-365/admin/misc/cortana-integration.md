...
1. Microsoft 365 관리 센터에서 **설정** > **서비스** 를 선택 하 고 **Cortana**를 선택 합니다.

2. **이러한 cortana 연결 환경에서 조직의 Microsoft hosted 데이터를 사용 하** 여 cortana 연결 환경을 사용 하지 않도록 설정 하려면 확인란을 선택 취소 합니다.

3. **변경 내용 저장**을 선택합니다.

Microsoft [서비스 계약](https://go.microsoft.com/fwlink/p/?LinkId=2109174) 및 [Microsoft 개인 정보 취급](https://privacy.microsoft.com/en-us/privacystatement)방침을 통해 관리 되는 서비스의 경우 microsoft는 데이터 컨트롤러입니다. Microsoft는 데이터 컨트롤러와 같은 [Microsoft 개인 정보 취급 방침](https://privacy.microsoft.com/en-us/privacystatement)에 따라 제품 및 서비스를 개선 하는 데이터를 사용 합니다.