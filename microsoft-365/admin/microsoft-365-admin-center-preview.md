...
Microsoft 365 관리 센터는 모든 Microsoft 365 관리자의 공통 진입점으로, 에서 액세스할 수 [https://admin.microsoft.com](https://go.microsoft.com/fwlink/?linkid=2024339) 있습니다. 보안 또는 장치 관리와 같은 전문가 작업 영역은 보다 세부적인 제어를 허용합니다. 관리 센터가 함께 작동하는 방식에 대한 자세한 내용은 이 문서 의 부분에 있는 보안, 장치 관리 또는 [Exchange와](#what-about-the-specific-types-of-it-roles-and-other-workspaces-like-security-device-management-or-exchange) 같은 특정 유형의 IT 역할 및 기타 작업 영역과 관련한 정보를 참조하십시오.
...
Microsoft 365 관리 센터에서 새로운 기능을 사용할 수 있게 되기 때문에 관리 센터에 옵트인하고 Microsoft와 의견을 공유하여 관리 환경을 계속 개선할 수 있습니다. 옵트인(opt in)하는 경우 사용자에게는 아무 영향도 주지 못하며, 원하는 경우 이전 관리 센터로 다시 전환할 수 있습니다.
[Microsoft 365](whats-new-in-preview.md)관리 센터의 새로운
  
> [!NOTE]
> 대상 릴리스 관리자는 새 기능에 처음 액세스할 수 있습니다. 그러면 새 기능이 모든 관리자에게 롤아웃됩니다. 즉, 관리 센터가 보지 못하거나 도움말 문서에 설명된 내용과 다를 수 있습니다. 새 기능을 처음 확인하려면 아래의 관리 센터에 참여를 참조하세요. 
...
3. 모든 사용자에 대한 대상 지정 릴리스 **또는** 선택한 사용자에 대한 **대상 지정 릴리스를 선택합니다.** 선택한 사용자에 대해 대상 지정 릴리스를 선택하는 경우 선택한 사용자 목록에 관리자 계정(및 참여하려는 다른 관리자)을 추가해야 합니다.
...
### <a name="switch-to-the-new-admin-center-and-back-again"></a>새 관리 센터로 전환한 후 다시

새 관리 센터가 미리 보기에 있는 동안 관리 센터 홈 페이지의 맨 위에 있는 토글을 사용하여 새 관리 센터와 이전 관리 센터 간에 전환할 수 있습니다. 새 관리 센터는 완벽하게 작동하며 이전 관리 센터의 모든 기능을 제공합니다.

새 관리 센터를 시도하려면 토글을 전환하여 <b>미리 보기를 시도합니다.</b> 그런 다음 토글에 <b>미리 보기가 표시됩니다.</b> 다음에 관리 센터에 로그인하면 선택이 기억나고 새 관리 센터에 로그인합니다.

이전 관리 센터를 다시 사용하려면 미리 보기에서 <b></b> 해제 위치로 토글합니다. 다음에 관리 센터에 로그인하면 이전 관리 센터에 로그인합니다.
...
## <a name="can-i-do-everything-in-the-new-admin-center-that-i-can-do-in-the-old-admin-center"></a>새 관리 센터에서 이전 관리 센터에서 할 수 있는 모든 작업을 할 수 있나요?

예. 새 관리 센터는 완벽하게 작동하며 이전 관리 센터의 모든 기능을 제공합니다.
  
## <a name="which-microsoft-365-plans-are-available-to-trial-or-buy"></a>평가판 또는 구입할 수 있는 Microsoft 365 요금제는 무엇입니까?

Microsoft 365는 Office 365, Windows 10 및 Enterprise Mobility + Security를 포함하는 완전한 지능형 솔루션으로, 모든 사람이 창의적이고 안전하게 함께 작업할 수 있도록 합니다. 관리 센터에서 다음 Microsoft 365 구독을 사용해 보거나 지금 구입할 수 있습니다.
...
- [새 SharePoint 관리 센터 시작](https://go.microsoft.com/fwlink/?linkid=2024186)
    
- [새 Microsoft Teams 비즈니스용 Skype 관리 센터로 전환하는 동안 &amp; Teams 관리](https://go.microsoft.com/fwlink/?linkid=2024308)
