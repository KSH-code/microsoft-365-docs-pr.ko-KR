...
<span data-ttu-id="e96b4-109">또한 다른 Microsoft 클라우드 서비스에서 새로운 것을 알고자 하는 경우:</span><span class="sxs-lookup"><span data-stu-id="e96b4-109">And if you'd like to know what's new with other Microsoft cloud services:</span></span>
...
<span data-ttu-id="e96b4-126">관리 센터에서 검색에 대한 자세한 내용은 Microsoft 365 관리 센터에서 [검색을 참조하세요.](manage/search-in-the-mac.md)</span><span class="sxs-lookup"><span data-stu-id="e96b4-126">To learn more about search in the admin center, see [Search in the Microsoft 365 admin center](manage/search-in-the-mac.md).</span></span>
...
### <a name="admin-mobile-app"></a><span data-ttu-id="e96b4-138">관리자 모바일 앱</span><span class="sxs-lookup"><span data-stu-id="e96b4-138">Admin mobile app</span></span>
...
## <a name="ignite-2021-march"></a><span data-ttu-id="e96b4-153">Ignite 2021(3월)</span><span class="sxs-lookup"><span data-stu-id="e96b4-153">Ignite 2021 (March)</span></span>
...
<span data-ttu-id="e96b4-205">우선 순위 계정에 대한 자세한 내용은 우선 순위 계정 [모니터링 을 참조하세요.](./setup/priority-accounts.md)</span><span class="sxs-lookup"><span data-stu-id="e96b4-205">For more info on priority accounts, check out [Monitoring priority accounts](./setup/priority-accounts.md).</span></span>
...
- <span data-ttu-id="e96b4-255">웹 Exchange 정책 변경</span><span class="sxs-lookup"><span data-stu-id="e96b4-255">Change your Exchange Web Service throttling policy</span></span>
...
## <a name="may-2020"></a><span data-ttu-id="e96b4-303">2020년 5월</span><span class="sxs-lookup"><span data-stu-id="e96b4-303">May 2020</span></span>
...
## <a name="april-2020"></a><span data-ttu-id="e96b4-337">2020년 4월</span><span class="sxs-lookup"><span data-stu-id="e96b4-337">April 2020</span></span>
...
### <a name="productivity-score"></a><span data-ttu-id="e96b4-371">생산성 점수</span><span class="sxs-lookup"><span data-stu-id="e96b4-371">Productivity score</span></span>
...
### <a name="docs-videos-and-training-april"></a><span data-ttu-id="e96b4-386">Docs, videos, and training (April)</span><span class="sxs-lookup"><span data-stu-id="e96b4-386">Docs, videos, and training (April)</span></span>
...
- [<span data-ttu-id="e96b4-400">2 요소 로그인 설정</span><span class="sxs-lookup"><span data-stu-id="e96b4-400">Setting up two-factor sign-in</span></span>](../business-video/sign-up.md)

## <a name="march-2020"></a><span data-ttu-id="e96b4-401">2020년 3월</span><span class="sxs-lookup"><span data-stu-id="e96b4-401">March 2020</span></span>

### <a name="featured-feedback-fix-improve-add-user-reliability-for-licensing"></a><span data-ttu-id="e96b4-402">주요 피드백 수정 사항: 라이선스에 대한 "사용자 추가" 안정성 개선</span><span class="sxs-lookup"><span data-stu-id="e96b4-402">Featured Feedback Fix: Improve "add user" reliability for licensing</span></span>

<span data-ttu-id="e96b4-403">사용자를 추가할 때 라이선스를 할당하는 것이 얼마나 어려운지 관리자로부터 많은 피드백을 받았습니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-403">We received a lot of feedback from admins about the how hard it is to assign licenses when adding users.</span></span> <span data-ttu-id="e96b4-404">We've made the first update to this fix and we've migrated to a reliable behind-the-scenes service to process those requests.</span><span class="sxs-lookup"><span data-stu-id="e96b4-404">We've made the first update to this fix and we've migrated to a more reliable behind-the-scenes service to process those requests.</span></span> <span data-ttu-id="e96b4-405">문제가 발생하면 다시 시도할 수 있는 오류 메시지가 표시됩니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-405">And if something goes wrong, you'll now get an error message that lets you to try again.</span></span>

![오류와 함께 사용자 확인 페이지를 추가합니다.](../media/MAC-WN-ImprovedLicensing.png)

### <a name="microsoft-teams-home-page-card"></a><span data-ttu-id="e96b4-407">Microsoft Teams 페이지 카드</span><span class="sxs-lookup"><span data-stu-id="e96b4-407">Microsoft Teams home page card</span></span>

<span data-ttu-id="e96b4-408">일부 Teams 사용하면 일부 Teams 더 쉽게 검색할 수 있도록 하는 고정된 대시보드 Teams 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-408">With the uptick in Teams usage, some orgs will get a pinned dashboard card that makes turning Teams on more discoverable.</span></span> <span data-ttu-id="e96b4-409">또한 카드에는 원격 작업으로 전환하는 데 도움이 되는 교육 및 문서에 대한 링크가 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-409">The card also has links to training and docs to help your org transition to remote work.</span></span> <span data-ttu-id="e96b4-410">홈 **페이지로 이동하여** 새 카드를 볼 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-410">Just go to the **Home** page to see the new card.</span></span>

![Microsoft Teams 페이지 카드](../media/MAC-WN-TeamsCard.PNG)

### <a name="customize-your-organizations-sharepoint-mobile-app-theme"></a><span data-ttu-id="e96b4-412">조직의 모바일 앱 테마 SharePoint 사용자 지정</span><span class="sxs-lookup"><span data-stu-id="e96b4-412">Customize your organization's SharePoint mobile app theme</span></span>

<span data-ttu-id="e96b4-413">Microsoft 365 관리 센터를 사용하여 이제 android용 모바일 앱 및 iOS용 SharePoint 앱에서 조직의 테마를 SharePoint 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-413">Using the Microsoft 365 admin center, you can now customize your organization's theme in SharePoint mobile app for iOS and SharePoint mobile app for Android.</span></span> <span data-ttu-id="e96b4-414">이 기능은 이동 중 직원을 위해 SharePoint 온라인과 일치할 수 있는 모바일 인트라넷 앱 환경을 편리하게 제공합니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-414">This feature conveniently provides a mobile intranet app experience that can match your SharePoint Online for employees on the go.</span></span> <span data-ttu-id="e96b4-415">테마 사용자 지정에는 로고 이미지, 탐색 모음 색, 텍스트 및 아이콘 색, 테마 컬러가 포함되어 있어 쉽게 인식할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-415">Theme customization includes your logo image, navigation bar color, text and icon colors, and accent colors, making for easy recognition.</span></span>

![관리 센터 설정을 모바일 앱에 매핑하는 다이어그램](../media/MAC-WN-CustThemeSP.png)

### <a name="improvements-to-the-add-a-group-wizard"></a><span data-ttu-id="e96b4-417">"그룹 추가" 마법사의 향상된 기능</span><span class="sxs-lookup"><span data-stu-id="e96b4-417">Improvements to the "Add a group" wizard</span></span>

<span data-ttu-id="e96b4-418">관리자가 새 그룹을 만들 때 동시에 팀으로 만들면 새 그룹을 포함하는 라이선스가 없는 소유자를 할당할 수 Teams.</span><span class="sxs-lookup"><span data-stu-id="e96b4-418">When admins created a new group - and made it a Team at they same time, they could assign owners who don't have a license that includes Teams.</span></span> <span data-ttu-id="e96b4-419">그리고 몇 가지 두통이 생성되었습니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-419">And that created some headaches.</span></span> <span data-ttu-id="e96b4-420">소유자가 Teams 라이선스가 있는지, 그룹을 팀으로 전환하는 옵션이 없는지 확인하기 위해 마법사 흐름을 업데이트했습니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-420">We've updated the wizard flow to verify that owners have a Teams license and if they don't the option to turn the group into a Team is disabled.</span></span>

### <a name="microsoft-365-offerings-for-small-and-medium-businesses"></a><span data-ttu-id="e96b4-421">Microsoft 365 중소기업을 위한 서비스</span><span class="sxs-lookup"><span data-stu-id="e96b4-421">Microsoft 365 offerings for small and medium businesses</span></span>

<span data-ttu-id="e96b4-422">다음 달의 공지 사항을 알고 있지만 준비를 했으면 합니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-422">We know that this is an announcement for next month, but we want to make sure you're prepared.</span></span>

<span data-ttu-id="e96b4-423">4월 21일부터 중소기업용 Office 365 구독과 관련된 변경을 진행하고 Office 365 ProPlus.</span><span class="sxs-lookup"><span data-stu-id="e96b4-423">Starting on April 21, we're making changes related to our Office 365 subscriptions for small and medium businesses – and to Office 365 ProPlus.</span></span> <span data-ttu-id="e96b4-424">이러한 제품은 이제 제품 브랜드를 Microsoft 365 것입니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-424">These products will now use the Microsoft 365 brand.</span></span>

<span data-ttu-id="e96b4-425">새 제품 이름은 2020년 4월 21일부터 적용됩니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-425">The new product names go into effect on April 21, 2020.</span></span> <span data-ttu-id="e96b4-426">이는 제품 이름만 변경된 것이고 현재는 가격 책정이나 기능 변경이 없습니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-426">This is a change to the product name only, and there are no pricing or feature changes at this time.</span></span>

|<span data-ttu-id="e96b4-427">현재 이름</span><span class="sxs-lookup"><span data-stu-id="e96b4-427">Current name</span></span> |<span data-ttu-id="e96b4-428">새 이름</span><span class="sxs-lookup"><span data-stu-id="e96b4-428">New name</span></span>  |
|---------|---------|
|<span data-ttu-id="e96b4-429">Office 365 Business Essentials</span><span class="sxs-lookup"><span data-stu-id="e96b4-429">Office 365 Business Essentials</span></span>     |   <span data-ttu-id="e96b4-430">Microsoft 365 Business Basic</span><span class="sxs-lookup"><span data-stu-id="e96b4-430">Microsoft 365 Business Basic</span></span>      |
|<span data-ttu-id="e96b4-431">Office 365 Business Premium</span><span class="sxs-lookup"><span data-stu-id="e96b4-431">Office 365 Business Premium</span></span>     |    <span data-ttu-id="e96b4-432">Microsoft 365 Business Standard</span><span class="sxs-lookup"><span data-stu-id="e96b4-432">Microsoft 365 Business Standard</span></span>     |
|<span data-ttu-id="e96b4-433">Microsoft 365 Business</span><span class="sxs-lookup"><span data-stu-id="e96b4-433">Microsoft 365 Business</span></span>     |    <span data-ttu-id="e96b4-434">Microsoft 365 Business Premium</span><span class="sxs-lookup"><span data-stu-id="e96b4-434">Microsoft 365 Business Premium</span></span>     |
|<span data-ttu-id="e96b4-435">Office 365 Business</span><span class="sxs-lookup"><span data-stu-id="e96b4-435">Office 365 Business</span></span>     |    <span data-ttu-id="e96b4-436">비즈니스용 Microsoft 365 앱</span><span class="sxs-lookup"><span data-stu-id="e96b4-436">Microsoft 365 Apps for business</span></span>       |
|<span data-ttu-id="e96b4-437">Office 365 ProPlus</span><span class="sxs-lookup"><span data-stu-id="e96b4-437">Office 365 ProPlus</span></span>    |   <span data-ttu-id="e96b4-438">Microsoft 365 앱</span><span class="sxs-lookup"><span data-stu-id="e96b4-438">Microsoft 365 apps for enterprise</span></span>      |

### <a name="videos-training-and-docs"></a><span data-ttu-id="e96b4-439">비디오, 교육 및 docs</span><span class="sxs-lookup"><span data-stu-id="e96b4-439">Videos, training, and docs</span></span>

<span data-ttu-id="e96b4-440">Microsoft 365 웹 시리즈의 새로운 [기능:](https://go.microsoft.com/fwlink/p/?linkid=2118096)이번 달의 시리즈에서는 3주년을 강조하고 Microsoft Teams 온라인 모임의 오디오 품질 향상, Shifts 앱을 포함한 일선 관리자를 위한 대상 통신, Teams 및 Skype 소비자 상호 상호성 등을 비롯한 새로운 기능을 다수 제공합니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-440">[What's New in Microsoft 365 web series](https://go.microsoft.com/fwlink/p/?linkid=2118096): In this month's episode, we highlight the 3-year anniversary of Microsoft Teams and cover new features including improved audio quality in online meetings, Targeted Communications for firstline managers with the Shifts app, Teams and Skype consumer interoperability, and more.</span></span>

## <a name="february-2020"></a><span data-ttu-id="e96b4-441">2020년 2월</span><span class="sxs-lookup"><span data-stu-id="e96b4-441">February 2020</span></span>

### <a name="featured-feedback-fix-multi-organization-switcher"></a><span data-ttu-id="e96b4-442">주요 피드백 수정: 다중 조직 전환기</span><span class="sxs-lookup"><span data-stu-id="e96b4-442">Featured Feedback Fix: Multi-organization switcher</span></span>

<span data-ttu-id="e96b4-443">여러 Microsoft 클라우드 구성을 관리해야 하는 과제에 대해 파트너 및 관리자로부터 많은 피드백을 받았습니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-443">We received a lot of feedback from partners and admins about the challenges of managing multiple Microsoft cloud orgs.</span></span> <span data-ttu-id="e96b4-444">첫 번째 다중 조직 관리 기능 중 하나는 **조직** 전환기입니다. 이 스위치를 사용하면 두 번의 클릭으로 관리 조직 간에 변경할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-444">One of our first multi-org management features is the **Organization switcher**, which lets you change between the orgs that you manage in just 2 clicks.</span></span>
> [!TIP]
> <span data-ttu-id="e96b4-445">하나 이상의 조직에 대한 공식 파트너인 경우 조직 전환을 표시하기 위해 아무 것도 할 일도 하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-445">You don't have to do anything to make the organization switcher appear as long as you are the Partner of record for at least one organization.</span></span>

1. <span data-ttu-id="e96b4-446">Microsoft 365 관리 센터에서 그룹 이름을 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-446">In the Microsoft 365 admin center, select the org name.</span></span>
<span data-ttu-id="e96b4-447">![화면 캡처: 전환기 아이콘이 있는 조직 프로필 이름을 표시하는 홈 페이지 위쪽입니다.](../media/MAC-Organization-switcher.png)</span><span class="sxs-lookup"><span data-stu-id="e96b4-447">![Screen capture: top of the Home page showing organization profile name with the switcher icon.](../media/MAC-Organization-switcher.png)</span></span>

2. <span data-ttu-id="e96b4-448">조직 전환기에서 관리할 조직을 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-448">In the organization switcher, select the org you want to manage.</span></span>
<span data-ttu-id="e96b4-449">![화면 캡처: 통합 Messenger 테넌트가 강조 표시된 조직 테넌트 전환기](../media/MAC-OrgSwitcherSelected.png)</span><span class="sxs-lookup"><span data-stu-id="e96b4-449">![Screen capture: My organizations tenant switcher with Consolidated Messenger tenant highlighted](../media/MAC-OrgSwitcherSelected.png)</span></span>

<span data-ttu-id="e96b4-450">이는 문자 그대로입니다!!!</span><span class="sxs-lookup"><span data-stu-id="e96b4-450">That's literally it!!!</span></span>

### <a name="groups"></a><span data-ttu-id="e96b4-451">그룹</span><span class="sxs-lookup"><span data-stu-id="e96b4-451">Groups</span></span>

<span data-ttu-id="e96b4-452">이번 달 그룹 영역의 몇 가지 변경 사항:</span><span class="sxs-lookup"><span data-stu-id="e96b4-452">A couple of changes in the groups area this month:</span></span>

- <span data-ttu-id="e96b4-453">**그룹 이름별로 정렬:** 그룹 이름 열을 선택하여 그룹 목록을 사전순으로 정렬할 **수** 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-453">**Sort by group name**: You can sort the groups list alphabetically, by selecting the **Group name** column.</span></span>
- <span data-ttu-id="e96b4-454">**삭제된 Microsoft 365 복원:** 더 이상 Exchange 관리 센터로 이동하여 삭제된 Microsoft 365 복원할 필요가 없습니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-454">**Restore deleted Microsoft 365 groups**: You don't have to go to the Exchange admin center anymore to restore  deleted Microsoft 365 groups.</span></span> <span data-ttu-id="e96b4-455">관리 **Microsoft 365** 그룹 삭제된 그룹으로 이동(목록에서 그룹 \>  \>  \> 선택) \> **그룹 복원으로 이동하세요.**</span><span class="sxs-lookup"><span data-stu-id="e96b4-455">Go to **Microsoft 365 admin center** \> **Groups** \> **Deleted groups** \> (select a group from the list) \> **Restore group**.</span></span> <span data-ttu-id="e96b4-456">그룹을 다시 그룹 목록으로 **복원하고** 그룹의 전자 메일, 대화, 전자 필기장, 파일 및 일정을 복원합니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-456">It'll restore the group back to the **Groups** list and restore the group's email, conversations, notebook, files, and calendar.</span></span>

### <a name="videos-training-and-docs-february"></a><span data-ttu-id="e96b4-457">비디오, 교육 및 docs(2월)</span><span class="sxs-lookup"><span data-stu-id="e96b4-457">Videos, training, and docs (February)</span></span>

- <span data-ttu-id="e96b4-458">**Microsoft 365** 비디오 시리즈의 새로운 기능: 이번 달에는 앱 내 도움말 창, Yammer의 최신 보안 및 규정 준수 업데이트를 통해 최종 사용자에게 특정 기능을 표시하거나 숨길 수 있는 Office "새로운 기능" 관리 기능인 SharePoint Online에 대한 사용자 지정 검색 기능에 초점을 맞추고 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-458">**What's new in Microsoft 365 video series**: This month, we're focused on custom search capabilities for SharePoint Online, the Office "What's New" management feature that lets you show or hide specific features from end-users via the in-app help pane, the latest security and compliance updates in Yammer, and more.</span></span> <span data-ttu-id="e96b4-459">다음은 새로운 소식입니다. [](https://go.microsoft.com/fwlink/p/?linkid=2118096) 새로운 Microsoft 365</span><span class="sxs-lookup"><span data-stu-id="e96b4-459">Here's the latest episode: [What's New in Microsoft 365](https://go.microsoft.com/fwlink/p/?linkid=2118096)</span></span>

- <span data-ttu-id="e96b4-460">**문서 이동**: Office 365 관리 웹 문서와 Microsoft 365 콘텐츠를 결합하여 새 URL을 확인한 것일 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-460">**Docs move**: We combined the Office 365 admin web articles with the Microsoft 365 content and you might've noticed the new URL.</span></span> <span data-ttu-id="e96b4-461">예를 들어 이 문서는 docs.microsoft.com/Office365/Admin/whats-new-in-preview 에서 호스팅했지만 이제 URL은 **docs.microsoft.com/microsoft-365/admin/whats-new-in-preview.** </span><span class="sxs-lookup"><span data-stu-id="e96b4-461">For example, this article used to be hosted at: **docs.microsoft.com/Office365/Admin/whats-new-in-preview**, but the URL is now: **docs.microsoft.com/microsoft-365/admin/whats-new-in-preview**.</span></span> <span data-ttu-id="e96b4-462">책갈피를 설정한 경우 링크를 업데이트해야 합니다. 그러나 콘텐츠 링크는 새 콘텐츠 리포지타입으로 리디렉션됩니다.</span><span class="sxs-lookup"><span data-stu-id="e96b4-462">If you've bookmarked pages, you should update your links; however, content links will be redirected to the new content repo.</span></span>
