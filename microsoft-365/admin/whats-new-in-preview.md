...
- [Microsoft 365 Defender를 사용 하 여 위협 으로부터 보호](https://docs.microsoft.com/learn/paths/m365-security-threat-protection/)
...
- **Microsoft defender For office 365** -조직에서 office 365 용 microsoft defender를 사용 하도록 허가 했으며이를 아직 구성 하지 않았거나 설정 하지 않은 경우이 페이지가 표시 됩니다. **설정** 으로 이동 하 여 다시 시도 합니다.
