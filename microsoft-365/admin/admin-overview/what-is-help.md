...
ms.locfileid: "53827153"
---
<!-- The following is just placeholder text from Madhura's mail. We need to add images/examples of each -->

# <a name="how-to-get-help-in-the-microsoft-365-admin-center"></a>2016년 8월 1일부로 Microsoft 365 관리 센터

관리자인 경우 admin.microsoft.com [](https://admin.microsoft.com) 구독을 관리하고 가장 효율적으로 관리할 수 있는 Microsoft 365 있습니다. 경우에 따라 올바른 작업을 찾지 못하거나 작업 흐름을 시작하기 전에 더 많은 컨텍스트가 필요하거나 단순히 관리자로 작업의 범위와 영향을 잘 모르겠을 수 있습니다. 이러한 상황을 다루기 위해 다음 방법으로 전반에 걸쳐 최신 도움말과 지능형 Microsoft 365 관리 센터 제공합니다.
...
인공 지능을 통해 지원되는 최신 자가진단 환경을  열기 위해 자가진단에서 도움이 필요 단추를 Microsoft 365 관리 센터. 예를 들어 "내 도메인 확인"을 검색하는 경우 단계와 함께 도움이 될 것으로 생각할 몇 가지 문서를 확인할 수 있습니다. 기계 학습을 사용하여 유사한 쿼리를 입력한 다른 관리자에게 도움이 되는 가장 가까운 솔루션을 제공합니다.
