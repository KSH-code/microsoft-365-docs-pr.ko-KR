...
# <a name="learn-about-office-365-germany"></a>Office 365 Germany에 대해 알아보기

Office 365 독일는 유럽에서 사용 가능한 Office 365 서비스와 차별화 된 옵션입니다. 독일어 데이터 센터에서 디지털 작업을 위해 업계 최고의 생산성 서비스를 제공 하 여 (EU, 유럽 연합 (유럽)의 규제 된 고객의 요구를 해결 하는 데 도움이 되었습니다. 독일의 상주, 독일어 법률에 의해 관리 되는 고유한 데이터 트러스티 모델을 통한 엄격한 데이터 액세스 및 제어 조치
...
고객이 이동 해야 하 고, Office 365 독일의 격리는 고객이 원하는 유연성 및 일관성을 처리할 수 있는 능력에 제한을 적용 합니다. 8 월 2018 이후로 새 고객을 더 이상 수락 하지 않거나 현재 사용 가능한 Microsoft 클라우드 독일에서 새 서비스를 배포 하지 않습니다. 자세한 내용은이 블로그 게시물: [Microsoft에서 제공 하는 2019 독일의 새 datacentres에서 클라우드 서비스를 전달 하 여 발전 한 고객의 요구 사항을 충족](https://go.microsoft.com/fwlink/p/?linkid=839016)하도록 합니다.
  
## <a name="what-microsoft-online-services-are-available-in-office-365-germany"></a>Office 365 Germany에서 사용할 수 있는 Microsoft Online Services는 무엇인가요?
...
- Office 365 ProPlus, Office 2016 및 Office 2013<sup>1</sup>. Office 2013에서는 office [클라이언트에 office 365 최신 인증을 사용](https://docs.microsoft.com/office365/enterprise/modern-auth-for-office-2013-and-2016)해야 합니다.
...
<sup>1</sup>Office 365 Germany 요금제에는 Office 365 ProPlus, Office 2013, Office 2016 같이 최종 사용자의 장치에서 설치되어 실행되는 클라이언트 소프트웨어 응용 프로그램(이하 "클라이언트 소프트웨어 응용 프로그램")이 포함됩니다. 클라이언트 소프트웨어 응용 프로그램은 독일 데이터 센터에서 독점적으로 실행되는 것이 아니며, 최종 사용자가 [독일 온라인 서비스](http://microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&amp;DocumentTypeId=58)가 아닌 온라인 서비스에 액세스하도록 할 수 있습니다. Microsoft와의 계약 목적을 위해 클라이언트 소프트웨어 응용 프로그램은 [독일 온라인 서비스](http://microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&amp;DocumentTypeId=58)가 아닙니다. 독일 데이터 수탁자에 의한 독일 데이터 상주 약속 및 액세스 제어는 [독일 온라인 서비스](http://microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&amp;DocumentTypeId=58)에만 적용됩니다.
...
|Office 2013 또는 Office 365 ProPlus보다 오래된 Office 버전<sup>1</sup> <br/> |지원되지 않습니다.  <br/> |
|Office Lens  <br/> |사용할 수 없습니다.  <br/> |
|Office 365 내에서 도메인을 구입하는 기능  <br/> |사용할 수 없습니다.  <br/> |
...
각 Office 365 요금제에서 사용할 수 있는 서비스에 대한 자세한 내용은 [Office 365 서비스 설명](https://docs.microsoft.com/office365/servicedescriptions/office-365-platform-service-description/office-365-platform-service-description)을 참조하세요.
