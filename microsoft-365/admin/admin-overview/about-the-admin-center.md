...
**비즈니스용 Microsoft 365** 구입한 경우 관리자 권한이 있는 경우 관리 센터에 액세스할 수 있습니다. 이 문서를 참조하세요.

**사용자 또는 Microsoft 365 Family 계획이 있는 경우 관리 센터가 없습니다.** 설치 Microsoft 365 PC 또는 Mac에서 Microsoft 365 또는 Office [2019](https://support.microsoft.com/office/4414eaaf-0478-48be-9c42-23adc4716658)다운로드 및 설치 또는 다시 설치로 이동하십시오.
...
2. 왼쪽 위에서 앱 시작 관리자 아이콘을 선택하고 **관리자** 를 선택합니다.
    ...
    관리자 **타일은** 관리자 권한이 있는 Microsoft 365 [표시됩니다.](../add-users/about-admin-roles.md) 타일이 표시되지 않으면 조직의 관리 센터에 액세스할 수 있는 권한이 없는 것입니다.
...
- [사용자 Microsoft 365 만들기](../create-groups/create-groups.md)

- [그룹 Microsoft 365 관리](../create-groups/manage-groups.md)
