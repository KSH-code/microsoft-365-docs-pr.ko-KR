...
**사용자 또는 Microsoft 365** 패밀리 요금제가 있는 경우 관리 센터가 없습니다. Microsoft 365를 설정하려면 PC 또는 [Mac에서 Microsoft 365 또는 Office 2019](https://support.microsoft.com/office/4414eaaf-0478-48be-9c42-23adc4716658)다운로드 및 설치 또는 다시 설치로 이동하십시오.
...
2. 왼쪽 위에서 앱 시작 관리자 아이콘을 선택하고 **관리자** 를 선택합니다.
    ...
    관리자 **타일은** Microsoft 365 관리자 권한이 있는 [사용자만 표시됩니다.](../add-users/about-admin-roles.md) 타일이 없는 경우 조직의 관리 센터에 액세스할 수 있는 권한이 없습니다.
...
|**보고서** <br/> |조직에서 전자 메일 사용, Office 정품 인증 등 자세한 보고서와 함께 Microsoft 365를 사용하는 방법을 한눈에 확인합니다. 새 활동 보고서를 사용하는 [방법을 배워야 합니다.](../activity-reports/activity-reports.md)<br/> |
|**상태** <br/> |서비스 상태를 한눈에 봅니다. 자세한 내용 및 서비스 상태 기록을 확인할 수도 있습니다. [서비스 상태 확인 방법](https://docs.microsoft.com/microsoft-365/enterprise/view-service-health)을 확인하세요.  <br/> 메시지 센터를 사용하여 기능 및 서비스에 예정된 변경 내용을 추적합니다. 변경을 계획하고, 변경 내용이 사용자에게 미칠 수 있는 영향을 이해하는 데 도움이 되는 정보를 포함하는 공지 사항이 여기에 게시됩니다. 자세한 내용은 [Office 365의 메시지 센터](../manage/message-center.md)를 참조하세요.  <br/> |
...
- 사용자 관리: [사용자를 추가하고](../add-users/add-users.md)동시에 라이선스를 할당하거나, 사용자를 삭제 [또는](../add-users/delete-a-user.md)복원하거나, 사용자 암호를 [다시 설정하십시오.](../add-users/reset-passwords.md)
