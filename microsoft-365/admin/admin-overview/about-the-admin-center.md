...
**비즈니스 계획에 대한 Microsoft 365 구입하고 관리자 권한이 있는 경우 관리 센터에 액세스할 수 있습니다.** 이 문서를 참조하세요.

**사용자이거나 Microsoft 365 Family 플랜이 있는 경우 관리자 센터가 없습니다.** Microsoft 365 설정하려면 PC [또는 Mac에서 다운로드하여 Microsoft 365 설치하거나 다시 설치하거나 2019년 Office.](https://support.microsoft.com/office/4414eaaf-0478-48be-9c42-23adc4716658)
...
2. 왼쪽 위에서 앱 시작 관리자 아이콘을 선택하고 **관리자** 를 선택합니다.
    ...
    **관리자** 타일은 관리자 [권한이](../add-users/about-admin-roles.md)Microsoft 365 있는 사람만 나타납니다. 타일이 표시되지 않으면 조직의 관리 센터에 액세스할 수 있는 권한이 없는 것입니다.
...
|**메뉴**|**용도**|
|-----|-----|
|**홈** <br/> |관리자 센터의 방문 페이지입니다. 사용자, 청구, 서비스 상태 및 보고서를 관리하는 위치가 표시됩니다.  <br/> |
...
|**보고서** <br/> |전자 메일 사용, Office 활성화 등에 대한 자세한 보고서를 통해 조직에서 Microsoft 365 사용하는 방법을 한눈에 확인하세요. 새로운 [활동 보고서](../activity-reports/activity-reports.md) 사용 방법을 알아봅니다.  <br/> |
|**상태** <br/> |건강을 한눈에 볼 수 있습니다. 자세한 내용과 건강 기록을 확인할 수도 있습니다. [서비스 상태를 확인하는 방법과](../../enterprise/view-service-health.md) 자세한 내용은 Windows 릴리스 상태를 확인하는 [방법을](/windows/deployment/update/check-release-health) 참조하십시오.  <br/><br/>메시지 센터를 사용하여 기능 및 서비스에 예정된 변경 내용을 추적합니다. 변경을 계획하고, 변경 내용이 사용자에게 미칠 수 있는 영향을 이해하는 데 도움이 되는 정보를 포함하는 공지 사항이 여기에 게시됩니다. [메시지 센터에서](../manage/message-center.md)자세한 내용을 확인하십시오. <br/> |
...
- 사용자 관리: [사용자를 추가하고 동시에 라이선스를 할당하거나,](../add-users/add-users.md)사용자를 삭제 또는 [복원하거나, 사용자의](../add-users/delete-a-user.md) [암호를 재설정합니다.](../add-users/reset-passwords.md)
...
[비즈니스 교육 동영상용 Microsoft 365(링크](../../business-video/index.yml) 페이지)