...
|                           |                          |
|---------------------------|--------------------------|
| [1&,.](../dns/create-dns-records-at-1-1-internet.md) | [가리키기](../dns/create-dns-records-at-hover.md) |
| [123-reg.co.uk](../dns/create-dns-records-at-123-reg-co-uk.md) | [Google (eNom)에서 관리](../dns/create-dns-records-for-domain-managed-by-google-enom.md)|
...
|[Hostgator](../dns/create-dns-records-at-hostgator.md)  | [!   소규모 기업](../dns/create-dns-records-at-yahoo-small-business.md)  |

[도메인 호스트가이 목록에 없기 때문에 일반 지침이 필요 합니다.](create-dns-records-at-any-dns-hosting-provider.md)
