...
다음 단계에 따라 GoDaddy 도메인을 자동으로 확인하고 설정하고 Microsoft 365.
...
1. **레코드에서** **ADD(아래로** 스크롤해야 할 수 있습니다)를 선택합니다.
...
1. 새 레코드의 상자에 표의 값을 입력하거나 복사하여 붙여넣습니다.
   ...
   |**유형** |**Host(호스트)**|**TXT 값**|**TTL** |
   |:-----|:-----|:-----|:-----|
   |TXT |@|MS=ms *XXXXXXXX*<br>**참고:** 예시입니다. 여기에는 표에 있는 특정 **대상 또는 주소 가리키기** 값을 사용합니다. [이 값을 찾는 방법](../get-help-with-domains/information-for-dns-records.md)|1시간  <br>|

   :::image type="content" source="../../media/dns-godaddy/godaddy-domains-TXT-values.png" alt-text="TXT 레코드에 대한 테이블의 값을 입력합니다.":::

1. **저장** 을 선택합니다.

   :::image type="content" source="../../media/dns-godaddy/godaddy-domains-TXTSave.png" alt-text="저장을 선택합니다.":::
...
4. 드롭다운 **목록에서 MX를** 선택합니다.

   :::image type="content" source="../../media/dns-godaddy/godaddy-domains-Type.png" alt-text="유형 드롭다운 목록에서 MX를 선택합니다.":::

5. 새 레코드의 상자에서 다음 표의 값을 입력하거나 복사하여 붙여넣습니다.

    **(드롭다운 목록에서 Type** 및 **TTL** 값을 선택합니다.)

    |**유형**|**Host(호스트)**|**Points to(연결 대상)**|**Priority(우선 순위)**|**TTL**|
    |:-----|:-----|:-----|:-----|:-----|
    |MX  <br/> |@  <br/> | *\<domain-key\>*  .mail.protection.outlook.com  <br/> **참고:** Microsoft  *\<domain-key\>*  계정에서 다운로드하세요.           [이 값을 찾는 방법](../get-help-with-domains/information-for-dns-records.md)          |10   <br/> 우선 순위에 대한 자세한 내용은 [MX 우선 순위란?](../setup/domains-faq.yml)을 참조하세요. <br/> |1시간  <br/> |

   :::image type="content" source="../../media/dns-godaddy/godaddy-domains-Type.png" alt-text="MX 레코드에 대한 테이블의 값을 입력합니다.":::
...
5. CNAME 레코드를 만들 수 있습니다.
    ...
    |:-----|:-----|:-----|:-----|
    |CNAME  <br/> |autodiscover <br/> |autodiscover.outlook.com  <br/> |1시간  <br/> |
...
5. In the boxes for the new record, type or copy and paste the following values.
    ...
    |**유형**|**Host(호스트)**|**TXT 값**|**TTL**|
    |:-----|:-----|:-----|:-----|
    |TXT <br/> |@  <br/> |v=spf1 include:spf.protection.outlook.com -all  <br/> **참고:** 모든 간격이 올바르게 유지되도록 이 항목을 복사하여 붙여넣는 것이 좋습니다. |1시간  <br/> |
...
1. 드롭다운 **목록에서 SRV를** 선택합니다.

   :::image type="content" source="../../media/dns-godaddy/godaddy-domains-Type.png" alt-text="유형 드롭다운 목록에서 SRV를 선택합니다.":::
...
1. 첫 번째 SRV 레코드를 생성합니다.
    ...
    **(드롭다운 목록에서 Type** 및 **TTL** 값을 선택합니다.)
    ...
    |**유형**|**서비스**|**프로토콜**| **Name(이름)** | **Target(대상)**|**Priority(우선 순위)**|**Weight(가중치)**|**Port(포트)**|**TTL**|
    |:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
    |SRV   <br/> |_sip  <br/> |_tls  <br/> |@  <br/> |sipdir.online.lync.com  <br/> |100 <br/> | 1  <br/> |443  <br/> |1시간  <br/> |
    |SRV  <br/> |_sipfederationtls  <br/> |_tcp  <br/> |@  <br/> | sipfed.online.lync.com  <br/> | 100  <br/> |1  <br/> |5061  <br/> |1시간  <br/> |

   :::image type="content" source="../../media/dns-godaddy/godaddy-domains-SRV-values.png" alt-text="SRV 레코드에 대한 테이블의 값을 입력합니다.":::
