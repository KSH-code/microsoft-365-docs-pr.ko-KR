...
6. 다른 MX 레코드가 있으면 다음 2단계 절차를 사용하여 각 레코드를 삭제합니다.
    ...
    각 삭제를 확인하려면 **작업** 열에서 **삭제를** 다시 선택합니다. 
...
5. 레코드 **추가를 선택하여** 첫 번째 레코드를 추가합니다. 
    
    ![Name-BP-Configure-3-2](../../media/1053c2a7-07c3-4c1b-b54a-1c02881fb0ec.png)
  
6. 두 번째 CNAME 레코드를 추가합니다.
    
    위 표의 두 번째 행 값을 사용하여  레코드 추가를 선택하여 두 번째 레코드를 추가합니다. 
...
위 표의 다음 행 값을 사용하여 레코드  추가를 선택하여 두 번째 레코드를 추가합니다.
