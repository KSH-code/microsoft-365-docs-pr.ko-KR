...
기본 이동성 및 보안에서 장치를 등록하려고 할 때 문제가 발생하면 여기에 있는 단계를 시도하여 문제를 추적합니다. 일반적인 단계로 문제가 해결되지 않는 경우 장치 유형에 대한 특정 단계가 있는 이후 섹션 중 하나를 참조하세요.
...
- Microsoft 365에서 기본 이동성 및 보안이 작동할 수 있도록 도메인이 설정되어 있는지 확인 자세한 내용은 기본 이동성 및 [보안 설정을 참조하세요.](set-up.md)
