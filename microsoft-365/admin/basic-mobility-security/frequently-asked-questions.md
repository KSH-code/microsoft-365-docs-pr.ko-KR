...
이 문서에는 모바일 장치에서 모바일 장치를 관리하고 보호하는 데 도움이 되는 기능인 기본 이동성 및 보안에 대한 질문과 Microsoft 365. 질문에 대한 답변을 찾을 수 없는 경우 이 문서에 질문을 추가할 수 있도록 페이지에 설명을 남기면 알려주세요.

## <a name="how-can-i-get-basic-mobility-and-security-i-dont-see-it-in-the-microsoft-365-admin-center"></a>기본 이동성 및 보안을 어떻게 얻을 수 있나요? I don't see it in the Microsoft 365 admin center

1.  기본 이동성 및 보안을 활성화하려면 Office 365 보안 및 & [페이지로](https://protection.office.com/) 이동합니다.
...
1. Office 365 보안 및 준수로 이동하여 & [활성화합니다.](https://protection.office.com/)
...
4. 정책이 적용된 사용자에게는 정책이 적용된 데이터에 액세스하려고 할 때 장치를 등록하라는 Microsoft 365 있습니다. 자세한 내용은 기본 모바일 및 보안을 사용하여 모바일 장치 [등록을 참조하세요.](enroll-your-mobile-device.md)

자세한 내용은 Set [up Basic Mobility and Security을 참조합니다.](set-up.md)

## <a name="im-trying-to-set-up-basic-mobility-and-security-but-it-seems-stuck-the-microsoft-365-service-health-has-been-showing-provisioning-for-a-while-what-can-i-do"></a>기본 이동성 및 보안을 설정하려고 했지만 정체된 것 같은데요. Microsoft 365 서비스 상태는 한 동안 "프로비전"을 표시했습니다. 어떻게 해야 하나요?
...
기본 Mobility and Security는 Intune 서비스에서 호스팅합니다. 이 서비스는 조직의 디바이스 관리에 Microsoft 365 추가된 혜택으로 제공되는 Intune 서비스의 하위 집합입니다. Intune 또는 Basic Mobility and Security for Microsoft 365 중 어떤 서비스를 사용하는 것이 가장 적합한지 결정하는 데 도움이 되는 두 서비스를 나란히 비교한 내용은 [Choose between Basic Mobility Security and Intune을](choose-between-basic-mobility-and-security-and-intune.md)참조합니다.
...
기본 모바일 및 보안에 대한 초기 설정을 완료한 후 정책을 만들어 보안 및 준수 센터의 사용자 & 적용합니다. 정책을 사용하려면 정책 사용자가 기본 이동성 및 보안에 장치를 등록해야 장치를 사용하여 모바일 데이터에 액세스할 Microsoft 365 있습니다. 설정하는 정책에 따라 모바일 장치의 설정(예: 암호를 다시 설정해야 하는 방법 또는 데이터 암호화가 필요한지 여부)이 결정됩니다. 자세한 내용은 [기본](create-device-security-policies.md)모바일 및 보안에서 장치 보안 정책 만들기 및 Microsoft 365   규정 준수 [센터를 참조하세요.](../../compliance/microsoft-365-compliance-center.md)
...
## <a name="can-i-switch-from-exchange-activesync-device-management-to-basic-mobility-and-security-for-microsoft-365"></a>장치 관리에서 Exchange ActiveSync 기본 이동성 및 보안으로 전환할 수 Microsoft 365?
...
기본 모바일 및 보안에서 만든 정책을 사용자 그룹에 적용하면 이러한 정책은 Exchange ActiveSync 사용자에 대해 Exchange 관리 센터에서 이전에 만든 모바일 장치 사서함 정책 및 장치 액세스 규칙에 Exchange 다시 적용됩니다.

장치가 기본 모바일 및 보안에 등록된 후 Exchange ActiveSync 모바일 장치 사서함 정책 또는 장치에 적용된 장치 액세스 규칙은 무시됩니다.
