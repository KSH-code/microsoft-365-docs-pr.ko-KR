---
title: 최신 버전의 사용 현황 분석 Microsoft 365 다운로드
f1.keywords:
- NOCSH
ms.author: efrene
author: efrene
...
템플릿 앱은 1년에 여러 번 새 데이터 또는 새로운 시각화로 새로 고칠 수 있습니다. 기존 인스턴스는 계속 작동하지만 최신 버전을 다운로드하려면 새 인스턴스를 만들어야 합니다. 사용자 지정을 새 인스턴스에 적용해야 합니다. 사용 [현황 Microsoft 365 사용을 참조하세요.](enable-usage-analytics.md) 
