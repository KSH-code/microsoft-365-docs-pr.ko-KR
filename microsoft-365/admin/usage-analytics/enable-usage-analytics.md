...
3. 앱 **탭에서** 검색 상자에 Microsoft 365를 입력하고 **Microsoft 365** 사용 현황 분석을 \> **지금 다운로드합니다.**
...
6.  **Connect를** 선택하고 **Microsoft 365** 사용 현황 분석 화면에서 복사한 테넌트 ID(대시 없이)를 입력하고(1단계) 다음을 **선택합니다.**
