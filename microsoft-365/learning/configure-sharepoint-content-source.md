...
---
# <a name="configure-sharepoint-as-a-learning-content-source-for-microsoft-viva-learning-preview"></a><span data-ttu-id="72eb7-103">Microsoft viva SharePoint 학습 콘텐츠 원본으로 구성(미리 보기) Learning 구성</span><span class="sxs-lookup"><span data-stu-id="72eb7-103">Configure SharePoint as a learning content source for Microsoft Viva Learning (Preview)</span></span>

> [!NOTE]
> <span data-ttu-id="72eb7-104">이 기능은 제품 미리 보기에서 아직 사용할 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="72eb7-104">This feature is not yet available in product preview.</span></span>
