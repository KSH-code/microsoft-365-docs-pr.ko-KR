...
비즈니스 또는 캠페인을 통해 사법 기관이 로그인 페이지에 개인 정보 및 동의 통지를 추가하여 온라인 범죄자에 대한 법적 요금을 보다 쉽게 제출할 수 있습니다.
...
로그인 페이지에서 사용자 지정 가능한 요소를 업데이트하려면 전역 관리자로 지정해야 합니다. 특정 지침은 회사 브랜랜드 [문서 추가를 참조하세요.](https://docs.microsoft.com/azure/active-directory/fundamentals/customize-branding)

업데이트할 수 있는 요소는 다음입니다.

- **로그인 페이지 텍스트** 개인 정보 및 동의 설명을 추가하기 쉬운 장소입니다.
- 로그인 페이지 배경 이미지
- 배너 로고
- 사용자 이름 힌트
