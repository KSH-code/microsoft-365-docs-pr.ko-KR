...
- 비즈니스 신용 카드와 전화를 준비합니다.
    ...
    > [!TIP]
    > 등록 링크는 캠페인에 고유합니다. 한 번만 작동하기 때문에 등록을 완료하는 데 충분한 시간이 있는지 확인하면 됩니다. 약 10분이 필요합니다.
...
8. **이 페이지는 잠시** 걸릴 수 있습니다. 로그인할 위치 및 사용자 ID에 대한 세부 정보를 찾을 수 있습니다. 또한 이 정보는 위 2단계 중에 입력한 전자 메일 주소로 전송됩니다.
...
Microsoft 365 Business Standard와 같은 비즈니스용 Microsoft 365 구독이 이미 있는 경우 Microsoft 365 for Campaigns 서비스를 사용하여 라이선스를 추가할 수 있습니다.
> [!IMPORTANT]
...
3. 로그인 페이지에서 기존 구독의 관리자 별칭을 입력합니다. 예를 들어 *<span></span> .org를* Alice@VoteContoso **다음,** 암호를 입력한 다음 **로그인을 선택합니다.**
