...
### <a name="set-up-atp-safe-links-in-the-security--compliance-center"></a>보안 & 준수 센터에서 ATP 안전한 링크 설정
...
3. **공유** 페이지의 **파일 및 폴더 링크**에서 **특정 사용자**를 선택 하 고 **고급 설정에서 "모든 사용자" 링크**를 선택 하 고, **이러한 링크는이 며칠 이내에 만료 되어야 함**을 선택한 다음, 14 (또는 다른 수의 연결 수명을 제한할 일 수를 선택 합니다.
