...
4. 확장 종료 **날짜** 창에서 확장 정보를 검토하고 필요한 경우 결제 방법을 선택합니다. 완료되면 평가판 **확장을 선택합니다.**
...
2. 구독 **페이지에서** 확장할 평가판 구독을 선택한 다음 만료 날짜에 평가판 **연장을 선택합니다.**
3. 마법사의 단계를 완료합니다.
...
구입 준비가 되면 평가판 [구입을 참조합니다.](buy-a-subscription-from-your-free-trial.md)