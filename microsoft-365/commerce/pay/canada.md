...
**CAD로 결제하고 송장 번호를 송장 번호로 송장 송장으로 송장으로 결제하십시오.**

**Microsoft Corporation에서** 청구한 송장이 있는 경우 다음 은행 정보를 사용하세요.

**은행:** 뱅크오브아메리카, 토론토 **SWIFT 코드:** BOFACATT 계정 **번호:** 45571239 계정 **이름:** MICROSOFT **은행 ID:** 241 **지점:** 56792 계정 **이름:** MICROSOFT
