...
1. 관리자는 다음의 양식을 사용하여 파트너를 찾아 <a href="https://www.microsoft.com/solution-providers/home" target="_blank">https://www.microsoft.com/solution-providers/home</a> 연락합니다.
...
## <a name="what-can-a-partner-do-for-my-organization-or-school"></a>파트너가 내 조직 또는 학교에 대해 어떤 작업을 할 수 있나요?

파트너가 사용자와 함께 작업할 수 있는 방법은 여러 가지가 있습니다. 비즈니스 요구에 따라 이러한 유형 중 하나를 선택하면 사용자와 함께 작업할 요청을 보낼 수 있습니다.

| 파트너 유형 | 설명 |
| ------ | ------------------- |
| 대리자 | 조직 또는 학교에 Microsoft 제품을 판매하는 파트너. |
...
| 위임된 & 대리자 | 조직 또는 학교에 Microsoft 제품 및 서비스를 판매하고 관리하는 파트너. |
| Partner | 파트너에게 테넌트의 사용자 계정을 제공하면 파트너가 사용자를 대신하여 다른 Microsoft 서비스와 함께 작업합니다. |
| Advisor | 파트너는 암호를 재설정하고 지원 인시던트도 처리할 수 있습니다. |
...
3. 하나 이상의 파트너를 선택한 다음 선택한 **공급자에게 문의합니다.**
...
## <a name="review-and-accept-a-partner-relationship-and-microsoft-customer-agreement"></a>파트너 관계 및 Microsoft 고객 계약 검토 및 동의

파트너를 찾은 후 파트너와 함께 작업하기로 결정하면 전자 메일 초대가 전송됩니다.

1. 전자 메일에서 Microsoft 365 관리 센터로 이동하는 링크를 선택합니다.
2. 파트너에게  & 수락 계약 페이지에서 **Microsoft 고객** 계약 링크를 선택하고 문서를 읽습니다.
3. 확인란을 확인하여 계약 내용을 읽은 것입니다.
4. 승인을 **& 선택합니다.**
5. 작업하고 있는 파트너 목록이 표시됩니다. 세부 정보를 볼 파트너를 선택합니다.

## <a name="review-and-accept-a-microsoft-customer-agreement"></a>Microsoft 고객 계약 검토 및 동의

이미 파트너가 있지만 아직 Microsoft 고객 계약에 서명하지 않은 경우 먼저 계약에 동의해야 구독을 구매하거나 구독을 관리할 수 있습니다.

1. 파트너로부터 전자 메일을 받으면 Microsoft 365 관리 센터로 이동하는 링크를 선택하거나 동의 페이지로 <a href="https://go.microsoft.com/fwlink/?linkid=2116573" target="_blank">이동합니다.</a>
...
파트너의 요청에 따라 초대를 수락하면 전역 및 헬프데스크 관리자 역할을 제공해야 합니다. 파트너에게 이러한 관리자 역할을 부여하면 Azure AD에서 위임된 관리자 권한을 자동으로 부여합니다. 자세한 내용은 Azure AD에서 위임된 [관리자 권한을 참조하세요.](https://docs.microsoft.com/partner-center/customers_revoke_admin_privileges#delegated-admin-privileges-in-azure-ad)

파트너에게 관리자 역할을 제공하지 않는 경우 초대를 수락하는 대신 취소합니다.

파트너에서 관리자 역할을 제거할 수 있습니다. 관리자 역할을 제거해도 파트너 관계는 제거되지 않습니다. 대리사와 같은 다른 용량에서 사용자와 계속 작업할 수 있습니다. 파트너와 더 이상 협력하지 않는 경우 파트너에게 연락하여 관계를 종료하세요.

1. 관리 센터에서 대금 청구 파트너 관계  >  <a href="https://go.microsoft.com/fwlink/p/?linkid=2074649" target="_blank">페이지로</a> 이동합니다.
