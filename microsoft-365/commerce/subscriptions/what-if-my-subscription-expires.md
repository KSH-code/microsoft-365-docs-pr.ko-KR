...
관리자 및 사용자는 더 이상 구독과 함께 제공 된 서비스 또는 Office 응용 프로그램에 액세스할 수 없습니다. 모든 고객 데이터 (사용자 데이터에서 문서 및 전자 메일까지)는 영구적으로 삭제 되며 어떤 방식으로든 복구할 수 없습니다.
...
- **평가판을 확장 합니다.** Microsoft 365을 평가하는 데 시간이 더 필요하신가요? 경우에 따라 [평가판을 연장할](../extend-your-trial.md)수 있습니다.
