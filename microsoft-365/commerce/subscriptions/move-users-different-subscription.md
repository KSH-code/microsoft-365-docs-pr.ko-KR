...
5. 해당 사용자에 게 할당 하려는 라이선스 **에 대해 설정 위치로 전환** 합니다. \
...
[수동으로 계획 변경](change-plans-manually.md) (문서)
[Microsoft 365 for business의 구독 및 라이선스 이해](../licenses/subscriptions-and-licenses.md) (문서) \
[다른 Microsoft 365 for business 구독을 구입 합니다](../buy-another-subscription.md) (문서).