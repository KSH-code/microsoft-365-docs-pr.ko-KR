...
구독이 두 개 이상 있는 경우 한 구독에 대한 라이선스가 있는 사용자가 있지만 다른 구독으로 이동하려는 경우 기존 라이선스를 다른 구독으로 바꿀 수 있습니다.
...
5. 이러한 사용자에게 할당할 라이선스의 **On** 위치로 토글합니다.\
...
[다른 비즈니스용 Microsoft 365 구독](../buy-another-subscription.md) 구입(문서)