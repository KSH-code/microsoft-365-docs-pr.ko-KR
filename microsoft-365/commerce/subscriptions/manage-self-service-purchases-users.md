...
구매한 모든 셀프 서비스 구매한 구독의 목록을 볼 수 있습니다.
...
1. 관리 센터에서 **Billing**  >  <a href="https://go.microsoft.com/fwlink/p/?linkid=842054" target="_blank">제품</a> 청구 페이지로 이동 합니다.
2. **제품** 탭에서 더 구입 하거나 라이선스를 줄이는 데 사용할 구독을 선택 합니다.
3. **라이선스 구입** 또는 **라이선스 제거**를 선택 합니다.
4. 오른쪽 창의 **총 라이선스** 수 상자에이 구독에 사용할 라이선스의 총 개수를 입력 한 다음 **저장**을 선택 합니다. 예를 들어 100 라이선스가 있고 5 개를 더 추가 하려면 105를 입력 합니다.
...
1. 관리 센터에서 **Billing**  >  <a href="https://go.microsoft.com/fwlink/p/?linkid=842054" target="_blank">제품</a> 청구 페이지로 이동 합니다.
2. **제품** 탭에서 취소할 구독을 찾습니다. **기타 작업** (점 3 개)을 선택한 다음 **구독 취소**를 선택 합니다.
3. **구독 취소** 창에서 취소 이유를 선택 합니다. 필요한 경우 의견을 제공 합니다.
4. **저장**을 선택합니다.
