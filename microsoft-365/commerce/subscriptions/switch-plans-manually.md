...
---
# <a name="switch-microsoft-365-for-business-plans-manually"></a>비즈니스용 Microsoft 365 요금제 수동 전환

::: moniker range="o365-worldwide"
> [!NOTE]
> 이 문서는 이전 관리 센터에 적용됩니다. 새 관리 센터에 대한 문서를 표시하려면 요금제 수동 [변경을 참조하세요.](change-plans-manually.md) 새 관리 센터는 모든 Microsoft 365 관리자가 사용할 수 있으며 홈  페이지 상단에 있는 새 관리 센터 시도 토글을 선택하여 옵트인(opt in)할 수 있습니다. 자세한 내용은 [새 Microsoft 365 관리 센터 정보](../../admin/microsoft-365-admin-center-preview.md)를 참고하세요.
::: moniker-end

## <a name="step-1-decide-how-to-switch-plans"></a>1단계: 요금제 전환 방법 결정

모든 사용자를 요금제에서 다른 요금제로 전환하는 가장 좋은 방법은 요금제 전환 단추를 [사용하는 것입니다.](switch-to-a-different-plan.md#use-the-switch-plans-button) 이 경우 가능하지 않은 경우도 있습니다. 대신 수동 스위치를 사용합니다.
  
- 요금제 **전환 단추가** 없는 경우

- 요금제 전환 단추를 선택하면 원하는 요금제가 나열되지 않습니다. 

- 모든 사용자를 동일한 방식으로 전환하지 않는 경우 일부 기업에서는 다른 요금제에 가입한 다른 사용자가 필요합니다. 이 경우 수동 스위치를 사용 합니다.

수동 전환을 계속하려면 이 항목의 [2단계:](#step-2-buy-a-new-subscription) 새 구독 구입을 참조하세요.
...
사용자가 현재 있는 조직과 동일한 조직에 대한 구독을 구입해야 합니다. 예를 들어 이동할 사용자의 전자 메일 주소를 확인할 수 있습니다. 전자 메일 주소에 @contoso.com 포함된 경우 새 구독을 구입해야 contoso.com. 이동할 각 사용자에 대한 라이선스를 포함합니다.
  
 **요금제 선택에** 도움이 필요한 경우 [비즈니스용 Microsoft 365](https://go.microsoft.com/fwlink/p/?linkid=842056) 제품 비교 페이지를 참조하거나 [지원에 문의하세요.](../../admin/contact-support-for-business-products.md)
...
2. **두 구독이 모두 나열 및 활성 상태인지 확인**

    사용자를 이동하는 구독과 사용자를 이동하는 구독이 함께 나열되어야 합니다. 새 구독을 처음 확인할 때 해당 구독이 없는 경우 나중에 다시 시도하세요. 두 구독이 모두 ACTIVE 아래에 나열되어 **있는지 확인** 새 구독이 목록에 없는 경우 [또는 활성화되지 않습니다.](#the-new-subscription-isnt-listed-or-isnt-active)

3. **각 사용자에 대한 라이선스가 충분한지 확인**

    각 사용자에게는 구독과 일치하는 라이선스가 필요합니다. 따라서 10명 사용자를 Microsoft 365 Business Premium으로 이동하려면 10개 라이선스를 사용할 수 있는지 확인해야 합니다. 

4. **새 구독에 대한 라이선스가 더 필요하세요?** 구독 **페이지로 이동하고** [비즈니스용 Microsoft 365](../licenses/buy-licenses.md)구독 라이선스 구입으로 이동합니다.
...
- **송장으로 구독을** 구입한 경우 신용 검사가 필요한 경우 구독을 사용할 수 있는 데 작업일 최대 2일이 걸릴 수 있습니다.

- **두 구독을 구매한** 경우 두 구독이 모두 여기에 나열되지 않은 경우 다른 조직에 대해 구입한 것일 수 있습니다(도메인마다 다를 수 있습니다). 구독이 조직 경계를 넘을 수 없습니다.

- **추가 구독이** 있는 경우 여기에 나열되지 않은 경우 또는 **ACTIVE** 아래에 나열되지 않은 경우 [지원에 문의하세요.](../../admin/contact-support-for-business-products.md)
...
2. 활성 **사용자 페이지에서** 라이선스를 할당할 사용자의 이름 옆에 있는 상자를 선택합니다.

3. 오른쪽의 제품 라이선스 **행에서** 편집 을 **선택합니다.**

4. 제품 **라이선스 창에서** 이 사용자에게 할당하려는 라이선스의 **켜기** 위치로 토글합니다. 기본적으로 해당 라이선스와 연결된 모든 서비스가 사용자에게 자동으로 할당됩니다.
...
5. 이 사용자가 더 이상  필요 없는 라이선스에 대해 해제 위치로 토글합니다.

6. 제품 라이선스 창의 아래쪽에서 닫기  **닫기** \> **할당을** \> **선택합니다.**

### <a name="reassign-licenses-for-multiple-users-at-once"></a>여러 사용자에 대한 라이선스를 한 번씩 다시 배정

::: moniker range="o365-worldwide"

1. 관리 센터에서 사용자 활성 **사용자** \> <a href="https://go.microsoft.com/fwlink/p/?linkid=834822" target="_blank">페이지로</a> 이동합니다.
