...
Office 365, office 365 Business, Office 365 Business Premium 및 office 365 Enterprise 요금제에 대 한 라이선스는 처음에 Office 365을 구입한 타사 파트너를 통해 구입 해야 합니다. 구입 시 이용한 파트너가 Microsoft에서 알고 있는 곳이라면 해당 파트너에 연락하는 방법을 다음 절차에 따라 확인할 수 있습니다.
...
2. 구독 페이지에서 라이선스를 추가할 구독을 선택 하 고 **VLSC (볼륨 라이선스 서비스 센터)** 링크를 선택 합니다. 
