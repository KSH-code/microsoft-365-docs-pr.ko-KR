...
청구 계정 **세부** 정보 페이지의 맨 위에는 계정 프로필이 있으며 조직에 대한 법적 및 세금 정보가 포함되어 있습니다. 프로필을 업데이트하여 법적 주소와 전화 번호를 변경할 수 있습니다. 이 계정은 구입한 제품에 대해 비용을 지불하는 법인입니다.

다음 표에는 청구 계정 세부 정보 페이지에 있는 중요한 **용어가 나열됩니다.**

| 필드 이름 | 설명 |
|------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 판매된 주소 | 결제 책임이 있으며 송장에 식별된 법인입니다. 여기에 제공된 주소는 구입 중에 다른 배송 주소를 제공하지 않는 한 세율을 결정하는 데 사용됩니다. 자세한 내용은 [세금 정보](billing-and-payments/tax-information.md)를 참조하세요. |
...
| 계약 | 직접 구매 또는 볼륨 라이선스 계약을 통해 대금 청구 계정을 만들 때 조직의 서명자는 계정의 조건에 대한 계약을 수락하거나 & 서명합니다. 해당하는 경우 이 보기에는 계약 기록이 나열됩니다. 업데이트된 약관에 동의해야 하는 경우 승인 계약에 대한 **링크가** 표시됩니다. |
| 청구 프로필 | 청구 프로필은 청구서를 받는 사람, 청구서 전달 방법, 결제 조건 및 PO 번호와 같은 송장 속성을 정의합니다. 조직 전체에 청구를 배포하려면 여러 청구 프로필을 만들고 구매 시 적절한 청구 프로필을 식별할 수 있습니다. 청구 프로필 및 이러한 프로필을 사용하여 조직의 보다 유연한 청구 옵션을 작성하는 방법에 대한 자세한 내용은 청구 프로필을 [관리하세요.](billing-and-payments/manage-billing-profiles.md) |
