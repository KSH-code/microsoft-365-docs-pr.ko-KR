...
2. 제품 **탭에서** 활성 구독을 찾을 수 있습니다. **추가 작업**(점 3개)을 선택한 다음 **구독 취소** 를 선택합니다.
...
> [!NOTE]
> 사용하지 않도록 설정한 구독을 즉시 삭제할 수 없는 경우 고객 <a href="/microsoft-365/Admin/contact-support-for-business-products" target="_blank">지원에 문의하세요.</a>
...
PowerShell을 사용하여 여러 사용자에 대해 <a href="/azure/active-directory/authentication/howto-mfa-userstates#change-state-using-powershell">다단계 인증을</a>사용하지 않도록 설정할 수도 있습니다.
