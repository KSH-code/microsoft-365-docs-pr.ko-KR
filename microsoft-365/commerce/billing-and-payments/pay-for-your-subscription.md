...
ms.locfileid: "42246438"
---
# <a name="pay-for-your-office-365-for-business-subscription"></a>비즈니스용 Office 365 구독 결제

구독을 설정할 때 신용 카드 지불 또는 은행 계좌 지불액을 사용 하 여 요금을 지불 하거나, 확인 또는 전자 자금 전송 (EFT)을 사용 하 여 송장으로 결제 하도록 선택할 수 있습니다. 어떤 방법을 선택하든 [결제 방법을 변경](change-payment-method.md)하지 않는 한 이후 청구 기간에도 계속 해당 결제 방법을 사용합니다.
...
신용 카드로 결제하려다가 신용 카드가 거부된 경우에는 결제를 처리하지 못했다는 내용의 전자 메일을 받습니다. 이 문제는 신용 카드 만료 등의 몇 가지 이유로 인해 발생할 수 있습니다. Microsoft에서는 며칠 간격으로 거래를 계속 다시 시도합니다. 그래도 결제에 실패할 경우에는 실패에 관련된 전자 메일 알림을 계속 받습니다. 언제 든 지 지불금 **잔액** 기능을 사용 하 여 신용 카드 정보를 변경 하 고 즉시 결제를 다시 제출할 수 있습니다.
...
2. 미해결 잔액의 구독을 찾습니다. **청구** 섹션에서 구독 옆의 **기한을 지불** **합니다 .를**선택 합니다.

3. 신용 카드 소유자 인 경우에는 카드의 만료 날짜를 변경 하거나, 다른 카드를 선택 하거나, [새 카드를 추가할](add-update-or-remove-credit-card-or-bank-account.md)수 있습니다.

    > [!NOTE]
    > **손익 잔액** 기능을 사용 하는 경우 사용자의 계정에 대 한 전체 잔고에 대 한 비용이 청구 되며,이는 다른 곳에 표시 된 금액 보다 더 많을 수 있습니다.

4. 신용 카드 소유자가 아닌 경우에는 다른 신용 카드를 선택 하거나 [새 카드를 추가할](add-update-or-remove-credit-card-or-bank-account.md)수 있습니다.

5. 신용 카드 정보를 업데이트 하거나 구독 요금을 지불 하는 데 사용 되는 신용 카드를 변경한 후에 **저장**을 선택 합니다.
...
2. 변경할 구독을 선택 합니다. **내 청구서** 섹션에서 **지금 결제**를 선택 합니다.
...
5. 신용 카드 정보를 업데이트 하거나 구독 요금을 지불 하는 데 사용 되는 신용 카드를 변경한 후 **제출을**선택 합니다. 그러면 "결제 방법이 업데이트되었고 모든 미결 요금이 결제되었습니다. 감사합니다."라는 확인 메시지가 표시됩니다.
...
> [!NOTE]
> 브라질에 거주 하는 고객은 Boleto Bancario을 사용 하 여 구독을 지불할 수 있습니다. 이 옵션을 선택한 경우 결제에 대 한 billet는 주문 날짜 10 일 이내에 구독을 구매 하는 동안 제공 된 전자 메일로 전송 됩니다. 기한은 주문 날짜 로부터 30 일 후입니다. 전자 메일로 Boleto을 받지 못하는 경우 스팸 폴더를 확인 하거나 지원 서비스에 문의 하세요. <br><br>원하는 경우 계정 간의 전자 전송에 대해 비용을 지불 해도 됩니다. 에이전시 및 계좌 번호는 송장 맨 아래에 있습니다. 전송 id 필드에 송장 번호를 입력 해야 합니다.
...
> [!NOTE]
> 기본적으로 조직의 청구 알림은 Office 365 전자 메일 주소와 조직 내 모든 전역 관리자와 대금 청구 관리자의 대체 전자 메일 주소로 전송됩니다. 대체 전자 메일 주소를 변경 하려면 [청구 주소 변경을](change-your-billing-addresses.md)참조 하세요.
...
> [!NOTE]
> 자동 신용 카드 결제로 전환할 경우 먼저 모든 미지불 잔액을 완납해야 합니다. 청구서에서 결제 옵션 및 지침을 확인하세요. 자세한 내용은 [청구서 이해](understand-your-invoice2.md)를 참조 하세요.
 ...
 **아래의 드롭다운 메뉴에서 "청구지" 국가 또는 지역을 선택 합니다.**
...
구독을 조정하여 송장 결제 자격을 상실할 만큼 결제 금액이 낮아진 경우와 같이 처음에 송장, 신용 카드 또는 은행 계좌를 선택한 이유가 변경된 경우에는 결제 방법을 변경할 수 있습니다. 자세한 내용은 [결제 방법 변경을](change-payment-method.md)참조 하십시오.
