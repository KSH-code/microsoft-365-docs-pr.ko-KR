...
2. 변경할 구독을 선택한 다음 결제 정보 **변경을 선택합니다.**
...
3. *신용 카드 및 은행 계좌 고객:*  결제 **정보** 변경 페이지에서 업데이트할 신용 카드 또는 은행 계좌를 선택하고 세부 정보 **편집을** 선택하고 청구 주소를 업데이트한 다음 제출을 **선택합니다.**
...
2. 변경할 구독을 선택하고 추가 작업을 선택한 다음 **서비스** 사용 주소 **편집을 선택합니다.**

    ![추가 작업 메뉴를 닫습니다.](../../media/befa74b7-62c1-42a3-a38e-db76a1c97dba.png)
  
3. 서비스 사용 **주소 편집 창에서** 주소를 업데이트한 다음 제출을 **선택합니다.**
...
2. 사용자 **아이콘을 선택한** 다음 내 **계정을 선택합니다.**
  
3. 개인 **정보를 선택합니다.**
  
4. 연락처 세부 **정보 상자에서** 편집을 **선택합니다.**
...
1. 관리 센터에서 청구 알림  페이지로 \> <a href="https://go.microsoft.com/fwlink/p/?linkid=853215" target="_blank"></a> 이동합니다.
