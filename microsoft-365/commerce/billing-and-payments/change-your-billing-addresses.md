...
3. *신용 카드 및 은행 계좌 고객:*  결제 **정보** 변경 페이지에서 업데이트할 신용 카드 또는 은행 계좌를 선택하고 세부 정보 **편집을** 선택하고 청구 주소를 업데이트한 다음 제출을 **선택합니다.**
    ...
    > [!NOTE]
    > 일부 국가나 지역에서는 수표로 송장 결제 기능을 사용할 수 없습니다.
...
2. 변경할 구독을 선택하고 추가 작업을 선택한 다음 서비스 사용 주소 **편집 을 선택합니다.**
...
1. 관리 센터에서 청구 청구  알림 \> <a href="https://go.microsoft.com/fwlink/p/?linkid=853215" target="_blank">페이지로</a> 이동합니다.
