...
Microsoft 365 for business를 처음 사용할 경우 [microsoft 365을 설정](../admin/setup/setup.md)하는 방법을 알아보세요.
  
## <a name="still-having-trouble-with-product-keys"></a>여전히 제품 키에 문제가 있나요?

일반적인 오류 및 해결 방법의 목록 확인: [Microsoft 365 for business 제품 키에 대 한 문제](product-key-errors-and-solutions.md)
