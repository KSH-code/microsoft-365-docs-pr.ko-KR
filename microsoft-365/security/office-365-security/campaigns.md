...
캠페인 보기는 Office 365 계획 2용 Microsoft Defender의 기능입니다(예: Microsoft 365 E5 또는 Office 365 요금제 2용 Defender 추가 기능이 있는 조직). 보안 및 준수 & 캠페인 보기는 서비스에서 피싱 공격을 식별하고 분류합니다. 캠페인 보기를 통해 다음을 수행할 수 있습니다.
...
## <a name="campaign-views-in-the-security--compliance-center"></a>보안 및 준수 센터의 & 보기

캠페인 보기는 보안 및 준수 [&](https://protection.office.com)  위협 관리 캠페인에서 또는 에서 직접 사용할 \> 수 <https://protection.office.com/campaigns> 있습니다.
...
캠페인 보기에 액세스하려면 보안 및 준수 센터에서 조직 관리, 보안 관리자 또는 보안 읽기 권한자 역할 & 합니다.  자세한 내용은 [보안 및 준수 센터의 사용 권한](permissions-in-the-security-and-compliance-center.md)을 참조하세요.
...
- **하위 스타일:** 이 값에는 캠페인에 대한 자세한 정보가 포함되어 있습니다. 예를 들면 다음과 같습니다.
  ...
  사용 가능한 경우 이 캠페인에 의해 피싱되는 브랜드입니다. 검색이 Office 365용 Defender 기술에 의해 구동되는 경우 **ATP-는** 하위 타이프 값에 추가됩니다.
...
기본 필터나 고급 필터를 만든 후 쿼리  저장 또는 쿼리를 로 저장을 사용하여 **저장할 수 있습니다.** 나중에 캠페인 보기로 돌아가면 저장된 쿼리 설정 을 클릭하여 저장된 **필터를 로드할 수 있습니다.**

그래프 또는 캠페인 목록을 내보내려면 내보내기 를 클릭하고 차트 데이터 내보내기 **또는** 캠페인 목록  **내보내기 를 선택합니다.**

Endpoint용 Microsoft Defender 구독이 있는 경우 **MDE** 설정을 클릭하여 끝점용 Microsoft Defender를 사용하여 캠페인 정보를 연결하거나 연결을 끊을 수 있습니다. 자세한 내용은 [Office 365용 Microsoft Defender와 끝점용 Microsoft Defender 통합을 참조하세요.](integrate-office-365-ti-with-mde.md)
...
- **시작 및** **종료:** 캠페인의 시작 날짜 및 종료 날짜입니다. 이러한 날짜는 개요 페이지에서 선택한 필터 날짜보다 더 연장될 수 있습니다.

- **영향:** 이 섹션에는 선택한 날짜 범위 필터(또는 시간 표시 막대에서 선택한 날짜 범위)에 대한 다음 데이터가 포함되어 있습니다.
  - 총 받는 사람 수입니다.
  - "받은 편지함"(정크 메일 폴더가 아니라 받은 편지함으로 배달) 메시지 수입니다.
  - 피싱 메시지에서 URL 페이로드를 클릭한 사용자 수입니다.
  - URL을 방문한 사용자 수

- **대상:** 계산된 비율: (조직의 캠페인 받는 사람 수) / (서비스의 모든 조직에서 캠페인의 총 받는 사람 수) 이 값은 캠페인의 전체 수명 동안 계산하며 날짜 필터에 따라 변경되지 않습니다.

- 캠페인 활동의 대화형 타임라인: 타임라인에는 캠페인의 전체 수명 동안 활동이 표시됩니다. 기본적으로 음영 처리된 영역에는 개요에서 선택한 날짜 범위 필터가 포함됩니다. 클릭한 후 끌어서 특정 시작점과 끝점을 선택할 수 있으며, 이 경우 영향 영역 및 다음 섹션에 설명된 바와 같이 페이지의 나머지 부분에서 데이터가 <u>변경됩니다.  </u>

제목 표시줄에서 캠페인 쓰기  다운로드 단추 캠페인 쓰기 다운로드 아이콘을 클릭하여 캠페인 세부 정보를 Word 문서(기본적으로 캠페인 이름 CampaignReport.docx)로 다운로드할 수 ![ ](../../media/download-campaign-write-up-button.png) 있습니다. 다운로드에는 선택한 필터 날짜만이 아니라 캠페인의 전체 수명에 대한 세부 정보가 포함되어 있습니다.

![캠페인 정보](../../media/campaign-details-campaign-info.png)

### <a name="campaign-flow"></a>캠페인 흐름

캠페인 세부 정보 보기 중간에 캠페인에 대한 중요한 세부  정보가 가로 흐름 _다이어그램(Sankey_ 다이어그램)의 흐름 섹션에 표시됩니다. 이러한 세부 정보는 캠페인의 요소와 조직에서 발생할 수 있는 영향을 이해 하는 데 도움이 됩니다.
...
- **배달 위치:** 사용자가 메시지의 페이로드 URL을 클릭하지 않은 경우에도 받는 사람에게 배달된 메시지를 조사할 수 있습니다(받은 편지함 또는 정크 메일 폴더로). 또한 검지에서 분리된 메시지를 제거할 수도 있습니다. 자세한 내용은 [EOP에서 Quarantined email messages를 참조하세요.](quarantine-email-messages.md)
  - **폴더 삭제됨**
  - **삭제**
...
- **PendingDetonationPage:** Microsoft Defender for Office 365의 안전한 첨부 파일이 가상 컴퓨터 환경에서 페이로드 URL을 열고 조사하는 중입니다.
...
> [!TIP]
> 탭에 표시되는 정보는 캠페인 정보 섹션에 설명된 바와 같이 타임라인의 음영이 있는 날짜 범위에 [의해 제어됩니다.](#campaign-information)
...
- **받은 편지함 메시지** 탐색: 캠페인 **ID** 및 배달 위치를 사용하여 새 위협 탐색기 검색 **탭을** 열고 받은 편지함을 검색 필터로 사용합니다.
