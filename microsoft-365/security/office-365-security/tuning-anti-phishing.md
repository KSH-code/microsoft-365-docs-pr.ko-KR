...
- [Office 365용 Microsoft Defender의 안전한 링크](set-up-safe-links-policies.md)

- [Office 365용 Microsoft Defender의 안전한 첨부 파일](set-up-safe-attachments-policies.md)
