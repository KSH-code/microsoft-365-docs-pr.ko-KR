...
Microsoft 365에는 기본적으로 사용하도록 설정된 다양한 피싱 방지 기능이 제공되어도 일부 피싱 메시지는 여전히 사서함을 통과할 수 있습니다. 이 항목에서는 피싱 메시지가 통과한 이유와 실수로 문제를 더 악화하지 않고 Microsoft 365 조직의 피싱 방지 설정을 조정하기 위해 할 수 있는 작업을 설명합니다.
