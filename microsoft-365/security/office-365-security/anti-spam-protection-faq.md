...
A. 예. MX 레코드를 Office 365로 가리키기는 것이 좋지만 Office 365이 아닌 다른 사람에 게 전자 메일을 라우팅하는 합법적인 비즈니스 이유가 있다는 것을 알 수 있습니다.
...
- **Outbound**: Office 365에서 대상 타사 공급자로의 스마트 호스트 라우팅을 구성 합니다.
