...
- **전자 메일 보호 유형의 우선 순위** :이 순서는 구성할 수 없으며 다음 표에 설명 되어 있습니다.
  ...
  ****
  ...
  |2-5<sup>\*</sup>|사용자 가장 (보호 된 도메인)|UIMP|[Microsoft Defender for Office 365에서 피싱 방지 정책 구성](configure-atp-anti-phishing-policies.md)|
  |번<sup>\*</sup>|도메인 가장 (보호 된 사용자)|DIMP|[Microsoft Defender for Office 365에서 피싱 방지 정책 구성](configure-atp-anti-phishing-policies.md)|
