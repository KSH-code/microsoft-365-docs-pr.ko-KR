...
에서 보안 & 센터를 열고 메일 흐름 메시지 <https://protection.office.com/>  \> **추적으로 이동하십시오.**

메시지 추적 페이지로 직접 **이동하기** 위해 를 를 니다. <https://protection.office.com/messagetrace>
...
- **reference**: 이 필드에는 특정 유형의 이벤트에 대한 추가 정보가 포함되어 있습니다. 예:
