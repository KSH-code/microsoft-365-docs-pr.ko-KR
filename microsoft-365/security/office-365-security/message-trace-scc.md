...
> [!NOTE]
> 보류 **중인 값,** **Quarantined 및** Filter as **spam** 값은 10일 미만의 검색에만 사용할 수 있습니다. 또한 실제 상태와 보고된 배달 상태 간에는 5~10분이 지연될 수 있습니다.
...
사용 가능(완료) 확장된 보고서는 메시지 추적 시작 부분의 다운로드 **가능한** 보고서 섹션에서 사용할 수 있습니다. 확장된 요약 보고서의 모든 정보는 확장된 보고서에서 사용할 수 있습니다(origin_timestamp 및 **delivery_priority).**  다음 추가 정보는 확장 보고서에서만 사용할 수 있습니다.
