...
모든 사용자 계정이 동일한 회사 정보에 액세스할 수 있는 것은 없습니다. 일부 계정은 재무 데이터, 제품 개발 정보, 중요한 빌드 시스템에 대한 파트너 액세스 등의 중요한 정보에 액세스할 수 있습니다. 손상된 경우 기밀 정보에 액세스할 수 있는 계정은 심각한 위협을 가할 수 있습니다. 이러한 유형의 계정 우선 순위 계정을 _호출합니다._ 우선 순위 계정에는 CEOS, CIS, COS, 인프라 관리자 계정, 시스템 계정 빌드 등(제한되지는 않습니다.)
