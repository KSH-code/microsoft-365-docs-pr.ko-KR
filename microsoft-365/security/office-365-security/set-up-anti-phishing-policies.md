...
- 보낸 사람 chris@contoso.com <u>주소의</u> 도메인(전자 메일 클라이언트에 표시되는 메시지 보낸 사람)이 DKIM 서명의 도메인 또는 **MAIL FROM** 주소와 다른 경우 경유 태그(michelle@fabrikam.com를 통해)가 추가됩니다. 이러한 주소에 대한 자세한 내용은 전자 메일 메시지 표준 [개요를 참조하세요.](how-office-365-validates-the-from-address.md#an-overview-of-email-message-standards)
