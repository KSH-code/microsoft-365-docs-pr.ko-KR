...
|CAT:|메시지에 적용 되는 보호 정책의 범주: <br/>MALW: 맬웨어 <br/>PHSH: 피싱 <br/>HSPM: 높은 정확도 스팸 <br/>SPOOF: 스푸핑 <br/>SPM: 스팸 <br/>BULK: 대량 <br/>DIMP: 도메인 가장 <br/>UIMP: 사용자 가장 <br/>GIMP: 사서함 인텔리전스<br/>잠재적으로, 받는 메시지는 여러 가지 유형의 보호 및 다중 검색 검사에 의해 플래그 지정될 수 있습니다. 정책의 우선 순위가 다르기 때문에 우선 순위가 가장 높은 정책이 적용됩니다. [전자 메일에 여러 보호 방법과 검색 검사가 실행될 때 어떤 정책이 적용되는지](how-policies-and-protections-are-combined.md) 확인합니다.|
