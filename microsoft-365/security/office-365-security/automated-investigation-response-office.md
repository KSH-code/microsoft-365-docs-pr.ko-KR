...
- EOP(Exchange Online Protection)[](exchange-online-protection-overview.md)및[(Office 365용 Microsoft Defender)에서](office-365-atp.md)확인을 수행하여 사용자가 보고한 다른 유사한 메시지가 없는지 확인할 수 있습니다.
