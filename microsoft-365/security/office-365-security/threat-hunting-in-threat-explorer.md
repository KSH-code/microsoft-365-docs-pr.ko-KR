...
탐색기 도구를 열기 위해 보안 및 준수 센터 위협 **&** 탐색기(또는 실시간 검색)로  >    >   **이동하세요.** 기본적으로 맬웨어 페이지에 도착하지만 보기 드롭다운을 사용하여 옵션에 익숙해지게 됩니다.   피싱을 헌팅하거나 위협 캠페인을 찾은 경우 해당 보기를 선택하세요.

> [!div class="mx-imgBorder"]
> ![위협 탐색기에서 보기 드롭다운](../../media/threat-explorer-view-drop-down.png)
...
> [!div class="mx-imgBorder"]
> ![위협 탐색기에서 보낸 사람 단추](../../media/threat-explorer-sender-button.png)
...
> [!div class="mx-imgBorder"]
> ![위협 탐색기에서 고급 필터](../../media/threat-explorer-advanced-filter.png)

고급 **필터를 클릭하면** Sec Ops 헌터가 쿼리를 직접 작성하여 보는 데 필요한 정보를 포함하거나 제외할 수 있는 패널이 표시됩니다. 탐색기 페이지의 차트와 테이블에 결과가 모두 반영됩니다. 

> [!div class="mx-imgBorder"]
> ![쿼리 결과](../../media/threat-explorer-chart-table.png)

열 옵션 **단추를 사용하여** 가장 유용한 표 정보의 종류를 얻을 수 있습니다. 

> [!div class="mx-imgBorder"]
> ![강조 표시된 열 옵션 단추](../../media/threat-explorer-column-options.png)

> [!div class="mx-imgBorder"]
> ![열에서 사용 가능한 옵션](../../media/threat-explorer-column-options-details.png)
...
> [!div class="mx-imgBorder"]
> ![캠페인 표시 옵션](../../media/threat-explorer-campaign-display.png)
...
> [!div class="mx-imgBorder"]
> ![전자 메일 엔터티 페이지](../../media/threat-explorer-email-entity-page.png)
...
> [!div class="mx-imgBorder"]
> ![전자 메일 엔터티 페이지의 분석 탭](../../media/threat-explorer-analysis-tab.png)
...
> [!div class="mx-imgBorder"]
> ![위협 탐색기에서 동작 단추](../../media/threat-explorer-email-actions-button.png)
...
> [!div class="mx-imgBorder"]
> ![동작 드롭다운](../../media/threat-explorer-email-actions-drop-down.png)
...
마지막으로 경고 ID가 URL에 포함됩니다. 예를 들면 다음과 같습니다. `https://protection.office.com/viewalerts?id=372c9b5b-a6c3-5847-fa00-08d8abb04ef1`
