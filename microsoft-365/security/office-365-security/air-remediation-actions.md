...
[Office 365용 Microsoft Defender의 위협](office-365-atp.md) 방지 기능에는 특정 수정 작업이 포함되어 있습니다. 이러한 수정 작업에는 다음이 포함됩니다.
...
|전자 메일|악성 URL<br/>(안전한 링크에서 악의적인 [URL이 검색되었습니다.)](atp-safe-links.md)|전자 메일/클러스터 소프트 삭제 <p>악의적인 URL이 포함된 전자 메일은 악의적인 것으로 간주됩니다.|
