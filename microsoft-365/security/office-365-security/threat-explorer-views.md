...
이 보고서를 보거나 탐색기(또는 실시간 검색)에서 콘텐츠 맬웨어  \> **보기를** \> **선택하세요.** 이 보기는 SharePoint Online, 비즈니스용 [OneDrive 및 Microsoft Teams에서 Office 365용 Microsoft Defender에](atp-for-spo-odb-and-teams.md)의해 악성으로 식별된 파일을 보여줍니다.
