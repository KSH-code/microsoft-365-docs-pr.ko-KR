...
Microsoft Defender for Office 365는 전자 메일 메시지, 링크(URL) 및 공동 작업 도구로 위협되는 악의적인 위협에 대해 조직을 보호합니다. Office 365용 Defender는 다음 사항을 포함합니다.
...
Office 365용 Microsoft Defender 평가판은 Office 365용 Defender의 기능을 사용해보는 가장 쉬운 방법으로, 몇 번의 클릭만 하면 됩니다. 평가판 설정이 완료되면 조직에서 Office 365 계획 1 및 계획 2의 모든 Defender 기능을 최대 90일 동안 사용할 수 있습니다.
...
Office 365용 Defender 평가판은 90일 동안 사용할 수 있으며 모든 사용자에 대해 시작할 수 있습니다. 자세한 내용은 [Microsoft Defender for Office 365 평가판 약관 & 참조하세요.](defender-for-office-365-trial-terms-and-conditions.md)

## <a name="set-up-a-defender-for-office-365-trial"></a>Office 365용 Defender 평가판 설정

평가판을 사용하면 조직에서 Office 365용 Defender 기능을 쉽게 설정하고 구성할 수 있습니다. 설치하는 동안 Office 365용 Defender 전용 정책(특히 안전한 [](safe-links.md)첨부 [파일,](safe-attachments.md)안전한 링크 및 스팸 방지 정책의 가장 보호)은 미리 설정한 보안 정책에 표준 템플릿을 사용하여 [](set-up-anti-phishing-policies.md#impersonation-settings-in-anti-phishing-policies-in-microsoft-defender-for-office-365) [적용됩니다.](preset-security-policies.md)
...
평가판을 시작하거나 종료하려면 Azure Active Directory에서 전역  관리자 또는 보안 관리자 역할의 구성원이 되거나,  자세한 내용은 관리자 역할 [정보를 참조하세요.](../../admin/add-users/about-admin-roles.md)
...
Office 365용 Defender 평가판은 특정 기준(지리 포함)을 충족하고 Office 365 계획 1 또는 계획 2 라이선스(구독 또는 추가 기능으로 포함)에 대한 기존 Defender가 없는 기존 고객에게 점진적으로 배포하고 있습니다.

## <a name="learn-more-about-defender-for-office-365"></a>Office 365용 Defender에 대해 자세히 알아보시고

Office 365용 Defender는 포괄적인 기능을 제공하면 조직이 엔터프라이즈를 보호하는 데 도움이 됩니다.

이 대화형 가이드에서 Office 365용 Defender에 대한 자세한 내용을 [볼 수도 있습니다.](https://techcommunity.microsoft.com/t5/video-hub/protect-your-organization-with-microsoft-365-defender/m-p/1671189)
...
- [Microsoft Defender for Office 365의 캠페인 보기](campaigns.md)
