...
중요 한 추적기를 통해 사용자가 알고 있어야 하는 크고 작은 위협과 위험을 확인할 수 있습니다. 중요 한 추적기는 이러한 문제가 Office 365 환경에 있는지 여부를 확인 하 고, 예를 들어, 위와 같은 문서에 대 한 링크를 통해 발생 하는 작업에 대 한 자세한 정보를 제공 하 고 조직의 Office 365 사용에 미치는 영향을 확인할 수 있습니다. 새로운 위협 (예: Wannacry, Petya) 또는 새 챌린지를 만들 수 있는 기존 위협 (기타 inaugural 주목할 항목-Nemucod)이 있는 경우에는이 기능을 통해 중요 한 새 항목을 찾아 보안 팀에서 검토 하 고 조사 해야 합니다. 정기적인.
...
새로운 주목할 위협 필터는 ATP 안전한 첨부 파일을 통해 최근에 검색 된 항목을 강조 표시 합니다. 이러한 검색은 전자 메일 흐름이 나 다른 고객의 전자 메일에서 이전에 Office 365에서 찾은 것이 아니라 새로운 악성 파일인 항목을 나타냅니다. 중요 한 위협 추적기의 항목에 주의를 기울여야 하 고, 누가 대상으로 지정 했는지 확인 하 고, 고급 분석 탭에 표시 된 샌드 박싱 세부 정보 (탐색기에서 전자 메일의 제목을 클릭 하 여 찾음)를 검토 합니다. 참고 ATP Safe 첨부 파일 기능을 통해 검색 되는 전자 메일 에서만이 탭을 찾을 수 있음-이 주목할 추적기에는 해당 필터가 포함 되어 있지만 탐색기의 다른 검색에도 해당 필터를 사용할 수도 있습니다.
