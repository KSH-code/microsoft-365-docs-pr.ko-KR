...
이러한 두 요소 간의 차이는 금고 포털에서 링크 Microsoft 365 Defender 명확하지 않습니다.
...
1. Microsoft 365 Defender 포털에서 Email & **Collaboration** Policies & \> **Rules** \> **Threat policies(규칙** 위협 정책 금고 정책) \>  \> **섹션으로 이동하세요.**
