...
5. 나타나는 **보호 설정** 페이지에서 다음 설정을 구성합니다.
   ...
   - **다음 URL을** 다시 덮어치지 않습니다. 링크에서 차단할 지정된 URL에 액세스할 금고 있습니다.
     ...
     기존 항목을 제거하려면 ![아이콘을 제거합니다.](../../media/m365-cc-sc-remove-selection-icon.png) 항목 옆의
...
2. 링크 **금고** 페이지에서 이름을 클릭하여 목록에서 정책을 선택합니다. 정책 세부 정보 플라이아웃이 나타나면 추가 작업 아이콘을 ![ 클릭합니다.](../../media/m365-cc-sc-more-actions-icon.png) **추가 작업** \> ![정책 아이콘 ](../../media/m365-cc-sc-delete-icon.png) **삭제 정책 삭제.**
