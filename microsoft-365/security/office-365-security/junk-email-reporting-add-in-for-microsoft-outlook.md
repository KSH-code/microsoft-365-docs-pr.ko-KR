...
> [!NOTE]
> 현재 정크 메일 보고 추가 기능을 사용하지 않는 경우 대신 보고서 메시지 추가 기능을 사용하는 [것이](enable-the-report-message-add-in.md) 좋습니다. 자세한 내용은 [Microsoft에 메시지와 파일 보고](report-junk-email-messages-to-microsoft.md)를 참조하세요.
...
- 정크 메일 보고 추가 기능을 설치하려면 [](#install-the-junk-email-reporting-add-in) 이 항목 부분의 정크 메일 보고 추가 기능 설치 섹션을 참조하세요.
