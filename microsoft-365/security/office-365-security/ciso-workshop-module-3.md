...
- PowerPoint 요약 다운로드: [모듈 3: id 및 액세스 관리](https://docs.microsoft.com/microsoft-365/security/media/ciso-workshop-3-identity-protection.pptx)
...
## <a name="part-7-identity-system-security-337"></a>7 부: Id 시스템 보안 (3:37)

> [!VIDEO https://www.microsoft.com/videoplayer/embed/RWtYMf]

##  <a name="part-8-lowering-risk-using-business-to-business-and-business-to-customer-447"></a>8 부: 비즈니스 간 및 b2b를 사용 하 여 위험 줄이기 (4:47)
