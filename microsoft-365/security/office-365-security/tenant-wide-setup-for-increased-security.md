...
|**맬웨어 방지 엔진** <br/> |예  <br/> | 기본 정책을 편집 합니다.  <br/> &ensp;&ensp;• 일반 첨부 파일 형식 필터-선택  <br/><br>  사용자 지정 맬웨어 필터 정책을 만들어 조직의 지정 된 사용자, 그룹 또는 도메인에 적용할 수도 있습니다.  <br/> <br> 추가 정보:  <br/> &ensp;&ensp;• [맬웨어 방지 보호 기능](anti-malware-protection.md) <br/> &ensp;&ensp;• [맬웨어 방지 정책 구성](configure-anti-malware-policies.md)|
