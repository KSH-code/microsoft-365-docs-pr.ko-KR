...
- **EOP(Exchange Online Protection)** 정책: Exchange Online 사서함이 있는 Microsoft 365 조직과 Exchange Online 사서함이 없는 독립 실행형 EOP 조직이 포함됩니다.
  ...
  - [Standard 미리](configure-anti-malware-policies.md) 설정  보안 정책 및 엄격한 미리 설정 보안 정책이라는 맬웨어 **방지 정책**
...
- 이 문서의 절차를 수행하려면 먼저 사용 권한을 할당해야 합니다.
  ...
  - 미리 설정한 보안 정책을 구성하려면 Security &  준수  센터에서 조직 관리 [또는 보안 관리자 역할의 구성원 & 합니다.](permissions-in-the-security-and-compliance-center.md)

  - 미리 설정한 보안 정책에 대한 읽기 전용 액세스 권한을  사용하려면 Security & 준수 센터에서 전역 [읽기 & 합니다.](permissions-in-the-security-and-compliance-center.md)
