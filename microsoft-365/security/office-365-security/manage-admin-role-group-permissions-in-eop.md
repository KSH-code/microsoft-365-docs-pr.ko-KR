...
2. **새 역할 그룹** 창이 나타나면 다음 설정을 구성 합니다.
    ...
    - **역할**: **추가** ![ 아이콘 추가 ](../../media/ITPro-EAC-AddIcon.png) 또는 ITPro-EAC-RemoveIcon **제거** ![ 를 클릭 하 여 ](../../media/ITPro-EAC-RemoveIcon.gif) 역할 그룹에 할당 된 역할을 선택 하거나 수정 합니다.

    - **구성원**: **add** ![ icon 추가 ](../../media/ITPro-EAC-AddIcon.png) 또는 **제거** ![ 를 클릭 하 여 ](../../media/ITPro-EAC-RemoveIcon.gif) 역할 그룹 구성원을 수정 ITPro-EAC-RemoveIcon.
...
2. 역할 그룹 속성 페이지가 열리면 **Memebers** 섹션에서 다음 단계 중 하나를 수행 합니다.
