...
EOP 또는 ATP가 필터링 한 전자 메일을 보려면 차트 범례에서 값을 클릭 합니다.
...
- **총 전자 메일**
- **에 지 허용,에 지 필터링 됨**
- **맬웨어 아님, ATP (안전한 첨부 파일 검색), 맬웨어 방지 엔진 검색, 규칙 블록**
- **피싱, DMARC 오류, 가장 감지, 스푸핑 감지, 피싱 검색**
- **URL 샌드 박싱, ATP (URL 샌드 박싱 detection)를 사용한 검색 기능 없음**
- **스팸 아님, 스팸**
- **악의적이 아닌 전자 메일, ATP (안전한 링크 검색), ZAP**
