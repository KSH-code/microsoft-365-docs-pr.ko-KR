...
- **총 전자 메일**
- 에 **지 허용** 및에 **지 필터링**
- **맬웨어**, **안전한 첨부 파일 감지** <sup>\*</sup> , **맬웨어 방지 엔진 감지** 및 **규칙 메시지**
- **피싱**, **DMARC 오류**, **가장 감지**, **스푸핑 감지** 및 **피싱 검색**
- URL 샌드 박싱 및 **url 샌드 박싱 검색** **을 사용 하 여 검색 되지 않음**<sup>\*</sup>
- **스팸** 및 **스팸** 아님
- **악의적이 지 않은 전자 메일**, **안전한 링크 검색** <sup>\*</sup> 및 **ZAP**
