...
이제 페이로드를 빌드해야 합니다. 보낸 사람 세부 정보 섹션에서 보낸 사람 이름, 전자 메일 주소 및 전자 메일 **제목을 입력합니다.** 페이로드를 구성할 언어를 선택할 수 있습니다. 제공된 목록에서 피싱 URL을 선택합니다. 이 URL은 나중에 메시지 본문에 추가됩니다.
