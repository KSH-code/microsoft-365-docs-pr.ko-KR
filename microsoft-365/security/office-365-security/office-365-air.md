...
1. 자동화 된 조사가 다음 중 한 가지 방법으로 시작 됩니다.
   ...
   - [경고](https://docs.microsoft.com/microsoft-365/compliance/alert-policies) 는 전자 메일 (예: 메시지, 첨부 파일 또는 URL)으로 의심 되는 항목에 의해 트리거됩니다. 인시던트가 생성 됩니다. 인시던트 유형에 따라 [보안 playbook](automated-investigation-response-office.md#security-playbooks) 실행 되 고 자동 조사가 시작 됩니다. 
...
> [!IMPORTANT]
> Office 365 용 Microsoft Defender에는 자동으로 수정 작업이 수행 되지 않습니다. 수정 작업은 조직의 보안 팀이 승인한 경우에만 적용될 수 있습니다. 그러나 AIR 역량은 수정 작업을 식별 하 고 의사 결정을 내리는 데 필요한 세부 정보를 제공 하 여 보안 운영 팀의 시간을 절약할 수 있습니다.
