...
## <a name="use-the-security-center-to-remove-custom-anti-spam-policies"></a>보안 센터를 사용하여 사용자 지정 스팸 방지 정책 제거

보안 센터를 사용하여 사용자 지정 스팸 방지 정책을 제거하면 스팸 필터 규칙과 해당 스팸 필터 정책이 모두 삭제됩니다. 기본 스팸 방지 정책은 제거할 수 없습니다.
