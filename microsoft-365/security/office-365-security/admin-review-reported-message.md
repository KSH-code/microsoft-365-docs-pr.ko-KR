...
1. 보안 [Microsoft 365 에서](../defender/overview-security-center.md)정책 정책 & 정책 위협 정책 사용자가 메시지 **설정을** \>  \> **보고했습니다.**

2. 보낸 사람 표시 이름을 지정하려면 관리자 검토 결과에 대한 **전자 메일 알림 섹션에서** 보낸  사람으로 사용할 Office 365 전자 메일 주소 지정 확인란을 확인하고 사용할 이름을 입력합니다. 이 전자 메일 주소는 메시지에 표시될 Outlook 위치로 이동됩니다.
