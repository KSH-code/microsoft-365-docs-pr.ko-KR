...
|**보류 중인 작업** | 조사 결과 악성 전자 메일, 악의적인 URL 또는 위험한 사서함 설정과 같은 위협을 발견 하 고 해당 위협이 [승인을 기다리는](https://docs.microsoft.com/microsoft-365/security/office-365-security/air-review-approve-pending-completed-actions)작업을 수정 합니다.<br/><br/>해당 하는 작업을 수행 하는 모든 위협이 발견 되 면 **보류 중인 작업** 상태가 트리거됩니다. 그러나 조사가 실행 됨에 따라 보류 중인 작업의 목록이 늘어날 수 있습니다. [조사 로그](https://docs.microsoft.com/microsoft-365/security/office-365-security/air-view-investigation-results#playbook-log) 를 확인 하 여 다른 항목의 완료가 아직 보류 중인지 확인 합니다.|
|**수정** | 조사가 완료 되 고 모든 재구성 작업이 승인 되었습니다 (완전히 재구성 된 것으로 표시 됨).<br/><br/>**참고** : 승인 된 재구성 작업은 작업이 수행 되지 않도록 하는 오류를 포함할 수 있습니다. 재구성 작업이 성공적으로 완료 되었는지 여부에 관계 없이 조사 상태는 변경 되지 않습니다. 자세한 결과는 [조사 로그](https://docs.microsoft.com/microsoft-365/security/office-365-security/air-view-investigation-results) 를 확인 하십시오.|
