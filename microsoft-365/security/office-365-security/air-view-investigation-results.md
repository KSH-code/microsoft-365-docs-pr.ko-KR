...
Microsoft [](office-365-air.md) [Defender에서](defender-for-office-365.md)자동화된 조사가 Office 365 자동화된 조사 프로세스가 진행되는 동안 및 이후에 이 조사에 대한 세부 정보를 사용할 수 있습니다. 필요한 권한이 있는 경우 Defender 포털에서 해당 세부 Microsoft 365 수 있습니다. 조사 세부 정보는 최신 상태를 제공하고 보류 중인 작업을 승인할 수 있는 기능을 제공합니다.

> [!TIP]
> Defender 포털의 새 통합 조사 Microsoft 365 확인 합니다. 자세한 내용은 [(NEW!)를 참조하세요. 통합 조사 페이지.](../defender/m365d-autoir-results.md#new-unified-investigation-page)
