...
|**HTML의 Embed 태그** <br><br/> *MarkAsSpamEmbedTagsInHtml*|HTML 태그를 포함 하는 메시지 `<embed>` 는 신뢰도가 높은 스팸으로 표시 됩니다. <br/><br/> 이 태그를 사용 하면 소리, 동영상 또는 그림 같은 HTML 문서에 다양 한 데이터 형식으로 다양 한 유형의 문서를 포함할 수 있습니다.|`X-CustomSpam: Embed tag in html`|
