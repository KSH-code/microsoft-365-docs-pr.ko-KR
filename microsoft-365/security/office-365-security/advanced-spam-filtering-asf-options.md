...
>
> - 스팸 및 높은 신뢰도 스팸 필터 판정의 주기적인 검사 알림
> - 필터링된 메시지의 존재
...
다음 **스팸** 점수 늘리기 ASF 설정은 검색된 메시지의 SCL(스팸 지수)을 스팸  필터 판정 및 스팸 방지 정책의 해당 동작에 해당하는 5 또는 6으로 설정합니다.
...
다음으로 **스팸으로 표시** ASF 설정은 검색된 메시지의 SCL을 9로 설정하며, 이 SCL은 스팸 방지 정책의 높은 지수 스팸 필터 판정 및 해당 동작에 해당합니다. 
...
다음으로 **스팸으로 표시** ASF 설정은 검색된 메시지의 SCL을 6으로 설정하며, 이 SCL은 스팸 필터 판정 및 스팸 방지 정책의 해당 동작에 해당합니다. 
