...
알림 센터에서 최근 30 일 동안의 모든 수정 작업을 표시 합니다. 위협 탐색기를 통해 수행 되는 작업은 수정 내용이 만들어질 때 보안 작업 팀이 제공한 이름에 따라 나열 됩니다. 자동화 된 조사를 통해 수행 되는 작업에는 조사를 트리거한 관련 경고 (예: "Zap email cluster ...")로 시작 하는 제목이 있습니다. ."

이름, 만든 날짜, 설명, 위협 심각도 및 상태를 포함 하 여 해당 항목에 대 한 세부 정보를 볼 수 있는 수정 내용을 확인 합니다. 또한 다음과 같은 두 개의 탭이 표시 됩니다.

- **메일 전송** 탭: 위협 탐색기나 자동화 된 조사를 통해 전송 되는 전자 메일 수를 표시 합니다. 이러한 전자 메일은 실행 가능 또는 조치 될 수 있습니다.<br/><br/>![작동 가능한 위협 및 조치를 취할 수 있는 작업 센터](../../media/tp-RemediationArticle5.png)
