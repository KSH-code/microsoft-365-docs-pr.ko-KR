...
또한 조직에서 [Office 365 계획 1](office-365-atp.md) 또는 [계획 2](office-365-ti.md)용 Microsoft Defender를 사용 하는 경우 보고서 메시지 추가 기능은 조직의 보안 팀에 게 보안 정책을 검토 하 고 업데이트 하는 데 사용할 수 있는 유용한 정보를 제공 합니다.
