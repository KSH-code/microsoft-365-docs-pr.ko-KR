...
- <https://protection.office.com/>에서 보안 및 준수 센터를 엽니다. 제출 페이지로 직접 **이동하기** 위해 를 <https://protection.office.com/reportsubmission> 사용하세요.
...
1. 보안 & 준수 센터에서 위협 관리  제출로 이동하여 관리 제출 탭에 있는지 확인한 다음 \> 새 제출 **을 클릭합니다.** 
...
1. 개체 **유형 섹션에서** **URL 을 선택합니다.** 나타나는 상자에 전체 URL(예: )을 `https://www.fabrikam.com/marketing.html` 입력합니다.
