...
- 메시지와 파일을 Microsoft에 제출하려면 다음 역할 그룹 중 하나의 구성원이 해야 합니다.
  - **Microsoft 365** [Defender 포털의 조직](permissions-microsoft-365-security-center.md)관리 또는 보안 읽기 
...
1. Microsoft 365 포털에서 전자 메일 &  \> **제출로 이동하세요.**
...
4. **Microsoft에** 제출할 이유 선택 섹션에서 다음 옵션 중 하나를 선택합니다.
   - **차단되지 않은 경우(가음성)**
   - **차단된** 경우: 전자  메일이 나타나는 섹션으로 분류되어 있습니다. 섹션에서 다음 값 중 하나를 선택합니다(확실하지 않은 경우 최상의 판단 사용).
     - **피싱**
     - **스팸**
     - **맬웨어**
...
보고서 메시지 추가 기능, 피싱 보고 [](enable-the-report-phish-add-in.md)추가 기능을 배포한 경우 또는 웹용 Outlook에서 기본 제공 보고를 사용하는 경우 사용자가 보고한 메시지 탭에서 보고하는 사용자를 볼 수 **있습니다.** [](enable-the-report-message-add-in.md) [](report-junk-email-and-phishing-scams-in-outlook-on-the-web-eop.md)
