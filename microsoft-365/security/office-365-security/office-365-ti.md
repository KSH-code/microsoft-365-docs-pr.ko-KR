...
|활동 |역할 및 사용 권한 |  
|:-----|:-----|
|위협 대시보드 (또는 새 [보안 대시보드](security-dashboard.md)) 사용<br/> <br/>최근 또는 현재 위협에 대 한 정보 보기  <br/> |다음 중 하나가 필요합니다. <br/>- **Office 365 전역 관리자**  <br/> - **보안 관리자** <br/>- **보안 독자** <br/> <br/>이러한 역할은 Azure Active Directory ([https://portal.azure.com](https://portal.azure.com)) 또는 Microsoft 365 관리 센터 ([https://admin.microsoft.com](https://admin.microsoft.com))에서 할당할 수 있습니다. |
|[위협 탐색기 (및 실시간 검색)](threat-explorer.md) 를 사용 하 여 위협 분석  <br/> |다음 중 하나가 필요합니다. <br/>- **Office 365 전역 관리자**  <br/> - **보안 관리자** <br/>- **보안 독자** <br/> <br/>이러한 역할은 Azure Active Directory ([https://portal.azure.com](https://portal.azure.com)) 또는 Microsoft 365 관리 센터 ([https://admin.microsoft.com](https://admin.microsoft.com))에서 할당할 수 있습니다. |
|인시던트 보기 (조사가 라고도 함) <br/> 인시던트에 전자 메일 메시지 추가  <br/> |다음 중 하나가 필요합니다. <br/>- **Office 365 전역 관리자**  <br/> - **보안 관리자** <br/>- **보안 독자** <br/> <br/>이러한 역할은 Azure Active Directory ([https://portal.azure.com](https://portal.azure.com)) 또는 Microsoft 365 관리 센터 ([https://admin.microsoft.com](https://admin.microsoft.com))에서 할당할 수 있습니다.  |
|인시던트에서 전자 메일 작업 트리거 <br/> <br/> 의심 스러운 전자 메일 메시지 찾기 및 삭제  <br/> |다음 중 하나가 필요합니다. <br/>- **Office 365 전역 관리자**  <br/> - **보안 관리자** 와 **검색 및 제거** 역할<br/><br/>**전역 관리자** 및 **보안 관리자** 역할은 Azure Active Directory ([https://portal.azure.com](https://portal.azure.com)) 또는 Microsoft 365 관리 센터 ([https://admin.microsoft.com](https://admin.microsoft.com))에서 할당 될 수 있습니다. <br/><br/>**검색 및 제거** 역할은 Office 365 Security & 준수 센터 ([https://protection.office.com](https://protection.office.com))에서 할당 해야 합니다. |
|Microsoft Defender Advanced Threat Protection과 Office 365 Advanced Threat Protection 계획 2 통합  <br/><br/> SIEM 서버를 사용 하 여 Office 365 Advanced Threat Protection 계획 2 통합  <br/> |Azure Active Directory ([https://portal.azure.com](https://portal.azure.com)) 또는 Microsoft 365 관리 센터 ([https://admin.microsoft.com](https://admin.microsoft.com))에서 할당 된 **Office 365 전역 관리자** 또는 **보안 관리자** 역할 중 하나<br/>--- **기호** ---<br/>추가 응용 프로그램에서 할당 되는 적절 한 역할 (예: [Microsoft Defender Security Center](https://docs.microsoft.com/windows/security/threat-protection/microsoft-defender-atp/user-roles) 또는 siem server)  |
