...
1. 시작 하려면 [보안 &amp; 및 준수 센터로 이동](../../compliance/go-to-the-securitycompliance-center.md)해야 합니다.
 ...
 **의심 스 럽 지 않은 도메인 쌍** 에는 자동 **복구 스푸핑이**포함 됩니다. 자동 복구 스푸핑은 명시적 인증 검사 [SPF](how-office-365-uses-spf-to-prevent-spoofing.md), [dkim](use-dkim-to-validate-outbound-email.md), [DMARC](use-dmarc-to-validate-email.md))에 실패 했지만 연장 인증 검사를 통과 한 도메인입니다. 따라서 Office 365은 사용자 대신 메일을 자동으로 복구 하며 메일에 대해 스푸핑 방지 작업을 수행 하지 않았습니다.
