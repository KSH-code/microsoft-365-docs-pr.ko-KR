...
- **전자 메일 & 공동 작업** \> **정책 & 규칙** \> **위협 정책** 페이지 정책 섹션 스팸 방지 스푸핑 인텔리전스 정책 표시 이미 검토한 보낸 사람 표시를 선택하고 도메인 또는 외부 도메인 탭을 선택하고 보낸 사람에 대해 스푸핑 허용 여부 값을 \>  \>  \>  \>  \> 확인하십시오.   
