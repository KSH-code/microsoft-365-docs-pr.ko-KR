...
1. 스푸핑 인텔리전스 통찰력에서 **의심스러운** 도메인  또는 의심스러운 도메인을 클릭하여 스푸핑 **인텔리전스** 정보 페이지로 이동합니다. **스푸핑 인텔리전스 정보 페이지에는** 다음 정보가 포함되어 있습니다.
...
2. 플라이아웃에서 도메인/보내는 인프라 쌍에 대한 세부 정보를 확인하려면 목록에서 항목을 선택합니다. 이 정보에는 다음이 포함됩니다.
   ...
   여기에서 스푸핑 허용된 보낸 사람 허용 목록에서 도메인/보내는 인프라 쌍을 추가하거나 제거할 수도 있습니다.  토글을 그에 따라 설정하기만 합니다.
