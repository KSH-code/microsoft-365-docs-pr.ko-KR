...
|---|:---:|:---:|:---:|
|**보낸 사람** _허용(PermissionToAllowSender)_|||![확인 표시](../../media/checkmark.png)|
...
3. 열 **수 있는 Quarantine notification settings** flyout, configure some or all of the following settings:
   ...
   - **회사 로고 사용:** 최종 사용자 스팸 알림의 맨 위에 있는 기본 Microsoft 로고를 대체하려면 이 옵션을 선택합니다. 이렇게 하기 전에 조직에서 사용자 지정 로고를 업로드할 수 있도록 [Microsoft 365](../../admin/setup/customize-your-organization-theme.md) 테마 사용자 지정의 지침을 따라야 합니다.
