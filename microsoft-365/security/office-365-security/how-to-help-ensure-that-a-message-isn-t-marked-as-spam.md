...
Exchange Online 또는 EOP (Exchange Online Protection) 관리자는 서비스를 통과 하는 전자 메일 메시지가 스팸으로 표시 되지 않도록 할 수 있습니다. [전자 메일이 Office 365에서 스팸으로 표시 되지 않도록 하는 방법](prevent-email-from-being-marked-as-spam.md)에서 업데이트 된 버전의 팁과 절차를 참조 하세요.
