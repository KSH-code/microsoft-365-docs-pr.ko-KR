...
다음은 EOP(Exchange Online Protection) 클라우드 호스팅 전자 메일 필터링 서비스에 대한 가장 일반적인 질문과 대답입니다. 그 이외의 FAQ(질문과 대답) 항목은 다음 링크를 참조하십시오.
...
- [메시지 추적 FAQ](/exchange/monitoring/trace-an-email-message/message-trace-faq)

## <a name="what-is-eop"></a>EOP란 무엇입니까?

EOP는 스팸 및 맬웨어로부터 고객을 보호하고 사용자 지정 정책 규칙을 구현하도록 구축된 클라우스 호스트 전자 메일 필터링 서비스입니다. EOP는 Exchange Online 사서함이 포함된 모든 Microsoft 365 구독에 포함됩니다. EOP는 또한 사내 전자 메일 환경을 보호하는 데 도움이 되는 독립 실행형 제품으로 사용할 수 있습니다.
...
## <a name="do-i-have-to-use-all-features-of-microsoft-365-to-use-eop-what-if-i-just-want-eop-protection-and-thats-all"></a>EOP를 사용하기 위해 Microsoft 365의 모든 기능을 사용해야 하나요? EOP 보호만 하고 싶으면 어떻게 하나요?

Microsoft 365의 다른 기능을 사용하지 않고 EOP를 사용하여 사내 사서함을 보호할 수 있습니다. 이를 독립 실행형 구독이라고 합니다. EOP 기능 목록은 [Exchange Online Protection 서비스 설명](/office365/servicedescriptions/exchange-online-protection-service-description/exchange-online-protection-service-description)에서 찾을 수 있습니다.
...
Microsoft 365는 Microsoft 365 테넌트를 통해 액세스할 수 있는 제품 및 서비스 컬렉션에 지정한 이름입니다. Microsoft 365 테넌트는 전자 메일 필터링용 라이선스를 추가할 수 있는 시작점으로 생각할 수 있습니다.
...
예. EOP의 제한에 대한 자세한 내용은 [Exchange Online Protection 제한](/office365/servicedescriptions/exchange-online-protection-service-description/exchange-online-protection-limits)을 참조하세요.

## <a name="does-eop-support-powershell"></a>EOP에서 PowerShell을 지원하나요?

예. 전체 EOP 기능은 PowerShell: Exchange Online 사서함이 있는 조직을 위한 Exchange Online PowerShell을 통해 사용할 수 있습니다. 독립 실행형 EOP 조직용 독립 실행형 EOP PowerShell 자세한 내용은 [Exchange Online PowerShell](/powershell/exchange/exchange-online-powershell) 및 [Exchange Online Protection PowerShell을 참조하세요.](/powershell/exchange/exchange-online-protection-powershell)