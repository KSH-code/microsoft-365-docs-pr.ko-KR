...
2. 스팸 **방지 정책 페이지에서** 이름을 클릭하여 목록에서 사용자 지정  **아웃바운드** 스팸 정책 유형 값이 있는 정책을 선택합니다. 정책 세부 정보 플라이아웃이 나타나면 추가 작업 아이콘을 ![ 클릭합니다.](../../media/m365-cc-sc-more-actions-icon.png) **추가 작업** \> ![정책 아이콘 ](../../media/m365-cc-sc-delete-icon.png) **삭제 정책 삭제.**
