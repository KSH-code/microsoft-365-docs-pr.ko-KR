...
알림은 보안 & 준수 센터에 있습니다. 페이지에 액세스 하는 방법은 다음과 같습니다.
...
### <a name="to-go-to-the-security--compliance-center-using-the-app-launcher"></a>앱 시작 관리자를 사용 하 여 보안 & 준수 센터로 이동 하려면
...
다음 표에서는 보안 & 준수 센터의 **경고** 아래에서 사용할 수 있는 도구에 대해 설명 합니다.
