...
- **조직 설정** 확인: 메시지가 스팸 필터링을 건너뛸 수 있도록 하는 설정(예: 스팸 방지 정책의 허용된 도메인 목록에 사용자 도메인을 추가하는 경우)을 확인합니다. 권장 설정은 EOP 및 [Office 365용 Microsoft Defender](recommended-settings-for-eop-and-office365-atp.md) 보안에 대한 권장 설정 및 안전한 보낸 사람 목록 [만들기를 참조하세요.](create-safe-sender-lists-in-office-365.md)
