...
- 전역 관리자 또는 보안 관리자 또는 검색 및 제거 역할이 Microsoft 365 Defender 있습니다. 자세한 내용은 Microsoft 365 Defender [포털의 사용 권한을 참조하세요.](permissions-microsoft-365-security-center.md) 일부 작업의 경우 미리 보기 역할도 할당해야 합니다.
...
> [!NOTE]
> Explorer의 기본 검색에는 현재 ZAP(제로 아워 자동 보호)를 통해 클라우드 사서함에서 제거된 배달된 항목이 포함되어 있습니다. 이 제한 사항은 모든 보기(예: **\>** 전자 메일 맬웨어 또는 전자 메일 피싱 **\> 보기)에** 적용됩니다. ZAP에서 제거된 항목을 포함하려면 ZAP에서 제거됨을 포함하기 위해 배달 작업  **집합을 추가해야 합니다.** 모든 옵션을 포함하면 ZAP에서 제거한 항목을 포함하여 모든 배달 작업 결과가 표시됩니다.
