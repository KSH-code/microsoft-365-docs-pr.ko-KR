...
---
# <a name="prepare-your-microsoft-365-defender-trial-lab-or-pilot-environment"></a>테스트 Microsoft 365 Defender 파일럿 환경 준비
...
Active Directory와 프레미스 간의 동기화를 이미 사용하도록 설정한 경우 이 Azure Active Directory 건너뜁. 해당 문서의 기존 모범 사례 설명서를 Azure Active Directory. 다음 단계는 파일럿 프로젝트를 평가하거나 실행하기 위해 Microsoft 365 Defender 최적화되어 있습니다.
...
다음 표에는 평가판 또는 파일럿 환경 배포에 Microsoft 365 Defender 구성하기 위해 Microsoft에서 권장하는 순서가 표시됩니다.
...
|![2 단계: 설정](../../media/setup.png) <br>[2 단계: 설정](setup-m365deval.md) | 평가판 Microsoft 365 Defender 파일럿 환경 설정
|:-------|:-----|
