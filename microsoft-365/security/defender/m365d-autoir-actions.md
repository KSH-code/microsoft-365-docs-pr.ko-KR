...
3. 작업 센터의 보류 중인 **탭에서** 목록의 항목을 선택합니다. 플라이아웃 창이 열립니다. 다음은 예입니다.
   ...
   :::image type="content" source="../../media/air-actioncenter-itemselected.png" alt-text="작업의 수락 또는 거부의 예입니다." lightbox="../../media/air-actioncenter-itemselected.png":::
