...
---
# <a name="address-false-positives-or-false-negatives-in-microsoft-365-defender"></a>Microsoft 365 Defender에서 가짓 긍정 또는 거짓 부정 해결
...
경우에 따라 모든 위협 방지 솔루션에서 가긍성 또는 부정이 발생할 수 있습니다. Microsoft [](m365d-autoir.md) 365 Defender의 자동화된 조사 및 대응 기능이 누락되거나 잘못 감지된 경우 보안 운영 팀에서 다음을 취할 수 있는 단계가 있습니다.
...
|시나리오 |서비스 |수행할 작업 |
|--------|--------|--------|
|- 합법적인 사용에 의해 경고가 트리거됩니다. <br/>- 경고가 부정확합니다.    |[Microsoft Cloud App Security](/cloud-app-security)<br/> 또는 <br/>[Azure 위협 방지](/azure/security/fundamentals/threat-detection)         |[Cloud App Security 포털에서 경고 관리](/cloud-app-security/managing-alerts)         |
