...
Imagine 계층 1 또는 계층 2 보안 운영 팀에 가상 분석가가 있는 경우 가상 분석가가 보안 운영에서 위협을 조사하고 수정하는 데 취하는 이상적인 단계를 모방합니다. 가상 도우미는 연중무휴, 무제한으로 작업하고, 상당한 양의 조사와 위협 수정을 수행할 수 있습니다. 이러한 가상 도우미는 대응 시간을 크게 줄이고 보안 운영팀이 다른 중요한 전략 프로젝트를 수행할 수 있도록 합니다. 이 시나리오가 과학 소설처럼 들리면 그렇지 않습니다. 이러한 가상 분석가는 Microsoft 365 Defender 제품군의 일부로, 해당 이름은 자동화된 조사 및 *응답입니다.*
...
- 디바이스를 고리로 설정
- URL 차단 및 
- 기타 작업. (Defender의 수정 [Microsoft 365 참조)](m365d-remediation-actions.md)
...
Microsoft 365 Defender에서 각 자동화된 조사는 다음 표에 요약된 ID, Microsoft Defender for Endpoint 및 Office 365에 대한 Microsoft Defender의 신호와 상관 관계가 있습니다. 
...
> [!NOTE]
> 모든 경고가 자동화된 조사를 트리거하는 것은 아니며, 모든 조사가 자동화된 수정 작업을 수행하지는 않습니다. 조직에 대해 자동화된 조사 및 응답이 구성되는 방식에 따라 달라 하게 됩니다. Defender에서 자동화된 조사 및 대응 [Microsoft 365 구성을 참조합니다.](m365d-configure-auto-investigation-response.md)
...
- [Defender에서 자동화된 조사 및 대응을 위한 Microsoft 365 참조](m365d-configure-auto-investigation-response.md#prerequisites-for-automated-investigation-and-response-in-microsoft-365-defender)
