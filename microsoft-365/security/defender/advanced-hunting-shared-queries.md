...
![공유 쿼리의 이미지입니다.](../../media/shared-query-1.png)
...
3. 쿼리 이름을 입력합니다. 
   ...
   ![쿼리 저장 이미지입니다.](../../media/shared-query-2.png)
...
1. 이름을 변경하거나 삭제할 쿼리 오른쪽에 있는 세 점을 선택합니다.

    ![삭제 쿼리의 이미지입니다.](../../media/shared-query-3.png)
