...
|[Office 365 보안 & 규정 준수](https://protection.office.com)|[Microsoft 365 Defender](https://security.microsoft.com)|[Microsoft 365 규정 준수 센터](https://compliance.microsoft.com/homepage)|[Exchange 관리 센터](https://admin.exchange.microsoft.com/#/)|
|---|---|---|---|
...
[Microsoft 365 Defender](./overview-security-center.md) 보안 및 준수 센터를 포함하여 기존 Microsoft 보안 포털의 보안 Office 365 <https://security.microsoft.com> & 결합합니다. 이 개선된 센터는 보안 팀이 더 효과적이고 효율적으로 위협으로부터 조직을 보호하는 데 도움이 됩니다.

Office 365 보안 및 규정 준수 포털(protection.office.com)에 익숙한 경우 이 문서에서는 Microsoft 365 Defender.
...
## <a name="new-and-improved-capabilities"></a>새 기능 및 향상된 기능
...
#### <a name="email-entity-page"></a>전자 메일 엔터티 페이지 
...
> Office 365 사용자의 경우 다음을 통해 *DKIM* 키를 관리하고 회전할 수 있습니다. 또는 Microsoft 365 Defender 규칙 위협 & <https://security.microsoft.com/threatpolicy>  \>  \> **DKIM으로** 이동할 수 있습니다.
> 
...
|[경고 큐](../../compliance/alert-policies.md)|보안 **및** 준수 센터의 경고 보기 플라이아웃 Office 이제 보안 및 준수 센터에 대한 링크가 Microsoft 365 Defender. 경고 페이지 **열기** 링크를 클릭하고 Microsoft 365 Defender 열립니다. 경고 큐에서 Office 365 경고를 클릭하여 **경고보기** 페이지에 액세스할 수 있습니다.|
...
## <a name="microsoft-365-defender-home-page"></a>Microsoft 365 Defender 홈페이지
...
- [Office 365 보안 및 준수 센터를 Microsoft 365 Defender로 리디렉션](microsoft-365-security-mdo-redirection.md)
