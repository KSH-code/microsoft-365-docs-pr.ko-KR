...
<span data-ttu-id="93232-110">아래 이미지와 표에는 Office 365 보안 및 준수 센터와 & 보안 센터 Microsoft 365 변경 내용이 나열되어 있습니다.</span><span class="sxs-lookup"><span data-stu-id="93232-110">The image and the table below lists the changes in navigation between the Office 365 Security & Compliance Center and the Microsoft 365 security center.</span></span>

> [!div class="mx-imgBorder"]
> <span data-ttu-id="93232-111">![이동한 위치의 이미지](../../media/mdo-m3d-security-center.png)</span><span class="sxs-lookup"><span data-stu-id="93232-111">![Image of what moved to where](../../media/mdo-m3d-security-center.png)</span></span>

<br>

****

|<span data-ttu-id="93232-112">Office 365 보안 & 규정 준수</span><span class="sxs-lookup"><span data-stu-id="93232-112">Office 365 Security & Compliance</span></span>|<span data-ttu-id="93232-113">Microsoft 365 보안 센터</span><span class="sxs-lookup"><span data-stu-id="93232-113">Microsoft 365 security center</span></span>|<span data-ttu-id="93232-114">Microsoft 365 규정 준수 센터</span><span class="sxs-lookup"><span data-stu-id="93232-114">Microsoft 365 compliance center</span></span>|<span data-ttu-id="93232-115">Exchange 관리 센터</span><span class="sxs-lookup"><span data-stu-id="93232-115">Exchange admin center</span></span>|
|---|---|---|---|
|<span data-ttu-id="93232-116">경고</span><span class="sxs-lookup"><span data-stu-id="93232-116">Alerts</span></span>|<span data-ttu-id="93232-117">전자 메일 및 공동 작업</span><span class="sxs-lookup"><span data-stu-id="93232-117">Email & collaboration</span></span>|||
|<span data-ttu-id="93232-118">분류</span><span class="sxs-lookup"><span data-stu-id="93232-118">Classification</span></span>||<span data-ttu-id="93232-119">준수 [Microsoft 365 참조](https://compliance.microsoft.com/homepage)</span><span class="sxs-lookup"><span data-stu-id="93232-119">See [Microsoft 365 compliance center](https://compliance.microsoft.com/homepage)</span></span>||
|<span data-ttu-id="93232-120">데이터 손실 방지</span><span class="sxs-lookup"><span data-stu-id="93232-120">Data loss prevention</span></span>||<span data-ttu-id="93232-121">준수 [Microsoft 365 참조](https://compliance.microsoft.com/homepage)</span><span class="sxs-lookup"><span data-stu-id="93232-121">See [Microsoft 365 compliance center](https://compliance.microsoft.com/homepage)</span></span>||
|<span data-ttu-id="93232-122">레코드 관리</span><span class="sxs-lookup"><span data-stu-id="93232-122">Records management</span></span>||<span data-ttu-id="93232-123">준수 [Microsoft 365 참조](https://compliance.microsoft.com/homepage)</span><span class="sxs-lookup"><span data-stu-id="93232-123">See [Microsoft 365 compliance center](https://compliance.microsoft.com/homepage)</span></span> ||
|<span data-ttu-id="93232-124">정보 거버넌스</span><span class="sxs-lookup"><span data-stu-id="93232-124">Information governance</span></span>||<span data-ttu-id="93232-125">준수 [Microsoft 365 참조](https://compliance.microsoft.com/homepage)</span><span class="sxs-lookup"><span data-stu-id="93232-125">See [Microsoft 365 compliance center](https://compliance.microsoft.com/homepage)</span></span>||
|<span data-ttu-id="93232-126">위협 관리</span><span class="sxs-lookup"><span data-stu-id="93232-126">Threat management</span></span>|<span data-ttu-id="93232-127">전자 메일 및 공동 작업</span><span class="sxs-lookup"><span data-stu-id="93232-127">Email & collaboration</span></span>|||
|<span data-ttu-id="93232-128">메일 흐름</span><span class="sxs-lookup"><span data-stu-id="93232-128">Mail flow</span></span>|||<span data-ttu-id="93232-129">관리 [Exchange 참조](https://admin.exchange.microsoft.com/#/)</span><span class="sxs-lookup"><span data-stu-id="93232-129">See [Exchange admin center](https://admin.exchange.microsoft.com/#/)</span></span>|
|<span data-ttu-id="93232-130">데이터 개인 정보</span><span class="sxs-lookup"><span data-stu-id="93232-130">Data privacy</span></span>||<span data-ttu-id="93232-131">준수 [Microsoft 365 참조](https://compliance.microsoft.com/homepage)</span><span class="sxs-lookup"><span data-stu-id="93232-131">See [Microsoft 365 compliance center](https://compliance.microsoft.com/homepage)</span></span>||
|<span data-ttu-id="93232-132">검색</span><span class="sxs-lookup"><span data-stu-id="93232-132">Search</span></span>|<span data-ttu-id="93232-133">검색</span><span class="sxs-lookup"><span data-stu-id="93232-133">Search</span></span>|||
|<span data-ttu-id="93232-134">보고서</span><span class="sxs-lookup"><span data-stu-id="93232-134">Reports</span></span>|<span data-ttu-id="93232-135">보고서</span><span class="sxs-lookup"><span data-stu-id="93232-135">Report</span></span>|||
|<span data-ttu-id="93232-136">서비스 보증</span><span class="sxs-lookup"><span data-stu-id="93232-136">Service assurance</span></span>|<span data-ttu-id="93232-137">설정</span><span class="sxs-lookup"><span data-stu-id="93232-137">Settings</span></span>|||
|

<span data-ttu-id="93232-138"><https://security.microsoft.com>의 개선된 [Microsoft 365 보안 센터](./overview-security-center.md)는 Microsoft Defender 보안 센터와 Office 365 보안 및 준수 센터 등의 기존 Microsoft 보안 포털의 보안 기능을 결합합니다.</span><span class="sxs-lookup"><span data-stu-id="93232-138">The improved [Microsoft 365 security center](./overview-security-center.md) at <https://security.microsoft.com> combines security capabilities from existing Microsoft security portals, including Microsoft Defender Security Center and the Office 365 Security & Compliance Center.</span></span> <span data-ttu-id="93232-139">이 개선된 센터는 보안 팀이 더 효과적이고 효율적으로 위협으로부터 조직을 보호하는 데 도움이 됩니다.</span><span class="sxs-lookup"><span data-stu-id="93232-139">This improved center helps security teams protect their organization from threats more effectively and efficiently.</span></span>
...
- <span data-ttu-id="93232-179">보안 점수 등급</span><span class="sxs-lookup"><span data-stu-id="93232-179">Secure Score ratings</span></span>
...
- [<span data-ttu-id="93232-200">조사에 대한 자세한 정보</span><span class="sxs-lookup"><span data-stu-id="93232-200">Learn more about Investigations</span></span>](incidents-overview.md)
...
### <a name="access-and-reports"></a><span data-ttu-id="93232-225">액세스 및 보고서</span><span class="sxs-lookup"><span data-stu-id="93232-225">Access and Reports</span></span>
...
<span data-ttu-id="93232-243">[링크](../office-365-security/protect-against-threats.md)를 통해 바로 시작하여 첫날에 구성을 시작하세요.</span><span class="sxs-lookup"><span data-stu-id="93232-243">Along with a [link](../office-365-security/protect-against-threats.md) to jump right in and get configuration going on Day 1.</span></span>
...
## <a name="related-information"></a><span data-ttu-id="93232-256">관련 정보</span><span class="sxs-lookup"><span data-stu-id="93232-256">Related information</span></span>
