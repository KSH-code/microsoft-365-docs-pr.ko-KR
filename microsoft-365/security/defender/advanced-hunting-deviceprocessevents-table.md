...
| `ProcessVersionInfoCompanyName` | 문자열 | 새로 만든 프로세스의 버전 정보의 회사 이름 |
| `ProcessVersionInfoProductName` | 문자열 | 새로 만든 프로세스의 버전 정보의 제품 이름 |
| `ProcessVersionInfoProductVersion` | 문자열 | 새로 만든 프로세스의 버전 정보의 제품 버전 |
| `ProcessVersionInfoInternalFileName` | 문자열 | 새로 만든 프로세스의 버전 정보의 내부 파일 이름 |
| `ProcessVersionInfoOriginalFileName` | 문자열 | 새로 만든 프로세스의 버전 정보의 원래 파일 이름 |
...
| `InitiatingProcessSignerType` | 문자열 | 이벤트를 시작한 프로세스의 파일 서명자 유형(이미지 파일) |
| `InitiatingProcessSignatureStatus` | 문자열 | 이벤트를 시작한 프로세스(이미지 파일)의 서명 상태에 대한 정보 |
