...
:::image type="content" source="../../media/incidents-queue/incidents-ss-incidents-manage.png" alt-text="인시던트의 인시던트 관리 창 예" lightbox="../../media/incidents-queue/incidents-ss-incidents-manage.png":::
