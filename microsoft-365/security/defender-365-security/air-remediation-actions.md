...
|전자 메일|악성 URL<br/>(안전한 링크에서 악성 [URL이 검색되었습니다.)](safe-links.md)|전자 메일/클러스터 소프트 삭제 <br/>URL 차단(클릭 시간 확인)<p> 악의적인 URL이 포함된 전자 메일은 악의적인 것으로 간주됩니다.|
