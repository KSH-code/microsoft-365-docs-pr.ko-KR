...
<span data-ttu-id="2f7f3-111">**적용 대상:**</span><span class="sxs-lookup"><span data-stu-id="2f7f3-111">**Applies to:**</span></span>
...
4. <span data-ttu-id="2f7f3-160">**온보더링 패키지 다운로드를 선택합니다.**</span><span class="sxs-lookup"><span data-stu-id="2f7f3-160">Select **Download onboarding package**.</span></span> <span data-ttu-id="2f7f3-161">동일한 _디렉터리에_ WindowsDefenderATPOnboardingPackage.zip저장합니다.</span><span class="sxs-lookup"><span data-stu-id="2f7f3-161">Save it as _WindowsDefenderATPOnboardingPackage.zip_ to the same directory.</span></span>
...
1. <span data-ttu-id="2f7f3-180">Intune에서 장치 구성  >  **관리를 열고**</span><span class="sxs-lookup"><span data-stu-id="2f7f3-180">In Intune, open **Manage** > **Device configuration**.</span></span> <span data-ttu-id="2f7f3-181">프로필 **만들기**  >  **를**  >  **선택합니다.**</span><span class="sxs-lookup"><span data-stu-id="2f7f3-181">Select **Manage** > **Profiles** > **Create Profile**.</span></span>

2. <span data-ttu-id="2f7f3-182">프로필 이름을 선택하세요.</span><span class="sxs-lookup"><span data-stu-id="2f7f3-182">Choose a name for the profile.</span></span> <span data-ttu-id="2f7f3-183">**Platform=macOS를** **프로필 유형=확장으로 변경합니다.**</span><span class="sxs-lookup"><span data-stu-id="2f7f3-183">Change **Platform=macOS** to **Profile type=Extensions**.</span></span> <span data-ttu-id="2f7f3-184">**만들기** 를 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="2f7f3-184">Select **Create**.</span></span>

3. <span data-ttu-id="2f7f3-185">기본 **탭에서** 이 새 프로필에 이름을 지정합니다.</span><span class="sxs-lookup"><span data-stu-id="2f7f3-185">In the **Basics** tab, give a name to this new profile.</span></span>

4. <span data-ttu-id="2f7f3-186">구성 **설정 탭의** 허용되는 시스템 확장 섹션에 다음 **항목을 추가합니다.**</span><span class="sxs-lookup"><span data-stu-id="2f7f3-186">In the **Configuration settings** tab, add the following entries in the **Allowed system extensions** section:</span></span>

    <span data-ttu-id="2f7f3-187">번들 식별자</span><span class="sxs-lookup"><span data-stu-id="2f7f3-187">Bundle identifier</span></span>         | <span data-ttu-id="2f7f3-188">팀 식별자</span><span class="sxs-lookup"><span data-stu-id="2f7f3-188">Team identifier</span></span>
    --------------------------|----------------
    <span data-ttu-id="2f7f3-189">com.microsoft.wdav.epsext</span><span class="sxs-lookup"><span data-stu-id="2f7f3-189">com.microsoft.wdav.epsext</span></span> | <span data-ttu-id="2f7f3-190">UBF8T346G9</span><span class="sxs-lookup"><span data-stu-id="2f7f3-190">UBF8T346G9</span></span>
    <span data-ttu-id="2f7f3-191">com.microsoft.wdav.netext</span><span class="sxs-lookup"><span data-stu-id="2f7f3-191">com.microsoft.wdav.netext</span></span> | <span data-ttu-id="2f7f3-192">UBF8T346G9</span><span class="sxs-lookup"><span data-stu-id="2f7f3-192">UBF8T346G9</span></span>

    > [!div class="mx-imgBorder"]
    > <span data-ttu-id="2f7f3-193">![기본 탭의 구성 설정에 있는 확장 설정 스크린샷](images/mac-system-extension-intune2.png)</span><span class="sxs-lookup"><span data-stu-id="2f7f3-193">![Screenshot of the extension settings in Configuration settings on the Basics tab](images/mac-system-extension-intune2.png)</span></span>

5. <span data-ttu-id="2f7f3-194">할당 **탭에서** 이 프로필을 모든 사용자 및 모든 & **할당합니다.**</span><span class="sxs-lookup"><span data-stu-id="2f7f3-194">In the **Assignments** tab, assign this profile to **All Users & All devices**.</span></span>
...
## <a name="publish-application"></a><span data-ttu-id="2f7f3-225">응용 프로그램 게시</span><span class="sxs-lookup"><span data-stu-id="2f7f3-225">Publish application</span></span>
...
## <a name="verify-client-device-state"></a><span data-ttu-id="2f7f3-257">클라이언트 장치 상태 확인</span><span class="sxs-lookup"><span data-stu-id="2f7f3-257">Verify client device state</span></span>
