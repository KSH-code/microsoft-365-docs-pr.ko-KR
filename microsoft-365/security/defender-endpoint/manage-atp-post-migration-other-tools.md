...
|**조직 Microsoft Defender 방화벽** 들어오거나 밖으로 흐르는 권한이 없는 네트워크 트래픽을 차단하도록 구성 |[Microsoft Defender 방화벽 고급 보안 관리 Windows PowerShell](/windows/security/threat-protection/windows-firewall/windows-firewall-with-advanced-security-administration-with-windows-powershell) |
|**암호화 및 BitLocker** 조직에서 실행되는 디바이스에 대한 정보를 보호할 수 Windows |[BitLocker PowerShell 참조 가이드](/powershell/module/bitlocker/?view=win10-ps&preserve-view=true) |
