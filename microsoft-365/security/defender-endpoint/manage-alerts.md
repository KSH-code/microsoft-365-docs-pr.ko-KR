...
Microsoft Defender 보안 센터에 경고가 나타나지 못하게 해야 하는 시나리오가 있을 수 있습니다. Endpoint용 Defender를 사용하면 조직의 알려진 도구 또는 프로세스와 같이 무해한 것으로 알려진 특정 경고에 대한 제거 규칙을 만들 수 있습니다.
