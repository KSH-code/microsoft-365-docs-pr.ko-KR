...
|---------|---------|
|**사용자 및 컴퓨터 개체에 대한 설정 관리** <br/><br/>*기본 제공 그룹 정책 개체를 사용자 지정하거나 조직의 요구 사항에 맞게 사용자 지정 그룹 정책 개체 및 조직 구성 단위를 만들 수 있습니다.*     |[도메인 서비스 관리 Azure Active Directory 그룹 정책 관리](/azure/active-directory-domain-services/manage-group-policy)   |
|**구성 Microsoft Defender 바이러스 백신** <br/><br/>*조직 & 정책 설정, 제외, 수정 및 예약된 검사(끝점이라고도 하는 검사)를 비롯한 바이러스 백신 기능을 구성합니다.*   |[그룹 정책 설정을 사용하여 그룹 정책 Microsoft Defender 바이러스 백신](/windows/security/threat-protection/microsoft-defender-antivirus/use-group-policy-microsoft-defender-antivirus) <br/><br/>[그룹 정책을 사용하여 클라우드 제공 보호 사용](/windows/security/threat-protection/microsoft-defender-antivirus/enable-cloud-protection-microsoft-defender-antivirus#use-group-policy-to-enable-cloud-delivered-protection)      |
|**조직의 공격 표면 감소 규칙 관리** <br/><br/>*폴더에 있는 파일을 제외하거나 사용자 & 알림에 사용자 지정 텍스트를 추가하여 공격 표면 감소 규칙을 사용자 지정합니다.* |[그룹 정책 개체를 사용하여 공격 표면 감소 규칙 사용자 지정](/microsoft-365/security/defender-endpoint/customize-attack-surface-reduction#use-group-policy-to-exclude-files-and-folders) |
|**Exploit Protection 설정 관리**<br/><br/>*Exploit Protection 설정을 사용자 지정하고 구성 파일을 가져온 다음 그룹 정책을 사용하여 해당 구성 파일을 배포할 수 있습니다.*  |[Exploit Protection 설정 사용자 지정](/microsoft-365/security/defender-endpoint/customize-exploit-protection) <br/><br/>[악용 보호 구성 가져오기, 내보내기 및 배포하기](/microsoft-365/security/defender-endpoint/import-export-exploit-protection-emet-xml)<br/><br/>[그룹 정책을 사용하여 구성 배포](/microsoft-365/security/defender-endpoint/import-export-exploit-protection-emet-xml#use-group-policy-to-distribute-the-configuration)  |
|**직원이 인터넷에서** 악성 콘텐츠를 사용하는 앱을 사용하지 못하도록 네트워크 보호를 사용하도록 설정 <br/><br/>*테스트 환경에서 [네트워크](/microsoft-365/security/defender-endpoint/evaluate-network-protection) 보호를 위해 먼저 감사 모드를 사용하여 롤아웃하기 전에 차단되는 앱을 보는 것이 좋습니다.* |[그룹 정책을 사용하여 네트워크 보호 켜기](/microsoft-365/security/defender-endpoint/enable-network-protection#group-policy)  |
|**랜섬웨어로부터 보호하도록** 제어된 폴더 액세스 구성 <br/><br/>*[제어된 폴더 액세스를](/microsoft-365/security/defender-endpoint/controlled-folders) 랜섬웨어 방지 보호라고도 합니다.*  |[그룹 정책을 사용하여 제어된 폴더 액세스 사용](/microsoft-365/security/defender-endpoint/enable-controlled-folders#group-policy) |
...
|**암호화 및 BitLocker** 조직에서 실행되는 디바이스에 대한 정보를 보호할 수 Windows |[BitLocker 그룹 정책 설정](/windows/security/information-protection/bitlocker/bitlocker-group-policy-settings) |
|자격 증명 도난 공격으로부터 보호하도록 **Microsoft Defender Credential Guard** 구성 |[그룹 Windows Defender Credential Guard 사용하여 사용자 설정](/windows/security/identity-protection/credential-guard/credential-guard-manage#enable-windows-defender-credential-guard-by-using-group-policy) |
