...
---
# <a name="get-one-remediation-activity-by-id"></a>ID로 수정 작업 1개 가져오기
...
relatedComponent | 문자열 | 이 수정 작업의 관련 구성 요소(보안 권장에 대한 관련 구성 요소와 유사) | Microsoft Microsoft Silverlight
...
title | 문자열 | 이 수정 활동의 제목입니다. | Microsoft Silverlight
type | 문자열 | 수정 유형 | 업데이트
