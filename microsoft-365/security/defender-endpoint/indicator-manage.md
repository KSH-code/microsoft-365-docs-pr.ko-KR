...
---
# <a name="manage-indicators"></a>표시기 관리
...
mitretechniques| 문자열 | MITRE 기술 코드/id(콤보로 구분) 자세한 내용은 [Enterprise 전술을 참조하세요.](https://attack.mitre.org/tactics/enterprise/) **선택 사항** MITRE 기술을 사용할 때 범주에 값을 추가하는 것이 좋습니다.
