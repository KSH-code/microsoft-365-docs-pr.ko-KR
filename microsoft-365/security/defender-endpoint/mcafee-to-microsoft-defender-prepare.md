...
|바이러스 검사 |macOS: <br/>- 10.15(카탈로나)<br/>- 10.14(Mojave) <br/>- 10.13(High Sierra) |[MacOS의 끝점용 Microsoft Defender: 네트워크 연결](microsoft-defender-endpoint-mac.md#network-connections) |
