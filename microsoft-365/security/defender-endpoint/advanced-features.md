...
이 기능을 사용하려면 장치가 버전 1709 이상에서 Windows 10 실행되고 있어야 합니다. 또한 맬웨어 방지 플랫폼의 차단 모드 및 버전 4.18.1906.3 이상에서도 네트워크 보호 기능을 사용할 수 [있습니다. KB 4052623을](https://go.microsoft.com/fwlink/?linkid=2099834)참조하세요.
...
Microsoft Threat Expert 구성 요소 2개 중 대상 공격 알림은 일반 공급 중입니다. 전문가 요구 시 기능은 여전히 미리 보기 상태입니다. 미리 보기를 신청하고 응용 프로그램이 승인된 경우 전문가 요구 시 기능만 사용할 수 있습니다. 끝점 포털의 경고 대시보드를 Microsoft 위협 전문가 및 구성하는 경우 전자 메일을 통해 대상 공격 알림을 받을 수 있습니다.
