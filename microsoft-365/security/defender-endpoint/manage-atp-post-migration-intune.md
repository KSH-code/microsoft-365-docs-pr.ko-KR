...
|**필요한 경우 제외를 지정합니다Microsoft Defender 바이러스 백신** <p> *일반적으로 제외를 적용할 필요는 없습니다. Microsoft Defender 바이러스 백신 운영 체제 동작 및 일반적인 관리 파일(예: 엔터프라이즈 관리, 데이터베이스 관리 및 기타 엔터프라이즈 시나리오에 사용되는 파일)을 기반으로 하는 여러 자동 제외가 포함됩니다.*|[현재 지원되는 Enterprise 실행 중인 컴퓨터의 바이러스 검사 권장 Windows](https://support.microsoft.com/help/822158/virus-scanning-recommendations-for-enterprise-computers) <p> [장치 제한: Microsoft Defender 바이러스 백신 및 Windows 10 11개 Windows 제외](/mem/intune/configuration/device-restrictions-windows-10#microsoft-defender-antivirus-exclusions) <p> [Microsoft Defender 바이러스 백신 또는 2019 또는 2022에 대한 Windows Server 2016 제외 구성](/windows/security/threat-protection/microsoft-defender-antivirus/configure-server-exclusions-microsoft-defender-antivirus)|
...
|**암호화 및 BitLocker를** 구성하여 암호화를 실행하는 조직의 장치에 대한 정보를 Windows|[끝점 보호: Windows 암호화](/mem/intune/protect/endpoint-protection-windows-10#windows-encryption) <p> [11개 Windows 10 및 Windows용 BitLocker](/windows/security/information-protection/bitlocker/bitlocker-overview)|
