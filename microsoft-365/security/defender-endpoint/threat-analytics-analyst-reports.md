...
끝점용 Microsoft Defender에 온보딩된 장치에 대해 EDR [경고가 발생했습니다.](onboard-configure.md) 이러한 경고는 일반적으로 Microsoft Defender for Endpoint 센서 및 기타 끝점 기능(예: 바이러스 백신, 네트워크 보호, 변조 방지)에서 수집한 보안 신호와 강력한 신호 원본 역할을 합니다.
