...
## <a name="summary"></a><span data-ttu-id="6bd1d-109">요약</span><span class="sxs-lookup"><span data-stu-id="6bd1d-109">Summary</span></span>
...
<span data-ttu-id="6bd1d-121">구성 *프로필의 antivirusEngine* 섹션은 끝점용 Microsoft Defender의 바이러스 백신 구성 요소의 기본 설정을 관리하는 데 사용됩니다.</span><span class="sxs-lookup"><span data-stu-id="6bd1d-121">The *antivirusEngine* section of the configuration profile is used to manage the preferences of the antivirus component of Microsoft Defender for Endpoint.</span></span>
...
|<span data-ttu-id="6bd1d-151">섹션</span><span class="sxs-lookup"><span data-stu-id="6bd1d-151">Section</span></span>|<span data-ttu-id="6bd1d-152">값</span><span class="sxs-lookup"><span data-stu-id="6bd1d-152">Value</span></span>|
|:---|:---|
...
| <span data-ttu-id="6bd1d-188">**Data type**</span><span class="sxs-lookup"><span data-stu-id="6bd1d-188">**Data type**</span></span> | <span data-ttu-id="6bd1d-189">사전(중첩된 기본 설정)</span><span class="sxs-lookup"><span data-stu-id="6bd1d-189">Dictionary (nested preference)</span></span> |
...
<span data-ttu-id="6bd1d-227">폴더</span><span class="sxs-lookup"><span data-stu-id="6bd1d-227">Folder</span></span> | <span data-ttu-id="6bd1d-228">지정된 폴더에 있는 모든 파일(재발성)</span><span class="sxs-lookup"><span data-stu-id="6bd1d-228">All files under the specified folder (recursively)</span></span> | `/var/log/`<br/>`/var/*/`
...
##### <a name="file-extension-excluded-from-the-scan"></a><span data-ttu-id="6bd1d-256">검사에서 제외된 파일 확장명</span><span class="sxs-lookup"><span data-stu-id="6bd1d-256">File extension excluded from the scan</span></span>
...
#### <a name="disallowed-threat-actions"></a><span data-ttu-id="6bd1d-293">위협 작업 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="6bd1d-293">Disallowed threat actions</span></span>
...
##### <a name="action-to-take"></a><span data-ttu-id="6bd1d-331">수행할 작업</span><span class="sxs-lookup"><span data-stu-id="6bd1d-331">Action to take</span></span>
...
#### <a name="antivirus-scan-history-retention-in-days"></a><span data-ttu-id="6bd1d-364">바이러스 백신 검사 기록 보존(일)</span><span class="sxs-lookup"><span data-stu-id="6bd1d-364">Antivirus scan history retention (in days)</span></span>
...
|<span data-ttu-id="6bd1d-397">섹션</span><span class="sxs-lookup"><span data-stu-id="6bd1d-397">Section</span></span>|<span data-ttu-id="6bd1d-398">값</span><span class="sxs-lookup"><span data-stu-id="6bd1d-398">Value</span></span>|
|:---|:---|
...
#### <a name="enable--disable-automatic-sample-submissions"></a><span data-ttu-id="6bd1d-432">자동 샘플 제출 사용/사용 안 하도록 설정</span><span class="sxs-lookup"><span data-stu-id="6bd1d-432">Enable / disable automatic sample submissions</span></span>
...
#### <a name="show--hide-status-menu-icon"></a><span data-ttu-id="6bd1d-467">상태 메뉴 아이콘 표시/숨기기</span><span class="sxs-lookup"><span data-stu-id="6bd1d-467">Show / hide status menu icon</span></span>
...
#### <a name="device-tags"></a><span data-ttu-id="6bd1d-504">장치 태그</span><span class="sxs-lookup"><span data-stu-id="6bd1d-504">Device tags</span></span>
...
### <a name="property-list-for-jamf-configuration-profile"></a><span data-ttu-id="6bd1d-554">JAMF 구성 프로필의 속성 목록</span><span class="sxs-lookup"><span data-stu-id="6bd1d-554">Property list for JAMF configuration profile</span></span>
...
### <a name="intune-profile"></a><span data-ttu-id="6bd1d-555">Intune 프로필</span><span class="sxs-lookup"><span data-stu-id="6bd1d-555">Intune profile</span></span>
...
## <a name="property-list-validation"></a><span data-ttu-id="6bd1d-556">속성 목록 유효성 검사</span><span class="sxs-lookup"><span data-stu-id="6bd1d-556">Property list validation</span></span>

<span data-ttu-id="6bd1d-557">속성 목록은 유효한 *.plist 파일입니다.*</span><span class="sxs-lookup"><span data-stu-id="6bd1d-557">The property list must be a valid *.plist* file.</span></span> <span data-ttu-id="6bd1d-558">다음을 실행하여 확인할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="6bd1d-558">This can be checked by executing:</span></span>
...
<span data-ttu-id="6bd1d-559">파일이 잘 형식이면 위의 명령은 의 종료 코드를 `OK` 출력하고 `0` 반환합니다.</span><span class="sxs-lookup"><span data-stu-id="6bd1d-559">If the file is well-formed, the above command outputs `OK` and returns an exit code of `0`.</span></span> <span data-ttu-id="6bd1d-560">그렇지 않으면 문제를 설명하는 오류가 표시되고 명령은 의 종료 코드를 `1` 반환합니다.</span><span class="sxs-lookup"><span data-stu-id="6bd1d-560">Otherwise, an error that describes the issue is displayed and the command returns an exit code of `1`.</span></span>

## <a name="configuration-profile-deployment"></a><span data-ttu-id="6bd1d-561">구성 프로필 배포</span><span class="sxs-lookup"><span data-stu-id="6bd1d-561">Configuration profile deployment</span></span>

<span data-ttu-id="6bd1d-562">엔터프라이즈의 구성 프로필을 작성한 후 엔터프라이즈에서 사용하는 관리 콘솔을 통해 배포할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="6bd1d-562">Once you've built the configuration profile for your enterprise, you can deploy it through the management console that your enterprise is using.</span></span> <span data-ttu-id="6bd1d-563">다음 섹션에서는 JAMF 및 Intune을 사용하여 이 프로필을 배포하는 방법에 대한 지침을 제공합니다.</span><span class="sxs-lookup"><span data-stu-id="6bd1d-563">The following sections provide instructions on how to deploy this profile using JAMF and Intune.</span></span>

### <a name="jamf-deployment"></a><span data-ttu-id="6bd1d-564">JAMF 배포</span><span class="sxs-lookup"><span data-stu-id="6bd1d-564">JAMF deployment</span></span>

<span data-ttu-id="6bd1d-565">JAMF 콘솔에서 컴퓨터 구성 프로필을 열고 사용할 구성 프로필로 이동한 다음 사용자 지정 프로필을  >   **설정.**</span><span class="sxs-lookup"><span data-stu-id="6bd1d-565">From the JAMF console, open **Computers** > **Configuration Profiles**, navigate to the configuration profile you'd like to use, then select **Custom Settings**.</span></span> <span data-ttu-id="6bd1d-566">기본 설정 도메인으로 항목을 만들고 앞에서 생성한 `com.microsoft.wdav` *.plist를* 업로드합니다.</span><span class="sxs-lookup"><span data-stu-id="6bd1d-566">Create an entry with `com.microsoft.wdav` as the preference domain and upload the *.plist* produced earlier.</span></span>

>[!CAUTION]
><span data-ttu-id="6bd1d-567">올바른 기본 설정 도메인( )을 입력해야 합니다. 그렇지 않으면 끝점용 Microsoft Defender에서 기본 설정이 `com.microsoft.wdav` 인식되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="6bd1d-567">You must enter the correct preference domain (`com.microsoft.wdav`); otherwise, the preferences will not be recognized by Microsoft Defender for Endpoint.</span></span>

### <a name="intune-deployment"></a><span data-ttu-id="6bd1d-568">Intune 배포</span><span class="sxs-lookup"><span data-stu-id="6bd1d-568">Intune deployment</span></span>

1. <span data-ttu-id="6bd1d-569">장치 **구성 관리를**  >  **니다.**</span><span class="sxs-lookup"><span data-stu-id="6bd1d-569">Open **Manage** > **Device configuration**.</span></span> <span data-ttu-id="6bd1d-570">프로필 **만들기**  >  **를**  >  **선택합니다.**</span><span class="sxs-lookup"><span data-stu-id="6bd1d-570">Select **Manage** > **Profiles** > **Create Profile**.</span></span>

2. <span data-ttu-id="6bd1d-571">프로필 이름을 선택하세요.</span><span class="sxs-lookup"><span data-stu-id="6bd1d-571">Choose a name for the profile.</span></span> <span data-ttu-id="6bd1d-572">**Platform=macOS를** **프로필 유형=사용자 지정으로 변경합니다.**</span><span class="sxs-lookup"><span data-stu-id="6bd1d-572">Change **Platform=macOS** to **Profile type=Custom**.</span></span> <span data-ttu-id="6bd1d-573">구성을 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="6bd1d-573">Select Configure.</span></span>

3. <span data-ttu-id="6bd1d-574">앞에서 생성한 .plist를 로 `com.microsoft.wdav.xml` 저장합니다.</span><span class="sxs-lookup"><span data-stu-id="6bd1d-574">Save the .plist produced earlier as `com.microsoft.wdav.xml`.</span></span>

4. <span data-ttu-id="6bd1d-575">사용자 `com.microsoft.wdav` 지정 구성 프로필 이름으로 **를 입력합니다.**</span><span class="sxs-lookup"><span data-stu-id="6bd1d-575">Enter `com.microsoft.wdav` as the **custom configuration profile name**.</span></span>

5. <span data-ttu-id="6bd1d-576">구성 프로필을 열고 파일을 `com.microsoft.wdav.xml` 업로드합니다.</span><span class="sxs-lookup"><span data-stu-id="6bd1d-576">Open the configuration profile and upload the `com.microsoft.wdav.xml` file.</span></span> <span data-ttu-id="6bd1d-577">이 파일은 3단계에서 만들어졌습니다.</span><span class="sxs-lookup"><span data-stu-id="6bd1d-577">(This file was created in step 3.)</span></span>

6. <span data-ttu-id="6bd1d-578">**확인** 을 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="6bd1d-578">Select **OK**.</span></span>

7. <span data-ttu-id="6bd1d-579">배정   >  **관리를 선택합니다.**</span><span class="sxs-lookup"><span data-stu-id="6bd1d-579">Select **Manage** > **Assignments**.</span></span> <span data-ttu-id="6bd1d-580">포함 **탭에서** 모든 사용자 및 모든 & **할당을 선택합니다.**</span><span class="sxs-lookup"><span data-stu-id="6bd1d-580">In the **Include** tab, select **Assign to All Users & All devices**.</span></span>

>[!CAUTION]
><span data-ttu-id="6bd1d-581">올바른 사용자 지정 구성 프로필 이름을 입력해야 합니다. 그렇지 않으면 이러한 기본 설정이 끝점용 Microsoft Defender에서 인식되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="6bd1d-581">You must enter the correct custom configuration profile name; otherwise, these preferences will not be recognized by Microsoft Defender for Endpoint.</span></span>

## <a name="resources"></a><span data-ttu-id="6bd1d-582">리소스</span><span class="sxs-lookup"><span data-stu-id="6bd1d-582">Resources</span></span>

- [<span data-ttu-id="6bd1d-583">구성 프로필 참조(Apple 개발자 문서)</span><span class="sxs-lookup"><span data-stu-id="6bd1d-583">Configuration Profile Reference (Apple developer documentation)</span></span>](https://developer.apple.com/business/documentation/Configuration-Profile-Reference.pdf)
