...
[Azure 규정 준수 서비스는](/azure/compliance/#compliance-offerings) 이러한 인증에 대한 자세한 정보를 제공합니다. 끝점용 Microsoft Defender의 모든 인증 아티팩트는 연결된 각 Azure 인증 보고서 내에서 Microsoft의 [Service Trust Portal에서](https://servicetrust.microsoft.com/) 찾을 수 있습니다.
