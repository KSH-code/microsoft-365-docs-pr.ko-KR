...
<span data-ttu-id="1e5a2-111">개별 디바이스의 이벤트 뷰어에서 이벤트 [ID를](https://msdn.microsoft.com/library/aa745633(v=bts.10).aspx) 검토할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-111">You can review event IDs in the [Event Viewer](https://msdn.microsoft.com/library/aa745633(v=bts.10).aspx) on individual devices.</span></span>
...
<tr>
<td><span data-ttu-id="1e5a2-131">2 </span><span class="sxs-lookup"><span data-stu-id="1e5a2-131">2</span></span></td>
...
<td><span data-ttu-id="1e5a2-153">장치가 올바르게 온보드되지 않았고 포털에 보고되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-153">The device didn't onboard correctly and won't be reporting to the portal.</span></span></td>
...
<tr>
<td><span data-ttu-id="1e5a2-176">9 </span><span class="sxs-lookup"><span data-stu-id="1e5a2-176">9</span></span></td>
...
<td><span data-ttu-id="1e5a2-199">서비스가 기본 구성을 적용할 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-199">Service was unable to apply the default configuration.</span></span></td>
...
<tr>
<td><span data-ttu-id="1e5a2-219">18 </span><span class="sxs-lookup"><span data-stu-id="1e5a2-219">18</span></span></td>
...
<td><span data-ttu-id="1e5a2-242">Microsoft Defender for Endpoint Service가 레지스트리에서 등록 상태를 설정하지 못했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-242">Microsoft Defender for Endpoint service failed to set the onboarding status in the registry.</span></span> <span data-ttu-id="1e5a2-243">오류 코드: <code>variable</code> .</span><span class="sxs-lookup"><span data-stu-id="1e5a2-243">Failure code: <code>variable</code>.</span></span></td>
...
<td><span data-ttu-id="1e5a2-285">Windows 원격 분석 서비스 에서 <a href="troubleshoot-onboarding.md#ensure-the-diagnostic-data-service-is-enabled" data-raw-source="[Check for errors with the Windows telemetry service](troubleshoot-onboarding.md#ensure-the-diagnostic-data-service-is-enabled)">오류를 검사합니다.</a></span><span class="sxs-lookup"><span data-stu-id="1e5a2-285"><a href="troubleshoot-onboarding.md#ensure-the-diagnostic-data-service-is-enabled" data-raw-source="[Check for errors with the Windows telemetry service](troubleshoot-onboarding.md#ensure-the-diagnostic-data-service-is-enabled)">Check for errors with the Windows telemetry service</a>.</span></span></td>
</tr>
<tr>
...
<td><span data-ttu-id="1e5a2-326">장치가 데이터 통신/유료 네트워크를 사용하고 있으며 서버에 자주 연결하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-326">The device is using a metered/paid network and will be contacting the server less frequently.</span></span></td>
...
<td><span data-ttu-id="1e5a2-351">이 오류가 계속되면 지원에 문의합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-351">If this error persists, contact Support.</span></span></td>
</tr>
<tr>
...
<tr>
   ...
   <td><span data-ttu-id="1e5a2-424">보안 ETW 자동 로거를 제거하지 못했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-424">Failed to remove the Secure ETW autologger.</span></span> <span data-ttu-id="1e5a2-425">오류 코드: %1</span><span class="sxs-lookup"><span data-stu-id="1e5a2-425">Failure code: %1</span></span></td>
...
<tr>
   ...
   <td><span data-ttu-id="1e5a2-447">연결된 사용자 환경 및 원격 분석(diagtrack) 서비스를 시작하지 못했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-447">Connected User Experiences and Telemetry (diagtrack) service failed to start.</span></span> <span data-ttu-id="1e5a2-448">끝점 원격 분석용 Microsoft Defender가 아닌 다른 원격 분석은 이 컴퓨터로부터 전송되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-448">Non-Microsoft Defender for Endpoint telemetry won't be sent from this machine.</span></span></td>
   <td><span data-ttu-id="1e5a2-449">이벤트 로그에서 Microsoft-Windows-UniversalTelemetryClient/Operational 문제 해결 힌트를 찾아 봐야 합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-449">Look for more troubleshooting hints in the event log: Microsoft-Windows-UniversalTelemetryClient/Operational.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-450">63</span><span class="sxs-lookup"><span data-stu-id="1e5a2-450">63</span></span></td>
   <td><span data-ttu-id="1e5a2-451">외부 서비스의 시작 유형을 업데이트합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-451">Updating the start type of external service.</span></span> <span data-ttu-id="1e5a2-452">이름: %1, 실제 시작 유형: %2, 예상 시작 유형: %3, 종료 코드: %4</span><span class="sxs-lookup"><span data-stu-id="1e5a2-452">Name: %1, actual start type: %2, expected start type: %3, exit code: %4</span></span></td>
   <td><span data-ttu-id="1e5a2-453">외부 서비스의 시작 유형이 업데이트되었습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-453">Updated start type of the external service.</span></span></td>
   <td><span data-ttu-id="1e5a2-454">정상 작동 알림 필요한 작업이 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-454">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-455">64</span><span class="sxs-lookup"><span data-stu-id="1e5a2-455">64</span></span></td>
   <td><span data-ttu-id="1e5a2-456">중지된 외부 서비스 시작</span><span class="sxs-lookup"><span data-stu-id="1e5a2-456">Starting stopped external service.</span></span> <span data-ttu-id="1e5a2-457">이름: %1, 종료 코드: %2</span><span class="sxs-lookup"><span data-stu-id="1e5a2-457">Name: %1, exit code: %2</span></span></td>
   <td><span data-ttu-id="1e5a2-458">외부 서비스 시작</span><span class="sxs-lookup"><span data-stu-id="1e5a2-458">Starting an external service.</span></span></td>
   <td><span data-ttu-id="1e5a2-459">정상 작동 알림 필요한 작업이 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-459">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-460">65</span><span class="sxs-lookup"><span data-stu-id="1e5a2-460">65</span></span></td>
   <td><span data-ttu-id="1e5a2-461">Microsoft 보안 이벤트 구성 요소 미니 필터 드라이버를 로드하지 못했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-461">Failed to load Microsoft Security Events Component Minifilter driver.</span></span> <span data-ttu-id="1e5a2-462">오류 코드: %1</span><span class="sxs-lookup"><span data-stu-id="1e5a2-462">Failure code: %1</span></span></td>
   <td><span data-ttu-id="1e5a2-463">파일 MsSecFlt.sys 로드하지 못했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-463">Failed to load MsSecFlt.sys filesystem minifilter.</span></span></td>
   <td><span data-ttu-id="1e5a2-464">장치를 다시부팅합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-464">Reboot the device.</span></span> <span data-ttu-id="1e5a2-465">이 오류가 계속되면 지원에 문의합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-465">If this error persists, contact Support.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-466">66</span><span class="sxs-lookup"><span data-stu-id="1e5a2-466">66</span></span></td>
   <td><span data-ttu-id="1e5a2-467">정책 업데이트: 대기 시간 모드 - %1</span><span class="sxs-lookup"><span data-stu-id="1e5a2-467">Policy update: Latency mode - %1</span></span></td>
   <td><span data-ttu-id="1e5a2-468">C&C 연결 빈도 정책이 업데이트되었습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-468">The C&C connection frequency policy was updated.</span></span></td>
   <td><span data-ttu-id="1e5a2-469">정상 작동 알림 필요한 작업이 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-469">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-470">68</span><span class="sxs-lookup"><span data-stu-id="1e5a2-470">68</span></span></td>
   <td><span data-ttu-id="1e5a2-471">서비스의 시작 유형이 예기치 않습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-471">The start type of the service is unexpected.</span></span> <span data-ttu-id="1e5a2-472">서비스 이름: %1, 실제 시작 유형: %2, 예상 시작 유형: %3</span><span class="sxs-lookup"><span data-stu-id="1e5a2-472">Service name: %1, actual start type: %2, expected start type: %3</span></span></td>
   <td><span data-ttu-id="1e5a2-473">예기치 않은 외부 서비스 시작 유형입니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-473">Unexpected external service start type.</span></span></td>
   <td><span data-ttu-id="1e5a2-474">외부 서비스 시작 유형을 수정합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-474">Fix the external service start type.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-475">69</span><span class="sxs-lookup"><span data-stu-id="1e5a2-475">69</span></span></td>
   <td><span data-ttu-id="1e5a2-476">서비스가 중지되었습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-476">The service is stopped.</span></span> <span data-ttu-id="1e5a2-477">서비스 이름: %1</span><span class="sxs-lookup"><span data-stu-id="1e5a2-477">Service name: %1</span></span></td>
   <td><span data-ttu-id="1e5a2-478">외부 서비스가 중지되었습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-478">The external service is stopped.</span></span></td>
   <td><span data-ttu-id="1e5a2-479">외부 서비스를 시작 합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-479">Start the external service.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-480">70</span><span class="sxs-lookup"><span data-stu-id="1e5a2-480">70</span></span></td>
   <td><span data-ttu-id="1e5a2-481">정책 업데이트: 샘플 수집 허용 - %1</span><span class="sxs-lookup"><span data-stu-id="1e5a2-481">Policy update: Allow sample collection - %1</span></span></td>
   <td><span data-ttu-id="1e5a2-482">샘플 수집 정책이 업데이트되었습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-482">The sample collection policy was updated.</span></span></td>
   <td><span data-ttu-id="1e5a2-483">정상 작동 알림 필요한 작업이 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-483">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-484">71</span><span class="sxs-lookup"><span data-stu-id="1e5a2-484">71</span></span></td>
   <td><span data-ttu-id="1e5a2-485">명령 실행 성공: %1</span><span class="sxs-lookup"><span data-stu-id="1e5a2-485">Succeeded to run command: %1</span></span></td>
   <td><span data-ttu-id="1e5a2-486">명령이 성공적으로 실행된 경우</span><span class="sxs-lookup"><span data-stu-id="1e5a2-486">The command was executed successfully.</span></span></td>
   <td><span data-ttu-id="1e5a2-487">정상 작동 알림 필요한 작업이 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-487">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-488">72</span><span class="sxs-lookup"><span data-stu-id="1e5a2-488">72</span></span></td>
   <td><span data-ttu-id="1e5a2-489">첫 번째 전체 컴퓨터 프로필 보고서를 보내려고 했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-489">Tried to send first full machine profile report.</span></span> <span data-ttu-id="1e5a2-490">결과 코드: %1</span><span class="sxs-lookup"><span data-stu-id="1e5a2-490">Result code: %1</span></span></td>
   <td><span data-ttu-id="1e5a2-491">정보 전용입니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-491">Informational only.</span></span></td>
   <td><span data-ttu-id="1e5a2-492">정상 작동 알림 필요한 작업이 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-492">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-493">73</span><span class="sxs-lookup"><span data-stu-id="1e5a2-493">73</span></span></td>
   <td><span data-ttu-id="1e5a2-494">플랫폼 시작 센스: %1</span><span class="sxs-lookup"><span data-stu-id="1e5a2-494">Sense starting for platform: %1</span></span></td>
   <td><span data-ttu-id="1e5a2-495">정보 전용입니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-495">Informational only.</span></span></td>
   <td><span data-ttu-id="1e5a2-496">정상 작동 알림 필요한 작업이 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-496">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-497">74</span><span class="sxs-lookup"><span data-stu-id="1e5a2-497">74</span></span></td>
   <td><span data-ttu-id="1e5a2-498">레지스트리의 장치 태그가 길이 제한을 초과합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-498">Device tag in registry exceeds length limit.</span></span> <span data-ttu-id="1e5a2-499">태그 이름: %2.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-499">Tag name: %2.</span></span> <span data-ttu-id="1e5a2-500">길이 제한: %1.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-500">Length limit: %1.</span></span></td>
   <td><span data-ttu-id="1e5a2-501">장치 태그가 길이 제한을 초과합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-501">The device tag exceeds the length limit.</span></span></td>
   <td><span data-ttu-id="1e5a2-502">더 짧은 장치 태그를 사용합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-502">Use a shorter device tag.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-503">81</span><span class="sxs-lookup"><span data-stu-id="1e5a2-503">81</span></span></td>
   <td><span data-ttu-id="1e5a2-504">Advanced Threat Protection ETW Windows Defender 만들지 못했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-504">Failed to create Windows Defender Advanced Threat Protection ETW autologger.</span></span> <span data-ttu-id="1e5a2-505">오류 코드: %1</span><span class="sxs-lookup"><span data-stu-id="1e5a2-505">Failure code: %1</span></span></td>
   <td><span data-ttu-id="1e5a2-506">ETW 세션을 만들지 못했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-506">Failed to create the ETW session.</span></span></td>
   <td><span data-ttu-id="1e5a2-507">장치를 다시부팅합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-507">Reboot the device.</span></span> <span data-ttu-id="1e5a2-508">이 오류가 계속되면 지원에 문의합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-508">If this error persists, contact Support.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-509">82</span><span class="sxs-lookup"><span data-stu-id="1e5a2-509">82</span></span></td>
   <td><span data-ttu-id="1e5a2-510">Advanced Threat Protection ETW Windows Defender 제거하지 못했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-510">Failed to remove Windows Defender Advanced Threat Protection ETW autologger.</span></span> <span data-ttu-id="1e5a2-511">오류 코드: %1</span><span class="sxs-lookup"><span data-stu-id="1e5a2-511">Failure code: %1</span></span></td>
   <td><span data-ttu-id="1e5a2-512">ETW 세션을 삭제하지 못했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-512">Failed to delete the ETW session.</span></span></td>
   <td><span data-ttu-id="1e5a2-513">고객 지원에 문의합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-513">Contact Support.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-514">84</span><span class="sxs-lookup"><span data-stu-id="1e5a2-514">84</span></span></td>
   <td><span data-ttu-id="1e5a2-515">바이러스 Windows Defender 모드로 설정</span><span class="sxs-lookup"><span data-stu-id="1e5a2-515">Set Windows Defender Antivirus running mode.</span></span> <span data-ttu-id="1e5a2-516">수동 모드 강제: %1, 결과 코드: %2.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-516">Force passive mode: %1, result code: %2.</span></span></td>
   <td><span data-ttu-id="1e5a2-517">Defender 실행 모드(활성 또는 수동)를 설정합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-517">Set defender running mode (active or passive).</span></span></td>
   <td><span data-ttu-id="1e5a2-518">정상 작동 알림 필요한 작업이 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-518">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-519">85</span><span class="sxs-lookup"><span data-stu-id="1e5a2-519">85</span></span></td>
   <td><span data-ttu-id="1e5a2-520">Advanced Threat Protection Windows Defender 트리거하지 못했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-520">Failed to trigger Windows Defender Advanced Threat Protection executable.</span></span> <span data-ttu-id="1e5a2-521">오류 코드: %1</span><span class="sxs-lookup"><span data-stu-id="1e5a2-521">Failure code: %1</span></span></td>
   <td><span data-ttu-id="1e5a2-522">센스IR 실행을 실행하지 못했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-522">Starring SenseIR executable failed.</span></span></td>
   <td><span data-ttu-id="1e5a2-523">장치를 다시부팅합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-523">Reboot the device.</span></span> <span data-ttu-id="1e5a2-524">이 오류가 계속되면 지원에 문의합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-524">If this error persists, contact Support.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-525">86</span><span class="sxs-lookup"><span data-stu-id="1e5a2-525">86</span></span></td>
   <td><span data-ttu-id="1e5a2-526">다시 시작해야 하는 외부 서비스가 중지되었습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-526">Starting again stopped external service that should be up.</span></span> <span data-ttu-id="1e5a2-527">이름: %1, 종료 코드: %2</span><span class="sxs-lookup"><span data-stu-id="1e5a2-527">Name: %1, exit code: %2</span></span></td>
   <td><span data-ttu-id="1e5a2-528">외부 서비스를 다시 시작하십시오.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-528">Starting the external service again.</span></span></td>
   <td><span data-ttu-id="1e5a2-529">정상 작동 알림 필요한 작업이 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-529">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-530">87</span><span class="sxs-lookup"><span data-stu-id="1e5a2-530">87</span></span></td>
   <td><span data-ttu-id="1e5a2-531">외부 서비스를 시작할 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-531">Cannot start the external service.</span></span> <span data-ttu-id="1e5a2-532">이름: %1</span><span class="sxs-lookup"><span data-stu-id="1e5a2-532">Name: %1</span></span></td>
   <td><span data-ttu-id="1e5a2-533">외부 서비스를 시작하지 못했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-533">Failed to start the external service.</span></span></td>
   <td><span data-ttu-id="1e5a2-534">고객 지원에 문의합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-534">Contact Support.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-535">88</span><span class="sxs-lookup"><span data-stu-id="1e5a2-535">88</span></span></td>
   <td><span data-ttu-id="1e5a2-536">외부 서비스의 시작 유형을 다시 업데이트합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-536">Updating the start type of external service again.</span></span> <span data-ttu-id="1e5a2-537">이름: %1, 실제 시작 유형: %2, 예상 시작 유형: %3, 종료 코드: %4</span><span class="sxs-lookup"><span data-stu-id="1e5a2-537">Name: %1, actual start type: %2, expected start type: %3, exit code: %4</span></span></td>
   <td><span data-ttu-id="1e5a2-538">외부 서비스의 시작 유형을 업데이트했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-538">Updated the start type of the external service.</span></span></td>
   <td><span data-ttu-id="1e5a2-539">정상 작동 알림 필요한 작업이 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-539">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-540">89</span><span class="sxs-lookup"><span data-stu-id="1e5a2-540">89</span></span></td>
   <td><span data-ttu-id="1e5a2-541">외부 서비스의 시작 유형을 업데이트할 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-541">Cannot update the start type of external service.</span></span> <span data-ttu-id="1e5a2-542">이름: %1, 실제 시작 유형: %2, 예상 시작 유형: %3</span><span class="sxs-lookup"><span data-stu-id="1e5a2-542">Name: %1, actual start type: %2, expected start type: %3</span></span></td>
   <td><span data-ttu-id="1e5a2-543">외부 서비스의 시작 유형을 업데이트할 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-543">Can't update the start type of the external service.</span></span></td>
   <td><span data-ttu-id="1e5a2-544">고객 지원에 문의합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-544">Contact Support.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-545">90</span><span class="sxs-lookup"><span data-stu-id="1e5a2-545">90</span></span></td>
   <td><span data-ttu-id="1e5a2-546">지리적 지역 %1의 클라우드 서비스에 연결하도록 System Guard 런타임 모니터를 구성하지 못했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-546">Failed to configure System Guard Runtime Monitor to connect to cloud service in geo-region %1.</span></span> <span data-ttu-id="1e5a2-547">오류 코드: %2</span><span class="sxs-lookup"><span data-stu-id="1e5a2-547">Failure code: %2</span></span></td>
   <td><span data-ttu-id="1e5a2-548">System Guard 런타임 모니터는 클라우드 서비스에 의거 데이터를 전송하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-548">System Guard Runtime Monitor won't send attestation data to the cloud service.</span></span></td>
   <td><span data-ttu-id="1e5a2-549">등록 경로에 대한 사용 권한을 검사합니다. "HKLM\Software\Microsoft\Windows\CurrentVersion\Sgrm".</span><span class="sxs-lookup"><span data-stu-id="1e5a2-549">Check the permissions on register path: "HKLM\Software\Microsoft\Windows\CurrentVersion\Sgrm".</span></span> <span data-ttu-id="1e5a2-550">문제가 없는 경우 지원에 문의합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-550">If no issues spotted, contact Support.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-551">91</span><span class="sxs-lookup"><span data-stu-id="1e5a2-551">91</span></span></td>
   <td><span data-ttu-id="1e5a2-552">System Guard 런타임 모니터 지리적 지역 정보를 제거하지 못했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-552">Failed to remove System Guard Runtime Monitor geo-region information.</span></span> <span data-ttu-id="1e5a2-553">오류 코드: %1</span><span class="sxs-lookup"><span data-stu-id="1e5a2-553">Failure code: %1</span></span></td>
   <td><span data-ttu-id="1e5a2-554">System Guard 런타임 모니터는 클라우드 서비스에 의거 데이터를 전송하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-554">System Guard Runtime Monitor won't send attestation data to the cloud service.</span></span></td>
   <td><span data-ttu-id="1e5a2-555">등록 경로에 대한 사용 권한을 검사합니다. "HKLM\Software\Microsoft\Windows\CurrentVersion\Sgrm".</span><span class="sxs-lookup"><span data-stu-id="1e5a2-555">Check the permissions on register path: "HKLM\Software\Microsoft\Windows\CurrentVersion\Sgrm".</span></span> <span data-ttu-id="1e5a2-556">문제가 없는 경우 지원에 문의합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-556">If no issues spotted, contact Support.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-557">92</span><span class="sxs-lookup"><span data-stu-id="1e5a2-557">92</span></span></td>
   <td><span data-ttu-id="1e5a2-558">데이터 할당량 초과로 센서 사이버 데이터 할당량 보내기 중지</span><span class="sxs-lookup"><span data-stu-id="1e5a2-558">Stopping sending sensor cyber data quota because data quota is exceeded.</span></span> <span data-ttu-id="1e5a2-559">할당량 기간이 지나면 보내기 다시 시작됩니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-559">Will resume sending once quota period passes.</span></span> <span data-ttu-id="1e5a2-560">상태 마스크: %1</span><span class="sxs-lookup"><span data-stu-id="1e5a2-560">State Mask: %1</span></span></td>
   <td><span data-ttu-id="1e5a2-561">제한 한도를 초과합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-561">Exceed throttling limit.</span></span></td>
   <td><span data-ttu-id="1e5a2-562">정상 작동 알림 필요한 작업이 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-562">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-563">93</span><span class="sxs-lookup"><span data-stu-id="1e5a2-563">93</span></span></td>
   <td><span data-ttu-id="1e5a2-564">센서 사이버 데이터 보내기 다시.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-564">Resuming sending sensor cyber data.</span></span> <span data-ttu-id="1e5a2-565">상태 마스크: %1</span><span class="sxs-lookup"><span data-stu-id="1e5a2-565">State Mask: %1</span></span></td>
   <td><span data-ttu-id="1e5a2-566">사이버 데이터 제출을 다시 시작합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-566">Resume cyber data submission.</span></span></td>
   <td><span data-ttu-id="1e5a2-567">정상 작동 알림 필요한 작업이 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-567">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-568">94</span><span class="sxs-lookup"><span data-stu-id="1e5a2-568">94</span></span></td>
   <td><span data-ttu-id="1e5a2-569">Windows Defender Advanced Threat Protection 실행이 시작된 경우</span><span class="sxs-lookup"><span data-stu-id="1e5a2-569">Windows Defender Advanced Threat Protection executable has started</span></span></td>
   <td><span data-ttu-id="1e5a2-570">SenseCE 실행이 시작된 경우</span><span class="sxs-lookup"><span data-stu-id="1e5a2-570">The SenseCE executable has started.</span></span></td>
   <td><span data-ttu-id="1e5a2-571">정상 작동 알림 필요한 작업이 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-571">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-572">95</span><span class="sxs-lookup"><span data-stu-id="1e5a2-572">95</span></span></td>
   <td><span data-ttu-id="1e5a2-573">Windows Defender Advanced Threat Protection 실행이 종료된 경우</span><span class="sxs-lookup"><span data-stu-id="1e5a2-573">Windows Defender Advanced Threat Protection executable has ended</span></span></td>
   <td><span data-ttu-id="1e5a2-574">SenseCE 실행이 끝났습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-574">The SenseCE executable has ended.</span></span></td>
   <td><span data-ttu-id="1e5a2-575">정상 작동 알림 필요한 작업이 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-575">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-576">96</span><span class="sxs-lookup"><span data-stu-id="1e5a2-576">96</span></span></td>
   <td><span data-ttu-id="1e5a2-577">Windows Defender Init가 호출했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-577">Windows Defender Advanced Threat Protection Init has called.</span></span> <span data-ttu-id="1e5a2-578">결과 코드: %2</span><span class="sxs-lookup"><span data-stu-id="1e5a2-578">Result code: %2</span></span></td>
   <td><span data-ttu-id="1e5a2-579">SenseCE 실행을 MCE 초기화라고 합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-579">The SenseCE executable has called MCE initialization.</span></span></td>
   <td><span data-ttu-id="1e5a2-580">정상 작동 알림 필요한 작업이 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-580">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-581">97</span><span class="sxs-lookup"><span data-stu-id="1e5a2-581">97</span></span></td>
   <td><span data-ttu-id="1e5a2-582">DLP 시나리오를 위해 클라우드에 대한 연결 문제가 있습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-582">There are connectivity issues to the Cloud for the DLP scenario</span></span></td>
   <td><span data-ttu-id="1e5a2-583">DLP 분류 흐름에 영향을 주는 네트워크 연결 문제가 있습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-583">There are network connectivity issues that affect the DLP classification flow.</span></span></td>
   <td><span data-ttu-id="1e5a2-584">네트워크 연결을 확인합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-584">Check the network connectivity.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-585">98</span><span class="sxs-lookup"><span data-stu-id="1e5a2-585">98</span></span></td>
   <td><span data-ttu-id="1e5a2-586">DLP 시나리오를 위한 클라우드 연결이 복원되었습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-586">The connectivity to the Cloud for the DLP scenario has been restored</span></span></td>
   <td><span data-ttu-id="1e5a2-587">네트워크에 대한 연결이 복원되고 DLP 분류 흐름이 계속될 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-587">The connectivity to the network was restored and the DLP classification flow can continue.</span></span></td>
   <td><span data-ttu-id="1e5a2-588">정상 작동 알림 필요한 작업이 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-588">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-589">99</span><span class="sxs-lookup"><span data-stu-id="1e5a2-589">99</span></span></td>
   <td><span data-ttu-id="1e5a2-590">서버와 통신하는 동안 센스에서 다음 오류가 발생했습니다. (%1).</span><span class="sxs-lookup"><span data-stu-id="1e5a2-590">Sense has encountered the following error while communicating with server: (%1).</span></span> <span data-ttu-id="1e5a2-591">결과: (%2)</span><span class="sxs-lookup"><span data-stu-id="1e5a2-591">Result: (%2)</span></span></td>
   <td><span data-ttu-id="1e5a2-592">통신 오류가 발생했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-592">A communication error occurred.</span></span></td>
   <td><span data-ttu-id="1e5a2-593">자세한 내용은 이벤트 로그에서 다음 이벤트를 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-593">Check the following events in the event log for further details.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-594">100</span><span class="sxs-lookup"><span data-stu-id="1e5a2-594">100</span></span></td>
   <td><span data-ttu-id="1e5a2-595">Windows Defender Advanced Threat Protection 실행을 시작하지 못했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-595">Windows Defender Advanced Threat Protection executable failed to start.</span></span> <span data-ttu-id="1e5a2-596">오류 코드: %1</span><span class="sxs-lookup"><span data-stu-id="1e5a2-596">Failure code: %1</span></span></td>
   <td><span data-ttu-id="1e5a2-597">SenseCE 실행을 시작하지 못했습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-597">The SenseCE executable has failed to start.</span></span></td>
   <td><span data-ttu-id="1e5a2-598">장치를 다시부팅합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-598">Reboot the device.</span></span> <span data-ttu-id="1e5a2-599">이 오류가 계속되면 지원에 문의합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-599">If this error persists, contact Support.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-600">102</span><span class="sxs-lookup"><span data-stu-id="1e5a2-600">102</span></span></td>
   <td><span data-ttu-id="1e5a2-601">Windows Defender Advanced Threat Protection 네트워크 검색 및 응답 실행이 시작된 경우</span><span class="sxs-lookup"><span data-stu-id="1e5a2-601">Windows Defender Advanced Threat Protection Network Detection and Response executable has started</span></span></td>
   <td><span data-ttu-id="1e5a2-602">SenseNdr 실행이 시작된 경우</span><span class="sxs-lookup"><span data-stu-id="1e5a2-602">The SenseNdr executable has started.</span></span></td>
   <td><span data-ttu-id="1e5a2-603">정상 작동 알림 필요한 작업이 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-603">Normal operating notification; no action required.</span></span></td>
</tr>
<tr>
   <td><span data-ttu-id="1e5a2-604">103</span><span class="sxs-lookup"><span data-stu-id="1e5a2-604">103</span></span></td>
   <td><span data-ttu-id="1e5a2-605">Windows Defender 네트워크 검색 및 응답 실행이 종료된 경우</span><span class="sxs-lookup"><span data-stu-id="1e5a2-605">Windows Defender Advanced Threat Protection Network Detection and Response executable has ended</span></span></td>
   <td><span data-ttu-id="1e5a2-606">SenseNdr 실행이 종료된 경우</span><span class="sxs-lookup"><span data-stu-id="1e5a2-606">The SenseNdr executable has ended.</span></span></td>
   <td><span data-ttu-id="1e5a2-607">정상 작동 알림 필요한 작업이 없습니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-607">Normal operating notification; no action required.</span></span></td>
</tr>
</tbody>
</table>

><span data-ttu-id="1e5a2-608">끝점용 Microsoft Defender를 경험하고 싶나요?</span><span class="sxs-lookup"><span data-stu-id="1e5a2-608">Want to experience Microsoft Defender for Endpoint?</span></span> [<span data-ttu-id="1e5a2-609">무료 평가판에 등록합니다.</span><span class="sxs-lookup"><span data-stu-id="1e5a2-609">Sign up for a free trial.</span></span>](https://www.microsoft.com/microsoft-365/windows/microsoft-defender-atp?ocid=docs-wdatp-eventerrorcodes-belowfoldlink)

## <a name="related-topics"></a><span data-ttu-id="1e5a2-610">관련 항목</span><span class="sxs-lookup"><span data-stu-id="1e5a2-610">Related topics</span></span>
- [<span data-ttu-id="1e5a2-611">Windows 10 장치 온보드</span><span class="sxs-lookup"><span data-stu-id="1e5a2-611">Onboard Windows 10 devices</span></span>](configure-endpoints.md)
- [<span data-ttu-id="1e5a2-612">장치 프록시 및 인터넷 연결 설정 구성</span><span class="sxs-lookup"><span data-stu-id="1e5a2-612">Configure device proxy and Internet connectivity settings</span></span>](configure-proxy-internet.md)
- [<span data-ttu-id="1e5a2-613">끝점용 Microsoft Defender 문제 해결</span><span class="sxs-lookup"><span data-stu-id="1e5a2-613">Troubleshoot Microsoft Defender for Endpoint</span></span>](troubleshoot-onboarding.md)
