...
|:---:|---|---|
|`1`|디바이스가 SenseIsRunning OMA-URI를 준수합니다. 그러나 OrgId, Onboarding 및 OnboardingState OMA-URIs는 준수하지 않습니다.|**가능한 원인:** 설치 또는 업그레이드를 완료한 후 Windows 확인 OOBE 온보더링을 완료할 수 없지만 SENSE가 이미 실행되고 있습니다. <p> **문제 해결 단계:** OOBE가 완료될 때까지 기다렸다가|
|`2`|장치는 OrgId, Onboarding 및 OnboardingState OMA-URI를 준수하지만 SenseIsRunning OMA-URI는 준수하지 않습니다.|**가능한 원인:** 센스 서비스의 시작 유형이 "지연된 시작"으로 설정됩니다. 이로 인해 시스템 Microsoft Intune DM 세션이 발생할 때 디바이스가 SenseIsRunning을 준수하지 않는 것으로 보고하는 경우도 있습니다. <p> **문제 해결 단계:** 이 문제는 24시간 내에 자동으로 해결됩니다.|
...
> [!NOTE]
> SENSE 서비스가 더 이상 최신 Windows 버전(Windows 10, 버전 1809 또는 Windows Server 2019) 또는 Windows Server [2022(2021년 4월 22일](https://support.microsoft.com/kb/5001384)업데이트 롤업)에서 시작하려면 OOBE 후 사용자 로그온이 더 이상 필요하지 않습니다. Windows 10 2021년 4월 업데이트 롤업이 [적용된 버전 1909입니다.](https://support.microsoft.com/kb/5001396) Windows 10 2021년 4월 28일 업데이트 롤업이 적용된 버전 [2004/20H2입니다.](https://support.microsoft.com/kb/5001391) 
