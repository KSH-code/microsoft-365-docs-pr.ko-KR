...
[요청된](machine.md) 내부 IP가 제공된 타임스탬프 이전 및 이후 15분의 시간 범위에 있는 컴퓨터를 찾을 수 있습니다.

## <a name="limitations"></a>제한 사항

1. 주어진 타임스탬프는 지난 30일 동안의 기간이 되어야 합니다.
...
타임스탬프가 지난 30일 ( 400 잘못된 요청)에 있지 않은 경우
