...
이제 조직의 장치를 Defender for Endpoint에 온보딩하고 Microsoft Defender 바이러스 백신 설치 및 사용하도록 설정한 후 다음 단계는 비 Microsoft 끝점 보호 솔루션을 제거하는 것입니다. 이 작업에 대한 도움말을 확인한 후 솔루션 공급자의 기술 지원 팀에 문의하세요.
