...
로고|파트너 이름|설명
:---|:---|:---
![AttackIQ 로고 이미지](images/attackiq-logo.png)|[AttackIQ 플랫폼](https://go.microsoft.com/fwlink/?linkid=2103502)|AttackIQ 플랫폼은 프로덕션 자산에서 안전하게 연속 공격을 시작하여 끝점에 대한 Defender가 제대로 구성되었는지 확인합니다.
![Azure Sentinel 로고 이미지](images/sentinel-logo.png)|[AzureSentinel](https://go.microsoft.com/fwlink/?linkid=2135705)|Endpoint용 Microsoft Defender의 경고를 Azure Sentinel로 스트리밍
![Cymulate 로고 이미지](images/cymulate-logo.png)|[Cymulate](https://go.microsoft.com/fwlink/?linkid=2135574)|시뮬레이트된 공격으로 끝점 결과를 위한 Defender를 상관 관계하여 정확한 감지 및 효과적인 대응 조치의 유효성을 검사합니다.
...
로고|파트너 이름|설명
:---|:---|:---
![MISP 맬웨어 정보 공유 플랫폼)로고의 이미지](images/misp-logo.png)|[MISP(맬웨어 정보 공유 플랫폼)](https://go.microsoft.com/fwlink/?linkid=2127543)|오픈 소스 위협 인텔리전스 공유 플랫폼의 위협 표시기를 끝점 환경용 Defender에 통합
![Palo Alto Networks 로고 이미지](images/paloalto-logo.png)|[Palo Alto Networks](https://go.microsoft.com/fwlink/?linkid=2099582)|MineMeld를 사용하여 끝점용 Defender로 자동 초점 및 기타 위협 피드를 확장하여 끝점 보호 강화
![ThreatConnect 로고 이미지](images/threatconnect-logo.png)|[ThreatConnect](https://go.microsoft.com/fwlink/?linkid=2114115)|Endpoint 표시기용 Defender를 사용하여 ThreatConnect Playbook에서 사용자 지정 위협 인텔리전스에 대한 경고 및/또는 차단
...
로고|파트너 이름|설명
:---|:---|:---
![Bitdefender 로고 이미지](images/bitdefender-logo.png)|[Bitdefender](https://go.microsoft.com/fwlink/?linkid=860032)|Bitdefender GravityZone은 정교한 사이버 위협의 전체 스펙트럼에 대한 포괄적인 보호를 제공하는 계층적 차세대 엔드포인트 보호 플랫폼입니다.
...
로고|파트너 이름|설명
:---|:---|:---
![키렌 웹 필터 로고 이미지](images/cyren-logo.png)|[키렌 웹 필터](https://go.microsoft.com/fwlink/?linkid=2108221)|고급 웹 필터링을 사용하여 끝점에 대한 Defender 향상
...
![THOR 클라우드 로고 이미지](images/nextron-thor-logo.png)|[THOR 클라우드](https://go.microsoft.com/fwlink/?linkid=862988)|지속적인 위협에 중점을 두는 서명 기반을 사용하여 요구 시 실시간 포렌식 검사 제공
