...
1. In [Microsoft Endpoint Manager admin center](https://go.microsoft.com/fwlink/?linkid=2109431) , go to **Apps** Android \> **Apps** Add Android store \> **\> app** and choose **Select**.
   ...
   :::image type="content" alt-text="Microsoft Endpoint Manager 센터의 이미지는 android 스토어 응용 프로그램을 추가합니다." source="images/mda-addandroidstoreapp.png" lightbox="images/mda-addandroidstoreapp.png":::
...
2. 앱 **추가 페이지에서** 앱 정보 *섹션에 다음을* 입력합니다.
   ...
   :::image type="content" alt-text="Microsoft Endpoint Manager 센터의 이미지는 앱 정보를 추가합니다." source="images/mda-addappinfo.png" lightbox="images/mda-addappinfo.png":::
...
3. 배정 *섹션에서* 필수 섹션으로 **이동하여** 그룹 **추가를 선택합니다.** 그런 다음 Android 앱에서 끝점용 Defender를 대상으로 할 사용자 그룹을 선택할 수 있습니다. **Select(선택)를** 선택하고 **Next(다음)를 선택합니다.**
    ...
    >
    > :::image type="content" alt-text="관리 센터에서 Microsoft Endpoint Manager 그룹의 이미지입니다." source="images/363bf30f7d69a94db578e8af0ddd044b.png" lightbox="images/363bf30f7d69a94db578e8af0ddd044b.png":::
...
5. 표시되는 앱 정보 페이지의 모니터 섹션에서 장치  설치 상태를 선택하여 장치 설치가 성공적으로 완료되어 있는지 확인합니다. 
    ...
    :::image type="content" alt-text="관리 Microsoft Endpoint Manager 설치의 이미지입니다." source="images/513cf5d59eaaef5d2b5bc122715b5844.png" lightbox="images/513cf5d59eaaef5d2b5bc122715b5844.png":::
...
3. 온보드에 성공하면 디바이스가 디바이스의 디바이스 목록에 Microsoft Defender 보안 센터.
    ...
    :::image type="content" alt-text="Endpoint 포털용 Defender의 장치 이미지입니다." source="images/9fe378a1dce0f143005c3aa53d8c4f51.png" lightbox="images/9fe378a1dce0f143005c3aa53d8c4f51.png":::
...
7. 동기화는 몇 분 후에 완료됩니다.
    ...
    :::image type="content" alt-text="Android 앱의 이미지입니다." source="images/9fc07ffc150171f169dc6e57fe6f1c74.png" lightbox="images/9fc07ffc150171f169dc6e57fe6f1c74.png":::

8. Android 앱 **화면에서** 새로 고침 단추를 선택하면 끝점용 Microsoft Defender가 앱 목록에 표시됩니다.

    :::image type="content" alt-text="Android 앱 목록의 이미지입니다." source="images/fa4ac18a6333335db3775630b8e6b353.png" lightbox="images/fa4ac18a6333335db3775630b8e6b353.png":::
...
9. Endpoint용 Defender는 Intune을 통해 관리되는 장치에 대한 앱 구성 정책을 지원합니다. 이 기능을 사용하여 적용 가능한 Android 사용 권한을 자동으로 그라데이터하여 최종 사용자가 이러한 사용 권한을 수락할 필요가 없습니다.
    ...
    1. 앱 **페이지에서** 정책 > 앱 구성 정책 > 관리 > **이동합니다.**
       ...
       :::image type="content" alt-text="관리 센터 Microsoft Endpoint Manager 관리되는 장치의 이미지입니다." source="images/android-mem.png":::
    ...
    1. 앱 **구성 정책 만들기 페이지에서** 다음 세부 정보를 입력합니다.
        ...
        :::image type="content" alt-text="앱 구성 정책 만들기 페이지의 이미지입니다." source="images/android-create-app.png" lightbox="images/android-create-app.png":::
    ...
    1. 설정 **페이지에서** 사용 권한 섹션으로 이동하여 추가를 클릭하여 지원되는 사용 권한 목록을 볼 수 있습니다. 사용 권한 추가 섹션에서 다음 사용 권한을 선택합니다.
       ...
       :::image type="content" alt-text="android의 이미지는 앱 구성 정책을 만듭니다." source="images/android-create-app-config.png" lightbox="images/android-create-app-config.png":::

    1. 이제 두 사용 권한이 모두 나열되어 있으며 이제 사용 권한 상태 드롭다운에서 자동grant를 선택하고 다음 을 선택하여 둘 다 자동 그라데이트할 수 **있습니다.** 

       :::image type="content" alt-text="android의 이미지 자동 부여 앱 구성 정책 만들기." source="images/android-auto-grant.png" lightbox="images/android-auto-grant.png":::
    ...
    1. 할당 **페이지에서** 이 앱 구성 정책을 할당할 사용자 그룹을 선택합니다. 그룹 **선택을 클릭하여** 해당 그룹을 포함하고 선택한 후 다음 을 **선택합니다.** 여기서 선택한 그룹은 일반적으로 Endpoint Android용 Microsoft Defender 앱을 할당할 그룹과 동일합니다.
       ...
       :::image type="content" alt-text="앱 구성 정책 만들기의 이미지입니다." source="images/android-select-group.png" lightbox="images/android-select-group.png":::
...
10. 속성 할당 편집 목록에서 **Microsoft Defender ATP** \>  \> **앱을** \> **선택합니다.**
    ...
    :::image type="content" alt-text="앱 목록의 이미지입니다." source="images/mda-properties.png" lightbox="images/mda-properties.png":::
...
1. 장치에서 구성 **프로필** 프로필 만들기 프로필 플랫폼 \>  \>  \> **Android** Enterprise
   ...
   **만들기** 를 선택합니다.
   ...
   :::image type="content" alt-text="장치 구성 프로필 만들기의 이미지입니다." source="images/1autosetupofvpn.png":::

2. **구성 설정** 구성 **프로필을** 고유하게 식별하는 **이름** 및 설명을 제공합니다.

   :::image type="content" alt-text="장치 구성 프로필 이름 및 설명의 이미지입니다." source="images/2autosetupofvpn.png":::
...
3. 연결을 **선택하고** VPN을 구성합니다.
   ...
   - **잠금 모드** 구성되지 않습니다(기본값)
     ...
     ![장치 구성 프로필의 이미지는 Always-on VPN을 사용하도록 설정합니다. ](images/3autosetupofvpn.png)
      :::image type="content" alt-text="장치 구성 프로필의 이미지는 Always-on VPN을 사용하도록 설정합니다." source="images/3autosetupofvpn.png":::
...
4. 이 단계에서 장치는 Android의 끝점용 Defender에 성공적으로 온보딩됩니다. 장치 페이지로 이동하여 Microsoft Defender 보안 센터 확인할 **수** 있습니다. [](https://securitycenter.microsoft.com)
    ...
    :::image type="content" alt-text="끝점 포털용 Microsoft Defender의 이미지입니다." source="images/9fe378a1dce0f143005c3aa53d8c4f51.png" lightbox="images/9fe378a1dce0f143005c3aa53d8c4f51.png":::
