...
**필터:** 취약성 심각도 수준, 악용 가용성, 취약성 사용 시간, 운영 체제 플랫폼, Windows 10 또는 Windows 11 그룹별로 데이터를 필터링할 수 있습니다.
...
## <a name="vulnerable-devices-by-windows-version-graphs"></a>버전 그래프를 Windows 취약한 장치

취약한 응용 프로그램 또는 OS로 Windows 10 Windows 11 버전당 장치 수입니다.
