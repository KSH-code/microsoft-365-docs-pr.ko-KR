...
이 옵션은 헤드셋처럼 보이는 아이콘을 클릭하여 사용할 수 있습니다. 그러면 지원 사례를 제출할 수 있는 다음 페이지가 표시됩니다. :::image type="content" source="../../media/contactsupport2.png" alt-text="고객 지원 2에 문의":::
