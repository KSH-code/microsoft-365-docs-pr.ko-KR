...
|[끝점에 대한 Microsoft Defender 설정](switch-to-microsoft-defender-setup.md) |설치 [ **단계 중에는**](switch-to-microsoft-defender-setup.md)Microsoft Defender 바이러스 백신을 사용하도록 설정하고 수동 모드로 설정해야 합니다. 또한 Microsoft Defender & 및 기존 끝점 보호 솔루션에 대한 제외에 대한 설정을 구성합니다. 그런 다음 장치 그룹, 컬렉션 및 조직 구성 단위를 생성합니다. 마지막으로 맬웨어 방지 정책 및 실시간 보호 설정을 구성합니다.|
