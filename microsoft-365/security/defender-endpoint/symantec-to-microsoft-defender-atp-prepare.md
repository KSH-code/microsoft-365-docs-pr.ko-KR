...
**[Symantec에서 끝점용 Defender로 마이그레이션하는 준비 단계에 오신 것을 환영합니다.](symantec-to-microsoft-defender-endpoint-migration.md#the-migration-process)** 

이 마이그레이션 단계에는 다음 단계가 포함됩니다.

1. [조직의 장치를 업데이트합니다.](#update-your-organizations-devices)
...
4. [장치 프록시 및 인터넷 연결 설정 구성](#configure-device-proxy-and-internet-connectivity-settings)

## <a name="update-your-organizations-devices"></a>조직의 장치 업데이트

조직의 장치 및 끝점을 최신으로 유지하는 것이 가장 좋은 모범 사례입니다. 기존 끝점 보호 및 바이러스 백신 솔루션이 최신 상태로 유지 관리되는 운영 체제 및 앱에도 최신 업데이트가 있는지 확인합니다. 이렇게 하면 나중에 Endpoint용 Defender로 마이그레이션할 때 문제를 방지하는 데 도움이 됩니다.

### <a name="make-sure-symantec-is-up-to-date"></a>Symantec이 최신 있는지 확인

기존 끝점 보호 솔루션을 최신으로 유지하고 조직의 장치에 최신 보안 업데이트가 있는지 확인합니다.

도움이 필요하신가요? Broadcom 설명서: [Symantec Endpoint Protection 및 관리 가이드를 참조하세요.](https://techdocs.broadcom.com/us/en/symantec-security-software/endpoint-security-and-management/endpoint-protection/all.html)

### <a name="make-sure-your-endpoints-are-up-to-date"></a>끝점이 최신으로 유지된지 확인
...
1. 지금 끝점용 Defender를 구입하거나 사용해 보아야 합니다. [Endpoint용 Defender를 방문하여 무료](https://aka.ms/mdatp)평가판을 시작하거나 견적을 요청합니다. 
...
|바이러스 검사 |macOS: <p>11.3.1(Big Sur)<p>10.15(카탈로나)<p>10.14(모잡)  |[Mac의 끝점용 Defender: 네트워크 연결](microsoft-defender-endpoint-mac.md#network-connections) |
...
**축하합니다!** [Symantec에서 끝점용 Defender로](symantec-to-microsoft-defender-endpoint-migration.md#the-migration-process)마이그레이션하는 준비 단계를 완료했습니다! 
- [끝점에 대한 Defender 설정으로 진행합니다.](symantec-to-microsoft-defender-atp-setup.md)
