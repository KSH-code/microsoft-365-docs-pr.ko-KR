...
> [!NOTE]
> Microsoft **MAPS** 보고를 위한 로컬 설정 다시 설정 구성 그룹 정책 설정을  사용 안 하도록 설정한 경우 Windows 설정 클라우드 기반 보호 설정은 회색으로 표시되어 사용할 수 없습니다. 그룹 정책 개체를 통해 변경한 내용은 먼저 개별 끝점에 배포해야 설정이 Windows 설정.
