...
Microsoft Defender 바이러스 백신 클라이언트는 Windows 10 및 Windows 11 핵심 부분으로 설치되어 있기 때문에 끝점에 대한 기존 클라이언트 배포는 적용되지 않습니다.
...
> [!IMPORTANT]
> 대부분의 경우 Windows 10 또는 Windows 11 실행 중인 다른 Microsoft Defender 바이러스 백신 바이러스 백신 제품이 발견되는 경우 이 기능을 사용하지 않도록 설정됩니다. 타사 바이러스 백신 제품을 사용하지 않도록 설정하거나 제거해야 Microsoft Defender 바이러스 백신 합니다. 타사 바이러스 백신 제품을 다시 사용하도록 설정하거나 설치하는 경우 Windows 10 또는 Windows 11 사용하지 않도록 Microsoft Defender 바이러스 백신.
...
항목 | 설명
---|---
[보호 기능 Microsoft Defender 바이러스 백신 배포 및 사용](deploy-microsoft-defender-antivirus.md) | 클라이언트가 Windows 10 또는 Windows 11 핵심 부분으로 설치되는 동안 기존 배포가 적용되지 않는 경우 끝점에서 Microsoft Endpoint Configuration Manager, Microsoft Intune 또는 그룹 정책 개체를 사용하여 클라이언트를 사용하도록 설정해야 합니다.
