...
1. [<span data-ttu-id="d3a18-109">끝점용 Microsoft Defender 온보딩 패키지 다운로드</span><span class="sxs-lookup"><span data-stu-id="d3a18-109">Get the Microsoft Defender for Endpoint onboarding package</span></span>](#step-1-get-the-microsoft-defender-for-endpoint-onboarding-package)
...
1. <span data-ttu-id="d3a18-129">이전 `WindowsDefenderATPOnboarding.plist` 섹션에서 파일을 찾습니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-129">Locate the file `WindowsDefenderATPOnboarding.plist` from the previous section.</span></span>
...
4. <span data-ttu-id="d3a18-140">응용 **프로그램 & 사용자 지정 설정** 구성을 **선택합니다.**</span><span class="sxs-lookup"><span data-stu-id="d3a18-140">In **Application & Custom Settings** select **Configure**.</span></span>
...
7. <span data-ttu-id="d3a18-147">를 **업로드.**</span><span class="sxs-lookup"><span data-stu-id="d3a18-147">Select **Upload**.</span></span>
...
9. <span data-ttu-id="d3a18-151">대상 컴퓨터를 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-151">Select the target computers.</span></span>

    ![대상 컴퓨터의 이미지](images/jamfpro-target-computer.png)

    ![대상 이미지](images/jamfpro-targets.png)

10. <span data-ttu-id="d3a18-154">**저장** 을 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-154">Select **Save**.</span></span>

    ![배포 대상 컴퓨터의 이미지](images/jamfpro-deployment-target.png)

    ![대상 컴퓨터의 이미지 선택](images/jamfpro-target-selected.png)

11. <span data-ttu-id="d3a18-157">**완료** 를 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-157">Select **Done**.</span></span>

    ![대상 그룹 컴퓨터의 이미지](images/jamfpro-target-group.png)

    ![구성 프로필 목록](images/jamfpro-configuration-policies.png)

## <a name="step-3-configure-microsoft-defender-for-endpoint-settings"></a><span data-ttu-id="d3a18-160">3단계: 끝점 설정에 맞게 Microsoft Defender 구성</span><span class="sxs-lookup"><span data-stu-id="d3a18-160">Step 3: Configure Microsoft Defender for Endpoint settings</span></span>
...
8. <span data-ttu-id="d3a18-189">**Contoso의 컴퓨터 그룹을 선택합니다.**</span><span class="sxs-lookup"><span data-stu-id="d3a18-189">Select **Contoso's Machine Group**.</span></span>
...
1. <span data-ttu-id="d3a18-200">끝점 구성 설정에 대해 다음 Microsoft Defender를 사용합니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-200">Use the following Microsoft Defender for Endpoint configuration settings:</span></span>
    ...
    - <span data-ttu-id="d3a18-204">제외</span><span class="sxs-lookup"><span data-stu-id="d3a18-204">exclusions</span></span>
...
6. <span data-ttu-id="d3a18-233">파일 **업로드(PLIST 파일)를 선택합니다.**</span><span class="sxs-lookup"><span data-stu-id="d3a18-233">Select **Upload File (PLIST file)**.</span></span>
...
8. <span data-ttu-id="d3a18-237">파일 **선택 을 선택합니다.**</span><span class="sxs-lookup"><span data-stu-id="d3a18-237">Select **Choose File**.</span></span>
...
10. <span data-ttu-id="d3a18-241">를 **업로드.**</span><span class="sxs-lookup"><span data-stu-id="d3a18-241">Select **Upload**.</span></span>
...
12. <span data-ttu-id="d3a18-248">파일이 업로드됩니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-248">The file is uploaded.</span></span>
...
13. <span data-ttu-id="d3a18-251">범위 **탭을** 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-251">Select the **Scope** tab.</span></span>
...
1. <span data-ttu-id="d3a18-262">Jamf Pro 대시보드에서 **컴퓨터,** 구성 **프로필을 선택합니다.**</span><span class="sxs-lookup"><span data-stu-id="d3a18-262">In the Jamf Pro dashboard, select **Computers**, then **Configuration Profiles**.</span></span>
...
6. <span data-ttu-id="d3a18-292">**완료** 를 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-292">Select **Done**.</span></span> <span data-ttu-id="d3a18-293">새 구성 **프로필이 표시됩니다.**</span><span class="sxs-lookup"><span data-stu-id="d3a18-293">You'll see the new **Configuration profile**.</span></span>
    <span data-ttu-id="d3a18-294">![구성 설정 완료 img의 이미지](images/633ad26b8bf24ec683c98b2feb884bdf.png)</span><span class="sxs-lookup"><span data-stu-id="d3a18-294">![Image of configuration setting done img](images/633ad26b8bf24ec683c98b2feb884bdf.png)</span></span>
...
7. <span data-ttu-id="d3a18-495">**열기** 를 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-495">Select **Open**.</span></span> <span data-ttu-id="d3a18-496">표시 **이름을** **Microsoft Defender Advanced Threat Protection으로 설정하고** Microsoft Defender 바이러스 백신.</span><span class="sxs-lookup"><span data-stu-id="d3a18-496">Set the **Display Name** to **Microsoft Defender Advanced Threat Protection and Microsoft Defender Antivirus**.</span></span>

    <span data-ttu-id="d3a18-497">**매니페스트 파일은** 필요하지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-497">**Manifest File** is not required.</span></span> <span data-ttu-id="d3a18-498">끝점용 Microsoft Defender는 매니페스트 파일 없이 작동합니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-498">Microsoft Defender for Endpoint works without Manifest File.</span></span>

    <span data-ttu-id="d3a18-499">**옵션 탭**</span><span class="sxs-lookup"><span data-stu-id="d3a18-499">**Options tab**</span></span><br> <span data-ttu-id="d3a18-500">기본값을 유지 합니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-500">Keep default values.</span></span>

    <span data-ttu-id="d3a18-501">**제한 사항 탭**</span><span class="sxs-lookup"><span data-stu-id="d3a18-501">**Limitations tab**</span></span><br> <span data-ttu-id="d3a18-502">기본값을 유지 합니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-502">Keep default values.</span></span>

     ![구성 설정 제한 탭의 이미지](images/56dac54634d13b2d3948ab50e8d3ef21.png)

8. <span data-ttu-id="d3a18-504">**저장** 을 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-504">Select **Save**.</span></span> <span data-ttu-id="d3a18-505">패키지가 Jamf 2013에 Pro.</span><span class="sxs-lookup"><span data-stu-id="d3a18-505">The package is uploaded to Jamf Pro.</span></span>

   ![구성 설정 팩 upl jamf pro의 이미지](images/33f1ecdc7d4872555418bbc3efe4b7a3.png)

   <span data-ttu-id="d3a18-507">패키지를 배포하는 데 몇 분 정도 걸릴 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-507">It can take a few minutes for the package to be available for deployment.</span></span>

   ![구성 설정 팩 업L 이미지](images/1626d138e6309c6e87bfaab64f5ccf7b.png)

9. <span data-ttu-id="d3a18-509">정책 **페이지로** 이동합니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-509">Navigate to the **Policies** page.</span></span>

    ![구성 설정 polocies의 이미지](images/f878f8efa5ebc92d069f4b8f79f62c7f.png)

10. <span data-ttu-id="d3a18-511">**+ 새로 만들기를 선택하여** 새 정책을 만들 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-511">Select **+ New** to create a new policy.</span></span>

    ![구성 설정 새 정책의 이미지](images/847b70e54ed04787e415f5180414b310.png)


11. <span data-ttu-id="d3a18-513">**일반에서** 다음 세부 정보를 입력합니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-513">In **General** Enter the following details:</span></span>

    - <span data-ttu-id="d3a18-514">표시 이름: MDATP 온보드 Contoso 200329 v100.86.92 이상</span><span class="sxs-lookup"><span data-stu-id="d3a18-514">Display name: MDATP Onboarding Contoso 200329 v100.86.92 or later</span></span>

    ![구성 설정mdatponboard의 이미지](images/625ba6d19e8597f05e4907298a454d28.png)

12. <span data-ttu-id="d3a18-516">재발 **체크 인 을 선택합니다.**</span><span class="sxs-lookup"><span data-stu-id="d3a18-516">Select **Recurring Check-in**.</span></span>

    ![구성 설정 재발 검사의 이미지](images/68bdbc5754dfc80aa1a024dde0fce7b0.png)


13. <span data-ttu-id="d3a18-518">**저장** 을 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-518">Select **Save**.</span></span>

14. <span data-ttu-id="d3a18-519">패키지를 **> 구성합니다.**</span><span class="sxs-lookup"><span data-stu-id="d3a18-519">Select **Packages > Configure**.</span></span>

    ![구성 설정 팩 구성 이미지](images/8fb4cc03721e1efb4a15867d5241ebfb.png)

15. <span data-ttu-id="d3a18-521">Microsoft  **Defender Advanced Threat Protection** 옆에 있는 추가 단추를 선택하고 Microsoft Defender 바이러스 백신.</span><span class="sxs-lookup"><span data-stu-id="d3a18-521">Select the **Add** button next to **Microsoft Defender Advanced Threat Protection and Microsoft Defender Antivirus**.</span></span>

    ![구성 설정의 이미지 MDATP 및 MDA 추가](images/526b83fbdbb31265b3d0c1e5fbbdc33a.png)

16. <span data-ttu-id="d3a18-523">**저장** 을 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-523">Select **Save**.</span></span>

    ![구성 설정savimg의 이미지](images/9d6e5386e652e00715ff348af72671c6.png)

17. <span data-ttu-id="d3a18-525">범위 **탭을** 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-525">Select the **Scope** tab.</span></span>

    ![구성 설정 scptab의 이미지](images/8d80fe378a31143db9be0bacf7ddc5a3.png)

18. <span data-ttu-id="d3a18-527">대상 컴퓨터를 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-527">Select the target computers.</span></span>

    ![구성 설정 tgtcomp의 이미지](images/6eda18a64a660fa149575454e54e7156.png)

    <span data-ttu-id="d3a18-529">**범위**</span><span class="sxs-lookup"><span data-stu-id="d3a18-529">**Scope**</span></span>

    <span data-ttu-id="d3a18-530">**추가** 를 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-530">Select **Add**.</span></span>
    ...
    <span data-ttu-id="d3a18-533">**셀프 서비스**</span><span class="sxs-lookup"><span data-stu-id="d3a18-533">**Self-Service**</span></span>

    ![구성 설정 셀프 서비스 이미지](images/c9f85bba3e96d627fe00fc5a8363b83a.png)

19. <span data-ttu-id="d3a18-535">**완료** 를 선택합니다.</span><span class="sxs-lookup"><span data-stu-id="d3a18-535">Select **Done**.</span></span>
