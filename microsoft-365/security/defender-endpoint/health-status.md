...
| network_protection_status                 | 네트워크 보호 구성 요소의 상태입니다(macOS만 해당). 다음 값 중 하나가 될 수 있습니다.       <br> <br>- **starting** - 네트워크 보호가 시작 중입니다.  <br> <br>     - **failed_to_start** - 오류로 인해 네트워크 보호를 시작할 수 없습니다.   <br> <br>    - **started** - 현재 장치에서 네트워크 보호가 실행되고 있습니다.     <br> <br>  - **restarting** - 네트워크 보호가 현재 다시 시작 중입니다.   <br> <br>    - **stopping** - 네트워크 보호가 중지됩니다.     <br> <br>  - **stopped** - 네트워크 보호가 실행되고 있지 않습니다. |
