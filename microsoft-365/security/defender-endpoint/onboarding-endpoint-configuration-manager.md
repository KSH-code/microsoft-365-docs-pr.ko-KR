...
14. 구성을 확인한 후 다음 을 **클릭합니다.**

     ![구성 설정의 이미지3.](images/configmgr-verify-configuration.png)

15. **마법사가** 완료되면 닫기 를 클릭합니다.

16.  Microsoft Endpoint Configuration Manager 콘솔에서 방금 만든 끝점용 Defender 정책을 마우스 오른쪽 단추로 클릭하고 배포를 **선택합니다.**

     ![구성 설정의 이미지4.](images/configmgr-deploy.png)

17. 오른쪽 패널에서 이전에 만든 컬렉션을 선택하고 확인 을 **클릭합니다.**
...
5. 정책을 만든 후 닫기 **를 클릭합니다.**
    ...
    ![console1의 Microsoft Endpoint Manager 이미지입니다.](images/95d23a07c2c8bc79176788f28cef7557.png)
...
3. 설정을 감사로 **설정하고** 다음을 **클릭합니다.** 
    ...
    ![Confirugatiom Manager2의 System Center 스크린샷입니다.](images/c039b2e05dba1ade6fb4512456380c9f.png)
