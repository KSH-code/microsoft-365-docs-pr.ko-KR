...
|도구/메서드  |설명  |
|---------|---------|
|**[위협 및 취약성 관리 대시보드 정보를](/windows/security/threat-protection/microsoft-defender-atp/tvm-dashboard-insights)** Microsoft Defender 보안 센터( [https://securitycenter.windows.com](https://securitycenter.windows.com) ) |위협 & 취약성 관리 대시보드는 보안 운영 팀이 노출을 줄이고 조직의 보안 자세를 개선하는 데 사용할 수 있는 실행 가능한 정보를 제공합니다. <br/><br/>위협 [& 취약성 관리](/microsoft-365/security/defender-endpoint/next-gen-threat-and-vuln-mgt) 및 [의 개요를 Microsoft Defender 보안 센터.](/microsoft-365/security/defender-endpoint/use)  |
