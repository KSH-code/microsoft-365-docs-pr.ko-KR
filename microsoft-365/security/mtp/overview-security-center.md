...
새로운 Microsoft 365 보안 센터와 [Microsoft 365 준수 센터](https://docs.microsoft.com/microsoft-365/compliance/microsoft-365-compliance-center) 는 보안 및 규정 준수 팀의 요구를 충족 하기 위해 설계 된 특수 한 작업 영역입니다. 이러한 솔루션은 Microsoft 365 서비스에 통합 되어 있으며 위험을 줄이고 디지털 공간을 보호 하는 데 도움이 되는 정보를 제공 합니다.
...
이 간략 한 정보를 통해 조직의 최신 활동을 유지 하는 데 도움이 됩니다. Microsoft 365 보안 센터는 다양 한 출처의 신호를 함께 Microsoft 365 환경을 전체적으로 보여 줍니다.
...
* **사용 권한** -Microsoft 365 보안 센터에서 조직의 사용자가 콘텐츠를 확인 하 고 작업을 수행할 수 있는 권한을 관리 합니다. Azure AD 포털에서 Microsoft 365 사용 권한을 할당할 수 있습니다.
