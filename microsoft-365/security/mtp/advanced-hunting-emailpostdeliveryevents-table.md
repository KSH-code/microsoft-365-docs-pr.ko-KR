...
- **수동 수정** - 관리자가 사용자 사서함으로 배달된 후 전자 메일 메시지에 대한 작업을 수동으로 수행했습니다. 여기에는 위협 탐색기를 [통해](../office-365-security/threat-explorer.md) 수동으로 수행한 작업 또는 자동화된 조사 및 대응(AIR) 작업의 [승인이 포함됩니다.](mtp-autoir-actions.md)
