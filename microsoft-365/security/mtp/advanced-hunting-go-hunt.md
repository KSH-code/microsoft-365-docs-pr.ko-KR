...
이동 *헌트를* 사용하여 사용자, 장치 또는 기타 엔터티 유형에 대한 정보를 쿼리할 때 쿼리는 모든 관련 Schema 테이블에서 해당 엔터티와 관련된 모든 이벤트를 확인합니다. 결과를 관리하기 위해 쿼리의 범위는 엔터티와 관련이 있으며 인시던트와 연결된 지난 30일 동안의 가장 빠른 활동과 동일한 기간으로 지정됩니다.
