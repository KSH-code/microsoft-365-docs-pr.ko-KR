...
---
# <a name="partner-access-through-microsoft-threat-protection-apis"></a>Microsoft Threat Protection Api를 통한 파트너 액세스
...
이 페이지에서는 고객을 대신 하 여 Microsoft Threat Protection에 프로그래밍 방식으로 액세스할 수 있도록 AAD 응용 프로그램을 만드는 방법에 대해 설명 합니다.
...
- 응용 프로그램에 대 한 고객 관리자가 승인 (동의) 하 여 필요한 Microsoft 위협 보호 리소스에 액세스 합니다.
- 이 응용 프로그램을 사용 하 여 액세스 토큰을 가져옵니다.
- 토큰을 사용 하 여 Microsoft Threat Protection API에 액세스 합니다.

다음 단계에서는 AAD 응용 프로그램을 만드는 방법과 Microsoft Threat Protection에 대 한 액세스 토큰을 가져오고 토큰의 유효성을 검사 하는 방법에 대해 설명 합니다.
...
4. 응용 프로그램에서 Microsoft Threat Protection에 액세스 하 여 통합을 완료 하는 데 필요한 최소한의 사용 권한 집합을 할당 하도록 허용 합니다.

   - 응용 프로그램 페이지에서 **API 사용 권한을**클릭  >  **Add permission**  >  **하 여 조직에서 사용 하는** 사용 권한 api 추가 > **microsoft threat protection** 을 입력 하 고 **microsoft threat protection**을 클릭 합니다.
...
8. 고객의 테 넌 트에 응용 프로그램을 추가 합니다.
    ...
    응용 프로그램이 사용 하려는 각 고객 테 넌 트에서 승인 되도록 해야 합니다. 이는 응용 프로그램이 고객을 대신 하 여 Microsoft Threat Protection 응용 프로그램과 상호 작용 하기 때문입니다.
...
- 응용 프로그램을 사용 하 여 Microsoft Threat Protection 응용 프로그램에 액세스 하려는 고객의 Azure 테 넌 트 ID로 TENANT_ID 설정
- 다음 명령을 실행 합니다.
...
- 아래 스크린샷에서는 Microsoft Threat Protection에 대 한 여러 사용 권한을 가진 응용 프로그램에서 얻은 디코딩된 토큰을 확인할 수 있습니다.
...
- 사용할 API를 선택 합니다. 자세한 내용은 [지원 되는 Microsoft Threat Protection api](api-supported.md) 를 참조 하세요.
