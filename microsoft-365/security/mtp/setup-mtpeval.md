...
>[!NOTE]
>평가판에 등록하면 한 달 동안 사용할 25개 사용자 라이선스가 부여됩니다. 자세한 [내용은 M365](../../commerce/try-or-buy-microsoft-365.md#try-or-buy-a-microsoft-365-subscription-1) 구독 시도 또는 구입을 참조하세요.
...
|[3단계: 온보드 & 구성](config-mtpeval.md) | Microsoft 365 Defender 평가판 랩 또는 파일럿 환경에 대한 각 Microsoft 365 Defender 기조를 구성하고 끝점을 온보딩합니다.
|:-------|:-----|