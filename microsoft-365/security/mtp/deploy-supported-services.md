...
[Microsoft 365 Defender는](microsoft-threat-protection.md) 다양한 Microsoft 보안 서비스를 통합하여 정교한 공격에 대한 중앙 집중식 감지, 예방 및 조사 기능을 제공합니다. 이 문서에서는 지원되는 서비스, 해당 라이선스 요구 사항, 하나 이상의 서비스 배포와 관련된 이점 및 제한 사항, 그리고 이러한 서비스를 개별적으로 완전히 배포하는 방법에 대한 링크를 제공합니다.
...
| 서비스 | 프로비저닝 지침 | 초기 구성 |
| ------ | ------ | ------ |
| 엔드포인트용 Microsoft Defender | [끝점용 Microsoft Defender 배포 가이드](/windows/security/threat-protection/microsoft-defender-atp/deployment-phases) | *프로비저닝 지침 참조* |
|Office 365용 Microsoft Defender | *없음, Office 365로 프로비전* | [Office 365용 Microsoft Defender 정책 구성](../office-365-security/office-365-atp.md#configure-atp-policies) |
...
- [끝점용 Microsoft Defender 개요](/windows/security/threat-protection/microsoft-defender-atp/microsoft-defender-advanced-threat-protection)
