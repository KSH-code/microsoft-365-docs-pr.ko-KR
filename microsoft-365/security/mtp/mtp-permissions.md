...
- **전역 Azure AD(Azure Active Directory) 역할**
- **사용자 지정 역할 액세스**

다음 전역 Azure AD 역할이 할당된 **계정은** Microsoft 365 Defender 기능 및 데이터에 액세스할 수 있습니다.
- 전역 관리자
- 보안 관리자
- 보안 운영자
- 전역 읽기 권한자
...
>! [참고] 이 문서는 전역 Azure AD 역할 관리에만 적용됩니다. 사용자 지정 역할 기반 액세스 제어 사용에 대한 자세한 내용은 역할 기반 액세스 제어에 대한 사용자 지정 [역할을 참조하세요.](custom-roles.md)
