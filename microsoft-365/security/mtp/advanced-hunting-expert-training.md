...
새로운 보안 분석가 및 경험 있는 위협 헌터를 위한 웹캐스트 시리즈인 사도 추적을 통해 고급 헌팅에 대한 지식을 빠르게 향상합니다. 이 시리즈에서는 정교한 쿼리를 만들기 위한 기본적인 방법을 안내합니다. 기본 사항에 대한 첫 번째 비디오로 시작하거나 환경 수준에 맞는 고급 비디오로 이동하세요.
...
*L33TSP3AK를 사용하여 보다 전문적인 교육을 얻습니다. Microsoft 365 Defender의 고급 헌팅: Microsoft 365 Defender의* 고급 헌팅을 사용하여 보안 조사를 수행하기 위한 기술 지식과 실무 기술을 확장하고자 하는 분석가를 위한 웹캐스트 시리즈입니다. 

| 제목 | 설명 | 감시 | 쿼리 | 
|--|--|--|--|
| 에피소드 1  | 이 에피소드에서는 고급 헌팅 쿼리를 실행하는 다양한 모범 사례를 배우게 됩니다. 쿼리를 최적화하고, 랜섬웨어에 고급 헌팅을 사용하며, JSON을 동적 유형으로 처리하고, 외부 데이터 연산자를 사용하는 방법도 다를 수 있습니다. | [](https://www.youtube.com/watch?v=nMGbK-ALaVg&feature=youtu.be) YouTube(56:34) | [CSL 파일](https://github.com/microsoft/Microsoft-365-Defender-Hunting-Queries/blob/master/Webcasts/l33tSpeak/Performance%2C%20Json%20and%20dynamics%20operator%2C%20external%20data.csl)
