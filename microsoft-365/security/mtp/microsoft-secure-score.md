...
### <a name="removed-improvement-actions-that-dont-meet-expectations-for-reliable-measurement"></a>신뢰할 수 있는 측정값에 대 한 기대치를 충족 하지 않는 개선 작업 제거

Microsoft 보안 점수가 의미 있고 모든 개선 조치를 측정할 수 있으며 안정성을 보장 하기 위해 다음과 같은 개선 작업을 제거 했습니다.
