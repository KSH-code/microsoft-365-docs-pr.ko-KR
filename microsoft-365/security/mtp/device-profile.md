...
* **라이브 응답** 세션 시작 - 심층 보안 조사를 위해 디바이스에 원격 [셸을 로드합니다.](/windows/security/threat-protection/microsoft-defender-atp/live-response)
...
* [라이브 응답을 사용하여 디바이스에서 엔터티 조사](/windows/security/threat-protection/microsoft-defender-atp/live-response)
