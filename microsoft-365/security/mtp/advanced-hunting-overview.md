...
고급 구하기를 사용 하려면 [Microsoft 365 Defender를 켜십시오](mtp-enable.md).
...
| **스키마의 이해** | 스키마와 해당 열에 있는 테이블에 대한 이해를 높이세요. 쿼리를 만들 때 데이터를 찾을 위치를 알아봅니다. | - [스키마 참조](advanced-hunting-schema-tables.md)<br>- [끝점에 대 한 Microsoft Defender에서 전환](advanced-hunting-migrate-from-mdatp.md) |
...
고급 구하기 또는 기타 [Microsoft 365 Defender](microsoft-threat-protection.md) 기능을 사용 하려면 Azure Active Directory에 적절 한 역할이 있어야 합니다. 또한 끝점에 대 한 Microsoft Defender의 RBAC (역할 기반 액세스 제어) 설정에 의해 종점 데이터에 대 한 액세스 권한이 결정 됩니다. [Microsoft 365 Defender 액세스 관리에 대해 자세히 알아봅니다.](mtp-permissions.md)
