...
[Microsoft Threat Protection](https://docs.microsoft.com/microsoft-365/security/mtp/microsoft-threat-protection) 은 끝점, id, 전자 메일 및 응용 프로그램 간의 검색, 예방, 조사 및 응답을 고유 하 게 조정 하 고 복잡 한 공격에 대 한 통합 된 보호 기능을 제공 하는 통합 사전 및 사후 위반 엔터프라이즈 방어 제품군입니다.

Microsoft Threat Protection은 [Microsoft DEFENDER atp](https://www.microsoft.com/microsoft-365/windows/microsoft-defender-atp), [Office 365 ATP](https://www.microsoft.com/microsoft-365/exchange/advance-threat-protection), [Azure ATP](https://azure.microsoft.com/features/azure-advanced-threat-protection/), [Azure AD id 보호](https://docs.microsoft.com/azure/active-directory/identity-protection/overview-identity-protection)및 [microsoft Cloud App Security](https://www.microsoft.com/microsoft-365/enterprise-mobility-security/cloud-app-security)의 기능을 단일 솔루션에 결합 합니다.
...
MITRE의 테스트 접근 방식에 대 한 핵심은 실제 공격을 에뮬레이트 하 여 솔루션이 적절 하 게 검색 및 응답할 수 있는지 여부를 파악 하는 것입니다. MITRE의 시뮬레이트된 APT29 공격에 대 한 테스트 중심에는 여러 개의 공격 도메인에 걸쳐 있으며, 끝점 보호 이외에 defenders의 역량을 강화 하기 위한 기회를 창출 합니다. Microsoft는 MTP (Microsoft Threat Protection)를 사용 하 여 끝점을 초과 하는 defenders의 가시성을 확장 했습니다.
...
- AT&T&접시 헤드 기반 Microsoft 위협 보호 평가- [실제 검색에서의 선두](https://www.microsoft.com/security/blog/2020/05/01/microsoft-threat-protection-leads-real-world-detection-mitre-attck-evaluation/) 2020:
    ...
    Microsoft Threat Protection은 공격 체인 단계에서 거의 100%의 범위를 제공 합니다. 기본 제공 되는 첫 번째 가시성을 공격자 활동으로 전달 하 여 보안 작업 센터와 특정 구성 변경에 의존 하는 공급 업체 솔루션에 대 한 수동 작업을 대폭 줄입니다. 또한 가시성을 최소화 하 여 공격자가 감지 하지 못하는 작업을 수행할 수 있도록 하는 것이 좋습니다.
