...
8. 나머지 옵션이  선택되어 있는 동안 사용자가 안전한 링크를 클릭하는 경우 추적 안 하세요. 옵션이 선택되어 있는지 확인 합니다. 자세한 [내용은 안전한 링크](../office-365-security/recommended-settings-for-eop-and-office365-atp.md) 설정을 참조하세요. **저장** 을 클릭합니다. 
...
보다 포괄적인 지침은 [Microsoft 365 Defender 켜기 를 참조하세요.](mtp-enable.md) 
