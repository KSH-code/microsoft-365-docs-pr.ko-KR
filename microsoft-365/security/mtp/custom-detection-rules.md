...
- 설정 권한 역할에서 Microsoft Defender 보안 센터에서 [끝점용 Microsoft Defender에](https://securitycenter.windows.com/) 대한 RBAC   >  **설정을**  >  **확인합니다.** 해당 역할을 선택하여 보안 설정 관리 **권한을 할당합니다.**
...
기존 사용자 지정 검색 규칙을 모두 보시고 **헌팅** 사용자 지정  >  **검색으로 이동합니다.** 페이지에 다음 실행 정보가 있는 모든 규칙이 나열됩니다.
...
규칙 세부 정보 **화면(헌팅** 사용자 지정 검색  >    >  **[규칙 이름])에서** 트리거된 경고로 이동하여 규칙과 일치하여 생성된 경고를 표시합니다. 경고를 선택하여 자세한 정보를 보고 다음 작업을 수행할 수 있습니다.
