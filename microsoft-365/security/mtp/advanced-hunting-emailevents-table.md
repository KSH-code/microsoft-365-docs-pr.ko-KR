...
| `ConfidenceLevel` | 문자열 | 스팸 또는 피싱 판정의 신뢰 수준 목록입니다. 스팸의 경우 이 열은 전자 메일을 건너뛴 경우(-1), 스팸이 아닌 것으로 확인(0,1), 보통 신뢰도(5,6) 또는 높은 신뢰도의 스팸인 것으로 확인(9)을 나타내는 SCL(스팸 지수)을 보여줍니다. 피싱의 경우 이 열에는 신뢰 수준이 "높음" 또는 "낮음"인지 표시됩니다. |
