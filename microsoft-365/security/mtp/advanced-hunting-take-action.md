...
각 작업은 각각 동작 센터 [](mtp-action-center.md) 기록( 또는 )의 security.microsoft.com/action-center/history  >   기록됩니다.[](https://security.microsoft.com/action-center/history) 작업 센터로 이동하여 각 작업의 상태를 검사합니다.
...
- [Action Center 개요](mtp-action-center.md)