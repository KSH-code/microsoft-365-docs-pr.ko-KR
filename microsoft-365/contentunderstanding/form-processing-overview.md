...
[Microsoft 365 Multi-Geo 환경](https://docs.microsoft.com/microsoft-365/enterprise/microsoft-365-multi-geo)에서 SharePoint Syntex를 설정할 때는 중앙 위치에서 양식 처리를 사용하도록만 구성할 수 있습니다. 위성 위치에서 양식 처리를 사용하려는 경우 Microsoft 지원에 문의하세요.
