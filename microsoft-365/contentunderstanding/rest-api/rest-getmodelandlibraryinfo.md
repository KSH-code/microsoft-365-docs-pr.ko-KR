...
모델 및 모델이 적용된 라이브러리에 대한 정보를 가져옵니다([예제](rest-getmodelandlibraryinfo.md#examples) 참조).
...
### <a name="get-information-about-the-contracts-model-and-primed-document-library-in-the-repository-site"></a>리포지토리 사이트에서 계약 모델 및 기본 문서 라이브러리에 대한 정보 가져오기

이 샘플에서 Contoso 계약 문서 이해 모델의 ID는 `7645e69d-21fb-4a24-a17a-9bdfa7cb63dc`입니다.
