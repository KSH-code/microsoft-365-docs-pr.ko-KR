...
모델 제목을 사용하여 SharePoint Syntex 문서 이해 모델에 대한 정보를 가져오거나 업데이트합니다([예제](rest-getbytitle-method.md#examples)참조).
...
### <a name="get-information-about-the-contoso-contract-model"></a>Contoso 계약 모델에 대한 정보 가져오기

이 샘플에서는 Syntex 문서 이해 모델의 이름이 `Contoso Contract`입니다.
...
### <a name="get-and-delete-the-contoso-contract-model-by-name"></a>이름으로 Contoso 계약 모델 가져오기 및 삭제

이 샘플에서는 Contoso Contract 문서 이해 모델의 이름이 `Contoso Contract`입니다.
