...
| AI 작성기 크레딧을 사용 합니다.<br>크레딧은 1M으로 일괄 구매할 수 있습니다.<br>300개 이상의 SharePoint Syntex 라이선스를 구매하면 1M 크레딧이 포함됩니다.<br>1M 크레딧은 2,000개 파일 페이지를 처리하도록 허용합니다. | 모델은 모든 라틴어 알파벳 언어로 작동됩니다. 영어 외에 독일어, 스웨덴어, 프랑스어, 스페인어, 이탈리아어 및 포르투갈어 |
