...
전체 조직을 [](search.md#topic-answer) 포함하기 위해 검색 범위를 변경한 후 SharePoint 시작 페이지에서 검색하거나 Office.com에서 검색하거나 SharePoint 사이트에서 검색할 때 검색 결과에 항목 응답을 볼 수 있습니다. 이 항목의 대답은 결과 목록의 항목에 표시되어 해당 항목과 관련된 짧은 정보 집합을 제공합니다. 

   ![사이트 검색의 검색 결과를 보여 SharePoint 스크린샷.](../media/knowledge-management/site-search-results.png) 

### <a name="office-application-search"></a>Office 응용 프로그램 검색
