...
Viva 항목에서는 Microsoft AI 기술, Microsoft 365, Microsoft Graph, 검색 및 기타 구성 요소 및 서비스를 사용하여 Word, SharePoint, Microsoft Search 및 Search in Word, SharePoint 최신 페이지, Microsoft Search 및 Search로 시작하는 Microsoft 365 앱의 사용자에게 지식을 PowerPoint, Outlook 및 Excel.
