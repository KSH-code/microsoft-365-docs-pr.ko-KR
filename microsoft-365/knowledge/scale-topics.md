...
Viva 항목을 구성할 때 사용 권한이 부여된 사용자 그룹을 추가하여 항목  관리 환경을 항목 센터에서 볼 수 있습니다. 이 항목은 항목에 대한 기본 큐레이터 역할을 보유하는 사용자에게만 표시됩니다. 또한 항목에 대한 데이터에 액세스할 수 있으며 검토 및 큐레이터에 액세스할 수 있는 모든 항목의 목록을 볼 수 있습니다.
