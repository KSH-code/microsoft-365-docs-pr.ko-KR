...
4. [챔피언 네트워크 구축:](#build-a-champion-network)
    - 연습 커뮤니티나 챔피언 네트워크가 이미 있을 수 있습니다. 이러한 방법은 서로에게 도움을 주면서 동료를 공유하고 전도하고 참여할 수 있는 좋은 방법입니다. 또한 매우 유용한 성공 사례를 공유할 수 있습니다. 조언을 제공하고 기대를 생성할 수 있습니다.

### <a name="target-scenarios"></a>대상 시나리오

항목에 성공하려면 먼저 조직에서 Viva 항목을 사용할 방법을 결정해야 합니다. 다음은 지식 관리 및 항목으로 조직에 도움이 되는 몇 가지 시나리오입니다.
