...
이 페이지의 리소스는 조직에서 Viva 항목에 대해 알아보고 사용하는 것을 시작할 수 있도록 디자인됩니다.
...
| 이 정보를 찾고 있는 경우 다음을 수행하세요. | 방문할 리소스: |
|:-----|:-----|
|항목으로 작업하는 방법 학습|[토픽 센터 개요](topic-center-overview.md)<br><br>[항목 관리](manage-topics.md)<br><br>[새 항목 만들기](create-a-topic.md)<br><br>[기존 항목 편집](edit-a-topic.md)<br><br>[Microsoft Search를 사용하여 항목 찾기](search.md)<br><br>|
