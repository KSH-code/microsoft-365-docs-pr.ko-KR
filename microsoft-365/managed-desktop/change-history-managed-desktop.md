...
--- | ---
[디바이스 인벤토리](working-with-managed-desktop/device-inventory-report.md) | 새 문서
...
[Microsoft Managed Desktop에서 업데이트를 처리 하는 방법](service-description/updates.md) | 업데이트된 문서
...
[Microsoft Project 및 microsoft Visio (관리 되는 데스크톱 장치) 설치](get-started/project-visio.md) | 새 문서 
...
[파트너에 대 한 Microsoft Managed Desktop의 장치 등록](get-started/register-devices-partner.md) | 새 문서
...
[장치 시작 하기](get-started/get-started-devices.md) | 새 문서
