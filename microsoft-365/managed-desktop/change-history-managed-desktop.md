...
새 문서 또는 변경된 문서 | 설명
--- | ---
[Microsoft Managed Desktop이란 무엇인가요?](https://docs.microsoft.com/microsoft-365/managed-desktop/intro/index) | 업데이트된 문서
[보고서 작업](working-with-managed-desktop/reports.md) | 업데이트된 문서
...
[Microsoft Managed Desktop의 필수 구성 요소](get-ready/prerequisites.md) | 업데이트된 문서
[Microsoft Managed Desktop의 보안 작업](service-description/security-operations.md) | 새 문서
[관리 포털 액세스](get-started/access-admin-portal.md) | 업데이트된 문서
...
새 문서 또는 변경된 문서 | 설명
--- | ---
[Microsoft Managed Desktop의 보안](service-description/security.md)| 업데이트된 문서
[인사이트를 활용한 작업](working-with-managed-desktop/insights.md) | 업데이트된 문서
[Windows 보안 업데이트 정보 활용](working-with-managed-desktop/security-update-insights.md) | 새 문서
[Microsoft Managed Desktop에서 업데이트 처리 방법](service-description/updates.md) | 업데이트된 문서
...
새 문서 또는 변경된 문서 | 설명
--- | ---
[인사이트를 활용한 작업](working-with-managed-desktop/insights.md) | 새 문서
[인사이트 활용](working-with-managed-desktop/usage-insights.md) | 새 문서
[안정성 인사이트](working-with-managed-desktop/reliability-insights.md) | 새 문서
[Microsoft Managed Desktop 장치](service-description/device-list.md) | 업데이트된 문서
[Microsoft Managed Desktop 기본 페이지](https://docs.microsoft.com/microsoft-365/managed-desktop/) | 업데이트된 문서
[Microsoft Managed Desktop이란 무엇인가요?](https://docs.microsoft.com/microsoft-365/managed-desktop/intro/index) | 업데이트된 문서
[사용자들이 장치를 사용할 수 있도록 준비시키기](get-started/get-started-devices.md) | 업데이트된 문서
...
[Microsoft Managed Desktop 제품 수명 주기](service-description/device-lifecycle.md) | 새 문서
...
새 문서 또는 변경된 문서 | 설명
--- | ---
[Microsoft Managed Desktop 장치에 Intune 회사 포털 설치](get-started/company-portal.md) | 새 문서
...
새 문서 또는 변경된 문서 | 설명
--- | ---
[Microsoft Managed Desktop 장치용 앱 배포](get-started/deploy-apps.md) | 새 문서입니다.
[Microsoft Managed Desktop용 앱 관리](working-with-managed-desktop/manage-apps.md) | 이전 버전의 비즈니스 앱 업데이트 또는 롤백 방법에 대한 정보로 업데이트되었습니다. 

## <a name="december-2018"></a>2018년 12월
새 문서 또는 변경된 문서 | 설명
--- | ---
[Microsoft Managed Desktop 운영 및 모니터링](service-description/operations-and-monitoring.md) | 책임 테이블의 균형이 추가되어 다른 테이블이 업데이트되었습니다.
...
새 문서 또는 변경된 문서 | 설명
--- | ---
[Microsoft Managed Desktop 지원](service-description/support.md)<br />및 [Microsoft Managed Desktop에 대한 사용자 지원](working-with-managed-desktop/end-user-support.md) | 오스트레일리아를 포함하기 위해 업데이트되었습니다.

## <a name="october-30-2018"></a>2018년 10월 30일
콘텐츠 재구성: Microsoft [Managed Desktop 서비스 설명에 대한 섹션이 추가되었습니다.](service-description/index.md) 
