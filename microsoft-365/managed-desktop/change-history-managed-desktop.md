...
[Microsoft Managed Desktop 장치](service-description/device-list.md) | 업데이트된 문서
[Microsoft Managed Desktop 기본 페이지](./index.yml) | 업데이트된 문서
[Microsoft Managed Desktop이란 무엇인가요?](./intro/index.md) | 업데이트된 문서
[사용자들이 장치를 사용할 수 있도록 준비시키기](get-started/get-started-devices.md) | 업데이트된 문서
...
신규 또는 변경된 문서 | 설명
--- | ---
[Microsoft Managed Desktop 장치용 앱 배포](get-started/deploy-apps.md) | 새 문서.
...
신규 또는 변경된 문서 | 설명
--- | ---
[Microsoft Managed Desktop 운영 및 모니터링](service-description/operations-and-monitoring.md) | 책임 테이블의 균형을 추가하고 다른 테이블을 업데이트했습니다.
...
콘텐츠 다시 구성: Microsoft [Managed Desktop 서비스 설명에 대한 섹션이 추가되었습니다.](service-description/index.md)