...
하나 이상의 기본 제공 역할을 기존 그룹에 할당해야 하는 경우 다음 단계를 수행합니다.
1. 다음으로 [portal.azure.com.](https://portal.azure.com/)
2. 엔터프라이즈 응용 프로그램을 **검색하고 여는 중입니다.**
3. 응용 프로그램 유형 **필터를** _Microsoft 응용_ 프로그램으로 변경한 다음 적용을 **선택합니다.**
