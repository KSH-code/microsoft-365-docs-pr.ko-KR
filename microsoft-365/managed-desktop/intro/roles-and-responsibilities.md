...
엔터프라이즈 구성 및 관리를 위한 Microsoft 365 앱 | Microsoft는 최종 사용자에 게 Office 응용 프로그램을 배포 하 고 해당 응용 프로그램을 최신 상태로 유지 하 고 있는지를 담당 합니다. <br><br> 고객은 Exchange Online 관리 책임을 포함 하 여 Microsoft 365 서비스 및 정책 관리를 담당 합니다.<br>-전자 메일 관리<br>-사서함 및 규칙 구성<br>-Exchange 온-프레미스 관리<br><br>고객은 Microsoft 365 관리 센터에 설정 된 공동 작업 도구, SharePoint server 관리, 도메인 관리, 보안 및 정보 정책도 담당 합니다. 
