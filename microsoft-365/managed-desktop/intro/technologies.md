...
OneDrive |OneDrive에 처음 로그인 할 때 사용자에 대해 Azure Active Directory Single Sign-on을 사용 하도록 설정 합니다.<br><br>"Desktop", "Document" 및 "Pictures" 폴더에 대해 알려진 폴더 리디렉션이 포함 됩니다. Microsoft Managed Desktop에서 사용 하도록 설정 하 고 구성 합니다.
