...
웹 응용 프로그램 |  Yammer, Office for browser, Delve, Flow, StaffHub, PowerApps는 장치와 함께 제공 되지 않습니다. 사용자는 브라우저를 사용 하 여 이러한 응용 프로그램의 웹 버전에 액세스할 수 있습니다.
...
Microsoft Defender Advanced Threat Protection | 이는 Microsoft Managed Desktop에서 장치 보안 정책을 관리 하는 데 사용 됩니다. 
