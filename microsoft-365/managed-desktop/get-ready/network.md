...
Azure Active Directory Domain Services | [하이브리드 ID에는 포트 및 프로토콜이 필요하고](/azure/active-directory/hybrid/reference-connect-ports) [Active Directory 및 Active Directory 도메인 서비스 포트 요구 사항](/previous-versions/windows/it-pro/windows-server-2008-R2-and-2008/dd772723(v=ws.10)) 
...
4. [네트워크 구성에 Microsoft Managed Desktop(이](network.md) 문서)
