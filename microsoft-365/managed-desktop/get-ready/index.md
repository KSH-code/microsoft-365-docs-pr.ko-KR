...
이러한 항목에서는 환경에서 주요 필수 구성 요소를 충족 하는지 확인 하 고, 네트워크를 구성 하 고, 인증서를 설정 하 고, 서비스에 포함할 앱을 준비 하는 등 조직에서 등록을 준비 하기 위해 수행 해야 하는 단계에 대해 설명 합니다.

- [Microsoft Managed Desktop의 필수 구성 요소](prerequisites.md)
- [Microsoft Managed Desktop에 대 한 네트워크 구성](network.md)
...
- [Microsoft Managed Desktop의 앱](apps.md)
