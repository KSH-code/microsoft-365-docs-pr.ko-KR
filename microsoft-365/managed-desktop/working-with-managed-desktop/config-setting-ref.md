...
조직의 Microsoft Managed Desktop 장치에 대한 데스크톱 배경 그림을 사용자 지정할 수 있습니다. 이를 사용하여 회사 브랜드 또는 마케팅 자료를 적용할 수 있습니다. 
...
3. 설정 **작업** 영역에서 바탕 화면 배경 **그림 을 선택합니다.** 
4. 사용할 그림의 위치를 입력합니다. 
...
1. [Microsoft Endpoint Manager에 로그인하고](https://endpoint.microsoft.com/) 장치 **메뉴로** 이동합니다.
2. Microsoft Managed Desktop 섹션을 찾아 설정을 **선택합니다.**
3. 설정 **작업** 영역에서 브라우저 시작 **페이지를 선택합니다.** 
4. 시작 **페이지 추가를 선택합니다.**
...
- **제한된 수의** 사이트 선택 - Microsoft Managed Desktop은 Microsoft Edge를 기본 설정 브라우저로 사용하여 조직의 전반적인 보안과 사용자의 사용성을 향상합니다. 이 목록의 대부분의 사이트는 많은 보안 기능을 포함하지 않는 이전 버전의 브라우저가 필요한 레거시 웹앱용입니다. 
...
1. [Microsoft Endpoint Manager에 로그인하고](https://endpoint.microsoft.com/) 장치 **메뉴로** 이동합니다.
2. Microsoft Managed Desktop 섹션을 찾아 설정을 **선택합니다.**
3. 설정 **작업** 영역에서 엔터프라이즈 모드 사이트 목록 **위치를 선택합니다.** 
...
1. [Microsoft Endpoint Manager에 로그인하고](https://endpoint.microsoft.com/) 장치 **메뉴로** 이동합니다.
2. Microsoft Managed Desktop 섹션을 찾아 설정을 **선택합니다.**
3. 설정 **작업** 영역에서 신뢰할 수 있는 사이트 **를** 선택한 다음 신뢰할 수 있는 사이트 **추가 를 선택합니다.** 
...
1. [Microsoft Endpoint Manager에 로그인하고](https://endpoint.microsoft.com/) 장치 **메뉴로** 이동합니다.
2. Microsoft Managed Desktop 섹션을 찾아 설정을 **선택합니다.**
3. 설정 **작업** 영역에서 신뢰할 수 있는 **사이트를 선택합니다.** 
...
Microsoft Managed Desktop 포털에서 추가하는 프록시 사이트 예외는 Microsoft Managed Desktop 서비스에 포함된 기본 프록시 예외에 추가됩니다. 
