...
조직의 Microsoft Managed desktop 장치에 대 한 바탕 화면 배경 그림을 사용자 지정할 수 있습니다. 이를 사용 하 여 회사 브랜드 또는 마케팅을 적용할 수 있습니다. 
...
5. **단계 배포** 를 선택 하 여 변경 내용을 저장 하 고 테스트 링에 배포 합니다. 
...
7. **단계 배포** 를 선택 하 여 변경 내용을 저장 하 고 테스트 링에 배포 합니다.
