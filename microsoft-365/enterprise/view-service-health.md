...
관리 센터에 로그인 할 수 없는 경우 [서비스 상태 페이지](https://status.office365.com) 를 사용 하 여 테 넌 트에 로그인 하지 못하도록 하는 알려진 문제를 확인할 수 있습니다.  또한 특정 이벤트에 대 한 정보를 보려면 Twitter에서 [@MSFT365status](https://twitter.com/MSFT365Status) 에 따라 로그인 합니다.
...
대시보드에 표시 되는 서비스에 대해 보기를 사용자 지정 하려면 **기본 설정**  >  **사용자 지정 보기** 를 선택 하 고, 서비스 상태 대시보드 보기에서 필터링 할 서비스에 대 한 확인란의 선택을 취소 합니다. 모니터링할 각 서비스에 대해 확인란이 선택 되어 있는지 확인 합니다.    

활성 인시던트의 테 넌 트 및 상태 변경에 영향을 주는 새 인시던트의 전자 메일 알림을 등록 하려면 **기본 설정**  >  **전자 메일** 을 선택 하 고 **전자 메일에서 me service heath 알림 보내기를** 클릭 한 후 다음을 지정 합니다.
...
[![서비스 advise ](../media/service-health-advisory.png) 를 보여 주는 스크린샷](../media/service-health-advisory.png#lightbox)
...
[Microsoft 365 관리 센터](https://support.office.com/article/0d6dfb17-8582-4172-a9a9-aed798150263) 
 의 활동 보고서 [메시지 센터 기본 설정](https://docs.microsoft.com/microsoft-365/admin/manage/message-center?view=o365-worldwide&preserve-view=true#preferences11)
