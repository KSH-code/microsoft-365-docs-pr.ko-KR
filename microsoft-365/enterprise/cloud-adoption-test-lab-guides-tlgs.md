---
title: 테스트 Microsoft 365(테스트 랩 가이드)
ms.author: josephd
...
## <a name="microsoft-365-devtest-environment"></a>Microsoft 365/테스트 환경

다음 문서를 사용하여 Microsoft 365/테스트 환경을 구축할 수 있습니다.
  
- [간단한 기본 구성](lightweight-base-configuration-microsoft-365-enterprise.md)
    
    E5 Microsoft 365 Enterprise 구독을 만들 수 있습니다.

- [시뮬레이트된 엔터프라이즈 기본 구성](simulated-ent-base-configuration-microsoft-365-enterprise.md)
    
    Microsoft Azure 인프라 서비스 및 E5 평가판 구독에서 Microsoft 365 Enterprise 간소화된 인트라넷을 만들 수 있습니다. 

    이 단계는 선택 사항이며 하이브리드 ID에 대한 시뮬레이트된 엔터프라이즈 구성을 구축하려는 경우에 필요합니다.
    
Office 365 및 Microsoft 365 추가 TLG에 대한 자세한 Microsoft 365 [테스트 랩 가이드로 이동하세요.](m365-enterprise-test-lab-guides.md)  
