...
[Microsoft 365에 대한 암호 해시 동기화의 지침을 따릅니다.](password-hash-sync-m365-ent-test-environment.md) 
...
- Azure AD Connect는 TESTLAB AD DS(Active Directory 도메인 서비스) 도메인을 Microsoft 365 구독의 Azure AD 테넌트와 주기적으로 동기화하기 위해 APP1에서 실행됩니다.
...
11. Azure Portal의 왼쪽 창에서 Azure **Active Directory**  >  **Azure AD Connect 를 선택합니다.** **Seamless Single Sign-On** 기능이 사용으로 **나타나는지 확인합니다.**
