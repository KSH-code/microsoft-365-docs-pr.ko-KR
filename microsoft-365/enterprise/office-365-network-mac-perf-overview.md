...
조직을 대신하여 이 기능에 대한 공개 미리 보기에 참가할지 묻는 질문이 표시될 수 있습니다. 일반적으로 수락이 즉시 발생하면 네트워크 연결 페이지가 표시됩니다. 
...
이 옵션은 Windows 위치 서비스 및 Wi-Fi 필요하지 않습니다. 위치의 각 컴퓨터에 Windows 버전 **20.161** 이상용 OneDrive가 필요합니다.
...
최적의 Microsoft 365 서비스 프런트 도어는 일반적으로 도시 또는 대도시 지역에 있는 네트워크에서 가장 가까운 서비스입니다. Microsoft [365](office-365-network-mac-perf-onboarding-tool.md) 연결 테스트 도구(미리 보기)를 사용하여 사용 중 Microsoft 365 서비스 프런트 도어의 위치와 최적의 서비스 프런트 도어를 확인할 수 있습니다. 이 도구에서 사용 중 프런트 도어가 최적으로 확인된 경우 Microsoft의 전역 네트워크에 최적으로 연결하게 됩니다.
