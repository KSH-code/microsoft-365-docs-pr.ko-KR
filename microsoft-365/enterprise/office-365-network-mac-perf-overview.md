...
Microsoft 365 관리 센터에는 이제 Microsoft 365 테 넌 트에서 수집 된 라이브 성능 메트릭이 포함 되며, 테 넌 트의 관리 사용자만 볼 수 있습니다. **네트워크 insights 및 성능 권장 사항** 및 **네트워크 평가가** Microsoft 365 관리 센터 ()에 표시 됩니다 <https://portal.microsoft.com/adminportal/home#/networkperformance> . 탐색 창의 상태 |에 페이지를 찾을 수 있습니다. ** 네트워크 성능**
