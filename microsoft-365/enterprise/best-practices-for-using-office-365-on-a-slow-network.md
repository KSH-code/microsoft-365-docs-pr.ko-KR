...
자세한 내용은 Windows 성능 및 [유지](https://windows.microsoft.com/windows/performance-maintenance-help#performance-maintenance-help) 관리 및 팁 에서 [PC](https://support.microsoft.com/en-za/help/4002019/windows-10-improve-pc-performance)성능을 개선하기 위한 Windows 10.
