...
관리자는 종종 기존 시스템에서 전자 메일을 처음 설정할 때 전자 메일을 Microsoft 365. 다음 문서에서는 다음 문서를 사용하여 전자 메일을 마이그레이션하는 Windows PowerShell.
...
[PowerShell을 사용하여 Microsoft 365 이유](why-you-need-to-use-microsoft-365-powershell.md)
