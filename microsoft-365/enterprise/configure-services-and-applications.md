...
ms.locfileid: "46694981"
---
# <a name="configure-microsoft-365-enterprise-services-and-applications"></a>Microsoft 365 Enterprise 서비스 및 응용 프로그램 구성

기본 [설정 지침은](https://docs.microsoft.com/microsoft-365/admin/setup/setup) 가능한 한 짧은 시간에 모든 사람이 Microsoft 365 서비스 및 응용 프로그램을 사용할 수 있도록 합니다. 경우에 따라 모든 사용자가 사용을 시작하기 전에 구성하는 것이 좋은 경우도 있습니다. 예를 들어 메일 라우팅, 파일 저장소 또는 공유 정책을 구성하려는 경우 
