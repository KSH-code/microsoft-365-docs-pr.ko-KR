...
엔터프라이즈 기반이 아닌 조직도 Microsoft 365 Enterprise를 배포하여 팀워크를 활성화하고 창의성을 여는 통합된 보안 인프라의 비즈니스 가치를 실현할 수 있습니다. 일반적으로 엔터프라이즈 기반이 아닌 조직은 다음을 포함합니다.
...
온-프레미스 AD DS 도메인이 있는 경우, Microsoft 365 Enterprise의 그룹을 Azure AD의 그룹으로 계속 사용합니다.
...
| 로그인 위험 수준이 보통 또는 위험인 경우 MFA 필요(Microsoft 365 Enterprise E5 필요) | 기준 |
| 로그인 위험이 낮음, 보통 또는 높음인 경우 MFA 필요(Microsoft 365 Enterprise E5 필요) | 중요 |
| 항상 MFA 필요 | 매우 엄격한 규제 |
...
다음은 만들고 활성화할 Azure AD Identity Protection(Microsoft 365 Enterprise E5 필요) 사용자 위험 정책입니다.
...
Microsoft 365 Enterprise에는 다양한 수준의 관리, 보안 및 보호를 적용하여 데이터 분류를 다르게 처리할 수 있는 정보 보호 기능 호스트가 있습니다. 
...
다음은 엔터프라이즈가 아닌 조직을 위한 Microsoft 365 Enterprise 기본 인프라 구성의 결과입니다.

### <a name="infrastructure-results"></a>인프라 결과

Microsoft 365 Enterprise 인프라를 빌드하고 구성한 후에는 다음이 있어야 합니다.
