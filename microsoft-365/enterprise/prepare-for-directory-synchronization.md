...
- **mailNickname** (Exchange 별칭)
  ...
  - 특성 값은 디렉터리 내에서 고유 해야 합니다.
    ...
    > [!NOTE]
    > 동기화 된 이름에서 밑줄 ("_")은이 특성의 원래 값에 잘못 된 문자가 있음을 나타냅니다. 이 특성에 대 한 자세한 내용은 [Exchange alias 특성](https://docs.microsoft.com/powershell/module/exchange/set-mailbox)을 참조 하십시오.
    >
