...
- 6월에는 Office 2013을 대체하는 Microsoft 365 앱을 설치합니다. (엔터프라이즈 용 Microsoft 365 앱)
...
- 7 월에는 Office 2013을 대체하는 Microsoft 365 앱을 설치합니다. (엔터프라이즈 용 Microsoft 365 앱)
...
- 4월에는 Office 2013을 대체하는 Microsoft 365 앱을 설치합니다. (엔터프라이즈 용 Microsoft 365 앱)
...
- 1월부터 MFA를 위해 내 스마트폰을 사용해야 합니다. (ID)
- 3월에는 내 Windows 8.1 데스크톱에 Windows 10 Enterprise를 설치하게 됩니다. (Windows 10 Enterprise)
- 5월에는 Office 2013을 대체하는 Microsoft 365 앱을 설치합니다. (엔터프라이즈 용 Microsoft 365 앱)
...
- 2월에는 Office 2013을 대체하는 Microsoft 365 앱을 설치합니다. (엔터프라이즈 용 Microsoft 365 앱)
...
- 1월부터 MFA를 위해 내 스마트폰을 사용해야 합니다. (ID)
- 2월에는 내 Windows 8.1 데스크톱에 Windows 10 Enterprise를 설치하게 됩니다. (Windows 10 Enterprise)
- 3월에는 Office 2013을 대체하는 Microsoft 365 앱을 설치합니다. (엔터프라이즈 용 Microsoft 365 앱)
...
- 엔터프라이즈 용 Office Suite Microsoft 365 앱 (엔터프라이즈 용 Microsoft 365 앱)
- 앱 및 장치 정책(모바일 장치 관리)
