...
Azure Active Directory powerShell for Graph cmdlet 참조 항목은 Azure Active Directory PowerShell for Graph 참조 [섹션에 있습니다.](/powershell/azure/active-directory/install-adv2?view=azureadps-2.0)

Azure Active Directory cmdlet용 Windows PowerShell 모듈은 [MSOnline(msOnline)](/powershell/azure/active-directory/overview?view=azureadps-1.0)설명서의 reference 섹션에 Azure Active Directory 있습니다.
