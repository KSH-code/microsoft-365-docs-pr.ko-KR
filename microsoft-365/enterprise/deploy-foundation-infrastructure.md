...
|![4단계: 엔터프라이즈용 Microsoft 365 앱](../media/deploy-foundation-infrastructure/O365proplus_icon-small.png)|[4단계: 엔터프라이즈용 Microsoft 365 앱](office365proplus-infrastructure.md)| 기존의 Microsoft Office 사용자는 엔터프라이즈용 Microsoft 365 앱으로 업그레이드할 수 있습니다. |
...
|![6단계: 정보 보호](../media/deploy-foundation-infrastructure/infoprotection_icon-small.png)|[6단계: 정보 보호](infoprotect-infrastructure.md)| Microsoft 365 보안 기능을 사용하도록 설정되었으며 레이블과 정책으로 문서 및 전자 메일을 보호할 준비가 되어있습니다. |
...
| 엔터프라이즈용 Microsoft 365 앱 | Office 2010, Office 2013 또는 Office 2016의 사용자를 위해 자동으로 엔터프라이즈용 Microsoft 365 앱을 배포하는 그룹. |
| 모바일 장치 관리 | 디바이스 등록 및 디바이스 기반 조건부 액세스 정책의 그룹. |
| 정보 보호 | 민감도 레이블을 위한 그룹 |
...
| 엔터프라이즈용 Microsoft 365 앱 | Office 2010, Office 2013 또는 Office 2016의 사용자를 위해 엔터프라이즈용 Microsoft 365 앱을 자동으로 배포하기 위해 그룹에 사용자 계정을 추가합니다. |
| 모바일 장치 관리 | 장치 등록 및 장치 기반 조건부 액세스 정책에 대한 그룹에 계정을 추가하십시오. |
| 정보 보호 | 민감도 레이블을 위한 그룹에 사용자 계정을 추가합니다. |

기초 인프라의 단계나 요소를 완료하고, 테스트하고, 시험 사용한 후, Windows 10 Enterprise 및 엔터프라이즈용 Microsoft 365 앱과 같이 설치된 소프트웨어와 디바이스 등록 및 조건부 액세스 정책과 같은 클라우드 기반 서비스 및 보호 기능을 비즈니스 목적 및 IT 리소스에 최적화된 방식으로 사용자에게 공개할 수 있습니다.
...
조직이 소규모이므로 비즈니스용 Microsoft 365가 사용자에게 적합하지 않은 경우 [비 엔터프라이즈를 위한 배포](deploy-foundation-infrastructure-non-enterprises.md)를 참조하여 간소화된 배포 방법을 확인하세요.
