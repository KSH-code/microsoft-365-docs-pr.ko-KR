...
### [고도로 규제되는 데이터를 위한 Teams 및 사이트](teams-sharepoint-online-sites-highly-regulated-data.md)
...
### [강도 높은 규제 대상 데이터를 위한 SharePoint Online 사이트](contoso-sharepoint-online-site-for-highly-confidential-assets.md)
