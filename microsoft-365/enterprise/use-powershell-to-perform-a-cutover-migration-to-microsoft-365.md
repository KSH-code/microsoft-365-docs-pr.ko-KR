...
DNS 공급자가 많이 있으므로 MX 레코드를 변경하기 위한 특정 지침이 제공됩니다. DNS 공급자가 포함 되어 있지 않거나 일반적인 지침을 이해 하려는 경우에는 [일반 MX 레코드 지침도](https://support.office.microsoft.com/article/7b7b075d-79f9-4e37-8a9e-fb60c1d95166#bkmk_add_mx) 함께 제공 됩니다.
