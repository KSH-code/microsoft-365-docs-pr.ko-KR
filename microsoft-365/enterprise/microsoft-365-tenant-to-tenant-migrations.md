...
이 모델을 PDF 형식으로 [다운로드하여](https://github.com/MicrosoftDocs/microsoft-365-docs/raw/public/microsoft-365/downloads/Microsoft-365-tenant-to-tenant-migration.pdf) 편지형, 법률형 또는 타블로이드(11 x 17) 크기 용지에 인쇄합니다.
