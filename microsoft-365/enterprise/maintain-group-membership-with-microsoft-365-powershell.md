...
>[!Note]
>[그룹 구성원 자격을 Microsoft 365 방법을](../admin/create-groups/add-or-remove-members-from-groups.md) Microsoft 365 관리 센터. 추가 리소스 목록은 사용자 및 그룹 [관리를 참조하세요.](/admin)
>
