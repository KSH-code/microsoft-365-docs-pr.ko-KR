...
> [!NOTE]
> eDiscovery를 사용하는 경우 [eDiscovery](ms-cloud-germany-transition-add-experience.md#ediscovery-phase-4-to-the-end-of-phase-9)마이그레이션 환경을 알고 있어야 합니다.
...
## <a name="power-bi-phase-8"></a>Power BI(8단계)
...
마이그레이션 후 활동 [문서를](ms-cloud-germany-transition-add-experience.md#post-migration) 읽고 그에 따라 실행해야 합니다.
