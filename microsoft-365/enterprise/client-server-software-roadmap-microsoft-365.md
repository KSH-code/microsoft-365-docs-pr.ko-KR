...
대부분의 엔터프라이즈 조직은 다양 한 버전의 운영 체제, 클라이언트 소프트웨어 및 서버 소프트웨어를 사용 하는 이기종 환경을 보유 하 고 있습니다. 엔터프라이즈에 대 한 Microsoft 365에는 클라우드 기술을 활용 하도록 설계 된 생산성 기능과 함께 IT 인프라의 가장 안전한 버전의 IT 인프라가 포함 되어 있습니다.
...
- 서버에 설치 된 Office 서버는 Microsoft 365의 해당 서비스로 해당 서비스
...
3. 개별적으로 또는 IT 출시와 함께 엔터프라이즈용 Microsoft 365 앱을 설치합니다. 자세한 내용은 [Microsoft 365 앱 배포 가이드](https://docs.microsoft.com/deployoffice/deployment-guide-microsoft-365-apps)를 참조 하세요.
...
- Exchange Server에서 Exchange Online으로의 사용자 사서함 [은 온-프레미스 조직과 Exchange online 조직 간의 사서함 이동을](https://docs.microsoft.com/exchange/hybrid-deployment/move-mailboxes)참조 하세요.
- Sharepoint Server에서 sharepoint Online으로 데이터를 [마이그레이션하려면 Microsoft 365로 콘텐츠 마이그레이션을](https://docs.microsoft.com/sharepointmigration/migrate-to-sharepoint-online)참조 하세요.
- 비즈니스용 Skype Online은 [마이그레이션 및 상호 운용성 지침](https://docs.microsoft.com/microsoftteams/migration-interop-guidance-for-teams-with-skype)을 참조 하세요.
...
1. Office 2007 서버의 데이터를 Microsoft 365로 마이그레이션합니다. 이를 위해 Microsoft 파트너를 고용 합니다.
...
1. Office 2013 서버의 데이터를 Microsoft 365로 마이그레이션합니다. 이에 대한 도움이 필요하면 [Microsoft 365의 FastTrack](https://fasttrack.microsoft.com/microsoft365) 또는 Microsoft 파트너 고용을 참조하세요.
2. 사용자에게 새 기능 및 작업 프로세스 롤아웃
...
1. Office 2016 서버의 데이터를 Microsoft 365로 마이그레이션합니다. 이에 대한 도움이 필요하면 [Microsoft 365의 FastTrack](https://fasttrack.microsoft.com/microsoft365) 또는 Microsoft 파트너 고용을 참조하세요.
2. 사용자에게 새 기능 및 작업 프로세스 롤아웃
...
이 한 페이지 포스터는 Office 2010 클라이언트 및 서버 제품 및 Windows 7의 지원 종료를 방지 하기 위해 수행할 수 있는 다양 한 경로를 이해 하는 데 도움이 되는 빠른 방법 이며, 엔터프라이즈가 강조 하기 위해 Microsoft 365의 기본 설정 경로 및 결과 대상을 지원 합니다.
