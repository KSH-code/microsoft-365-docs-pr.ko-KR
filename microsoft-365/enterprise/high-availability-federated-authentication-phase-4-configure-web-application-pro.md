...
[5 단계: Microsoft 365에 대 한 페더레이션 인증 구성](high-availability-federated-authentication-phase-5-configure-federated-authentic.md)에서 이동 하기 전에이 단계를 완료 해야 합니다. 모든 단계에 대 한 자세한 내용은 [Azure에서 Microsoft 365에 대 한 고가용성 페더레이션 인증 배포](deploy-high-availability-federated-authentication-for-microsoft-365-in-azure.md) 를 참조 하세요.
...
[Microsoft 365 개발/테스트 환경용 페더레이션 id](federated-identity-for-your-microsoft-365-dev-test-environment.md)
