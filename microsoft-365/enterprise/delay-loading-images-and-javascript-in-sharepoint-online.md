...
JavaScript를 사용 하 여 웹 브라우저에서 이미지를 미리 가져오는 것을 방지할 수 있습니다. 이렇게 하면 전반적인 문서 렌더링이 향상 됩니다. 이렇게 하려면 tag에서 src 특성 값을 제거 하 \<img\> 고 데이터-src와 같은 데이터 특성에 있는 파일에 대 한 경로로 바꿉니다. 예를 들면 다음과 같습니다.
