...
이 문서의 지침을과 함께 Microsoft 365 기업 테스트 환경에서 Office 365 레이블을 사용 하 여 데이터 분류를 구성 합니다.
...
이 단계에서는 다양 한 수준의 SharePoint Online 문서 폴더에 대 한 보안에 대 한 레이블을 만듭니다.
  
1. 필요한 경우 인터넷 브라우저의 개인 인스턴스를 사용 하 고 전역 관리자 계정 사용 하 여 Office 365 포털에 로그인 합니다. 도움말을 보려면 [Office 365에 로그인 할 위치](https://support.office.com/Article/Where-to-sign-in-to-Office-365-e9eb7d51-5430-4929-91ab-6157c5a050b4)를 참조 하십시오.
...
## <a name="phase-3-apply-office-365-labels-to-documents"></a>3 단계: Office 365 레이블을 문서에 적용
...
5. **속성** 섹션 **적용 레이블**아래에서 오른쪽 창에서 문서 자동으로 적용 하는 **중요 한** 레이블 길었던는 note 합니다.
    
6. **모든 편집**을 클릭 합니다.
    
7. **Document.docx** 창의 **적용 레이블** **매우 기밀** 레이블 선택한 다음 **저장**을 클릭 합니다.

정보 및 프로덕션 환경에서 Office 365 레이블에 대 한 링크에 대 한 **정보 보호** 단계에서 [사용자 환경에 대 한 구성 분류](data-classification-microsoft-365-enterprise-dev-test-environment.md) 단계를 참조 하십시오.
