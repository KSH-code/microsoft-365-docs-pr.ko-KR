...
1. 전역 관리자 계정으로 [Microsoft 365 준수 포털](https://compliance.microsoft.com) 에 로그인 합니다.
    
2. 브라우저의 **Home-Microsoft 365 준수** 탭에서 **분류 > 레이블을**클릭 합니다.
    
3. **보존 레이블 > 레이블 만들기**를 클릭합니다.
    
4. **레이블 이름** 지정 창의 **이름**에 **내부 공용** 을 입력 하 고 **다음**을 클릭 합니다.
...
8. 다음 이름을 사용 하 여 추가 레이블에 대해 3-7 단계를 반복 합니다.
