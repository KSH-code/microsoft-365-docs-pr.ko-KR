...
ms.custom: ''
description: 최신 데스크톱 배포 센터의 개요입니다.
ms.openlocfilehash: d9c91c57fda8c1438ae7233002508c51b7b0ff5e
ms.sourcegitcommit: eb1a77e4cc4e8f564a1c78d2ef53d7245fe4517a
ms.translationtype: HT
ms.contentlocale: ko-KR
ms.lasthandoff: 11/28/2018
ms.locfileid: "26870083"
---
# <a name="modern-desktop-deployment-center"></a>최신 데스크톱 배포 센터
...
아래 단계에 따라 Windows 10 및 Office 365 ProPlus의 대규모 배포를 계획하고 수행합니다. 아래의 각 단계는 단계별 배포에서 서로 동시에 실행되는 전반적인 계획/배포 프로세스 및 단계에 속합니다. 배포 프로세스에서 강조 표시된 도구를 사용하는 실무 위주의 학습에 대해서는 무료 [최신 데스크톱 배포 및 관리 랩 키트](https://aka.ms/howtoshiftlabs)를 참조하세요.
...
<td><p><strong><a href="https://aka.ms/mdd7">7단계: Windows 및 Office as a Service 준비</a></strong></p>
...
<p>배포 리서치를 완료하고, 앱 및 장치 준비 상태를 평가하고, 배포 계획을 수립하고, 배포 파일럿을 시작했으나 관리 팀에서 배포 타임라인을 충족하는 데 필요한 지원이나 리소스가 없는 경우 Microsoft의 비즈니스 가치 프로그램이 도움이 될 수 있습니다. 최신 데스크톱에 대한 비즈니스 사례를 구축하고 모든 사용자의 준비를 지원하는 방법을 알아봅니다.</p></td>
