...
4. **구성원**을 클릭하고 **사용자 3**을 찾아서 선택한 다음, **선택** 및 **만들기**를 차례로 클릭합니다.
5. **그룹** 창을 닫습니다.
6. Azure Active Directory 창의 왼쪽 탐색에서 **암호 재설정**을 클릭합니다.
7. **암호 재설정 속성** 창의 옵션 **셀프 서비스 암호 재설정이 사용하도록 설정됨**에서 **선택됨**을 선택합니다.
8. **그룹 선택**을 클릭하고 **PWReset** 그룹을 선택한 다음, **선택 > 저장**을 클릭합니다.
...
10. **확인 단계 1**에서 **Email my alternate email**(다른 이메일로 메일 보내기)를 클릭한 다음, **이메일**을 클릭합니다. 이메일을 받으면 확인 코드를 입력하고 **다음**을 클릭합니다.
