...
Microsoft 365는 Microsoft 365 구독에 포함된 클라우드 기반 사용자 ID 및 인증 서비스인 Azure AD(Azure Active Directory)를 사용하여 Microsoft 365에 대한 ID 및 인증을 관리합니다. 조직에 대한 Microsoft 365 사용자 액세스 및 사용 권한을 관리하려면 ID 인프라를 올바르게 구성하는 것이 중요합니다.
