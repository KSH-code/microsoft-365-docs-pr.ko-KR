...
사용자 계정은 Azure AD에만 저장되어 있기 때문에 Microsoft 365 관리 센터 [](../admin/add-users/index.yml) 및 [Windows PowerShell.](manage-user-accounts-and-licenses-with-microsoft-365-powershell.md) 
...
Azure AD에서 동기화된 사용자 계정을 관리하기 위해 Microsoft 365 관리 센터 또는 PowerShell을 Microsoft 365 사용하지 않습니다.
