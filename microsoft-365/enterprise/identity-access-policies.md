...
새 앱 보호 정책을 만들려면 관리자 자격 증명을 사용 하 여 Microsoft Azure portal에 로그인 한 다음 **모바일 앱 > 앱 보호 정책**으로 이동 합니다. **정책 추가를**선택 합니다.
...
|Defender|Windows Defender 맬웨어 방지|할||
