...
최신 인증을 suppport 하는 Microsoft 365의 클라이언트 목록에 대해서는 [이 문서](microsoft-365-client-support-modern-authentication.md) 를 참조 하십시오.
...
|유형|속성|값|작업|
|:---|:---------|:-----|:----|
|Microsoft Defender Advanced Threat Protection 규칙|장치가 컴퓨터 위험 점수에 있거나 그 아래에 있어야 합니다.|보통|선택한|
|||||
