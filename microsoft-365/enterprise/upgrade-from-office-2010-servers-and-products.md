...
업그레이드를 계획하는 동안 Microsoft 365로 이동하는 것이 고려됩니다.

- Microsoft 365에는 Exchange Server 및 SharePoint Server와 같은 Office 2010 서버 제품 및 Teams 및 비즈니스용 OneDrive와 같은 서비스용 클라우드 기반 서비스가 있습니다.

- Microsoft 365 E3 및 E5에 포함된 엔터프라이즈용 Microsoft 365 앱(이전의 *Office 365 ProPlus)은* 로컬 장치에 설치하는 Office 클라이언트 앱 집합입니다. Microsoft 클라우드에서 정기적으로 새로운 생산성 및 보안 기능으로 업데이트됩니다.

Office 2010 클라이언트 및 서버 및 Windows 7에 대한 업그레이드, 마이그레이션 및 클라우드로의 이동 옵션에 대한 시각적 요약은 지원 종료 포스터를 [참조하세요.](../downloads/Office2010Windows7EndOfSupport.pdf)
...
이 한 페이지 포스터에는 지원 종료 시 Office 2010 클라이언트 및 서버 제품 및 Windows 7을 처리하는 데 사용할 수 있는 다양한 경로가 요약됩니다. Microsoft 365 Enterprise의 기본 경로 및 옵션 지원이 강조 표시됩니다.
...
|---|---|---|
|Office 2010 (Word 2010, Excel 2010, PowerPoint 2010, Outlook 2010 포함)|2020년 10월 13일 |[Office 2010 지원 종료 로드맵](https://docs.microsoft.com/DeployOffice/office-2010-end-support-roadmap)|
...
|Lync Server 2010|2021년 4월 13일|[비즈니스용 Skype 서버 업그레이드 요금제](https://docs.microsoft.com/skypeforbusiness/plan-your-deployment/upgrade)|
