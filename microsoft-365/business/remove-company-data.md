...
3. 관리 **페이지에서** 제거할 데이터를 선택하거나 검색하고 이름을 선택합니다. 
    
4. 다음 창의 장치 목록에서 장치 또는 **장치를** 선택합니다. 열 수 있는 장치 창에서 장치 유형에 따라 장치를 공장 설정으로 다시 설정하거나 회사 데이터를 제거할 수 있습니다. 
    
    ![회사 데이터 제거 창에서 데이터를 제거할 장치를 선택합니다.](../media/resetorremove.png)
  
5. 확인 창에서 확인 **닫기** \> **를 선택 합니다.**
