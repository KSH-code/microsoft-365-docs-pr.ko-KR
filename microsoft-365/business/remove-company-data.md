...
비즈니스용 Microsoft 365을 사용 하 여 사용자가 Microsoft 365로 보호 되는 [장치](app-protection-settings-for-android-and-ios.md) 또는 [Windows pc](protection-settings-for-windows-10-devices.md) 에 대 한 회사 데이터를 제거할 수 있습니다. **장치에서 회사 데이터를 제거하면 나중에 복원할 수 없습니다**. 
