...
여기서 구성하는 설정은 Windows 10의 기본 장치 정책에 해당합니다. Windows 10 장치(모바일 장치 및 PC 포함)에서 회사 계정으로 접속하는 모든 사용자에게는 이와 같은 설정이 자동으로 적용됩니다. 설치 중에 기본 정책을 수락하고 특정 사용자 그룹을 대상으로 하는 정책은 나중에 추가하는 것이 권장됩니다.
