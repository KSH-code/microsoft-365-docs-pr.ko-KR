...
또는 비즈니스에 엔터프라이즈용 Microsoft 365 앱, Windows 10 Enterprise E3 또는 ENTERPRISE CLIENT Access Licenses(CA)가 필요합니다.
...
>[!Note]
>최대 300명까지 Microsoft 365 Business Premium 구독을 사용할 수 있으며 300개가 넘는 사용자 수에 대해 Microsoft 365 E3 구독을 받을 수 있습니다. 그러나 Office 365용 Microsoft Defender는 Microsoft 365 E3에 포함되어 있지 않습니다. 계속 위협 방지를 위해 Office 365용 Defender의 범위에 있는 모든 사용자에게 라이선스를 부여할 수 있도록 Office 365 라이선스에 대한 Defender를 추가해야 합니다.
>
...
이 표에는 Microsoft 365 Business Premium과 Microsoft 365 E3의 차이점이 표시됩니다.
...
| **위협 방지**        | | | 
| 공격 표면 감소 기능    | [이 목록 보기](#threat-protection) | Microsoft Edge에 대한 하드웨어 기반의 엔터프라이즈 관리 | 
...
| Azure AD Premium 1 SSO: 제한 없음(앱 통합 템플릿을 사용하여 Azure AD 응용 프로그램 프록시 및 Self-Service 비 갤러리 앱을 통한 Self-Service 앱)    |     | ![Microsoft 365 E3에 포함](../media/check-mark.png) | 
| **장치 및 앱 관리**        | | | 
...
| **CAL(클라이언트 액세스 라이선스)**    | | |     
| Enterprise CAL Suite(Exchange, SharePoint, Skype, Windows, Microsoft Endpoint Configuration Manager, Windows 권한 관리)| |         ![Microsoft 365 E3에 포함](../media/check-mark.png) | 
| **규정 준수**        | | | 
...
마이그레이션하려면 파트너와 협력하여 Microsoft 365 Business Premium 구독 및 라이선스를 해당 라이선스가 있는 적절한 Microsoft 365 E3 구독으로 이동하세요.
...
- 지능형 보안 그래프를 통해 지원된 응용 프로그램 제어
- 디바이스 제어(USB)
- 웹 기반 위협에 대한 네트워크 보호
- 호스트 침입 방지 규칙

Windows 10 Enterprise E3에는 Microsoft Edge에 대한 하드웨어 기반 고리의 엔터프라이즈 관리도 포함되어 있습니다.

>[!Note]
>Microsoft 365 E3로 마이그레이션된 사용자에게는 지속적으로 위협 방지를 위해 각각 Microsoft Defender for Office 365 라이선스가 필요합니다. Office 365용 Defender의 범위에 있는 모든 사용자에게 라이선스가 부여될 수 있도록 Office 365용 추가 Defender 라이선스를 구입해야 합니다. 
>
...
장치에 설치된 비즈니스용 Microsoft 365 앱 클라이언트는 엔터프라이즈용 Microsoft 365 앱의 기능을 자동으로 사용하기 시작하게 됩니다. 마이그레이션 후 다음을 사용할 수 있습니다.
