...
---
# <a name="edit-or-create-device-protection-settings-for-windows-10-pcs"></a>Windows 10 PC에 대한 장치 보호 설정 편집 또는 만들기

이 문서는 Microsoft 365 Business Premium에 적용됩니다.

설치 페이지에서 기본 Windows 보호 설정을 지정한 후 모든 사용자 또는 사용자 집합에 적용되는 새 보호 설정을 추가할 수 있습니다. 만든 파일을 편집할 수도 있습니다.
...
1. 기존 Windows 장치 정책을 선택한 다음 편집 **을 선택하세요.**
