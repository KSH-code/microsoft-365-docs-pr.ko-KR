...
<sup>1</sup> Microsoft 365 Business 버전의 Office 앱에는 그룹 정책, 앱 원격 분석, 업데이트 컨트롤, 스프레드시트 비교 및 조회, 비즈니스 인텔리전스를 통한 볼륨 정품 인증이 포함 되지 않습니다.

## <a name="migration"></a>마이그레이션

구독을 마이그레이션하려면 [다른 요금제를 수동으로 전환을](https://docs.microsoft.com/office365/admin/misc/switch-plans-manually) 참조 하세요. Microsoft 365 Business로 소수의 사용자만 이동 하려면 [모든 사용자를 자동으로 업그레이드](https://docs.microsoft.com/office365/admin/subscriptions-and-billing/upgrade-to-different-plan)하거나 파트너와 협력 하 여 E3을 이동할 수 있습니다. Microsoft 365 Business 구독에 대 한 구독 및 라이선스
...
조직의 모든 사용자를 Microsoft 365 Business로 업그레이드 한 경우 홈 페이지에 설정 마법사가 표시 되 고 [설치 마법사의 Microsoft 365 Business 설정 단계에](set-up.md) 따라 파일 및 모바일 장치를 보호할 수 있습니다.
