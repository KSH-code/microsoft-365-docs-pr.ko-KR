...
1. 고급 **사이버** 위협으로부터 보호 강화에서 [Office 365 Advanced Threat Protection이 Office](../security/office-365-security/defender-for-office-365.md) 앱에서 파일 및 링크를 검사할 수 있는 기본값을 수락하는 것이 좋습니다.
