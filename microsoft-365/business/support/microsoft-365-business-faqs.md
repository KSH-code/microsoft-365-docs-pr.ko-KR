...
- Office 365 Advanced Threat Protection 계획 1 및 Windows Defender Exploit Guard와 같은 피싱 및 정교한 멀웨어와 같은 외부 위협 으로부터 보호를 제공 합니다. 
-  Office 365 데이터 손실 방지 정책 및 Azure Information Protection 계획 1을 사용 하 여 중요 한 정보를 액세스 및 전송 하는 방법을 제어 하 고 관리 하는 데 도움이 됩니다. 
...
**간소화된 장치 배포 및 사용자 설정** 
* 사용자 및 장치를 설정 하 고 관리 하기 위한 단일 관리 콘솔 
...
- 비즈니스에 연결 하는 장치를 보호 하 고 iOS, Android, Windows 및 Mac 장치에 대 한 데이터를 안전 하 게 유지 하 고 Windows 장치를 최신 상태로 유지할 수 있도록 지원 합니다.
...
Microsoft 365 Business는 <a href="https://www.microsoft.com/solution-providers/search" target="_blank">Microsoft 파트너</a> 를 통해 또는 <a href="https://www.microsoft.com//microsoft-365/business" target="_blank">microsoft</a>에서 직접 구매할 수 있습니다. Microsoft에서 직접 구매할지 또는 Microsoft 파트너를 통해 구매할지를 결정할 때 직원에 대한 기능과 IT 인프라 유지에 대한 요구를 고려해야 합니다. Microsoft 파트너는 Microsoft 솔루션을 포함 하 여 IT 인프라를 배포 하 고 관리 하는 데 도움이 될 수 있습니다.

### <a name="how-much-does-microsoft-365-business-cost"></a>Microsoft 365 Business는 비용이 얼마나 드나요? 

Microsoft 365 Business는 Microsoft에서 직접 구입하는 경우 _연간 계약_에 따라 사용자당 월 미화 20.00달러에 제공됩니다. Microsoft 파트너 통해 구입한 경우 파트너가 제공하는 서비스와 Microsoft 365 Business에 대한 가격 책정 모델에 따라 가격은 다를 수 있습니다. 
...
IT 환경을 표준화 하면 시간에 따른 유지 관리 및 보안 비용을 줄이고 비즈니스에서 달성 해야 하는 상태를 파악할 수 있습니다. 그러나 일부 중소 규모의 고객이 하드웨어를 업그레이드 하는 경우에는 확장 된 기간 동안 소프트웨어를 업데이트 하는 것을 인식 합니다. 비즈니스는 조직의 일부에 Microsoft 365 Business를 배포할 수 있지만 중요한 비즈니스 데이터에 대한 최적의 보호와 일관적인 공동 작업 환경을 위해 모든 사용자에게 배포하는 것이 좋습니다.
...
현재 실행 중인 하드웨어가 Windows 7 Pro 이상을 실행하고 있다면 Microsoft 365 Business에 대한 최소 요구 사항을 충족할 것입니다. Cortana, Windows Hello, 멀티 터치 등의 특정 Windows 10 기능을 사용 하려면 최신 Pc 에서만 사용할 수 있는 특정 하드웨어가 필요 합니다. 자세한 내용은 <a href="https://www.microsoft.com/windows/windows-10-specifications" target="_blank">Windows 10 Pro 시스템 요구 사항을</a> 참조 하세요. 
...
Windows 10 Business는 Windows 10 Pro를 보완 하 고 Microsoft 365 비즈니스의 중앙 집중식 관리 및 보안 제어를 사용 하는 클라우드 서비스 및 장치 관리 기능 집합입니다.
...
Windows 7, 8 및 8.1 Professional에 사용이 허가 된 장치가 있는 경우 Microsoft 365 Business는 windows 10 Pro로의 업그레이드를 제공 하며,이는 3-3 비즈니스를 배포 하기 위한 필수 구성 요소입니다.
> [!IMPORTANT]
...
* Office **모바일 앱에 대 한 앱 보호** 를 통해 office 데이터를 보호할 수 있습니다. IOS 및 Android 모바일 장치의 전자 메일, 일정, 연락처 및 문서를 포함 하 여, 서비스에 연결 하지 않는 미리 정의 된 시간에 비즈니스 데이터를 자동으로 삭제 하는 등의 정책을 적용 하 고, office 앱에 액세스 하기 위해 PIN/지문 확인을 요구 하며, 회사 데이터가 office 앱에서 개인 앱으로 복사 되지 않도록 해야 합니다. Intune을 통해 다른 모바일 앱에 대 한 모바일 응용 프로그램 관리도 Microsoft 365 Business 구독자에 게 제공 됩니다. 
  
* **Windows 10 PC용 장치 관리**를 사용하면 비즈니스는 맬웨어에 대한 Windows Defender 보호, 자동 업데이트, 지정된 시간 이후 화면 끄기 등의 기능을 설정하고 시행하도록 선택할 수 있습니다. 또한 Windows 10 장치를 분실 하거나 도난당 한 경우 관리 센터를 통해 비즈니스 응용 프로그램 및 데이터를 완전히 제거할 수 있습니다. 
...
Microsoft 365 Business로 관리되는 PC는 Windows Defender로 관리되며 이것은 좋지 않습니다. Windows 10의 단일 바이러스 백신 기능은 다른 어떤 솔루션보다 더 많은 컴퓨터를 바이러스, 맬웨어, 스파이웨어 및 기타 위협으로부터 보호합니다.  Microsoft 365 Business를 사용 하 여 조직에서 windows Defender protection이 실행 되 고 있으며 항상 모든 Windows 10 장치에서 최신 상태를 유지 하 고 있는지 확인할 수 있습니다.  
 
Windows 10 Business에는 새로운 침입 방지 기능 집합인 Windows Defender Exploit Guard도 포함 됩니다. 제어 된 폴더 액세스의 기능 중 하나로, 폴더를 잠그고 권한 없는 앱이 사용자의 중요 한 파일에 액세스 하지 못하도록 차단 합니다. 

### <a name="whats-the-difference-between-office-365-business-premium-microsoft-365-business-and-microsoft-365-enterprise"></a>Office 365 Business Premium, Microsoft 365 Business 및 Microsoft 365 Enterprise의 차이점은 무엇 인가요? 

Microsoft는 데스크톱 및 장치 인프라를 업그레이드 하는 경우 각각 점점 더 강력한 기능과 기능을 제공 하는 중소 규모의 고객이 고려할 수 있는 다양 한 생산성 및 보안 관리 서비스를 갖추고 있습니다. 

**Office 365 Business Premium** 은 office 365 앱 및 서비스에 대 한 최고의 생산성을 제공 하지만 Microsoft 365 Business의 응용 프로그램 보호 및 장치 관리 기능을 포함 하지는 않습니다.
...
예, 고객은 자격이 있는 Office 365 요금제에서 Microsoft 365 Business로 전환할 수 있습니다. 고객의 현재 계획에 따라 월별 비용이 감소 하거나 늘어날 수 있습니다.

### <a name="in-what-regions-is-microsoft-365-business-available"></a>Microsoft 365 Business를 사용할 수 있는 지역은 어디인가요? 

Microsoft 365 Business는 Office 365를 사용할 수 있는 모든 파트너 및 고객에 게 제공 됩니다. <a href="https://products.office.com/business/international-availability" target="_blank">언어, 국가 및 지역에 대 한 Office 365 국제 가용성</a>목록을 참조 하세요. 

### <a name="is-there-a-microsoft-365-business-trial-i-may-use-to-evaluate-the-offer"></a>Microsoft 365 Business 평가판을 사용할 수 있나요?

Csp에 대해 Microsoft 365 비즈니스 평가판을 사용할 수 있습니다. 직접 고객을 위한 평가판은 나중에 사용할 수 있습니다. 
...
Microsoft 365 Business의 전체 기능을 경험 하려는 고객은 기존 데스크톱에서 Windows 7, 8.1 또는 10 Pro<sup>[2](#footnote2)</sup> 를 실행 해야 합니다. 기존 Windows 10 Pro PC는 크리에이터스 업데이트를 하지 않은 경우 이를 실행해야 합니다. 
...
이전 Microsoft 365 Business에는 조건부 액세스, 셀프 서비스 암호 재설정 및 다단계 인증을 비롯 하 여 Azure AD Premium 요금제 1의 하위 집합이 있었습니다. 이제는 Microsoft 365 Business 구독자에 게 초기에 전체 Azure AD Premium P1 라이선스를 배포 하 고, 처음에는 신규 고객을 선택한 다음 현재 구독자에 게 제공 됩니다. 자세한 내용은 [Microsoft 365 Business Service Description](https://docs.microsoft.com/office365/servicedescriptions/microsoft-365-service-descriptions/microsoft-365-business-service-description) and이 [블로그](https://techcommunity.microsoft.com/t5/small-and-medium-business-blog/azure-active-directory-premium-p1-is-coming-to-microsoft-365/ba-p/1275496)를 참조 하세요.
...
Windows AutoPilot은 새로운 Windows 10 PC의 배포를 간소화하는 서비스입니다. 최종 사용자가 microsoft 365 Business의 중앙화 된 관리 제어를 활용&mdash;&mdash;하 여 처음으로 microsoft 365 business에 로그온 할 때이 프로세스를 수행할 수 있습니다. 또한 Windows 10 Professional 크리에이터스 업데이트(이상)를 실행하고 공장 초기화된 기존 PC에 대해 Windows AutoPilot을 사용할 수도 있습니다. Windows AutoPilot에 대 한 자세한 내용은 <a href="https://blogs.technet.microsoft.com/windowsitpro/2017/06/29/modernizing-windows-deployment-with-windows-autopilot/" target="_blank">이 6 월 2017 블로그 게시물</a>에 나와 있습니다.
...
Microsoft는 CSP 파트너가 Microsoft 365 Business를 출시, 판매, 및 지원할 수 있는 다양한 리소스를 제공합니다. [https://partners.office.com/microsoft365business](https://partners.office.com/microsoft365business)를 참고하세요.
...
Microsoft 365 Business에서는 파트너가 추가 서비스를 판매 하 고 기존 제품 및 서비스를 업그레이드 하는 데 사용할 수 있는 견고한 보안 플랫폼을 만들어 고객에 게 신뢰 관리자의 위치를 유지할 수 있도록 합니다. Microsoft 365 Business에서는 이제 Exchange Server, Exchange Online 또는 Office 365 Business Essentials를 사용 하 여 고객에 게 업그레이드에 대 한 토론을 제공할 수 있습니다. 파트너는 또한 관리 되는 서비스 및/또는 peruser 지원 수수료를 증가 시켜 더 많은 수익을 얻을 수 있습니다. 
...
GDPR (일반 데이터 보호 규정)은 EU (유럽 연합)에서 "개인 데이터"를 보다 강력 하 게 제어할 수 있도록 하 고 조직에서 해당 개인 데이터의 무결성을 유지 해야 하는 포괄적인 새로운 개인 정보 보호법입니다. GDPR에서는 EU 거주자와 연결 된 개인 데이터를 제어 하거나 처리 하기 위해 개인 데이터 처리에 대 한 GDPR 요구 사항을 충족 하는 타사 데이터 프로세서만 사용 하는 조직이 필요 합니다. 2017년 3월 Microsoft는 이러한 보장을 제공하는 보증 계약을 체결했습니다. Microsoft에서 추가 GDPR 의무를 충족 하는 데 도움이 되는 고객은 microsoft 365 Business에서 사용할 수 있는 고급 규정 준수 및 보안 기능 (예: Azure Information Protection, 데이터 손실 방지, Advanced Threat Protection 등)과 다른 도구 모음 (예: Microsoft 365 Enterprise E5)에 대해 알아보세요. 자세한 내용을 보려면 [www.microsoft.com/gdpr](https://www.microsoft.com/gdpr)을 방문하세요.
