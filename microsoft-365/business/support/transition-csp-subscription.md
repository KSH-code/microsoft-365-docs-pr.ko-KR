...
1. <a href="https://partnercenter.microsoft.com" target="_blank">파트너 센터</a>에 로그인합니다.
...
3. 회사의 **구독** 페이지에서 **구독 추가**를 선택합니다.
4. **새 구독** 페이지에서 **중소기업**을 선택한 다음 목록에서 **Microsoft 365 Business**를 선택합니다.
5. 라이선스 수를 추가하고 **다음: 검토**를 선택하여 구독을 검토한 다음 **제출**을 선택합니다.
    ...
    **라이선스 기준 구독**에 **Microsoft 365 Business 미리 보기** 및 **Microsoft 365 Business**가 표시됩니다. 다음에 미리 보기 구독을 일시 중지해야 합니다.

6. **Microsoft 365 Business 미리 보기**를 선택합니다.
7. **Microsoft 365 Business 미리 보기** 페이지에서 **일시 중단**을 선택하여 미리 보기 구독을 일시 중단합니다.

    ![Microsoft 365 Business 미리 보기 구독 일시 중단](images/pc_customer_m365bpreview_suspend.png)

8. **제출**을 선택하여 확인합니다.

    **구독** 페이지에서 **Microsoft 365 Business 미리 보기** 상태가 **일시 중단**으로 표시되는지 확인합니다.
...
9. 필요에 따라 라이선스 계약을 확인할 수도 있습니다. 이렇게 하려면 다음 단계를 따르세요.
    ...
    3. 사용자의 페이지에서 **라이선스 할당** 섹션을 점검하여 **Microsoft 365 Business**가 표시되는지 확인합니다.
...
전환 도중 및 이후 고객과 사용자에게 미치는 영향이 없습니다.
...
| **서비스 영향**                                                        |
| **Microsoft 365 Business 관리 포털** | 기능에 미치는 영향은 없음 | 기능에 미치는 영향은 없음 | 사용자를 추가/삭제하고, 구독을 구매할 수 있습니다.</br> 라이선스를 할당/취소할 수 없습니다. | 고객의 구독 및 모든 데이터가 삭제됩니다. 관리자는 다른 유료 구독을 관리할 수 있습니다. |
...
| **Windows 10 PC에 대한 Azure AD 로그인** | 관리자 영향 없음</br> 최종 사용자 영향 없음 | 관리자 영향 없음</br> 최종 사용자 영향 없음 | 관리자 영향 없음</br> 최종 사용자 영향 없음 | 테넌트가 삭제되면 사용자가 로컬 자격 증명으로만 로그인할 수 있습니다. 로컬 자격 증명이 없는 경우 이미지로 장치를 다시 설치합니다. |

## <a name="mobile-device-impacts-upon-subscription-expiration"></a>구독 만료 시 모바일 장치 영향

다음 표에는 모바일 장치 앱 관리 정책에 대한 영향이 요약되어 있습니다.
...
| **무단 해제 또는 루팅된 장치에 있는 작업 파일에 액세스 거부** | 무단 해제 또는 루팅된 장치에 있는 작업 파일에 액세스할 수 없습니다. | 무단 해제 또는 루팅된 장치에 있는 작업 파일에 액세스할 수 있습니다. |
...
| **Microsoft Edge에서 웹 기반 위협으로부터 PC를 보호** | Microsoft Edge에서 PC 보호 | 사용자가 Microsoft Edge에서 PC 보호를 켜고 끌 수 있습니다. |
...
| **사용자가 Office 앱에서 개인 앱으로 콘텐츠를 복사하도록 허용** | Windows 10 장치를 최신 상태로 유지하는 정책을 관리자가 정의합니다. | 사용자가 Windows 업데이트 시기를 결정할 수 있습니다. |
