...
description: Microsoft 365 Business CSP 구독을 미리 보기에서 GA(일반 가용성)로 전환하는 방법을 확인하십시오.
author: jasongroce
f1.keywords:
- NOCSH
ms.custom:
...
4. 새 구독 **페이지에서** **중소기업을** 선택한 다음 목록에서 Microsoft **365 Business를** 선택합니다.
...
7. Microsoft **365 Business 미리 보기** 페이지에서 **일시** 중단을 선택하여 미리 보기 구독을 일시 중단합니다.

    ![Microsoft 365 Business 미리 보기 구독 일시 중단](../../media/pc_customer_m365bpreview_suspend.png)

8. **제출** 을 선택하여 확인합니다.

    구독 **페이지에서** **Microsoft 365 Business 미리** 보기 상태가 일시 중단 **상태인지 확인하십시오.**
...
9. 필요에 따라 라이선스 계약을 확인할 수도 있습니다. 이렇게 하려면 다음 단계를 따르세요.
    ...
    3. 사용자 페이지에서 라이선스 할당 섹션을 확인하고 **Microsoft 365 Business가 표시하는지 확인하십시오.** 
...
| **무단 해제 또는 루팅된 장치에 있는 작업 파일에 액세스 거부** | 무단 사용/루팅된 장치에서는 작업 파일에 액세스할 수 없습니다. | 무단 해제 또는 루팅된 장치에 있는 작업 파일에 액세스할 수 있습니다. |
...
|                            | 완전히 사용이 허가된 환경                      | 만료 후 T+60일          |
|----------------------------|------------------------------------------------|------------------------------------|
| **Windows Defender를 사용하여 위협으로부터 PC를 보호** | 켜기/끄기가 사용자 제어에 포함되지 않습니다. | 사용자가 Windows 10 PC에서 Windows Defender/끄기 |
| **Microsoft Edge에서 웹 기반 위협으로부터 PC를 보호** | Microsoft Edge에서 PC 보호 | 사용자가 Microsoft Edge에서 PC 보호를 켜고 끄기 |
...
| **사용자가 Office 앱에서 개인 앱으로 콘텐츠를 복사하도록 허용** | 관리자가 Windows 10 장치를 최신으로 유지하기 위한 정책을 정의합니다. | 사용자가 Windows 업데이트 시기를 결정할 수 있습니다. |
