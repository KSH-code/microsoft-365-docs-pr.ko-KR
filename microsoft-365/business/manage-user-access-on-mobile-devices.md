...
|:-----|:-----|
|설정  <br/> |설명  <br/> |
|Office 앱 액세스에 PIN 또는 지문 필요  <br/> |이 설정이 **으로** 설정되는 경우 사용자는 자신의 사용자 이름 및 암호와 함께 다른 인증 형식을 제공해야 모바일 장치에서 Office 앱을 사용할 수 있습니다.  <br/> |
...
|사용자가 Office 앱에서 개인 앱으로 콘텐츠를 복사하도록 허용하지 않습니다.  <br/> |설정이 **으로 설정될** 때 사용자는 작업 파일의 정보를 개인 파일에 복사할 수 없습니다. 설정이 **꺼진 경우** 사용자는 작업 파일의 정보를 개인 앱 또는 개인 계정으로 복사할 수 있습니다.  <br/> |
