...
앱 [보호](protection-settings-for-windows-10-devices.md)정책을 설정한 후 정책이 사용자의 장치에 적용되는 데 최대 몇 시간이 걸릴 수 있습니다. 사용자가 회사  데이터를  개인 파일에 복사할 수 없습니다.를 으로 설정하고 회사 소유 장치에 대한 비즈니스용 OneDrive 파일을 저장하도록 강제로 설정한 경우 Azure AD에 연결하고 로그인한 후 사용자의 장치에서 이 설정을 확인할 수 있습니다. 
  
 **연결 설정 확인**
  
1. Microsoft 365 Business Premium 자격 증명으로 로그인하고 Windows 장치 설정에 설명된 바와 같이 Azure AD에 연결한 Microsoft 365 Business Premium [계정](set-up-windows-devices.md)액세스로 Windows 설정 계정  \>  \> **액세스로 이동하세요.** **\<tenant name\> Azure AD에 연결 을 선택한** 다음 정보 **를 선택 합니다.**
...
1. 설치 Outlook 2016 설치한 Microsoft 365 Business Premium.
...
1. 로컬 Windows 10 로그인한 개인 장치에서 Windows 설정 로 이동하고 계정 액세스 직장 또는 학교 **를**  \> **클릭하거나 탭합니다.**
    
2. **회사 또는 학교 액세스** 에서 **연결** 을 선택합니다.
    
3. 직장 또는 Microsoft 365 Business Premium 계정 설정 대화 상자 **로그인** 에 사용자 자격 \> **증명을 입력합니다.**
...
1. 필요한 Outlook 2016 열고 Microsoft 365 Business Premium 계정을 추가하고 사용자 자격 증명으로 Microsoft 365 Business Premium 로그인합니다.
