...
|:-----|:-----|
|설정  <br/> |설명  <br/> |
|이 기간이 지난 후 비활성 장치에서 업무 파일 삭제  <br/> |여기에 지정한 기간만큼 장치가 사용되지 않는 경우 장치에 저장된 모든 업무 파일이 자동으로 삭제됩니다.  <br/> |
|사용자가 모든 업무 파일을 비즈니스용 OneDrive에 저장하도록 강제 적용  <br/> |이 설정이 **켜짐**으로 되어 있으면 업무 파일은 오직 비즈니스용 OneDrive에만 저장할 수 있습니다.  <br/> |
|업무 파일 암호화  <br/> |업무 파일이 암호화로 보호되도록 이 설정을 **켜짐**으로 둡니다. 장치를 분실하거나 도난당하더라도 다른 사람이 회사 데이터를 읽을 수 없게 됩니다.  <br/> |
