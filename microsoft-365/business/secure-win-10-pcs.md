...
4. Windows 10 설정에서 설정 하려는 옵션을 선택 합니다. 설정에 대 한 자세한 내용은 [Windows 10 장치 보안](secure-windows-10-devices.md)을 참조 하십시오. 
5. 조직에서 정책을 적용할 사용자를 선택한 다음 **변경 내용 저장**을 선택 합니다.
