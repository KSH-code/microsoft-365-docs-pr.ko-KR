...
Microsoft 365 Business Premium에는 데이터 및 장치를 보호하고 사용자와 고객의 중요한 정보를 안전하게 유지하는 데 도움이 되는 기능이 함께 제공되어 있습니다.
 ...
 **Exchange Online Archiving** 기능은 eDiscovery에 대한 전자 메일 콘텐츠를 보존하여 규정 준수 및 규정 표준을 유지하는 데 도움이 됩니다. 또한 소송이 있는 경우 위험을 줄이는 데 도움이 되고, 보안 위반 후 또는 삭제된 항목을 복구해야 할 때 데이터를 복구할 수 있는 방법을 제공합니다. 소송 보존을 사용하여 사용자의 모든 콘텐츠를 보존하거나 보존 정책을 사용하여 보존할 콘텐츠를 사용자 지정할 수 있습니다.
